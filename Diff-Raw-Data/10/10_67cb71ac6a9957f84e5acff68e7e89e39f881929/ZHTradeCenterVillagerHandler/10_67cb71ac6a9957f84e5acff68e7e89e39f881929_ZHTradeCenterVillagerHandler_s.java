     ...
     public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random random)
     {
         if (villager.getProfession() == 0) // Farmer
         {
             ...
             if (TradeCenter.enableBetterVillagerTrades.getBoolean(true))
             {
                ...
                recipeList.add(new MerchantRecipe(new ItemStack(Item.emerald, 1), null, new ItemStack(Item.dyePowder, 4, 4)));
                recipeList.add(new MerchantRecipe(new ItemStack(Item.emerald, 1), null, new ItemStack(Item.dyePowder, 4, 5)));
