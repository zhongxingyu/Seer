 ...
 //		issueCommand("flush", null);
 	...
 	private SimVector newVector(int command, String [] params, double insertTime, boolean justAppend)
 	{
 		...
 		switch (command)
 		{
 			...
 			case VECTORPATH:
 			case VECTORSTOP:
 				newsv.sigs = new ArrayList<Signal>();
 				newsv.sigsNegated = null;
 				if (command == VECTORT) newsv.sigsNegated = new ArrayList<Signal>();
 ...
 //					afterSV.parameters[0] = TextUtils.formatDouble(thisStep / cmdFileUnits);
 	...
 	private void getTargetNodes(String [] params, int low, List<Signal> normalList, List<Signal> negatedList)
 	{
