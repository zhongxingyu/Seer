 ...
 public class CodeCompiler extends Visitor {
 	...
 	public boolean fast_locals, class_body, print_results;
 	...
 	public Object Dot_Op(SimpleNode node) throws Exception {
 		String name = (String)node.getChild(1).getInfo();
 		int old_mode = mode;
 		mode = GET;
 		node.getChild(0).visit(this);
 		mode = old_mode;
 			...
 			if (!fast_locals || i != null) {
 				if (i == null) {
 					...
 					if (mrefs.getlocal1 == 0) {
 						mrefs.getlocal1 = code.pool.Methodref("org/python/core/PyFrame", "getlocal",
 							"(Ljava/lang/String;)Lorg/python/core/PyObject;");
 					}
