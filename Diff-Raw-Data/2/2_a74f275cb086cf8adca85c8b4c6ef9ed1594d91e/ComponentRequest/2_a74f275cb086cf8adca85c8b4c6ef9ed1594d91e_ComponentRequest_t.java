 ...
 /**
  * The <code>ComponentRequest</code> defines the interface to provide client
  * request information to a component.
  * <p id="decomp">
  * <b>Decomposition of a Request URL</b>
  * <p>
  * The Component Framework is responsible to decompose the
  ...
  * or <i>multipart/form-data</i>. The Component Framework must decode
  * parameters transferred as request data and make them available through the
  * various parameter accessor methods. Generally parameters transferred as
 ...
 public interface ComponentRequest extends HttpServletRequest {
      ...
      *         path.
      * @throws ComponentException If an error occurrs trying to load the content
     ...
     /**
      * Returns the value of a request parameter as a {@link RequestParameter}, or
