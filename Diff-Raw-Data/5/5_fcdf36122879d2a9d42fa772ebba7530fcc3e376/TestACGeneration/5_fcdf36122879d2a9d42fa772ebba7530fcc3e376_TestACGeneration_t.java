 ...
 public class TestACGeneration {
 	...
 	final List<VOMSGenericAttribute> defaultGAs = Arrays.asList(
 				buildGA("test", "value", defaultVO),
 				buildGA("test2", "value", defaultVO));
	...
	static VOMSValidationErrorMessage expiredCertCRLErrorMessage;
 	...
 	private AttributeCertificate createAC(PEMCredential aaCredential, List<String> fqans, 
 		...
 		X509AttributeCertificateHolder ac = gen.generateVOMSAttributeCertificate(fqans, 
 				gas, 
 				null, 
 	...
 	@Test
 	public void testGeneratedACParsing() throws KeyStoreException, CertificateException, FileNotFoundException, IOException, OperatorCreationException {	
