 ...
 public class UsrpropsDslFormatter extends AbstractDeclarativeFormatter {
     ...
     protected void configureFormatting(FormattingConfig c) {
         ...
         c.setLinewrap(0, 1, 10).before(grammar.getREMRule());
         c.setLinewrap(0, 1, 10).after(grammar.getREMRule());
         ...
         c.setNoSpace().around(grammar.getFillColorAccess().getBeginAssignment_1());
         c.setNoSpace().around(grammar.getFillColorAccess().getCommaKeyword_3());
         c.setNoSpace().around(grammar.getFillColorAccess().getCommaKeyword_5());
         c.setNoSpace().before(grammar.getFillColorAccess().getEndAssignment_7());
         ...
         c.setNoLinewrap().between(grammar.getValueRule(), grammar.getDepictionsRule());
         ...
         // Symbol rules are on their own line
         c.setLinewrap().before(grammar.getDefinedByRule());
         c.setLinewrap().before(grammar.getAssignToRule());
         c.setLinewrap().before(grammar.getDepictLikeRule());
         c.setLinewrap().before(grammar.getDepictionsRule());
