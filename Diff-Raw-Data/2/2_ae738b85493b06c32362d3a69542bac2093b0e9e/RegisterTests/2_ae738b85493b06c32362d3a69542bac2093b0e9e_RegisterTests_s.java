 ...
 public class RegisterTests extends SubscriptionManagerCLITestScript {
 	...
 	public void RegisterWithCredentials_Test(String username, String password, String org) {
 		...
 		SSHCommandResult registerResult = clienttasks.register_(username, password, org, null, null, null, null, null, (String)null, null, null, null, null);
 ...
 //DO NOT		clienttasks.unregister();
 		...
 		SSHCommandResult sshCommandResult = clienttasks.register_(username, password, owner, null, type, name, consumerId, autosubscribe, (String)null, force, null, null, null);
 	...
 	@Test(	description="subscription-manager-cli: register to a Candlepin server using autosubscribe functionality",
 			groups={"RegisterWithAutosubscribe_Test","blockedByBug-602378", "blockedByBug-616137", "blockedByBug-678049", "blockedByBug-737762", "AcceptanceTests"},
 			enabled=true)
 	public void RegisterWithAutosubscribe_Test() throws JSONException, Exception {
 		...
 		clienttasks.unregister(null, null, null);
 		SSHCommandResult sshCommandResult = clienttasks.register(sm_clientUsername, sm_clientPassword, sm_clientOrg, null, null, null, null, Boolean.TRUE, (String)null, null, null, null, null);
 		...
 		*/
 		...
 		clienttasks.unregister(null, null, null);
 		sshCommandResult = clienttasks.register(sm_clientUsername, sm_clientPassword, sm_clientOrg, null, null, null, null, Boolean.TRUE, (String)null, null, null, null, null);
 	...
 	public void RegisterWithForce_Test() {
 		...
 		SSHCommandResult sshCommandResult = clienttasks.register(sm_clientUsername,sm_clientPassword,sm_clientOrg,null,null,null,null,null, (String)null, null, null, null, null);
 		...
 		sshCommandResult = clienttasks.register(sm_clientUsername,sm_clientPassword,sm_clientOrg,null,null,null,null,null, (String)null, null, null, null, null);
 		...
 		// register with force
 		sshCommandResult = clienttasks.register(sm_clientUsername,sm_clientPassword,sm_clientOrg,null,null,null,null,null, (String)null, Boolean.TRUE, null, null, null);
 	...
 	public void RegisterWithName_Test(Object meta, String name, Integer expectedExitCode, String expectedStdoutRegex, String expectedStderrRegex) {
 		...
 		SSHCommandResult sshCommandResult = clienttasks.register_(sm_clientUsername,sm_clientPassword,sm_clientOrg,null,null,name,null, null, (String)null, null, null, null, null);
 	...
 	public void RegisterWithNameAndType_Test(Object meta, String username, String password, String owner, String name, ConsumerType type, Integer expectedExitCode, String expectedStdoutRegex, String expectedStderrRegex) {
 		...
 		// register with a name
 		SSHCommandResult sshCommandResult = clienttasks.register_(username,password,owner,null,type,name,null, null, (String)null, null, null, null, null);
 	...
 	public void ReregisterBasicRegistration_Test() {
 		...
 		clienttasks.unregister(null, null, null);
 		String consumerIdBefore = clienttasks.getCurrentConsumerId(clienttasks.register(sm_clientUsername,sm_clientPassword,sm_clientOrg,null,null,null,null,null,(String)null,null,null,null,null));
 	...
 	public void ReregisterWithBadIdentityCert_Test() {
 		...
 		clienttasks.register(sm_clientUsername,sm_clientPassword,null,null,null,null,consumerCertBefore.consumerid, null, (String)null, Boolean.TRUE, null, null, null);
 ...
 Expected Results:
     ...
     * when registering a new system to an already existing consumer, all of the existing consumers entitlement certs should be downloaded to the new system
 	...
 	public void ReregisterWithConsumerIdShouldAutomaticallyRefreshEntitlements_Test() {
 		...
 		clienttasks.register(sm_clientUsername,sm_clientPassword,null,null,null,null,consumerId, null, (String)null, null, null, null, null);
 	...
 	public void AttemptRegisterToEnvironmentWhenCandlepinDoesNotSupportEnvironments_Test() throws JSONException, Exception {
 		...
 		SSHCommandResult result = clienttasks.register_(sm_clientUsername,sm_clientPassword,sm_clientOrg,"foo",null,null,null,null,(String)null,true,null,null, null);
 	...
 	public void AttemptRegisterToEnvironmentWithoutOrg_Test() {
 		...
 		SSHCommandResult result = clienttasks.register_(sm_clientUsername,sm_clientPassword,null,"foo",null,null,null,null,(String)null,true,null,null, null);
 	...
 	protected List<List<Object>> getInvalidRegistrationWithLocalizedStringsAsListOfLists(){
 		...
 		if (sm_isServerOnPremises) {
 			...
 			ll.add(Arrays.asList(new Object[]{null,								"pt_BR.UTF8", sm_clientUsername+getRandInt(), sm_clientPassword+getRandInt(), 255, null, "Credenciais inválidas"}));
