 ...
 public class GetTermCount2 extends PowerTool {
 	private static final Logger LOG = Logger.getLogger(GetTermCount2.class);
 	...
 	public GetTermCount2(Configuration conf) {
 		super(conf);
 	}
