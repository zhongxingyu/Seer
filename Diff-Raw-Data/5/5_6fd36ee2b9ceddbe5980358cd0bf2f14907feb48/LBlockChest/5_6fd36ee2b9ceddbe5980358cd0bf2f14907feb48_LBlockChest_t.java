 ...
 public class LBlockChest extends BlockContainer
 {
     ...
     public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
     {
         ...
         {
             ((TileEntityLChest)par1World.getBlockTileEntity(par2, par3, par4)).setChestGuiName(par6ItemStack.getDisplayName());
         }
     }
     ...
     {
         this.blockIcon = par1IconRegister.registerIcon("learncraft:copper_front");
     }
 }
