 ...
 import com.rcs.configuration.model.ConfigurationClp;
 ...
 public class ClpSerializer {
 	...
 	public static Object translateOutput(BaseModel<?> oldModel) {
 		...
 		if (oldModelClassName.equals(
 					"com.rcs.configuration.model.impl.ConfigurationImpl")) {
 	...
 	public static Throwable translateThrowable(Throwable throwable) {
 		...
 		if (className.equals(
 			...
 			return new com.rcs.configuration.NoSuchConfigurationException();
 		}
