 ...
 public class RemoteBrowserResourceAuthTest extends AbstractPluginTestCase
 {
     ...
     public void testSiteWithAuth() throws Exception
     {
        String remoteUrl = server.getUrl( "auth-test/" );
         ...
         TemplateProvider templateProvider =  this.lookup( TemplateProvider.class,  DefaultRepositoryTemplateProvider.PROVIDER_ID );
         Maven2ProxyRepositoryTemplate template = (Maven2ProxyRepositoryTemplate) templateProvider.getTemplateById( "default_proxy_release" );
