 ...
 public final class Settings {
     ...
     public static final class System extends NameValueTable {
         ...
         static {
             ...
             MOVED_TO_SECURE.add(Secure.POWER_SAVER_ORIGINAL_NETWORK_MODE);
             MOVED_TO_SECURE.add(Secure.POWER_SAVER_ORIGINAL_NETWORK_ON);
             MOVED_TO_SECURE.add(Secure.POWER_SAVER_MODE);
             MOVED_TO_SECURE.add(Secure.POWER_SAVER_DATA_MODE);
             MOVED_TO_SECURE.add(Secure.POWER_SAVER_SYNC_MODE);
             MOVED_TO_SECURE.add(Secure.POWER_SAVER_SYNC_INTERVAL);
             MOVED_TO_SECURE.add(Secure.POWER_SAVER_DATA_DELAY);
             MOVED_TO_SECURE.add(Secure.POWER_DIALOG_SHOW_POWER_SAVER);
             MOVED_TO_SECURE.add(Secure.POWER_SAVER_WIFI_MODE);
             MOVED_TO_SECURE.add(Secure.POWER_SAVER_SYNC_DATA_MODE);
             MOVED_TO_SECURE.add(Secure.POWER_SAVER_SYNC_MOBILE_PREFERENCE);
 	...
 	/**
         ...
         /**
          * The color to render the background app
          * hex value including alpha
          * default: ff000000
          * @hide
          */
         public static final String BACKGROUND_APP_COLOR = "background_app_color";
 	...
 	/**
          ...
          * @hide
          */
         public static final String TRANSPARENT_BACKGROUND_APP = "transparent_background_app";
 	...
 	/**
          ...
          * @hide
          */
         public static final String CARRIER_LOGO_STATUS_BAR = "carrier_logo_status_bar";
 	...
 	/**
          ...
          * @hide
          */
         public static final String MUSIC_WIDGET_TOGGLE = "music_widget_toggle";
 	...
 	/**
          ...
          * @hide
          */
         public static final String TEXT_GLOBALOFCOLOR = "text_globalofcolor";
          ...
          * @hide
          */
         public static final String STATUS_BAR_LOCKSCREENCOLOR = "status_bar_lockscreencolor";
         ...
         /**
          * Specifies whether or not to enable smspopup
          * @hide
          */
         public static final String USE_POPUP_SMS = "use_popup_sms";
         ...
         /**
          * Specifies whether or not to use a task switcher instead of the recent applications dialog
          * @hide
          */
         public static final String USE_TASKSWITCHER = "use_taskswitcher";
          ...
          * @hide
          */
         public static final String USE_CUSTOM_QUICK_APP_TOGGLE = "use_custom_quick_app_toggle";
 
         /**
          * Specifies whether or not to use a custom app on home key press
          * @hide
          */
         public static final String USE_CUSTOM_HOME_APP_TOGGLE = "use_custom_home_app_toggle";
 
         /**
          * Specifies whether or not to use a custom app on back key press
          * @hide
          */
         public static final String USE_CUSTOM_BACK_APP_TOGGLE = "use_custom_back_app_toggle";
 
         /**
          * Specifies whether or not to use a custom app on menu key press
          * @hide
          */
         public static final String USE_CUSTOM_MENU_APP_TOGGLE = "use_custom_menu_app_toggle";
 
         /**
          * Contains activity to start on navisearch key press
          * @hide
          */
         public static final String USE_CUSTOM_NAVISEARCH_APP_ACTIVITY = "use_custom_navisearch_app_activity";
 
         /**
          * Contains activity to start on quick key press
          * @hide
          */
         public static final String USE_CUSTOM_QUICK_APP_ACTIVITY = "use_custom_quick_app_activity";
 
         /**
          * Contains activity to start on home key press
          * @hide
          */
         public static final String USE_CUSTOM_HOME_APP_ACTIVITY = "use_custom_home_app_activity";
 
         /**
          * Contains activity to start on menu key press
          * @hide
          */
         public static final String USE_CUSTOM_MENU_APP_ACTIVITY = "use_custom_menu_app_activity";
 
         /**
          * Contains activity to start on back key press
          * @hide
          */
         public static final String USE_CUSTOM_BACK_APP_ACTIVITY = "use_custom_back_app_activity";
 
         /**
          * Specifies whether or not to use a custom app on shortcut statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT_TOGGLE = "use_custom_shortcut_toggle";
 
         /**
          * Contains activity to start on shortcut1 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT1_ACTIVITY = "use_custom_shortcut1_activity";
 
         /**
          * Contains activity to start on shortcut2 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT2_ACTIVITY = "use_custom_shortcut2_activity";
 
         /**
          * Contains activity to start on shortcut3 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT3_ACTIVITY = "use_custom_shortcut3_activity";
 
         /**
          * Contains activity to start on shortcut4 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT4_ACTIVITY = "use_custom_shortcut4_activity";
 
         /**
          * Contains activity to start on shortcut5 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT5_ACTIVITY = "use_custom_shortcut5_activity";
 
         /**
          * Contains activity to start on shortcut6 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT6_ACTIVITY = "use_custom_shortcut6_activity";
 
         /**
          * Contains activity to start on shortcut7 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT7_ACTIVITY = "use_custom_shortcut7_activity";
 
         /**
          * Contains activity to start on shortcut8 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT8_ACTIVITY = "use_custom_shortcut8_activity";
 
         /**
          * Contains activity to start on shortcut9 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT9_ACTIVITY = "use_custom_shortcut9_activity";
 
         /**
          * Contains activity to start on shortcut10 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT10_ACTIVITY = "use_custom_shortcut10_activity";
 
         /**
          * Contains activity to start on shortcut11 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT11_ACTIVITY = "use_custom_shortcut11_activity";
 
         /**
          * Contains activity to start on shortcut12 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT12_ACTIVITY = "use_custom_shortcut12_activity";
 
         /**
          * Contains activity to start on shortcut13 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT13_ACTIVITY = "use_custom_shortcut13_activity";
 
         /**
          * Contains activity to start on shortcut14 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT14_ACTIVITY = "use_custom_shortcut14_activity";
 
         /**
          * Contains activity to start on shortcut15 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT15_ACTIVITY = "use_custom_shortcut15_activity";
 
         /**
          * Contains activity to start on shortcut16 statusbar
          * @hide
          */
         public static final String USE_CUSTOM_SHORTCUT16_ACTIVITY = "use_custom_shortcut16_activity";
         ...
         /**
          * Whether to play a sound for full or low-battery alerts.
          * @hide
          */
          ...
          * @hide
          */
         public static final String POWER_BATTERYFULL_ENABLED = "power_batteryfull_enabled";
 
         /**
          * Whether to play a sound for full or low-battery alerts.
          * @hide
          */
         public static final String POWER_BATTERYLOW_ENABLED = "power_batterylow_enabled";
         ...
         /**
          * URI for the charging battery sound file.
          * @hide
          */
         public static final String CHARGING_BATTERY_SOUND = "charging_battery_sound";
 
         /**
          * URI for the discharging battery sound file.
          * @hide
          */
         public static final String DISCHARGING_BATTERY_SOUND = "discharging_battery_sound";
         ...
         /**
          * Whether to enable bootsound
          * @hide
          */
         public static final String ENABLE_BOOTSOUND = "enable_bootsound";
          ...
          * @hide
          */
         public static final String CARRIER_LABEL_LOCKSCREEN_TYPE = "carrier_label_lockscreen_type";
          ...
          * @hide
          */
         public static final String CARRIER_LABEL_LOCKSCREEN_CUSTOM_STRING = "carrier_label_lockscreen_custom_string";
 
         /**
          * The custom string to show as carrier label
          * @hide
          */
         public static final String CUSTOM_TEXT_STRING = "custom_text_string";
 	 ...
 	 * 3: Display status bar battery
         ...
         /**
          * Display style of cm battery percentage information
          * 0: Default cm battery percentage
          * 1: cm battery with percent
          * 2: cm battery percentage with color
          * default: 0
          * @hide
          */
        ...
        public static final String STATUS_BAR_3G = "status_bar_3g";
         ...
         /**
          * Whether to show the date in status bar
          * of the stock battery icon
          * 0: don't show the date
          * 1: show the date
          * default: 1
          * @hide
          */
         ...
         /**
          * Whether to show the Notif in status bar
          * of the stock battery icon
          * 0: don't show the notif
          * 1: show the notif
          * default: 1
          * @hide
          */
         ...
         /**
          * Whether to show the wifi text or wifi bars.
          * default: 0
          * 0: show signal bars
          * 1: show signal text numbers
          * @hide
          */
         public static final String STATUS_BAR_CM_WIFI_TEXT = "status_bar_cm_wifi";
         ...
         /**
          * Whether to display the soft buttons
          * 0: hide soft buttons (default for most devices)
          * 1: show soft buttons
          * @hide
          */
         public static final String USE_SOFT_BUTTONS = "use_soft_buttons";
 
         /**
          * Whether to display the nav buttons
          * 0: hide nav buttons (default for most devices)
          * 1: show nav buttons
          * @hide
          */
          ...
          * @hide
          */
         public static final String SHOW_STATUSBAR_LOCKSCREEN = "show_statusbar_lockscreen";
          ...
          * @hide
          */
         public static final String NAVI_BUTTONS = "navi_buttons";
 
         /**
          * Whether or not home is displayed in soft buttons.
          * @hide
          */
         public static final String NAVI_BUTTON_SHOW_HOME = "navi_button_show_home";
 
         /**
          * Whether or not menu is displayed in soft buttons.
          * @hide
          */
         public static final String NAVI_BUTTON_SHOW_MENU = "navi_button_show_menu";
 
         /**
          * Whether or not back is displayed in soft buttons.
          * @hide
          */
         public static final String NAVI_BUTTON_SHOW_BACK = "navi_button_show_back";
 
         /**
          * Whether or not search is displayed in soft buttons.
          * @hide
          */
         public static final String NAVI_BUTTON_SHOW_SEARCH = "navi_button_show_search";
 
         /**
          * Whether or not quick is displayed in soft buttons.
          * @hide
          */
          ...
          * @hide
          */
         public static final String STATUS_BAR_REVERSE = "status_bar_reverse";
 
         /**
          * Whether to add statusbar carrier label layout
          *
          * @hide
          */
          ...
          * @hide
          */
         public static final String STATUSBAR_STATS_SIZE = "statusbar_stats_size";
 
         /**
          * @hide
          */
         public static final String STATUSBAR_ICONS_SIZE = "statusbar_icons_size";
          ...
          * @hide
          */
         public static final String STATUSBAR_ICON_FONT_SIZE = "statusbar_icon_font_size";
 
         /**
          * @hide
          */
         public static final String STATUSBAR_CARRIER_FONT_SIZE = "statusbar_carrier_font_size";
         ...
         /**
          * Whether to animate at shutdown. The value is boolean (1 or 0).
          * @hide
          */
         public static final String ANIMATION_ON_SHUTDOWN = "animation_on_shutdown";
 
         /**
          * Whether to display 4g icon on status bar
          * 0: 4g icon is never displayed
          * 1: 4g icon is displayed
          * @hide
          */
        ...
        /**
         * Toggle message on the lockscreen
         * @hide
         */
         ...
         /**
          * Whether to show/hide secure icon
          * @hide
          */
         public static final String SHOW_STATUS_BAR_LOCK = "show_status_bar_lock";
 	...
 	/**
          ...
          * @hide
          */
         public static final String EXPANDED_VIEW_WIDGET_GRID_ONE = "expanded_view_widget_grid_one";
          ...
          * @hide
          */
         public static final String EXPANDED_VIEW_WIDGET_GRID_TWO = "expanded_view_widget_grid_two";
          ...
          * @hide
          */
         public static final String EXPANDED_VIEW_WIDGET_GRID_THREE = "expanded_view_widget_grid_three";
          ...
          * @hide
          */
         public static final String EXPANDED_VIEW_WIDGET_GRID_FOUR = "expanded_view_widget_grid_four";
         ...
         /**
          * Whether to enable/disable setting option
          * button
          *
          * @hide
          */
         public static final String ENABLE_SETTING_BUTTON = "enable_setting_button";
        ...
        /**
         * Power Menu - Airplane toggle
         * @hide
         */
         public static final String POWER_DIALOG_SHOW_AIRPLANE = "power_dialog_show_airplane";
 
        /**
         * Power Menu - Suspend toggle
         * @hide
         */
         public static final String POWER_DIALOG_SHOW_SUSPEND = "power_dialog_show_suspend";
 
        /**
         * Power Menu - Hibernate toggle
         * @hide
         */
         public static final String POWER_DIALOG_SHOW_HIBERNATE = "power_dialog_show_hibernate";
        ...
        /**
         * Power Menu - Navbar toggle
         * @hide
         */
         public static final String POWER_DIALOG_SHOW_NAVI = "power_dialog_show_navi";
         ...
         */
         ...
         public static final String[] SETTINGS_TO_BACKUP = {
             ...
             RINGER_LOOP,
             RECENT_APPS_STATUS_BAR,
             CALL_ME_LOUDER,
             MUTE_ANNOYING_NOTIFICATIONS_THRESHOLD,
             HIDE_AVATAR_MESSAGE,
             FLIPPING_DOWN_MUTES_RINGER,
             FLIPPING_DOWN_SNOOZES_ALARM,
             BACK_BUTTON_ENDS_CALL,
             END_BUTTON_BEHAVIOR,
             STATUS_BAR_COLOR,
             BACKGROUND_APP_COLOR,
             TRANSPARENT_STATUS_BAR,
             TRANSPARENT_BACKGROUND_APP,
             TRANSPARENT_BACKGROUND_FULL,
             NAVI_BAR_COLOR,
             PWR_CRR_COLOR,
             STS_BTT_COLOR,
             OVERICON_COLOR,
             ENABLE_OVERICON_COLOR,
             TRANSPARENT_NAVI_BAR,
             TRANSPARENT_PWR_CRR,
             TRANSPARENT_STS_BTT,
             CARRIER_LOGO_STATUS_BAR,
             MUSIC_WIDGET_TOGGLE,
             NOTIFICATION_BACKGROUND_COLOR,
             TRANSPARENT_NOTIFICATION_BACKGROUND,
             STATUS_BAR_CLOCKCOLOR,
             STATUS_BAR_SETTINGSCOLOR,
             TEXT_GLOBALOFCOLOR,
             TEXT_FULLOFCOLOR,
             STATUS_BAR_CARRIERCOLOR,
             STATUS_BAR_LOCKSCREENCOLOR,
             MODE_VOLUME_OVERLAY,
             INCREASING_RING,
             INCREASING_RING_MIN_VOLUME,
             INCREASING_RING_INTERVAL,
             NOTIFICATIONS_USE_RING_VOLUME,
             DEFAULT_VOLUME_CONTROL_MEDIA,
             LOCK_VOLUME_KEYS,
             VOLUME_KEY_BEEPS,
             CAMERA_FOCUS_MUTE,
             ...
             WEB_VIEW_PINCH_REFLOW,
             LOCKSCREEN_SEE_THROUGH,
             SWAP_VOLUME_KEYS_ORIENTATION,
             USE_POPUP_SMS,
             RECENT_APPS_NUMBER,
             RECENT_APPS_SHOW_TITLE,
             USE_QUICK_RECENT,
             USE_CUSTOM_APP,
             USE_TASKSWITCHER,
             SELECTED_CUSTOM_APP,
             USE_CUSTOM_SEARCH_APP_TOGGLE,
             USE_CUSTOM_SEARCH_APP_ACTIVITY,
             USE_CUSTOM_LONG_MENU,
             USE_CUSTOM_LONG_MENU_APP_ACTIVITY,
             ...
             USE_CUSTOM_MENU_APP_TOGGLE,
             USE_CUSTOM_NAVISEARCH_APP_ACTIVITY,
             USE_CUSTOM_QUICK_APP_ACTIVITY,
             USE_CUSTOM_HOME_APP_ACTIVITY,
             USE_CUSTOM_MENU_APP_ACTIVITY,
             USE_CUSTOM_BACK_APP_ACTIVITY,
             USE_CUSTOM_SHORTCUT_TOGGLE,
             USE_CUSTOM_SHORTCUT1_ACTIVITY,
             USE_CUSTOM_SHORTCUT2_ACTIVITY,
             USE_CUSTOM_SHORTCUT3_ACTIVITY,
             USE_CUSTOM_SHORTCUT4_ACTIVITY,
             USE_CUSTOM_SHORTCUT5_ACTIVITY,
             USE_CUSTOM_SHORTCUT6_ACTIVITY,
             USE_CUSTOM_SHORTCUT7_ACTIVITY,
             USE_CUSTOM_SHORTCUT8_ACTIVITY,
             USE_CUSTOM_SHORTCUT9_ACTIVITY,
             USE_CUSTOM_SHORTCUT10_ACTIVITY,
             USE_CUSTOM_SHORTCUT11_ACTIVITY,
             USE_CUSTOM_SHORTCUT12_ACTIVITY,
             USE_CUSTOM_SHORTCUT13_ACTIVITY,
             USE_CUSTOM_SHORTCUT14_ACTIVITY,
             USE_CUSTOM_SHORTCUT15_ACTIVITY,
             USE_CUSTOM_SHORTCUT16_ACTIVITY,
             USER_DEFINED_KEY1_APP,
             USER_DEFINED_KEY2_APP,
             USER_DEFINED_KEY3_APP,
             USER_DEFINED_KEY_ENVELOPE,
             USER_DEFINED_KEY_EXPLORER,
             POWER_DIALOG_PROMPT,
             SHARE_SCREENSHOT,
             SCREEN_LOCK_SECURITY_TIMEOUT_DELAY,
             SCREEN_LOCK_SECURITY_SCREENOFF_DELAY,
             SCREEN_LOCK_SLIDE_DELAY_TOGGLE,
             SCREEN_LOCK_SLIDE_TIMEOUT_DELAY,
             SCREEN_LOCK_SLIDE_SCREENOFF_DELAY,
             CALL_AUTO_RETRY,
             POWER_BATTERYFULL_ENABLED,
             POWER_BATTERYLOW_ENABLED,
             ...
             CARRIER_LABEL_LOCKSCREEN_CUSTOM_STRING,
             CUSTOM_TEXT_STRING,
             STATUS_BAR_AM_PM,
             STATUS_BAR_BATTERY,
             ...
             STATUS_BAR_CLOCK,
             STATUS_BAR_WEEKDAY,
             STATUS_BAR_CLOCKEXPAND,
             STATUS_BAR_INTRUDER_ALERT,
             STATUS_BAR_INTRUDER_TIME,
             VOLUME_KEY_CURSOR_CONTROL,
             MENU_BUTTON_ANSWERS_CALL,
             STATUS_BAR_DATE,
             COLOR_DATE,
             COLOR_NOTIFICATION_NONE,
             COLOR_NOTIFICATION_LATEST,
             COLOR_NOTIFICATION_ONGOING,
             COLOR_NOTIFICATION_CLEAR_BUTTON,
             COLOR_NOTIFICATION_TICKER_TEXT,
             COLOR_NOTIFICATION_ITEM_TITLE,
             COLOR_NOTIFICATION_ITEM_TEXT,
             COLOR_NOTIFICATION_ITEM_TIME,
             STATUS_BAR_NOTIF,
             STATUS_BAR_SHOWRAM,
             STATUS_BAR_SHOWICONEX,
             STATUS_BAR_CM_SIGNAL_TEXT,
             STATUS_BAR_CM_WIFI_TEXT,
             STATUS_BAR_BOTTOM,
             USE_SOFT_BUTTONS,
             SHOW_NAVI_BUTTONS,
             WATCH_IS_NEXT,
             ...
             SOFT_BUTTON_SHOW_HOME,
             SOFT_BUTTON_SHOW_MENU,
             SOFT_BUTTON_SHOW_BACK,
             SOFT_BUTTON_SHOW_SEARCH,
             SOFT_BUTTON_SHOW_QUICK_NA,
             SOFT_BUTTONS_LEFT,
             NAVI_BUTTONS,
             NAVI_BUTTON_SHOW_HOME,
             NAVI_BUTTON_SHOW_MENU,
             NAVI_BUTTON_SHOW_BACK,
             NAVI_BUTTON_SHOW_SEARCH,
             NAVI_BUTTON_SHOW_QUICKER,
             REVERSE_ROTATIONS,
             DISPLAY_CUSTOM_SIZES,
             FULLSCREEN_DISABLED,
             LOCKSCREEN_DISABLED,
             UNHIDE_BUTTON,
             EXTEND_PM,
             ...
             EXTEND_PM_SHOW_MENU,
             EXTEND_PM_SHOW_BACK,
             REVERSE_VOLUME_BEHAVIOR,
             VOLUME_REMAP_BEHAVIOR,
             LONG_VOLP_ACTION,
             LONG_VOLM_ACTION,
             VOL_BOTH_ACTION,
             LONG_VOL_BOTH_ACTION,
             CARRIER_LOGO,
             STATUS_BAR_REVERSE,
             STATUS_BAR_CARRIER,
             STATUSBAR_CLOCK_FONT_SIZE,
             STATUSBAR_STATS_SIZE,
             STATUSBAR_ICONS_SIZE,
             STATUSBAR_NAVI_SIZE,
             STATUSBAR_EXPANDED_SIZE,
             STATUSBAR_TINY_EXPANDED,
             STATUSBAR_MORE_EXPANDED,
             STATUSBAR_ICON_FONT_SIZE,
             STATUSBAR_CARRIER_FONT_SIZE,
             STATUS_BAR_BRIGHTNESS_TOGGLE,
             STATUS_BAR_HEADSET,
             VIBRATE_ON_SHUTDOWN,
             ANIMATION_ON_SHUTDOWN,
             STATUS_BAR_FOURG,
             LOCKSCREEN_WEATHER,
             ...
             WEATHER_USE_METRIC,
             WEATHER_INVERT_LOWHIGH,
             TRACKBALL_WAKE_SCREEN,
             TRACKBALL_UNLOCK_SCREEN,
             SLIDER_UNLOCK_SCREEN,
             VOLUME_WAKE_SCREEN,
             CLOCK_FONT,
             LOCKSCREEN_DISABLE_ON_SECURITY,
             LOCKSCREEN_QUICK_UNLOCK_CONTROL,
             LOCKSCREEN_FUZZY_CLOCK,
             LOCKSCREEN_MESSAGE,
             LOCKSCREEN_CUSTOM_APP_TOGGLE,
             SHOW_STATUS_BAR_LOCK,
             SHOW_STATUS_CLOCK,
             PHONE_FORCE_INCOMING_CALL_UI,
             PICK_UP_TO_CALL,
             LOCKSCREEN_CUSTOM_APP_ACTIVITY,
             LOCKSCREEN_CUSTOM_ICON_STYLE,
             LOCKSCREEN_WIDGETS_LAYOUT,
             LOCKSCREEN_ROTARY_UNLOCK_DOWN,
             LOCKSCREEN_ROTARY_HIDE_ARROWS,
             LOCKSCREEN_RING_UNLOCK_MIDDLE,
             LOCKSCREEN_RING_MINIMAL,
             ...
             PATTERN_STYLE_PREF,
             MENU_UNLOCK_SCREEN,
             LOCKSCREEN_ALWAYS_BATTERY,
             LOCKSCREEN_LONG_HOME_ACTION,
             EXPANDED_VIEW_WIDGET,
             EXPANDED_VIEW_WIDGET_GRID_ONE,
             EXPANDED_VIEW_WIDGET_GRID_TWO,
             EXPANDED_VIEW_WIDGET_GRID_THREE,
             EXPANDED_VIEW_WIDGET_GRID_FOUR,
             EXPANDED_HIDE_ONCHANGE,
             ENABLE_SETTING_BUTTON,
             EXPANDED_HIDE_SCROLLBAR,
             EXPANDED_HIDE_INDICATOR,
             EXPANDED_HAPTIC_FEEDBACK,
             EXPANDED_VIEW_WIDGET_COLOR,
             WIDGET_BUTTONS,
             QUICK_SETTINGS_TILES,
             USER_MY_NUMBERS,
             EXPANDED_BRIGHTNESS_MODE,
             EXPANDED_NETWORK_MODE,
             EXPANDED_SCREENTIMEOUT_MODE,
             EXPANDED_RING_MODE,
             EXPANDED_FLASH_MODE,
             POWER_DIALOG_SHOW_SCREENSHOT,
             POWER_DIALOG_SHOW_PROFILE,
             POWER_DIALOG_SHOW_AIRPLANE,
             POWER_DIALOG_SHOW_SUSPEND,
             POWER_DIALOG_SHOW_HIBERNATE,
             POWER_DIALOG_SHOW_SILENT,
             POWER_DIALOG_SHOW_EXTEND,
             POWER_DIALOG_SHOW_NAVI,
             EXPANDED_MOBILEDATANETWORK_MODE,
             OVERSCROLL_EFFECT,
             OVERSCROLL_WEIGHT,
             OVERSCROLL_COLOR,
             VOLBTN_MUSIC_CONTROLS,
             CAMBTN_MUSIC_CONTROLS,
        ...
        /**
         ...
         @Deprecated
         public static final String POWER_SAVER_ORIGINAL_NETWORK_MODE =
                 Secure.POWER_SAVER_ORIGINAL_NETWORK_MODE;
 
         @Deprecated
         public static final String POWER_SAVER_ORIGINAL_NETWORK_ON =
                 Secure.POWER_SAVER_ORIGINAL_NETWORK_ON;
 
         @Deprecated
         public static final String POWER_SAVER_MODE =
                 Secure.POWER_SAVER_MODE;
 
         @Deprecated
         public static final String POWER_SAVER_DATA_MODE =
                 Secure.POWER_SAVER_DATA_MODE;
 
         @Deprecated
         public static final String POWER_SAVER_SYNC_MODE =
                 Secure.POWER_SAVER_SYNC_MODE;
 
         @Deprecated
         public static final String POWER_SAVER_SYNC_INTERVAL =
                 Secure.POWER_SAVER_SYNC_INTERVAL;
 
         @Deprecated
         public static final String POWER_SAVER_DATA_DELAY =
                 Secure.POWER_SAVER_DATA_DELAY;
 
         @Deprecated
         public static final String POWER_DIALOG_SHOW_POWER_SAVER =
                 Secure.POWER_DIALOG_SHOW_POWER_SAVER;
 
         @Deprecated
         public static final String POWER_SAVER_WIFI_MODE =
                 Secure.POWER_SAVER_WIFI_MODE;
 
         @Deprecated
         public static final String POWER_SAVER_SYNC_DATA_MODE =
                 Secure.POWER_SAVER_SYNC_DATA_MODE;
 
         @Deprecated
         public static final String POWER_SAVER_SYNC_MOBILE_PREFERENCE =
                 Secure.POWER_SAVER_SYNC_MOBILE_PREFERENCE;
