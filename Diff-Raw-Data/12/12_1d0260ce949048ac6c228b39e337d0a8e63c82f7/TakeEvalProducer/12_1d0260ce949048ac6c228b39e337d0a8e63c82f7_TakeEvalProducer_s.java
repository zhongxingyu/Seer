 ...
 public class TakeEvalProducer implements ViewComponentProducer, ViewParamsReporter, NavigationCaseReporter, ActionResultInterceptor {
     ...
     * @param ncItemsList the list of items to render in this section
     ...
     * @param associatedId
     */
    private void renderItemPrep(UIBranchContainer radiobranch, UIForm form, EvalTemplateItem templateItem, String itemCategory, String associatedId) {
