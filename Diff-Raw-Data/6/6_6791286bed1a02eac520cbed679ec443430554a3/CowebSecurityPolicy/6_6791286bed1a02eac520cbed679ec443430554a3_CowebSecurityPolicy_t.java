 ...
 /**
  * Provides an extension point to handle permission checks for coweb protocol
  * events.
  * 
  */
 public class CowebSecurityPolicy extends DefaultSecurityPolicy {
 	...
 	@Override
 	public final boolean canPublish(BayeuxServer server, ServerSession client,
 	...
 	public final boolean canSubscribe(BayeuxServer server,
 			ServerSession client, ServerChannel channel, ServerMessage message) {
 	 ...
 	 *            Cometd BayeuxServer
 	 * @param client
 	 *            Client invoking the subscribe
 	 * @param channel
 	 *            Channel client is subscribing to.
 	 * @param message
 	 *            Bayeux message request was wrapped in.
 	 * @return true if the client can subscribe to this channel.
 	 */
 	public boolean canSubscribeOther(BayeuxServer server, ServerSession client,
 			ServerChannel channel, ServerMessage message) {
 		return true;
 	}
 	 ...
 	 * 
 	 * @param username
 	 *            User attempting the prep request
 	 * @param key
 	 *            Conference Key
 	 * @param collab
 	 *            If this conference is collaborative
 	 ...
 	 * 
 	 * @param username
 	 *            User attempting to join a session.
 	 * @param key
 	 *            Coweb key associated with this session.
 	 * @param collab
 	 *            true is this session is collaborative.
 	 * @return true if the user is allowed to join the session.
 	 */
 	public boolean canSubscribeToSession(String username, String key,
 			boolean collab) {
 		return true;
 	}
 	 ...
 	 * 
 	 * @param username
 	 *            User attempting to make the request.
 	 * @param sessionid
 	 *            Id of the session
 	 * @param serviceName
 	 *            Name of the service the bot provides.
 	 * @return true if the user is allowed to make the request.
 	 */
 	public boolean canInvokeServiceRequest(String username, String sessionid,
 			String serviceName) {
 		return true;
 	}
 	 ...
 	 */
 	public boolean canSubscribeService(String username, String sessionid,
 			String serviceName) {
 		return true;
 	}
 }
