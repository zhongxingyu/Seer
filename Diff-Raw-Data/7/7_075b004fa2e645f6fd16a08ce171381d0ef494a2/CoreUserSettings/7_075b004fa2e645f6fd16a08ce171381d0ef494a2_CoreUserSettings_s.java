 ...
 //    protected StringUserSetting locale = new StringUserSetting(Locale.getDefault().toLanguageTag(), NAME_TRANSLATOR, DESCRIPTION_TRANSLATOR);
    ...
    protected StringUserSetting smtpUsername = new StringUserSetting("CoreUserSettings.smtpUsername.description", NAME_TRANSLATOR, DESCRIPTION_TRANSLATOR);
    protected StringUserSetting smtpPassword = new StringUserSetting("CoreUserSettings.smtpPassword.description", NAME_TRANSLATOR, DESCRIPTION_TRANSLATOR);
    ...
    protected StringUserSetting smtpHost = new StringUserSetting("CoreUserSettings.smtpHost.description", NAME_TRANSLATOR, DESCRIPTION_TRANSLATOR);
