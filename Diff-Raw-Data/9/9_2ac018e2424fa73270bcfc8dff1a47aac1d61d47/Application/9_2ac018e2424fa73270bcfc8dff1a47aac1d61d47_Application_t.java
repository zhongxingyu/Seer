 ...
 public class Application extends Controller {
 	...
 	public static void showPost(Long id) {
		...
		System.out.println("Errors(0): " + ((validation.errors().size() > 0) ? validation.errors().get(0) : ""));
 	...
 	public static void postComment(Long postId, 
 	    ...
 	    if (validation.hasErrors()) {
	    	System.out.println("Validation failed: " + validation.errors().get(0));
	    	
	    	render("Application/showPost.html", post, randomID); 
 	    }
