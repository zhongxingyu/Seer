 ...
 * @author missi
 */
public abstract class AbstractMatrix2D extends AbstractMatrixForFeature
{

	protected int	firstNodeStride, firstAnnotationStride;
	...
	{
		int firstAnnotationStride = 1;
		int firstNodeStride = maxAnnotations;
		setUp(1, maxNodes, maxAnnotations, firstNodeStride, firstAnnotationStride);
	}
