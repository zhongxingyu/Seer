 ...
 * @version $Revision: 1.10 $
 ...
 public class AgeBusinessBean extends com.idega.business.IBOServiceBean implements AgeBusiness  {
 	...
 	public final static String DEFAULT_PERIOD_VALUES = "Periodens startdatum mste vara mindre eller lika med slutdatum.";
 	public final static String DEFAULT_SEARCH_PERIOD_VALUES = "Skperiodens startdatum mste vara mindre eller lika med slutdatum.";
 	public final static String DEFAULT_OPERATIONAL_FIELD_MISSING = "Huvudverksamhet mste v?ljas.";
 	...
 	public final static String DEFAULT_AGE_FROM_MISSING = "lder frn mste fyllas i.";
 	public final static String DEFAULT_AGE_FROM_VALUE = "lder frn mste vara mellan 0 och 18.";
 	public final static String DEFAULT_AGE_TO_MISSING = "lder till mste fyllas i.";
 	public final static String DEFAULT_AGE_TO_VALUE = "lder till mste vara mellan 0 och 18.";
 	public final static String DEFAULT_AGE_VALUES = "lder till mste vara mindre n lder frn.";
 	public final static String DEFAULT_AGE_OVERLAP = "ldersintervall fr ej verlappa. Det finns redan en regel inom detta intervall.";
 	...
 	public final static String DEFAULT_DESCRIPTION_MISSING = "Regeltyp mste vljas.";
 	public final static String DEFAULT_CUT_DATE_FORMAT = "Brytdatum mste anges p? formen MMDD.";
 	...
 	public final static String DEFAULT_CUT_DATE_MISSING = "Brytdatum mste fyllas i n?r regeltyp brytdatum, aktuellt ?r har valts.";
 	public final static String DEFAULT_CANNOT_SAVE_AGE_REGULATION = "ldersregeln kunde inte sparas p grund av tekniskt fel.";
 	public final static String DEFAULT_CANNOT_DELETE_AGE_REGULATION = "ldersregeln kunde inte tas bort p grund av tekniskt fel.";
 	public final static String DEFAULT_CANNOT_FIND_AGE_REGULATION = "Kan ej hitta ldersregeln.";
