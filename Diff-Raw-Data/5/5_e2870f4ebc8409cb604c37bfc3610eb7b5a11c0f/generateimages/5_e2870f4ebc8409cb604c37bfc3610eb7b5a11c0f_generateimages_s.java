 ...
 public class generateimages
 {
   ...
   static public void main(String[] args) throws Exception
   {
     ...
     System.setProperty("apple.awt.graphics.UseQuartz", "true");
 	  ...
 	  if(args.length < 3) {
 		  System.out.println("Usage: java generateimages sentenceFile segIdFile outputDir (FontName)");
 		  System.exit(0);
 	  }
 	  ...
 	  while (sentence != null) {
 		...
 		//System.out.println(count);
 		  ...
 		  if (!dir.exists()) {			
 			  dir.mkdir();
 			System.out.println("created folder: "+langDir);
 		  }
 		  String subDir=langDir+"/"+sub;
 		  dir = new File(subDir);
 		  if (!dir.exists()) {
 			  dir.mkdir();
