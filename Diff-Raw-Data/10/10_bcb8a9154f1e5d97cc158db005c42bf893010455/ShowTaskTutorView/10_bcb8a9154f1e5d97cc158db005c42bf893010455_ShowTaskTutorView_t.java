 ...
 public class ShowTaskTutorView extends HttpServlet {
 	...
 	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
 		...
 		if (participation.getRoleType() == ParticipationRole.ADVISOR) {
 			...
 			out.println("<p><div class=mid><a href=\"" + response.encodeURL("TaskManager?lecture=" + task.getLecture().getId() + "&amp;taskid=" + task.getTaskid() + "&amp;action=deleteTask") + "\">Aufgabe lschen</a></div>");
 			out.println("<p><div class=mid><a href=\"" + response.encodeURL("SubmitSolution?taskid=" + task.getTaskid()) + "\">Aufgabe fr Studenten durchfhren</a></div>");
 		}
