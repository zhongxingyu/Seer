...
import com.sun.identity.shared.debug.Debug;
 ...
 public class Locale {
     ...
     static {
         ...
         String loc = SystemProperties.get("com.iplanet.am.locale", "en_US");
     ...
     protected static ResourceBundle getResourceBundle(Session sess,
             String bundle) {
     ...
     public static ResourceBundle getInstallResourceBundle(String bundle) {
         String loc = null;
         loc = SystemProperties.get("com.iplanet.am.locale", "en_US");
      ...
      * format. Access Manager stores date in <code>ISO-8601</code> format
      ...
      * work for Sun Java System Access Manager if default encoding is not
      ...
      * Access Manager if default encoding is not <code>UTF-8</code>, hence this
      * method was written.
      * 
