 ...
 public class RailCraft extends ProtBase
 {
 	...
 	{
 		clCartTNT = Class.forName("railcraft.common.carts.EntityCartTNT");
 		clBore = Class.forName("railcraft.common.carts.EntityTunnelBore");
 	}
 	
 	@Override
 	public boolean loaded() { return clCartTNT != null; }
 	@Override
 	public boolean isEntityInstance(Entity e) { return e.getClass() == clCartTNT || e.getClass() == clBore; }
 	...
 	public String update(Entity e) throws Exception
 	{
 		...
 		else
 		{
 			...
 			int i = MathHelper.floor_double(getXAhead(e, e.posX, offset));
 			int j = MathHelper.floor_double(e.posY) + 1;
 			int k = MathHelper.floor_double(getZAhead(e, e.posZ, offset));
 
 	        if (canRoam(e.dimension, e.posX - radius, e.posY - radius, e.posY + radius, e.posZ - radius) &&
 	...
 	public String getMod() { return "RailCraft"; }
 	public String getComment() { return "Town permission: disableTNT & allowRailcraftBores "; }
 }
