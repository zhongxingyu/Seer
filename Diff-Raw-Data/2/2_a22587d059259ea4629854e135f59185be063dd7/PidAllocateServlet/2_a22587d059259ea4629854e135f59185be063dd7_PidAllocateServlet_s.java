 ...
 public class PidAllocateServlet extends BasicServlet {
     ...
     private void allocate_forced_pid(String patientId)
         ...
         try {
             ...
             arb.saveToDatabase();
             System.out.println("REST SERVICE: Added Patient ID = " + patientId);
             logger.info("REST SERVICE: Added Patient ID = " + patientId);
         } catch (XdsInternalException e) {
             throw new ServletException(RegistryUtility.exception_details(e));
     ...
     private String allocate_pid(String assigning_authority)
         ...
         try {
             ...
             arb.saveToDatabase();
            System.out.println("REST SERVICE: Added Patient ID = " + pid);
             logger.info("REST SERVICE: Added Patient ID = " + pid);
             return pid;
         } catch (XdsInternalException e) {
             throw new ServletException(RegistryUtility.exception_details(e));
         } catch (SQLException e) {
