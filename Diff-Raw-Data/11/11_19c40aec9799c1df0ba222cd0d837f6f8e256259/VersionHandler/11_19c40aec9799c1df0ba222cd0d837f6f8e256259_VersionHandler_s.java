 ...
 public class VersionHandler extends XMLHandler
 {
    ...
    * @throws SAXException
    */
   public VersionHandler(String source, String schemaLocation, Action action) throws SAXException
   {
    ...
    * @throws SAXException
    */
   public VersionHandler(File file, String schemaLocation, Action action) throws SAXException
   {
   ...
   {
     if((action.equals(Action.DO_IT) && localName.equals(XMLTags.DO_IT_TAG)) ||
        (action.equals(Action.UNDO_IT) && localName.equals(XMLTags.UNDO_IT_TAG)))
     {
       parse = true;
     }
    ...
    * @param action Action for the import to perform
    * @param xsd TODO
    */
   @Transaction
