 ...
 public class Api {
     ...
     public ArrayList<AudioAlbum> getAudioAlbums(Long owner_id, Integer offset, Integer count) throws MalformedURLException, IOException, JSONException, KException{
