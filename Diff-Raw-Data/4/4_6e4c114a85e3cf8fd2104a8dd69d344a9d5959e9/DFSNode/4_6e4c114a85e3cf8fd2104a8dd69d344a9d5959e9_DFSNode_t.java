 ...
 public class DFSNode extends RIONode {
    ...
    *
    * @param txStatus
    *            If callback is fired on a response to a transaction request,
    *            txState gives the status of the request.
    *
    * @param file
    ...
    */
   public void getCommandComplete(TransactionStatus txStatus, DFSFilename file,
   ...
   public void onCommand(String command) {
     ...
     Method method;
     try {
      String[] paramTypes = { "TransactionStatus", "DFSFilename",
     ...
     if (action.equals("txstart")) {
       cl.txStart(nonDataCb);
     } else if (action.equals("txcommit")) {
       cl.txCommit(nonDataCb);
     } else if (action.equals("txabort")) {
       cl.txAbort(nonDataCb);
