 ...
 public class ItemProvider
 {
   ...
   protected final String TEXT_27 = "PropertyDescriptor(Object object)" + NL + "\t{" + NL + "\t\titemPropertyDescriptors.add" + NL + "\t\t\t(createItemPropertyDescriptor" + NL + "\t\t\t\t(((";
   protected final String TEXT_28 = ")adapterFactory).getRootAdapterFactory()," + NL + "\t\t\t\t getResourceLocator()," + NL + "\t\t\t\t getString(\"_UI_";
   protected final String TEXT_29 = "_";
   protected final String TEXT_30 = "_feature\"),";
   protected final String TEXT_31 = NL + "\t\t\t\t getString(\"_UI_PropertyDescriptor_description\", \"_UI_";
   protected final String TEXT_32 = "_";
   protected final String TEXT_33 = "_feature\", \"_UI_";
   protected final String TEXT_34 = "_type\"),";
   protected final String TEXT_35 = NL + "\t\t\t\t getString(\"_UI_";
   protected final String TEXT_36 = "_";
   protected final String TEXT_37 = "_description\"),";
   ...
   protected final String TEXT_48 = NL + "\t\t\t\t getString(\"";
   protected final String TEXT_49 = "\"),";
   protected final String TEXT_50 = NL + "\t\t\t\t null));";
   protected final String TEXT_51 = NL + "\t\t\t\t new String[] {";
   protected final String TEXT_52 = NL + "\t\t\t\t\t\"";
   protected final String TEXT_53 = "\"";
   protected final String TEXT_54 = ",";
   protected final String TEXT_55 = NL + "\t\t\t\t }));";
   protected final String TEXT_56 = NL + "\t}" + NL;
   protected final String TEXT_57 = NL + "\t/**" + NL + "\t * This specifies how to implement {@link #getChildren} and is used to deduce an appropriate feature for an" + NL + "\t * {@link org.eclipse.emf.edit.command.AddCommand}, {@link org.eclipse.emf.edit.command.RemoveCommand} or" + NL + "\t * {@link org.eclipse.emf.edit.command.MoveCommand} in {@link #createCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
   protected final String TEXT_58 = NL + "\t@Override";
   protected final String TEXT_59 = NL + "\tpublic ";
   protected final String TEXT_60 = " getChildrenFeatures(Object object)" + NL + "\t{" + NL + "\t\tif (childrenFeatures == null)" + NL + "\t\t{" + NL + "\t\t\tsuper.getChildrenFeatures(object);";
   protected final String TEXT_61 = NL + "\t\t\tchildrenFeatures.add(";
   protected final String TEXT_62 = ");";
   protected final String TEXT_63 = NL + "\t\t}" + NL + "\t\treturn childrenFeatures;" + NL + "\t}" + NL;
   protected final String TEXT_64 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
   protected final String TEXT_65 = NL + "\t@Override";
   protected final String TEXT_66 = NL + "\tprotected ";
   protected final String TEXT_67 = " getChildFeature(Object object, Object child)" + NL + "\t{" + NL + "\t\t// Check the type of the specified child object and return the proper feature to use for" + NL + "\t\t// adding (see {@link AddCommand}) it as a child." + NL + "" + NL + "\t\treturn super.getChildFeature(object, child);" + NL + "\t}" + NL;
   ...
   protected final String TEXT_71 = NL + "\tpublic Object getImage(Object object)" + NL + "\t{" + NL + "\t\treturn overlayImage(object, getResourceLocator().getImage(\"full/obj16/";
   protected final String TEXT_72 = "\"));";
   protected final String TEXT_73 = NL + "\t}" + NL;
   protected final String TEXT_74 = NL + "\t/**" + NL + "\t * This returns the label text for the adapted class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
   ...
   protected final String TEXT_82 = ")object;";
   protected final String TEXT_83 = NL + "\t\treturn \"\" + ";
   protected final String TEXT_84 = ".getKey() + \" -> \" + ";
   protected final String TEXT_85 = ".getValue();";
   protected final String TEXT_86 = NL + "\t\tString key = crop(\"\" + ";
   protected final String TEXT_87 = ".getKey());";
   protected final String TEXT_88 = NL + "\t\tString key = \"\" + ";
   protected final String TEXT_89 = ".getKey();";
   protected final String TEXT_90 = NL + "\t\tString value = crop(\"\" + ";
   protected final String TEXT_91 = ".getValue());";
   protected final String TEXT_92 = NL + "\t\tString value = \"\" + ";
   protected final String TEXT_93 = ".getValue();";
   protected final String TEXT_94 = NL + "\t\treturn key + \" -> \" + value;";
   protected final String TEXT_95 = NL + "\t\t";
   protected final String TEXT_96 = " ";
   protected final String TEXT_97 = " = (";
   protected final String TEXT_98 = ")object;" + NL + "\t\treturn getString(\"_UI_";
   protected final String TEXT_99 = "_type\") + \" \" + ";
   protected final String TEXT_100 = ".";
   protected final String TEXT_101 = "();";
   protected final String TEXT_102 = NL + "\t\tString label = crop(((";
   protected final String TEXT_103 = ")object).";
   protected final String TEXT_104 = "());";
   protected final String TEXT_105 = NL + "\t\tString label = ((";
   protected final String TEXT_106 = ")object).";
   protected final String TEXT_107 = "();";
   protected final String TEXT_108 = NL + "\t\t";
   protected final String TEXT_109 = " labelValue = ((";
   protected final String TEXT_110 = ")object).eGet(";
   protected final String TEXT_111 = ");";
   protected final String TEXT_112 = NL + "\t\t";
   protected final String TEXT_113 = " labelValue = ((";
   protected final String TEXT_114 = ")object).";
   protected final String TEXT_115 = "();";
   protected final String TEXT_116 = NL + "\t\tString label = labelValue == null ? null : labelValue.toString();";
   protected final String TEXT_117 = NL + "\t\treturn label == null || label.length() == 0 ?" + NL + "\t\t\tgetString(\"_UI_";
   protected final String TEXT_118 = "_type\") :";
   protected final String TEXT_119 = NL + "\t\t\tgetString(\"_UI_";
   protected final String TEXT_120 = "_type\") + \" \" + label;";
   protected final String TEXT_121 = NL + "\t\treturn getString(\"_UI_";
   protected final String TEXT_122 = "_type\");";
   protected final String TEXT_123 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * This handles model notifications by calling {@link #updateChildren} to update any cached" + NL + "\t * children and by creating a viewer notification, which it passes to {@link #fireNotifyChanged}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
   protected final String TEXT_124 = NL + "\t@Override";
   protected final String TEXT_125 = NL + "\tpublic void notifyChanged(Notification notification)" + NL + "\t{" + NL + "\t\tupdateChildren(notification);";
   protected final String TEXT_126 = NL + NL + "\t\tswitch (notification.getFeatureID(";
   protected final String TEXT_127 = ".class))" + NL + "\t\t{";
   protected final String TEXT_128 = NL + "\t\t\tcase ";
   protected final String TEXT_129 = ":";
   protected final String TEXT_130 = NL + "\t\t\t\tfireNotifyChanged(new ";
   protected final String TEXT_131 = "(notification, notification.getNotifier(), false, true));" + NL + "\t\t\t\treturn;";
   protected final String TEXT_132 = NL + "\t\t\tcase ";
   protected final String TEXT_133 = ":";
   protected final String TEXT_134 = NL + "\t\t\t\tfireNotifyChanged(new ";
   protected final String TEXT_135 = "(notification, notification.getNotifier(), true, false));" + NL + "\t\t\t\treturn;";
  ...
  protected final String TEXT_142 = NL + "\t/**" + NL + "\t * This adds to the collection of {@link org.eclipse.emf.edit.command.CommandParameter}s" + NL + "\t * describing all of the children that can be created under this object." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
   ...
   protected final String TEXT_224 = NL + "\tpublic ResourceLocator getResourceLocator()" + NL + "\t{" + NL + "\t\treturn ";
   protected final String TEXT_225 = ".INSTANCE;" + NL + "\t}" + NL;
