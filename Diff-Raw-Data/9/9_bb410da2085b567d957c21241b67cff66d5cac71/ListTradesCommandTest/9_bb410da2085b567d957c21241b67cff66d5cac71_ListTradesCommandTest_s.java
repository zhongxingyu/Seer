 ...
 public class ListTradesCommandTest extends CommandTestSuper {
 	...
 	public void testExecuteNormal() {
		...
		when(t.getTradeDate()).thenReturn(new DateMidnight().toDate());
		when(t.getMaturityDate()).thenReturn(new DateMidnight().plusDays(2).toDate());
		...
		p = Pattern.compile("1\\s+03/03/2012\\s+05/03/2012\\s+1,000.00 GBP\\s+1,200.00 EUR\\s+980.00 GBP\\s+" +
