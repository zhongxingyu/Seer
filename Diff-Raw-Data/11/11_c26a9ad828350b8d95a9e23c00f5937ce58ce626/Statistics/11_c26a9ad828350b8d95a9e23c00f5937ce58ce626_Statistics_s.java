 ...
 * @version $Id: Statistics.java,v 1.2 2003/02/05 22:56:34 desruisseaux Exp $
 ...
 public class Statistics implements Cloneable, Serializable {
     ...
     /**
      * Valeur minimale qui aie t transmise  la mthode
     ...
     /**
      * Valeur maximale qui aie t transmise  la mthode
      * {@link #add(double)}. Lors de la construction, ce
      * champs est initialis  NaN.
      */
      ...
      * la mthode {@link #add(double)}. Lors de la construction,
      * ce champs est initialis  0.
      */
     private double sum = 0;
 
     /**
      * Somme des carrs de toutes les valeurs qui ont t
      * transmises  la mthode {@link #add(double)}. Lors
      * de la construction, ce champs est initialis  0.
      */
     private double sum2 = 0;
 
     /**
      * Nombre de donnes autres que NaN qui ont t transmises
      *  la mthode {@link #add(double)}. Lors de la construction,
      * ce champs est initialis  0.
      */
     private int n = 0;
     ...
     /**
      * Nombre de donnes gales  NaN qui ont t transmises 
      * la mthode {@link #add(double)}. Les NaN sont ingors lors
      * du calcul des statistiques, mais on les compte quand mme
     ...
     /**
      * Retourne l'cart type des chantillons par rapport  la moyenne. Si les donnes
      * fournies aux diffrentes mthodes <code>add(...)</code> se distribuent selon une
      * loi normale, alors l'cart type est la distance de part et d'autre de la moyenne
      * dans lequel se trouveraient environ 84% des donnes. Le tableau ci-dessous donne
      * le pourcentage approximatif des donnes que l'on trouve de part et d'autre de la
      ...
      * </table>
      *
      * @param allPopulation La valeur <code>true</code> indique que les donnes fournies
      *        aux diffrentes mthodes <code>add(...)</code> reprsentent l'ensemble de
      *        la polulation. La valeur <code>false</code> indique que ces donnes ne
      *        reprsentent qu'un chantillon de la population, ce qui est gnralement le
      *        cas. Si le nombre de donnes est lev, alors les valeurs <code>true</code>
      *        et <code>false</code> donneront sensiblement les mmes rsultats.
      */
