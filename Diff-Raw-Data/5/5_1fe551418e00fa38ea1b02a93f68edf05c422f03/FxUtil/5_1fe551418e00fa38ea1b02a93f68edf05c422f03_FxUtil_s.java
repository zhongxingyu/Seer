 ...
 public class FxUtil {
 	 ...
 	 * 
 	 * @see http://www.wiki.vg/Protocol#Sound_Or_Particle_Effect_.280x3D.29
 	 * 
 	 * @param player
 	...
 	/**
	 * Spawn particles of a specific material. <b>Important:</b> The following
	 * materials will not get spawned because of a client crash: REDSTONE
 	 * 
 	 * @see Material
 	 * 
 	 * @param world
