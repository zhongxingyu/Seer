 ...
 {	
 	...
 	public void payTax(double ammount){
 		if (ammount==0){
 			if(Econ.transferMoney(this, this, this.getFaction(), tax)){tax=0;}
 		}else{
 			if(Econ.transferMoney(this, this, this.getFaction(), ammount)){tax=tax-ammount;}
 		}
 	}
 	...
 	public String getIsclaimabuilding() {return isclaimabuilding;}
 	public void setIsclaimabuilding(String isclaimabuilding) {this.isclaimabuilding = isclaimabuilding;}
 	public Block getFirstclaimblock() {return firstclaimblock;}
 	...
 	public void setsMenu(SpoutMenu sMenu) {this.sMenu = sMenu;}
 	public SpoutPlayer getsPlayer() {return sPlayer;}
 	public void setsPlayer(SpoutPlayer sPlayer) {this.sPlayer = sPlayer;}
 	public long getBuildingticker() {return buildingticker;}
 	public void setBuildingticker(long buildingticker) {this.buildingticker = buildingticker;}
 	...
 	{
 		if ( ! Econ.shouldBeUsed() || this == null || cost == 0.0 || this.isAdminBypassing()) return true;
 
 		if(Conf.bankEnabled && Conf.bankFactionPaysCosts && this.hasFaction())
 		{
 			if ( ! Econ.modifyMoney(this.getFaction(), -cost, toDoThis, forDoingThis)) return false;
 		}
 		else
 		{
 			if ( ! Econ.modifyMoney(this, -cost, toDoThis, forDoingThis)) return false;
 		}
 		return true;
 	}
