 ...
 public class NGramHighScore {
   ...
   public static class PageScorePair implements Writable{
     ...
     public void readFields(DataInput in) throws IOException {
       int pageTitleLength = in.readInt();
       byte[] byteArray = new byte[pageTitleLength];
       in.readFully(byteArray, 0, pageTitleLength);
       pageTitle = new String(byteArray);
       score = in.readInt();
     }
 
     @Override
     public void write(DataOutput out) throws IOException {
       out.writeInt(pageTitle.length());
