...
import jp.rejaxon.spring.domain_framework.jpa.criteria.WhereBuilder.MergeType;
 	...
 	public static Specification<Customer> search(final CustomerCriteria criteria) {
 		return new Specification<Customer>() {
 			...
 			public Predicate toPredicate(Root<Customer> root,
				...
				predicates.addEqual("mailAddress", criteria.getMailAddress())//TODO: EntityのMetaModel用意.文字列だとミス多い・・・。
				...
				return predicates.mergeAll(MergeType.AND);
 			}
 		};
 	}
 }
