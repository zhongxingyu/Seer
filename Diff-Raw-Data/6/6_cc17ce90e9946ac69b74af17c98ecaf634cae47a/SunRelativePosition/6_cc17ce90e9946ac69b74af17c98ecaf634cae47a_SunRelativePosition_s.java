  ...
  * Cette classe reoit en entrs les coordonnes spatio-temporelles de
  * l'observateur, soit:
  *
 * <TABLE border='0'><TR><TD>
  * <UL>
  *   <LI>La longitude (en degres) de l'observateur;</LI>
  *   <LI>La latitude (en degres) de l'observateur;</LI>
  *   <LI>La date et heure en heure universelle (GMT).</LI>
  * </UL>
  *
  * La position du soleil calcule en sortie comprend les valeurs suivantes:
  *
  * <UL>
  *   <LI>L'azimuth du soleil (en degrs dans le sens des aiguilles d'une montre depuis le nord);</LI>
  *   <LI>L'lvation du soleil (en degrs par rapport a l'horizon).</LI>
  * </UL>
  * </TD>
  *
  ...
  * </TR></TABLE>
  *
  * Les algorithmes utiliss dans cette classe sont des adaptations des algorithmes
 ...
 * @version $Id: SunRelativePosition.java,v 1.2 2003/04/17 13:58:31 desruisseaux Exp $
 ...
 public final class SunRelativePosition {
     ...
     /**
      * Heure  laquelle le soleil est au plus haut dans la journe en millisecondes
      * coules depuis le 1er janvier 1970.
      */
     private long noonTime;
     
     /**
      * Azimuth du soleil, en degrs dans le sens des
      * aiguilles d'une montre depuis le nord.
      */
     private double azimuth;
 
     /**
      * Elvation du soleil, en degrs par rapport a l'horizon.
      */
     ...
     */
     ...
     /**
      * Retourne l'azimuth en degrs.
      *
      * @return L'azimuth en degrs.
      */
     ...
     /**
      * Retourne l'lvation en degrs.
      *
      * @return L'lvation en degrs.
      */
      ...
      * retourne en nombre de millisecondes coules depuis le debut de la
      * journe (minuit) en heure UTC.
      */
     ...
     /**
      * Retourne la date  laquelle le soleil est au plus haut dans la journe.
      * Cette mthode est quivalente  {@link #getNoonTime} mais inclue le jour
      * de la date qui avait t spcifie  la mthode {@link #compute}.
      */
     ...
     /**
      * Affiche la position du soleil  la date et coordonnes spcifie.
      * Cette application peut tre lance avec la syntaxe suivante:
      *
      * <pre>SunRelativePosition <var>[longitude]</var> <var>[latitude]</var> <var>[date]</var></pre>
      *
      * o <var>date</var> est un argument optionel spcifiant la date et l'heure.
      * Si cet argument est omis, la date et heure actuelles seront utilises.
      */
