 ...
 public interface LoggerManager
 {
      ...
      * <p>
     * Note that the logs generated by the current thread are not sent anymore to the standard outputs configured in the
     * implementation of SLF4J used and are only received as XWiki events sent to the provided listener. In addition, it
     * also overrides any previous call to {@link #pushLogListener(EventListener)} (which will get active again after a
     * call to {@link #popLogListener()}).
      * 
