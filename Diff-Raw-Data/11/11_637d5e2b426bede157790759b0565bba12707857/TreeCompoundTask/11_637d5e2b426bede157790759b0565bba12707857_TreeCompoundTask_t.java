 ...
 public class TreeCompoundTask extends CompoundTask
 {
 	...
 	/**
 	 * Stores the last popup selection to open in the next time. If this
 	 * selection is not existent in current subtask, to open the popup stored in
 	 * the subtask.
 	 * 
 	 * @param popupName
