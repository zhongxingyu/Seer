 ...
 public class FactoryState implements ActionListener {
	...
	public FactoryState() {
		//Variables should be initialized STRICTLY IN THE ORDER THEY ARE
		//DECLARED. This will make editing easier. Please factor out loops and
		//more complicated stuff to other functions in factory state.
