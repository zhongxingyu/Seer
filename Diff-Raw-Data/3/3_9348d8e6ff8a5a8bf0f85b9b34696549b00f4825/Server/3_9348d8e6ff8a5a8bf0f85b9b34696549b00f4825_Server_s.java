 ...
 import game.EquipmentGameThing.Slot;
 ...
 public class Server{
 	...
 	public static GameWorld defaultworld(){
 		...
 		sgm.level(0).location(new Position(-15,-14), Direction.NORTH).put(new game.EquipmentGameThing(sgm, 1, 1, 1, 1, Slot.WEAPON, "Short sword", "sword_1"));
