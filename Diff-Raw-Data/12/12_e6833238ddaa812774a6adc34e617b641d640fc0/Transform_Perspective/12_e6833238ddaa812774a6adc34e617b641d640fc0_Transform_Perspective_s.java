 ...
 public class Transform_Perspective implements PlugIn, MouseListener,  MouseMotionListener, KeyListener
 {
 	ImagePlus imp;
 	ImageProcessor ip;
 	...
 	public void run( String arg )
     {
 		...
 		int[] x = new int[]{ ip.getWidth() / 4, 3 * ip.getWidth() / 4, 3 * ip.getWidth() / 4, ip.getWidth() / 4 };
 		int[] y = new int[]{ ip.getHeight() / 4, ip.getHeight() / 4, 3 * ip.getHeight() / 4, 3 * ip.getHeight() / 4 };
