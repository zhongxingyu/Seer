 ...
 */
 public class IabHelper {
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        logDebug("Handle activity result: extras = " + extras.toString());
    ...
    public void queryInventoryAsync(final boolean querySkuDetails,
 	   ...
 	   logDebug("starting Query inventory async");
    ...
    public void queryInventoryAsync(final boolean querySkuDetails, final List<String> moreSkus, QueryInventoryFinishedListener listener) {
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
        ...
        do {
            ...
            logDebug("Owned SKUs: " + ownedSkus);
            logDebug("Purchase data list: " + purchaseDataList);
            logDebug("Signature list: " + signatureList);
