...
import android.content.DialogInterface;
 ...
 public class Transactions extends Activity {
 	private static final int ADVANCE_KEY = 1532;
 	
 	private static final String CATEGORY_NAME = "CATEGORY_NAME";
 	private static final String RECUR_TIME = "RECUR_TIME";
     ...
     public void onCreate(Bundle savedInstanceState) {
         ...
         spinner_categories.setOnItemSelectedListener(new MyOnItemSelectedListener());
         ...
         */
         ...
         if(extras != null) {
         	...
         	int cents = Math.abs((int)((amount - dollars) * 100));
         	 ...
         	 */
         	for(int index=0; index < num_categories; index++) {
         		if(category.equalsIgnoreCase(category_list.get(index).getCategory())) {
         			setSpinner(index);
         			break;
         		}
         	}
     ...
     public void updateCategories() {
         ...
         categories[num_categories] = "{ New Category }";
     ...
     public void updateCategories(String[] categories, int select_index) {
         /*
          * Set spinner to categories from Database
          */
         ArrayAdapter<String> adapter = new ArrayAdapter<String>(Transactions.this, android.R.layout.simple_list_item_1, categories);
         ...
         setSpinner(select_index);
     }
     
     public void updateCategories(int select_index) {
     	List<Category> category_list = m_database.getAllCategories();
         ...
         categories[num_categories] = "{ New Categories }";
     ...
     public class MyOnItemSelectedListener implements OnItemSelectedListener {
 		...
 		public void onItemSelected(AdapterView<?> parent, View view, int pos,
 			...
 			if(parent.getItemAtPosition(pos).toString().equals("{ New Category }")){
 				createCategoryAddDialog();				
 			}
 	...
 	private void createCategoryAddDialog(){
 		/*
         ...
         m_dialog = new Dialog(Transactions.this);
         m_dialog.setContentView(R.layout.category_dialog);
         m_dialog.setTitle("Add new category:");
        ...
        m_dialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
         ...
         //set up button
         Button dialog_button = (Button) m_dialog.findViewById(R.id.category_button_add);
         dialog_button.setOnClickListener(new View.OnClickListener() {
 			
 			@Override
 			public void onClick(View v) {
 				EditText edittext = (EditText) m_dialog.findViewById(R.id.category_edittext);
 				String new_category = edittext.getText().toString();
 				m_database.insertCategory(new Category(new_category));
 				
 				List<Category> category_list = m_database.getAllCategories();
 				int num_categories = category_list.size();
 
 				//Manually adding "{ New Category } to array
 		        String[] categories = new String[num_categories + 1];
 		        
 		        int target_index = 0;
 		        for(int index = 0; index < num_categories; index++) {
 		        	categories[index] = category_list.get(index).getCategory();
 		        	if(new_category.compareToIgnoreCase(categories[index]) == 0) {
 		        		target_index = index;
 		        	}
 		        }
 		        categories[num_categories] = "{ New Category }";
 		        
 				//Adding this here to update the spinner after the new
 				//category has been added
 				updateCategories(categories, target_index);
 
 				m_dialog.dismiss();
 				
 			}
 		});
         dialog_button = (Button) m_dialog.findViewById(R.id.category_button_close);
         dialog_button.setOnClickListener(new View.OnClickListener() {
     ...
     public void setSpinner(int select_index) {
     	spinner_categories.setSelection(select_index);
     }
     ...
     public void buttonClick(View view)
     {
     	...
     	switch(id) {
     		...
     		case R.id.b_advanced:
     			//launch new activity
     			Intent i = new Intent(this, AdvancedOptions.class);
     			startActivityForResult(i, ADVANCE_KEY);
     			break;
     		default:
     ...
     public void returnTransaction() {
     	...
     	cents = (float)np_cents.getValue() / 100;
     	...
     	if(m_duration>0) {
     		...
     		RecurringTransaction rec_transaction = new RecurringTransaction(-1, name, amount, category, description, start_date, m_duration);
     		
     		m_database.insertRecurringTransactions(rec_transaction);
     	}
     	/*
     ...
     protected void onActivityResult(int requestCode, int resultCode,
     	...
     	if(resultCode == RESULT_OK) {
     		if (requestCode == ADVANCE_KEY) {
     			Bundle extras = data.getExtras();
     			
     			m_duration = extras.getLong(RECUR_TIME);
     			
     			//Toast.makeText(getApplicationContext(), "Adv returned: " + m_duration + " ms", Toast.LENGTH_SHORT).show();
     		}
     	} 
     }
 }
