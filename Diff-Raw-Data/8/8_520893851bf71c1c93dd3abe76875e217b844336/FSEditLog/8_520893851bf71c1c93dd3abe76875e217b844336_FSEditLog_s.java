 ...
 public class FSEditLog {
   ...
   static {
     FSNamesystem.LOG.info("######## DROP IN FS EDIT LOG CLASS LOADED ########");
   }
  ...
  for (Iterator<StorageDirectory> it = 
   ...
   public synchronized void open() throws IOException {
     ...
     for (Iterator<StorageDirectory> it = 
       ...
       try {
         ...
         FSNamesystem.LOG.warn("Unable to open edit log file " + eFile, e);
    ...
    * @param dsQuota the directory size limit
    */
