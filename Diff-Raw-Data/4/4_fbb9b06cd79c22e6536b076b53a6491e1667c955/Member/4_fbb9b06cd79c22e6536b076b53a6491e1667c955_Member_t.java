 ...
 */
 ...
 /**
 *@author <a href="mailto:gimmi@idega.is">Grmur Jnsson</a>
 *@version 1.2
 */
 ...
 public class Member extends GenericEntity implements Comparable{
   ...
   private static String sClassName = "com.idega.data.genericentity.Member";
 	...
 	public void initializeAttributes(){
           ...
           addAttribute("middle_name","Minafn",true,true,"java.lang.String");
           addAttribute("last_name","Eftirnafn",true,true,"java.lang.String");
           addAttribute("date_of_birth","Fingardagur",true,true,"java.sql.Date");
           ...
           /* Tillaga um vibtur one to many tengs */
 ...
 //        addAttribute("address_id", "Address_id", false, false, "java.lang.Integer");
           ...
           addAttribute("image_id","MyndNmer",false,false,"java.lang.Integer");
