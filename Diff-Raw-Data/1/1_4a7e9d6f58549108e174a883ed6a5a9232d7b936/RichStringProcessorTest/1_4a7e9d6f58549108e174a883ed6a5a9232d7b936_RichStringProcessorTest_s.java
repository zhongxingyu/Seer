...
import org.eclipse.jdt.annotation.NonNullByDefault;
 ...
 public class RichStringProcessorTest extends AbstractRichStringTest {
 	...
 	@Test public void testStackIsConsistent_02() throws Exception {
 		doTestStackIsConsistent(
 			"'''var max = 10FOR i: 1..max SEPARATOR ', 'iENDFOR'''");
 	}
 	...
 	@Test public void testStackIsConsistent_88() throws Exception {
 		doTestStackIsConsistent(
 			"'''\n" +
 			"  FOR c : 'test'.bytesFOR c : 'test'.bytes'test123'ENDFOR\n" +
 			"  ENDFOR\n" +
 			"  FOR c : 'test'.bytesFOR c : 'test'.bytes'test123'\n" +
 			"  ENDFORENDFOR\n" +
 			"  FOR c : 'test'.bytesFOR c : 'test'.bytesFOR c : 'test'.bytes'test123'ENDFOR\n" +
 			"  ENDFORENDFOR\n" +
 			"'''");
 	}
