...
import de.willuhn.jameica.hbci.gui.action.EmpfaengerAdd;
 ...
 public class UmsatzList extends ContextMenu
 {
 	...
 	public UmsatzList()
 	{
 		...
 		addItem(new CheckedContextMenuItem(i18n.tr("ffnen"),new UmsatzDetail()));

		addItem(new CheckedContextMenuItem(i18n.tr("Empfnger in Adressbuch bernehmen"),new EmpfaengerAdd()));
