 ...
 public class AatsrProductFileTest extends TestCase {
     ...
     public void testCalculateSceneRasterHeight() {
        ...
        assertEquals((numRecords_1 - 1) * 32, AatsrProductFile.calculateSceneRasterHeight(geolocationDSD));
 
         geolocationDSD = new DSD(0, "ignore", 'A', "", 12, 13, numRecords_2, 14);
        assertEquals((numRecords_2 - 1) * 32, AatsrProductFile.calculateSceneRasterHeight(geolocationDSD));
     }
 }
