 ...
 public final class WordPenaltyFF extends DefaultStatelessFF {
 	...
 	/**Each additional word gets a penalty.
 	 * The more number of words, the more negative.
 	 * So, to encourage longer sentence, we should have
 	 * a negative weight on the feature*/
