 ...
 public class HealthBar extends Node {
     ...
     public HealthBar(AssetManager assetManager, String name) {
        ...
        Geometry bgBar = new Geometry("Quad", new Quad(1.4f, 0.7f));
         healthBar = new Geometry("Quad", new Quad(.86f, 0.04f));
 
         //FIXME: set bar height according to player
        bgBar.setLocalTranslation(-0.70f, 0.2f, 0.5f);
        ...
        background.getAdditionalRenderState().setBlendMode(BlendMode.Alpha);
        bgBar.setQueueBucket(Bucket.Transparent);
        ...
        txt.setLocalTranslation(-0.43f, 0.7f, 0.52f);
