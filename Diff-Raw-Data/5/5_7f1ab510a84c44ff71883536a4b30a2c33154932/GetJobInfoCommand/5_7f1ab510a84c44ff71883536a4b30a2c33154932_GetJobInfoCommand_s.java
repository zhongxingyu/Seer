 ...
 public class GetJobInfoCommand extends Command {
          ...
          * (non-Javadoc)
          * 
          * @see com.google.refine.commands.Command#doPost(javax.servlet.http.
         ...
         private void generateResponse(HttpServletResponse response, JSONObject data) throws IOException, JSONException {
                 ...
                 try {
                         writer.object();
                         writer.key("status");
                         writer.value(data.getString("status"));
 
                         writer.key("title");
                         writer.value(data.get("title"));
                         writer.key("instructions");
                         writer.value(data.get("instructions"));
                         writer.key("units_count");
                         writer.value(data.get("units_count"));
