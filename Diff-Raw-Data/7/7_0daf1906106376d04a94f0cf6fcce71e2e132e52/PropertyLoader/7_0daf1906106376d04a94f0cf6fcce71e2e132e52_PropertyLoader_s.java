 ...
 public class PropertyLoader {
 	...
 	/**
 	 * <p>Loads a properties file from the classpath</p>
 	 * <p>Will parse a properties file found in the classpath.
 	 * The file must respect standard properties conventions :
 	 * <li>Name must end with .properties</li>
 	 * <li>File content should be lines containing pair of key = value
 	 * e.g : foo.bar = 42 </li></p>
 	 * <p>For ease of use, the loader is flexible with the <i>name</i>
 	 * of the properties file, and therefore :
 	 * <li><i>name</i> can be described using <b>.</b> or <b>/</b> as separators</li>
 	 * <li><i>name</i> can optionally end with <b>.properties</b></ki>
 	 * <li>leading <b>/</b> in <i>name</i> will be ignored
 	 * Therefore all the following <i>names</i> are the same :
 	 * <pre>
 	 * foo.bar
 	 * foo.bar.properties
 	 * foo/bar
