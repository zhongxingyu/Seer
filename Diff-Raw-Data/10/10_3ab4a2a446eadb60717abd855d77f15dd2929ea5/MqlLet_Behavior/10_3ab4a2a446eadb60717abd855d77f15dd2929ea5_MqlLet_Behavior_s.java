 ...
 public class MqlLet_Behavior {
   ...
   public static Scope virtual_getScope_3734116213129936182(SNode thisNode, SNode kind, SNode child) {
    ...
    if (SNodeOperations.getContainingLinkRole(child).equals("expression")) {
       ...
       // we're from one of the bindings, giving only those which are before this one 
       // Q: including this one? it's more safe not to include, but for closures it could be convenient 
       SNode stop = child;
