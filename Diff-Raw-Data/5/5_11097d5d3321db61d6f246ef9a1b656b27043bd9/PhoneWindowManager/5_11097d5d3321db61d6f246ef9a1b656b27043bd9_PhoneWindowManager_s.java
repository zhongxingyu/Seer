 ...
 public class PhoneWindowManager implements WindowManagerPolicy {
     ...
     static final int STATUS_BAR_SUB_PANEL_LAYER = 9;
     ...
     class SettingsObserver extends ContentObserver {
         ...
         void observe() {
             ...
             resolver.registerContentObserver(Settings.System.getUriFor(
                     Settings.System.SHOW_NAVI_BUTTONS), false, this);
             resolver.registerContentObserver(Settings.System.getUriFor(
                     Settings.System.NAVI_BUTTONS), false, this);
             resolver.registerContentObserver(Settings.System.getUriFor(
             ...
             if (SEPARATE_TIMEOUT_FOR_SCREEN_SAVER) {
                 resolver.registerContentObserver(Settings.Secure.getUriFor(
                         Settings.Secure.SCREENSAVER_TIMEOUT), false, this);
         ...
         public void run() {
             ...
             if (Settings.System.getInt(mContext.getContentResolver(),
                 ...
                 runCustomApp();
                     ...
                     Settings.System.USE_TASKSWITCHER, 1) != 0) {
                 runImagesCustomApp();
             } else {
     ...
     public void init(Context context, IWindowManager windowManager,
         ...
         mBackKillTimeout = SystemProperties.getInt("persist.sys.back_kill_timeout", 1500);
     ...
     public void updateSettings() {
         ...
         synchronized (mLock) {
             ...
             mScreenSaverEnabledByUser = Settings.Secure.getInt(resolver,
     ...
     public View addStartingWindow(IBinder appToken, String packageName,
         ...
         try {
             ...
             int cstransBackgroundAppss = Settings.System.getInt(mContext.getContentResolver(), Settings.System.TRANSPARENT_BACKGROUND_FULL, 0);
             if (ta.getBoolean(
                         com.android.internal.R.styleable.Window_windowDisablePreview, false)
                 || ta.getBoolean(
                         com.android.internal.R.styleable.Window_windowShowWallpaper,false) || cstransBackgroundAppss == 2) {
                 return null;
             }
     ...
     public int interceptKeyBeforeQueueing(long whenNanos, int action, int flags,
         ...
         switch (keyCode) {
             ...
             if (down) {
               ...
               if (Settings.System.getInt(mContext.getContentResolver(), Settings.System.BACK_BUTTON_ENDS_CALL, 1) == 1) {
               ITelephony telephonyService = getTelephonyService();
                 if (telephonyService != null) {
                   try {
             ...
             if (down) {
               ...
               if (Settings.System.getInt(mContext.getContentResolver(), Settings.System.MENU_BUTTON_ANSWERS_CALL, 1) == 1) {
               ITelephony telephonyService = getTelephonyService();
                 if (telephonyService != null) {
                   try {
     ...
     public boolean detectSafeMode() {
         try {
           if ("1".equals(SystemProperties.get("persist.sys.safe_mode", "0"))) {
             mSafeMode = true;
             performHapticFeedbackLw(null, mSafeMode
                     ? HapticFeedbackConstants.SAFE_MODE_ENABLED
                     : HapticFeedbackConstants.SAFE_MODE_DISABLED, true);
             if (mSafeMode) {
                 Log.i(TAG, "SAFE MODE ENABLED (Force enable by user)");
             } else {
     ...
     Runnable mScreenSaverActivator = new Runnable() {	
         public void run() {
             ...
             if (keyguardOn()) {
                 if (localLOGV) Log.v(TAG, "mScreenSaverActivator: not running screen saver when keyguard active");
                 return;
             }
             ...
             try {
                 ...
                 if (component == null) {
                     component = "com.android.settings/com.android.settings.cube.CubeActivity"; //mContext.getResources().getString(R.string.config_defaultDreamComponent);
                 }
                 if (component != null) {
