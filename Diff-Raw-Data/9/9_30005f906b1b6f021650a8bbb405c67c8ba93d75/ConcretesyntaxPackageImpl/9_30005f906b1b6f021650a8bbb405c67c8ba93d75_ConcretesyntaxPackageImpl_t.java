 ...
 public class ConcretesyntaxPackageImpl extends EPackageImpl implements ConcretesyntaxPackage {
 	...
 	public void initializePackageContents() {
 		...
 		importEClass.getESuperTypes().add(this.getAnnotable());
 		...
 		op = addEOperation(defaultTokenStyleAdderEClass, theEcorePackage.getEString(), "getAllKeywords", 0, -1, IS_UNIQUE, IS_ORDERED);
 		addEParameter(op, this.getRule(), "rule", 0, 1, IS_UNIQUE, IS_ORDERED);
 		...
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_NEW_PROJECT_WIZARD);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.DISABLE_NEW_PROJECT_WIZARD);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_OPTION_PROVIDER);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.IGNORE_TYPE_RESTRICTIONS_FOR_PRINTING);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_INAME_PROVIDER);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_DEFAULT_NAME_PROVIDER);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_REFERENCE_CACHE);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_OUTLINE_PAGE_LEXICAL_SORTING_ACTION);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_OUTLINE_PAGE_COLLAPSE_ALL_ACTION);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_OUTLINE_PAGE_GROUP_TYPES_ACTION);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_ABSTRACT_OUTLINE_PAGE_ACTION);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_OUTLINE_PAGE_TREE_VIEWER_COMPARATOR);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_OUTLINE_PAGE_EXPAND_ALL_ACTION);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_OUTLINE_PAGE_ACTION_PROVIDER);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_OUTLINE_PAGE_LINK_WITH_EDITOR_ACTION);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_OUTLINE_PAGE_AUTO_EXPAND_ACTION);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_CONTAINED_FEATURE);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_EXPECTATION_CONSTANTS);
 		addEEnumLiteral(optionTypesEEnum, OptionTypes.OVERRIDE_ECLIPSE_PROXY);
 	...
 	protected void createGenModelAnnotations() {
 		...
 		addAnnotation
 		  (optionTypesEEnum.getELiterals().get(140), 
 		   source, 
 		   new String[] {
 			 "documentation", "Sets the ID for the generated common ANTLR runtime plug-in. The default value for this option is <code>org.emftext.commons.antlr3_4_0</code>."
 		   });		
 		addAnnotation
 		...
 		addAnnotation
 		  (optionTypesEEnum.getELiterals().get(254), 
 		   source, 
 		   new String[] {
 			 "documentation", "If set to <code>false</code>, the LaunchConfigurationHelper class will not be overridden. The default value for this option is <code>true</code>."
 		   });		
 		addAnnotation
 		...
 		addAnnotation
 		  (optionTypesEEnum.getELiterals().get(256), 
 		   source, 
 		   new String[] {
 			 "documentation", "If set to <code>true</code>, the new NewProjectWizard is not registered. Use this option if there is already an existing wizard. The default value for this option is <code>false</code>."
 		   });		
 		addAnnotation
 		  (optionTypesEEnum.getELiterals().get(257), 
 		   source, 
 		   new String[] {
 			 "documentation", "If set to <code>false</code>, the OptionProvider class will not be overridden. The default value for this option is <code>true</code>."
 		   });		
 		addAnnotation
 		  (optionTypesEEnum.getELiterals().get(258), 
 		   source, 
 		   new String[] {
 		...
 		addAnnotation
 		  (optionTypesEEnum.getELiterals().get(271), 
 		   source, 
 		   new String[] {
 			 "documentation", "If set to <code>false</code>, the ContainedFeature class will not be overridden. The default value for this option is <code>true</code>."
 		   });		
 		addAnnotation
 		  (optionTypesEEnum.getELiterals().get(272), 
 		   source, 
 		   new String[] {
 			 "documentation", "If set to <code>false</code>, the ExpectationConstants class will not be overridden. The default value for this option is <code>true</code>."
 		   });		
 		addAnnotation
 		  (optionTypesEEnum.getELiterals().get(273), 
 		   source, 
 		   new String[] {
