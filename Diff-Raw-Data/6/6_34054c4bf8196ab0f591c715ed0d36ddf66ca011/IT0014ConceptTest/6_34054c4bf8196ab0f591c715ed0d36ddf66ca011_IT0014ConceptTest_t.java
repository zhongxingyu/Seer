 ...
 public class IT0014ConceptTest extends AbstractMavenIntegrationTestCase {
 	...
 	public void testSimpleAirApplication() throws Exception {
 		standardConceptTester("simple-air-application");
 	}
 
 	public void testSimpleAirLibrary() throws Exception {
 		standardConceptTester("simple-air-library");
 	}
 
 	public void testSimpleFlexApplication() throws Exception {
 		standardConceptTester("simple-flex-application");
 	}
 
 	public void testSimpleFlexLibrary() throws Exception {
 		standardConceptTester("simple-flex-library");
 	}
 
 	public void testEncrypterMojo() throws Exception {
 		standardConceptTester("encrypt-test");
 	}
 
 	public void testFlashPlayer10() throws Exception {
 		standardConceptTester("flash-player-10");
 	}
 
 	public void testFlex3SDK() throws Exception {
 		File testDir = ResourceExtractor.simpleExtractResources(
 				MavenVerifierHelper.class, "/flex-sdk");
 		assertTrue(
 				"Flex SDK source not found.  Download it from opensource.adobe.com",
 				new File(testDir, "framework").exists());
 		standardConceptTester("flex-sdk");
 	}
 
 	public void testFlex4Gumbo() throws Exception {
 		standardConceptTester("flex4-gumbo");
 	}
 
 	public void testFlexUnitExample() throws Exception {
 		standardConceptTester("flexunit-example");
 	}
 
 	public void testHelloCaching() throws Exception {
 		standardConceptTester("hello-cachingframework");
 	}
 
 	public void testHtmlTemplateApplication() throws Exception {
 		File testDir = ResourceExtractor.simpleExtractResources(
 	...
 	public void testMetadataTest() throws Exception {
 		standardConceptTester("metadata-test");
 	}
 
 	public void testOptimizedFlexLibrary() throws Exception {
 	...
 	public void testRuntimeCss() throws Exception {
 		standardConceptTester("runtime-css");
 	}
 
 	public void testSimpleFlexModular() throws Exception {
