     ...
     public void run() {
       try {
         ...
         try {
           ...
           boolean isPrintRequestsDebug = Boolean.parseBoolean(SweetSystemProperty.WEBSERVER_DEBUG_PRINTREQUESTS.get());
           String printDataProperty = SweetSystemProperty.WEBSERVER_DEBUG_PRINTDATA.get();
 ...
 //        e.printStackTrace();
   ...
   public void start(boolean isDaemon) throws IOException {
     ...
     if(Boolean.parseBoolean(SweetSystemProperty.WEBSERVER_DEBUG_PRINTPORT.get())) {
