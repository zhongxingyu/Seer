 ...
 */
 ...
 public class Setup extends AbstractBatch {
     ...
     private void createSampleIssue(IssueManager issueManager,
        ...
        issue.setDescription("Um <bold>Suchwort</bold>-Analysen erstellen zu knnen bentigen wir die Mglichkeit, einen Blick in den Index (in die fr eine Kampagne erstellten Suchwrter) zu werfen." +
                              "<br>" +
