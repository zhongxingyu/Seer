 /*
  * $Id: MosaicProcessor.java,v 1.9 2007/04/13 14:42:09 marcop Exp $
  *
 ...
 public class MosaicProcessor extends Processor {
         ...
         if (_projectionMode) {
             ...
             try {
                 ...
                 for (String flagCodingName : flagCodingNames) {
                     ...
                     outputProduct.addFlagCoding(flagCodingOut);
     ...
     private Rectangle2D createOutputProductBoundaries() throws ProcessorException {
         ...
         if (MosaicUtils.isTrue(_fitOutputParam)) {
             ...
             final int width = _northEastMapParams.getOutputWidth();
             final int height = _northEastMapParams.getOutputHeight();
 ...
 /////////////////////////////////////
     ...
     private static class NorthEastMapParams {
         ...
         public int getOutputWidth() {
             return MosaicUtils.getInt(outputWidth);
         }
 
         public int getOutputHeight() {
             return MosaicUtils.getInt(outputHeight);
         }
     }
