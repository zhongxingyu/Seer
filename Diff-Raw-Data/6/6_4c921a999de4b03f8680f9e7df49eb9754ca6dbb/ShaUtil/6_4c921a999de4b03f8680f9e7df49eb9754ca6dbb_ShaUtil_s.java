 ...
 public class ShaUtil {
 	...
 	public static void main(String[] args) {
		final String sample1 = "12345:/sites/foo/bar !@#$%^&*()_+|}{\":?><[]\';/.,'ЭҹόĩɾֳÍŽ";
		final String sample2 = "12345:/sites/foo/bar !@#$%^&*()_+|}{\":?><[]\';/.,'ЭҹόĩɾֳÍŽ";
		final String sample3 = "12345:/sites/foo/bar !@#$%^&*()_+|}{\":?><[]\';/.,'ЭҹόĩɾֳÍ";
