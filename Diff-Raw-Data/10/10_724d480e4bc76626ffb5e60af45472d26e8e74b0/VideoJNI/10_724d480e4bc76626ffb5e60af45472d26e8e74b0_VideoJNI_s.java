 ...
 // HumbleVideo.i: End generated code
   ...
   public final static native int MetaData_METADATA_NONE_get();
   public final static native int MetaData_METADATA_MATCH_CASE_get();
   public final static native int MetaData_METADATA_DONT_OVERWRITE_get();
   public final static native int MetaData_META_DATA_APPEND_get();
   public final static native int MetaData_getNumKeys(long jarg1, MetaData jarg1_);
   public final static native String MetaData_getKey(long jarg1, MetaData jarg1_, int jarg2);
   public final static native String MetaData_getValue(long jarg1, MetaData jarg1_, String jarg2, int jarg3);
   public final static native int MetaData_setValue__SWIG_0(long jarg1, MetaData jarg1_, String jarg2, String jarg3);
   public final static native long MetaData_make();
   public final static native int MetaData_setValue__SWIG_1(long jarg1, MetaData jarg1_, String jarg2, String jarg3, int jarg4);
  ...
  public final static native void Stream_noop(long jarg1, Stream jarg1_);
   ...
   public final static native boolean Container_isOpened(long jarg1, Container jarg1_);
   public final static native long Container_getFormat(long jarg1, Container jarg1_);
   public final static native int Container_close(long jarg1, Container jarg1_);
   public final static native int Container_getNumStreams(long jarg1, Container jarg1_);
   public final static native long Container_getStream(long jarg1, Container jarg1_, long jarg2);
   public final static native long Container_getDuration(long jarg1, Container jarg1_);
   public final static native long Container_getStartTime(long jarg1, Container jarg1_);
   public final static native long Container_getFileSize(long jarg1, Container jarg1_);
   public final static native int Container_getBitRate(long jarg1, Container jarg1_);
   public final static native int Container_getNumProperties(long jarg1, Container jarg1_);
   public final static native long Container_getPropertyMetaData__SWIG_0(long jarg1, Container jarg1_, int jarg2);
   public final static native long Container_getPropertyMetaData__SWIG_1(long jarg1, Container jarg1_, String jarg2);
   public final static native int Container_setProperty__SWIG_0(long jarg1, Container jarg1_, String jarg2, String jarg3);
   public final static native int Container_setProperty__SWIG_1(long jarg1, Container jarg1_, String jarg2, double jarg3);
   public final static native int Container_setProperty__SWIG_2(long jarg1, Container jarg1_, String jarg2, long jarg3);
   public final static native int Container_setProperty__SWIG_3(long jarg1, Container jarg1_, String jarg2, boolean jarg3);
   public final static native int Container_setProperty__SWIG_4(long jarg1, Container jarg1_, String jarg2, long jarg3, Rational jarg3_);
   public final static native String Container_getPropertyAsString(long jarg1, Container jarg1_, String jarg2);
   public final static native double Container_getPropertyAsDouble(long jarg1, Container jarg1_, String jarg2);
   public final static native long Container_getPropertyAsLong(long jarg1, Container jarg1_, String jarg2);
   public final static native long Container_getPropertyAsRational(long jarg1, Container jarg1_, String jarg2);
   public final static native boolean Container_getPropertyAsBoolean(long jarg1, Container jarg1_, String jarg2);
   public final static native int Container_getFlags(long jarg1, Container jarg1_);
   public final static native boolean Container_getFlag(long jarg1, Container jarg1_, int jarg2);
   public final static native void Container_setFlag(long jarg1, Container jarg1_, int jarg2, boolean jarg3);
   public final static native void Container_setFlags(long jarg1, Container jarg1_, int jarg2);
   public final static native String Container_getURL(long jarg1, Container jarg1_);
   public final static native long Container_getMetaData(long jarg1, Container jarg1_);
   public final static native int Container_setProperty__SWIG_5(long jarg1, Container jarg1_, long jarg2, MetaData jarg2_, long jarg3, MetaData jarg3_);
   ...
   public final static native long SWIGMetaDataUpcast(long jarg1);
