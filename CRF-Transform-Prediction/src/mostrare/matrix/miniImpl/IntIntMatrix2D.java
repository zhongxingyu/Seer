 ...
 * @author missi
 */
public abstract class IntIntMatrix2D extends AbstractMatrix2D
{
	/**
	 ...
	 *             bounds.
	 */
	public void set(int indexNode1, int annotation1, int value)
	{
	 ...
	 *            the value to be filled into the specified cell.
	 */
	public abstract void setQuick(int indexNode1, int annotation1, int value);
	 ...
	 *             bounds.
	 */
	public int get(int indexNode1, int annotation1)
	{
	 ...
	 * @return the value of the specified cell.
	 */
	public abstract int getQuick(int indexNode1, int annotation1);
