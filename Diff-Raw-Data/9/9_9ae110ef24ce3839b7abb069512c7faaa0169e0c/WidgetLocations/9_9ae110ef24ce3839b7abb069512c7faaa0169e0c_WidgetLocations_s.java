 ...
 public class WidgetLocations {
	...
	public static final String ENVIRONMENT_CONTENT_SIDEBAR_RIGHT = "environment.content-sidebar-right";
 	...
 	public static final String WORKSPACE_HEADER_LEFT = "workspace.header.left";
 	public static final String WORKSPACE_HEADER_CENTER = "workspace.header.center";
 	public static final String WORKSPACE_HEADER_RIGHT = "workspace.header.right";	
 	public static final String WORKSPACE_DOCK_TOP_LEFT = "workspace.dock-top.left";
 	public static final String WORKSPACE_DOCK_TOP_CENTER = "workspace.dock-top.center";
 	public static final String WORKSPACE_DOCK_TOP_RIGHT = "workspace.dock-top.right";
 	public static final String WORKSPACE_CONTENT = "workspace.content";
 	public static final String WORKSPACE_CONTENT_TOOLS_TOP_LEFT = "workspace.content-tools-top.left";
 	public static final String WORKSPACE_CONTENT_TOOLS_TOP_CENTER = "workspace.content-tools-top.center";
 	public static final String WORKSPACE_CONTENT_TOOLS_TOP_RIGHT = "workspace.content-tools-top.right";
	...
	public static final String WORKSPACE_CONTENT_SIDEBAR_RIGHT = "workspace.content-sidebar-right";
 	...
 	public static final String WORKSPACE_FOOTER_LEFT = "workspace.footer.left";
 	...
 	public static String[] getAll() {
 		return new String[] {
 		  ...
 		  ENVIRONMENT_CONTENT_TOOLS_TOP_LEFT,
 			...
 			WORKSPACE_HEADER_CENTER,
 			WORKSPACE_HEADER_RIGHT,
 			WORKSPACE_DOCK_TOP_LEFT,
 			WORKSPACE_DOCK_TOP_CENTER,
 			WORKSPACE_DOCK_TOP_RIGHT,
 			WORKSPACE_CONTENT,
 		  WORKSPACE_CONTENT_TOOLS_TOP_LEFT,
 			WORKSPACE_CONTENT_TOOLS_TOP_CENTER,
 			WORKSPACE_CONTENT_TOOLS_TOP_RIGHT,
 			WORKSPACE_CONTENT_TOOLS_BOTTOM_LEFT,
 			WORKSPACE_CONTENT_TOOLS_BOTTOM_CENTER,
 			WORKSPACE_CONTENT_TOOLS_BOTTOM_RIGHT,
 			WORKSPACE_CONTENT_SIDEBAR_LEFT,
 			WORKSPACE_CONTENT_SIDEBAR_RIGHT,
 			WORKSPACE_DOCK_BOTTOM_LEFT,
 			WORKSPACE_DOCK_BOTTOM_CENTER,
 			WORKSPACE_DOCK_BOTTOM_RIGHT,
 			WORKSPACE_FOOTER_LEFT,
 			WORKSPACE_FOOTER_CENTER,
 			WORKSPACE_FOOTER_RIGHT
 		};
 	}
 }
