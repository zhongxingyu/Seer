 ...
 import static net.ser1.timetracker.Tasks.Result;
 ...
 public class DBBackup extends AsyncTask<SQLiteDatabase, Integer, Void> {
     ...
     public DBBackup(Tasks callback, ProgressDialog progress, int operation) {
 ...
 //        publishProgress(SETMAX, tasks.size());
     ...
     protected void onPostExecute(Void v) {
         ...
         callback.finishedCopy(result, message, operation);
     }
