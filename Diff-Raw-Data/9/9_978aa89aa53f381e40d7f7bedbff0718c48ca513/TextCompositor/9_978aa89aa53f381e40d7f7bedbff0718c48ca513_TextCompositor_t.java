 ...
 public class TextCompositor
 {
 	...
 	/** 
 	 * Check if current TextArea contains line break.
 	 * If text wrapping need not be handled, hasNextArea() will return false when hasLineBreak is true.
 	 */
 	...
 	public TextCompositor( ITextContent textContent, FontMappingManager fontManager,
 			boolean bidiProcessing, boolean fontSubstitution, boolean textWrapping,
 			boolean hyphenation, Locale locale )
 	{
