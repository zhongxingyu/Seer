 ...
 public class Wallet implements Serializable, IsMultiBitClass {
      ...
      * 
      * @param to
      *            Address to send the coins to.
      * @param nanocoins
      *            How many coins to send.
      * @return the Transaction that was created, or null if there are
      *         insufficient coins in thew allet.
      */
     ...
     synchronized Transaction createSend(Address address, BigInteger nanocoins, final BigInteger fee, Address changeAddress) {
         log.info("Creating send tx to " + address.toString() + " for " + bitcoinValueToFriendlyString(nanocoins));
