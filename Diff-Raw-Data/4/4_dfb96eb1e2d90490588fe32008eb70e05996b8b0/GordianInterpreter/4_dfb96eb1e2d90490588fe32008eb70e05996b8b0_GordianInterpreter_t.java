 ...
 public final class GordianInterpreter implements Interpreter {
     ...
     private class NumberLiteral implements ValueType {
     ...
     private class BooleanLiteral implements ValueType {
     ...
     private class Declaration implements ValueType {
     ...
     private class Parentheses implements ValueType {
     ...
     private class Reversed implements ValueType {
     ...
     private class Function implements ValueType {
     ...
     private class ListLiteral implements ValueType {
     ...
     private class Calculation implements ValueType {
     ...
     private class Constructor implements ValueType {
 
         public Value from(String s) throws NoValue {
             if (s.startsWith("[") && s.endsWith("]")) {
                 Value v = null;
                 try {
                     v = scope.getInterpreter().interpretValue(s.substring(1, s.length() - 1));
     ...
     private class And implements ValueType {
     ...
     private class Or implements ValueType {
     ...
     private class Equals implements ValueType {
     ...
     private class NotEquals implements ValueType {
     ...
     private class ComparisonWithEquals implements ValueType {
     ...
     private class ComparisonWithoutEquals implements ValueType {
     ...
     private class Concatenation implements ValueType {
     ...
     private class ObjectAccess implements ValueType {
     ...
     private class ListAccess implements ValueType {
     ...
     private class Variable implements ValueType {
