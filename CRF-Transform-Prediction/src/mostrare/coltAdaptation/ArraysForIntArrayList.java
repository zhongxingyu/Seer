 ...
 * @author missi
 */
public class ArraysForIntArrayList
{
	/**
	 * Makes this class non instantiable, but still let's others inherit from it.
	 */
	protected ArraysForIntArrayList()
	{
	}
	 ...
	 *            the desired minimum capacity.
	 */
	public static IntArrayList[] ensureCapacity(IntArrayList[] array, int minCapacity)
	{
		int oldCapacity = array.length;
		IntArrayList[] newArray;
		if (minCapacity > oldCapacity)
		{
			int newCapacity = (oldCapacity * 3) / 2 + 1;
			if (newCapacity < minCapacity)
			...
			newArray = new IntArrayList[newCapacity];
			System.arraycopy(array, 0, newArray, 0, oldCapacity);
		}
		else
		{
	 ...
	 *            the desired maximum capacity.
	 */
	public static IntArrayList[] trimToCapacity(IntArrayList[] array, int maxCapacity)
	{
		if (array.length > maxCapacity)
		{
			IntArrayList oldArray[] = array;
			array = new IntArrayList[maxCapacity];
			System.arraycopy(oldArray, 0, array, 0, maxCapacity);
		}
		return array;
	}
