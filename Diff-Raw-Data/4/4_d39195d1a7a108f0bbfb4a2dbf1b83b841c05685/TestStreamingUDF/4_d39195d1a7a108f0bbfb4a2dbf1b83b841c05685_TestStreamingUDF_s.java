 ...
 public class TestStreamingUDF {
     ...
     public void testPythonUDF__allTypes() throws Exception {
          ...
          * (10,
         * {(user1,10,(,32,1000000099990000,32.0,3200.12346785,Some String,Hello\u2026Hello,HelloHello,Some Byte Array),
         *   [Simple Name#Simple Value,SomeNum#32,WeirdName#Weird  Value],)
          * })
          */
