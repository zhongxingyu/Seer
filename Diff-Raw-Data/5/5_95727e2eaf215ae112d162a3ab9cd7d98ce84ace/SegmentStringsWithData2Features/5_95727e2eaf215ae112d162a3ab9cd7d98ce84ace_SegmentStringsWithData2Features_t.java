 ...
 public class SegmentStringsWithData2Features {
     ...
     public static Map<Feature,Map<Integer,Map<Integer,List<SegmentString>>>> 
         ...
         // Cration de geomStructureMap, une table regroupant les SegmentStrings
         // rsultant du traitement en fonction du feature, du component, 
         // (GeometryCollection) et de l'lment linaire d'origine.
