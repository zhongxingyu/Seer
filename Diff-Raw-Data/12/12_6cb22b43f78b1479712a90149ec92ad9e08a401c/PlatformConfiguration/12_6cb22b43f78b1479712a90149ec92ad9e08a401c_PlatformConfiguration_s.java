 	...
 	public static synchronized void startup(URL installURL, Location platformConfigLocation) throws Exception {
 		...
 		if (currentPlatformConfiguration == null) {
 			...
 			if (currentPlatformConfiguration.config.isDirty())
 				// If this is a transient config (generated by PDE, fix the timestamp
 				// otherwise, save the configuration with proper date
 				if (currentPlatformConfiguration.isTransient()) {
 					URL configLocation = currentPlatformConfiguration.getConfigurationLocation();
 					if ("file".equals(configLocation.getProtocol())) {
 						File platformXML = new File(configLocation.getFile());
 						platformXML.setLastModified(currentPlatformConfiguration.getChangeStamp());
 					}
 				} else
