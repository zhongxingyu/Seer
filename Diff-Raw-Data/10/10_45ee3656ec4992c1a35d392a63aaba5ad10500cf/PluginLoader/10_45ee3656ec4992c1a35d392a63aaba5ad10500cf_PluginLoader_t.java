...
import java.util.Map;
 ...
 public final class PluginLoader {
 	...
 	private static Class<?> ensureBackwardsCompatibility(Class<?> clazz) {
		...
		// Alpha 1.1.1 Plugins Test
		map.put("spaceshooters/api/plugins/PluginMetadataAnnotation", "spaceshooters/api/plugins/PluginMetadata$Annotation");
		map.put("spaceshooters/entities/EntityTypes", "spaceshooters/entities/EntityType");
		ClassVisitor remapper = new RemappingClassAdapter(writer, new SimpleRemapper(map));
