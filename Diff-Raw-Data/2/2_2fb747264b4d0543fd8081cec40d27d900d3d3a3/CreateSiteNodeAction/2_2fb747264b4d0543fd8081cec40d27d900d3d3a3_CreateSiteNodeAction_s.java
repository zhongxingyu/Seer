 ...
 public class CreateSiteNodeAction extends InfoGlueAbstractAction
 {
     ...
     public String doExecuteV3() throws Exception
     {
         ...
         try
         {
             ...
             addActionLink(userSessionKey, new LinkBean("newPageUrl", "Direkt till sidan du skapade","Klicka hr om du vill komma direkt till sidan du just startat.", "Klicka hr om du vill komma direkt till sidan du just startat.", getDecoratedPageUrl(newSiteNodeVO.getId()), ""));
         }
         catch(Exception e)
         {
             logger.error("An error occurred so we should not complete the transaction:" + e, e);
     ...
     {    	
         ...
         addActionLink(userSessionKey, new LinkBean("currentPageUrl", "Tillbaka till sidan du utgick frn", "Klicka hr om du vill komma tillbaka till sidan dr du startade fldet.", "Klicka hr om du vill komma tillbaka till sidan dr du startade fldet.", this.originalAddress, ""));
