...
import org.opengis.util.SimpleEnumerationType;
 ...
 public class TransactionEventType extends SimpleEnumerationType<TransactionEventType> {
     ...
     /**
      * Notification of inserted features, before insertion occurs (collection
     ...
     /**
      * Notification of inserted features, after insertion occurs (collection
      * contains newly inserted features). Depending on the operation, only pre
      * or post insert will be issued
      */
     ...
     /**
      * Notification of updated features, before update occurs (collection
     ...
     /**
      * Notification of updated features, after update occurs (collection
      * contains updated features)
      */
