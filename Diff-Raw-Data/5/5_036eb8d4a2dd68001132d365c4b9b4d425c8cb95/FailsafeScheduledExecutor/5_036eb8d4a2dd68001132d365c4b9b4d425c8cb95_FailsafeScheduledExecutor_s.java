 ...
 public class FailsafeScheduledExecutor extends ScheduledThreadPoolExecutor
 {
     ...
     /**
     * Creates a new single-threaded executor with a {@link ning.concurrent.NamedThreadFactory} of the given name.
      *
     ...
     /**
     * Creates a new executor with a {@link ning.concurrent.NamedThreadFactory} of the given name.
      *
