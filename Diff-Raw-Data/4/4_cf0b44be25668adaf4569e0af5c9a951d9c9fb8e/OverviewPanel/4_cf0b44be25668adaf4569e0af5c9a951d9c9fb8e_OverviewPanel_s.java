 ...
 public class OverviewPanel extends javax.swing.JPanel {
     ...
     public OverviewPanel(PeptideShakerGUI parent) {
         ...
         sequencePtmTableScrollPane.setBorder(null);
         ...
         sequencePtmTableScrollPane.getViewport().setOpaque(false);
     ...
     private void setTableProperties() {
         ...
         ptmTable.getColumn(" ").setCellRenderer(new JSparklinesTableCellRenderer(JSparklinesTableCellRenderer.PlotType.proteinSequence, PlotOrientation.HORIZONTAL, 0.0, 100d));
         ((JSparklinesTableCellRenderer) ptmTable.getColumn(" ").getCellRenderer()).setBackgroundColor(Color.WHITE);
         ((JSparklinesTableCellRenderer) ptmTable.getColumn(" ").getCellRenderer()).showProteinSequenceReferenceLine(false);
     ...
     private void initComponents() {
         ...
         sequencePtmTableScrollPane = new javax.swing.JScrollPane();
         ...
         ptmTable.setEnabled(false);
         ptmTable.setOpaque(false);
         ptmTable.setRowHeight(8);
         ptmTable.setTableHeader(null);
         ptmTable.addMouseListener(new java.awt.event.MouseAdapter() {
             public void mouseExited(java.awt.event.MouseEvent evt) {
                 ptmTableMouseExited(evt);
             }
         });
         ptmTable.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
             public void mouseMoved(java.awt.event.MouseEvent evt) {
                 ptmTableMouseMoved(evt);
             }
         });
         sequencePtmTableScrollPane.setViewportView(ptmTable);
         ...
         peptideTable.setModel(new javax.swing.table.DefaultTableModel(
             ...
             new String [] {
                 " ", "  ", "PI", "Sequence", "Start", "#Spectra", "Score", "Confidence", ""
             }
         ) {
             Class[] types = new Class [] {
                 java.lang.Integer.class, java.lang.Boolean.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Double.class, java.lang.Boolean.class
             };
             boolean[] canEdit = new boolean [] {
     ...
     private void coverageTableMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_coverageTableMouseMoved
         ...
         if (currentProteinSequence != null) {
             ...
             if (!tooltipText.equalsIgnoreCase("<html>")) {
                 coverageTable.setToolTipText(tooltipText + "</html>");
                 this.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
             } else {
             ...
             if (!peptideIndexes.isEmpty()) {
                 ...
                 if (peptideIndexes.size() == 1) {
                     ...
                     for (int i = 0; i < tempPeptideIndexes.size(); i++) {
                         ...
                         String text = "<html>" + (i + 1) + ": " + peptideStart + " - "
                                 + modifiedSequence
                                 + " - " + peptideEnd
                                 + "</html>";
 ...
 private void coverageTableMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_coverageTableMouseExited
      ...
      * @param evt 
      */
     private void ptmTableMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ptmTableMouseExited
         this.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
     }//GEN-LAST:event_ptmTableMouseExited
 
     /**
      * Update the protein table PTM tooltip.
      * 
      * @param evt 
      */
     private void ptmTableMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ptmTableMouseMoved
         ...
         if (currentProteinSequence != null) {
             ...
             if (!tooltipText.equalsIgnoreCase("<html>")) {
                 ptmTable.setToolTipText(tooltipText);
                 this.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
             } else {
                 ptmTable.setToolTipText(null);
                 this.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
             }
         }
     }//GEN-LAST:event_ptmTableMouseMoved
     ...
     private javax.swing.JScrollPane sequencePtmTableScrollPane;
 ...
 //                        }
     ...
     private void updatePsmSelection(int row) {
         ...
         if (row != -1) {
             ...
             try {
                 ...
                 String peptideKey = peptideTableMap.get(getPeptideIndex(row));
                 ArrayList<String> psmKeys = peptideShakerGUI.getIdentificationFeaturesGenerator().getSortedPsmKeys(peptideKey);
     ...
     private void updatedPeptideSelection(int row) {
         ...
         if (row != -1) {
             ...
             try {
                 ...
                 String proteinMatchKey = proteinTableMap.get(getProteinIndex(row));
                 ...
                 for (String peptideKey : peptideKeys) {
                     ...
                     if (!probabilities.isHidden()) {
                         ...
                         spectrumCount = currentMatch.getSpectrumCount();
                         ...
                         ((DefaultTableModel) peptideTable.getModel()).addRow(new Object[]{
                                     ...
                                     peptideStart,
                                     new XYDataPoint(validatedSpectraCounter, spectrumCount - validatedSpectraCounter, false),
         ...
         new Thread("DisplayThread") {
             ...
             public void run() {
                 ...
                 try {
                     ...
                     ArrayList<String> keys = peptideShakerGUI.getIdentificationFeaturesGenerator().getSortedProteinKeys(progressDialog);
                     ...
                     PSParameter secondaryPSParameter = new PSParameter();
                     PSParameter probabilities = new PSParameter();
                     int currentNP, currentNS;
 
                     for (String proteinMatchKey : keys) {
 
                         nValidatedPeptides = 0;
                         nValidatedSpectra = 0;
 
                         proteinMatch = peptideShakerGUI.getIdentification().getProteinMatch(proteinMatchKey);
                         probabilities = (PSParameter) peptideShakerGUI.getIdentification().getMatchParameter(proteinMatchKey, probabilities);
 
                         if (!probabilities.isHidden()) {
 
                             currentNP = proteinMatch.getPeptideCount();
                             currentNS = peptideShakerGUI.getIdentificationFeaturesGenerator().getNSpectra(proteinMatchKey);
                             ...
                             spectrumCounting = featuresGenerator.getSpectrumCounting(proteinMatchKey);
                             description = sequenceFactory.getHeader(proteinMatch.getMainMatch()).getDescription();
                             sequenceCoverage = 100 * featuresGenerator.getSequenceCoverage(proteinMatchKey);
                             possibleCoverage = 100 * featuresGenerator.getObservableCoverage(proteinMatchKey);
     ...
     private void updateSpectrumPanelBorderTitle(Peptide currentPeptide, MSnSpectrum currentSpectrum) {
         ...
         String peptideKey = peptideTableMap.get(getPeptideIndex(peptideTable.getSelectedRow()));
         int peptideStart = (Integer) peptideTable.getValueAt(peptideTable.getSelectedRow(), peptideTable.getColumn("Start").getModelIndex());
         int peptideEnd = peptideStart + peptideShakerGUI.getIdentification().getPeptideMatch(peptideKey).getTheoreticPeptide().getSequence().length();
         ...
         if (peptideStart - 2 >= 0) {
             before = currentProteinSequence.substring(peptideStart - 2, peptideStart) + " - ";
         } else if (peptideStart - 1 >= 0) {
             before = currentProteinSequence.substring(peptideStart - 1, peptideStart) + " - ";
         }
 
         if (peptideEnd + 2 <= currentProteinSequence.length()) {
             after = " - " + currentProteinSequence.substring(peptideEnd, peptideEnd + 2);
         } else if (peptideEnd + 1 <= currentProteinSequence.length()) {
             after = " - " + currentProteinSequence.substring(peptideEnd, peptideEnd + 1);
         }
