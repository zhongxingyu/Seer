 ...
 public class JCPMenuTextMaker {
     ...
     public void init(String guistring){
        ...
        entries.put("pseudoRX", GT._("Other..."));	
         ...
         entries.put("NTooltip", GT._("Change drawing symbol to {0}", "N"));
         entries.put("PTooltip", GT._("Change drawing symbol to {0}", "P"));
         entries.put("STooltip", GT._("Change drawing symbol to {0}", "S"));
         entries.put("FTooltip", GT._("Change drawing symbol to {0}", "F"));
