 ...
 public class DaiaXmlParser
 {
 	...
 	public ArrayList<AvailableEntry> parse(InputStream in) throws XmlPullParserException, IOException
 	{
 		try
 		{
 	...
 	private ArrayList<AvailableEntry> readDaia(XmlPullParser parser) throws XmlPullParserException, IOException
 	{
 		ArrayList<AvailableEntry> entryList = new ArrayList<AvailableEntry>();
 	...
 	private ArrayList<AvailableEntry> readDocument(XmlPullParser parser) throws XmlPullParserException, IOException
 	{
 		ArrayList<AvailableEntry> itemList = new ArrayList<AvailableEntry>();
 		String itemUriUrl = "";
 		...
 		while ( parser.next() != XmlPullParser.END_TAG )
 		{
 			...
 			if ( name.equals("item") )
 			{
 				...
 				AvailableEntry item = this.readItem(parser);
 	...
 	private AvailableEntry readItem(XmlPullParser parser) throws XmlPullParserException, IOException
 	{
