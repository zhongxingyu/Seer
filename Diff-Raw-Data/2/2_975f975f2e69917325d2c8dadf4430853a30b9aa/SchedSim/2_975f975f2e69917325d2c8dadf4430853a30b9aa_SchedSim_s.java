 ...
 class SchedSim {
 	...
 	private static double runFCFS(){	//if simulating an FCFS queue
 		...
 		while(!(eventQueue.isEmpty())){
			...
			//Therefore the activeprocess is set to null. This will make the scheuduler pull the next process off of the ready queue
 	...
 	private static boolean parseRandomFile(String [] args){
 		...
 		try {
 			...
 			for(int i = 0; i < Integer.parseInt(args[1]);i++){	//Get the information for each process from the random file
