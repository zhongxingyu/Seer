 ...
 import org.eclipse.gef.examples.flow.model.DfmAbout;
 ...
 private static PaletteContainer createComponentsDrawer() {
 	...
 	CombinedTemplateCreationEntry combined = new CombinedTemplateCreationEntry(
 			"NetApp Task",
 			"Create a NetApp Task",
 			Task.class,
 			new SimpleFactory(Task.class),
 			ImageDescriptor.createFromFile(FlowPlugin.class, "images/gear16.gif"), 
 			ImageDescriptor.createFromFile(Task.class, "images/gear16.gif")
 	);
 	entries.add(combined);
 	
 	combined = new CombinedTemplateCreationEntry(
 			"Init NetApp Connection",
 			"Init NetApp Connection",
 			ConnectTask.class,
 			new SimpleFactory(ConnectTask.class),
 			ImageDescriptor.createFromFile(FlowPlugin.class, "images/gear16.gif"), 
 			ImageDescriptor.createFromFile(ConnectTask.class, "images/gear16.gif")
 		);
 	entries.add(combined);
 	...
 	combined = new CombinedTemplateCreationEntry(
 		"Activity",
 		"Create a new NetApp SDK API Node",
 		Activity.class,
 		new SimpleFactory(Activity.class),
 		ImageDescriptor.createFromFile(FlowPlugin.class, "images/gear16.gif"), 
 		ImageDescriptor.createFromFile(Activity.class, "images/gear16.gif")
