 ...
 *
 */
public interface ValuesCalc
{

	/**
	 * Returns the log of Z(<code>tree</code>) by summing
	 * <code>beta[treeRoot,annotationIndex]</code> for each annotation of the <code>crf</code>.
	 * 
	 * @param betaParts
	 * @param tree
	 * @param crf
	 * @return log Z(<code>tree</code>).
	 */
	public abstract double logZ(BetaParts betaParts, Tree tree, CRF crf);
	 ...
	 * @param tree
	 * @param crf
	 * @return the log of the score.
	 */
	public abstract double logScore(MParts mparts, Tree tree, CRF crf);
