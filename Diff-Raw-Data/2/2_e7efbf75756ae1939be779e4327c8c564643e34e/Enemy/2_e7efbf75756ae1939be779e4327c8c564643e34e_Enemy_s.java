 ...
 public class Enemy extends AnimatedEntity {
	...
	private static final Animation anim = new Animation(new SpriteSheet("data/textures/vanilla/entities/enemy.png", 34, 41, 3, 1), new AnimationInfo(Enemy.class.getResourceAsStream("/data/textures/vanilla/entities/enemy.animinfo")));
