 		...
 		if (rule == null) {
 			...
 			try {
 				if (isPreTokenization) {
 					...
 					assertArrayEquals(
 							new Object[] { "Apple is one of the world's most valuable publicly traded companies in 2011010120120101." },
 							runtest("Apple is one of the world's most valuable publicly traded companies in 201112."));
 				} else {
 					assertArrayEquals(
