 ...
 import com.bjorsond.android.timeline.TimelineDirectory;
 import com.bjorsond.android.timeline.adapters.TimelineListAdapter;
 ...
 public TimelineBrowserDialog(Context context, Intent receivedIntent, int shared) {
 	...
 	public android.content.DialogInterface.OnClickListener deleteTimelineListener = new DialogInterface.OnClickListener() {	
 		...
 		public void onClick(DialogInterface dialog, int which) {
			...
			Toast.makeText(context, "Timeline: "+selectedTimeline.toString()+context.getString(R.string.Timeline_deleted_toast), Toast.LENGTH_SHORT).show();
