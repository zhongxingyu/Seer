 ...
 //#endif
 	...
 	Msg msg = null;
 	    ...
 	    msg = ((MessageItem) contact.msgs.elementAt(cursor)).msg;
 	}
 	if (msg != null) {
 ...
 //# 	if (msg != null && msg.isJuickMsg)
 //# 	    Juick.commandState(this);
 //#ifdef PLUGINS
 //#         }
 //#endif
 //#endif
 ...
 //# 		case '#':
 //# 		    Juick.juickAction(this, "", msg);
 //# 		    return;
 //# 		case '@':
 //# 		    Juick.juickAction(this, "PM", msg);
 //# 		    return;
 //# 	    }
 //# 	}
 //# 
