 ...
 public class PluginManager {
     ...
     /**
      * Contains a <TT>PluginInfo</TT> object for every plugin that we
      * attempted to load.
      */
      ...
      * and contains a <TT>List</TT> of active <TT>ISessionPlugin</TT>
     ...
     /**
      * Collection of <TT>PluginLoadInfo</TT> objects for the plugins. Stores
      * info about how long it took to load each plugin.
      */
     ...
     /**
      * A new session has been created. At this point the <TT>SessionPanel</TT>
     ...
     /**
      * Retrieve an array of all the <TT>URL</TT> objects that are used to find
      * plugin classes.
      * 
      * @return <TT>URL[]</TT>.
      */
      ...
      * 
      * @return <TT>Iterator</TT> over a collection of <TT>ISessionPlugin</TT>
      *         objects.
      */
      ...
      * 
      * @return <TT>Iterator</TT> over a collection of <TT>PluginLoadInfo</TT>
      *         objects.
      */
      ...
      *            Is the accessed plugins internal name returned by
      *            IPlugin.getInternalName().
      * 
      * @param toBindTo
      *            Is an interface that is to bind against the object that the
      *            accessed plugin returns by its getExternalService() method.
      * 
      * @return An Object that may be cast to the toBindTo interface and
      *         delegates all calls to the object returned by the accessed
      *         plugin's getExternalService() method. The method signature of the
      *         methods in the toBintTo interface and external service object
      *         must be identical. This method returns null if the plugin can not
     ...
     /**
      * A plugin implementation that serves only to identify plugins that aren't
      * being loaded, but which are still installed, and available to load on 
      * startup if the user changes the isLoadedOnStartup attribute.
      * 
      * @author rmmannin
      */
