 ...
 public class DbreCommands implements CommandMarker {
 	...
 	public void serializeDatabaseMetadata(
		...
		@CliOption(key = "activeRecord", specifiedDefaultValue = "true", unspecifiedDefaultValue = "true", help = "Generate CRUD active record methods for each entity") boolean activeRecord)
 	{
