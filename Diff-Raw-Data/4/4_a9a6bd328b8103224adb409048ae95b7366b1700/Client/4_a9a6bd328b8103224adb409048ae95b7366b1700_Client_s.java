 ...
 public class Client extends JFrame {
     ...
     public Client() {
        ...
        app1 = new Appointment("Testappointment", "Utendørs", "Dette er en test for å teste testen", new Date(2012, 3, 14), new Date(2012, 3, 15));
        app2 = new Appointment("Testappointment nummer 2", f1, "Dette er en test for å teste testen", new Date(2012, 3, 14), new Date(2012, 3, 15));
         f1 = new Room("F1", 300);
     }
     /**
