...
public abstract class DoubleMatrix3D extends AbstractMatrix3D
{
	 ...
	 *             bounds.
	 */
	public void set(int indexNode1, int annotation1, int annotation2, double value)
	{
		if (indexNode1 < 0 || indexNode1 >= nodes || annotation1 < 0 || annotation1 >= annotations
				|| annotation2 < 0 || annotation2 >= annotations)
			throw new IndexOutOfBoundsException("Wrong coordinate");
		setQuick(indexNode1, annotation1, annotation2, value);
	}
	 ...
	 *            the value to be filled into the specified cell.
	 */
	public abstract void setQuick(int indexNode1, int annotation1, int annotation2, double value);
	 ...
	 *             bounds.
	 */
	public double get(int indexNode1, int annotation1, int annotation2)
	{
		if (indexNode1 < 0 || indexNode1 >= nodes || annotation1 < 0 || annotation1 >= annotations
				|| annotation2 < 0 || annotation2 >= annotations)
			throw new IndexOutOfBoundsException("Wrong coordinate");

		return getQuick(indexNode1, annotation1, annotation2);
	}
	 ...
	 * @return the value of the specified cell.
	 */
	public abstract double getQuick(int indexNode1, int annotation1, int annotation2);
