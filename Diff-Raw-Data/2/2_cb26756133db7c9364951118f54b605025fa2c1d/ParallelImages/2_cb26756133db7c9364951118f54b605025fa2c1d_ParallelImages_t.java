 ...
 public class ParallelImages {
	...
	public static final String IMG_DEBUG_JOB_STARTING = "debug_job_starting.gif"; //$NON-NLS-1$
 	...
 	static {
 		...
 		ImageManager.createImageDescriptor(RMICONURL, IMG_RM_STOPPING, IMG_RM_STOPPING);
 		ImageManager.createImageDescriptor(RMICONURL, IMG_RM_SUSPENDED, IMG_RM_SUSPENDED);
 	...
 	public static final Image[][] nodeImages = {
 		...
 		// Internal states
 		{ ImageManager.getImage(ParallelImages.IMG_NODE_RUNNING_PROCESS),	ImageManager.getImage(ParallelImages.IMG_NODE_RUNNING_PROCESS_SEL)	},
 		{ ImageManager.getImage(ParallelImages.IMG_NODE_EXITED_PROCESS),	ImageManager.getImage(ParallelImages.IMG_NODE_EXITED_PROCESS_SEL)	},
 	};
