 ...
 public class YUIJavaScriptCompressor implements Compressor {
 	...
 	private Logger log = LoggerFactory.getLogger(YUIJavaScriptCompressor.class);
 	
 	private ErrorReporter defaultErrorReporter = new LoggerErrorReporter();
 	...
 	public void compress(Reader in, Writer out, String fileName) throws IOException {
 		LoggerErrorReporter errorReporter = new LoggerErrorReporter();
 	...
 	private class LoggerErrorReporter implements ErrorReporter {
