 ...
 public class InheritanceTests extends AbstractAnnotationsTestCase {
     ...
     @Ignore("alias property not supported")
     public void testOverride() throws Exception {
        ...
        assertEquals(8-1, resource.getProperties().length);
     ...
     @Ignore("poly alias not supported yet")
     ...
     @Ignore("extended aliases not stored in all property")
