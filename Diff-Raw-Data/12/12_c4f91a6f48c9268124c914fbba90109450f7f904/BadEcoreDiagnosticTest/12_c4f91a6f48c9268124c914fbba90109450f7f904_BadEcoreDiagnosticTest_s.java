 ...
 public class BadEcoreDiagnosticTest extends TestCase
 {
   ...
   public void testDiagnostic() throws Exception
   {
     ...
     assertEquals(115, diagnostic1.getChildren().size());
    ...
    assertEquals("The opposite of a transient reference must transient if it is proxy resolving", removeObjectHashCode(diagnostic75.getMessage()));
     ...
     assertEquals("org.eclipse.emf.ecore", diagnostic84.getSource());
     assertEquals("The required feature 'eAttributeType' of 'org.eclipse.emf.ecore.impl.EAttributeImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/AttributeClassType/a}' must be set", removeObjectHashCode(diagnostic84.getMessage()));
     assertEquals(1, diagnostic84.getCode());
     assertEquals(0, diagnostic84.getChildren().size());
     assertEquals(2, diagnostic84.getData().size());
     ...
     assertEquals("org.eclipse.emf.ecore", diagnostic86.getSource());
     assertEquals("The required feature 'eReferenceType' of 'org.eclipse.emf.ecore.impl.EReferenceImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#//genericType/ReferenceDataType/r}' must be set", removeObjectHashCode(diagnostic86.getMessage()));
     assertEquals(1, diagnostic86.getCode());
     assertEquals(0, diagnostic86.getChildren().size());
     assertEquals(2, diagnostic86.getData().size());
     ...
     assertEquals(Diagnostic.WARNING, diagnostic97.getSeverity());
     ...
     assertEquals(Diagnostic.ERROR, diagnostic117.getSeverity());
     ...
     assertEquals(Diagnostic.WARNING, diagnostic120.getSeverity());
     ...
     assertEquals(Diagnostic.ERROR, diagnostic122.getSeverity());
     ...
     assertEquals("org.eclipse.emf.ecore.model", diagnostic124.getSource());
     ...
     assertEquals(Diagnostic.WARNING, diagnostic125.getSeverity());
     ...
     assertEquals("The value '256' must be less than or equal to '255' ", removeObjectHashCode(diagnostic127.getMessage()));
     assertEquals(5, diagnostic127.getCode());
     ...
     assertEquals(Diagnostic.ERROR, diagnostic129.getSeverity());
     assertEquals("org.eclipse.emf.ecore", diagnostic129.getSource());
     assertEquals("The feature 'eSubpackages' of 'org.eclipse.emf.ecore.impl.EPackageImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#/}' contains an unresolved proxy 'org.eclipse.emf.ecore.impl.EPackageImpl{platform:/plugin/platform:/plugin/org.eclipse.emf.test.core/data/Bad.ecore#/1}'", removeObjectHashCode(diagnostic129.getMessage()));
     assertEquals(4, diagnostic129.getCode());
     assertEquals(0, diagnostic129.getChildren().size());
     assertEquals(3, diagnostic129.getData().size());
     assertNull(diagnostic129.getException());
