   ...
   public void bind() throws Exception {
    ...
    if (k != null && !k.isNewObject())
     ...
     buttonArea.addButton(i18n.tr("Protokoll des Kontos"),new ProtokollList(),control.getKonto());
 		buttonArea.addButton(i18n.tr("Konto lschen"),new KontoDelete(),control.getKonto());
     ...
     TabGroup tab = new TabGroup(folder,i18n.tr("Umstze der letzten {0} Tage",""+HBCIProperties.UMSATZ_DEFAULT_DAYS), false,1);
     ...
     buttons.addButton(i18n.tr("Zurck"),new Back(),null,true);
     buttons.addButton(i18n.tr("Saldo und Umstze abrufen"), new KontoFetchUmsaetze(),control.getKonto());
     buttons.addButton(i18n.tr("Alle Umstze anzeigen"),     new UmsatzList(),control.getKonto());
   }
