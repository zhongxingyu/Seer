 ...
 public class CombinedPresetDialog extends JDialog {
     ...
     private void buildComponents(GridBagConstraints constraints) {
        ...
        buildSingleLabel(constraints,0,1,new JLabel("Select first signal:"));
        ...
        buildSingleRadioButton(constraints, 1, 1, jRadioButtonHarmonic);
        ...
        buildSingleRadioButton(constraints,2,1,jRadioButtonRandom);
