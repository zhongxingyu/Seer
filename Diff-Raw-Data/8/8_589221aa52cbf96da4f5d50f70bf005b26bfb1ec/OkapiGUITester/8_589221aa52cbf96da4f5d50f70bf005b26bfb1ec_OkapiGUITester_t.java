...
public class OkapiGUITester {
 	...
 	String[] GUI_CLASSES = new String[] {
 			...
 			net.sf.okapi.steps.tokenization.ui.mapping.Mapper.class.getName(),
 			net.sf.okapi.steps.tokenization.ui.mapping.MappingItemPage.class.getName(),
 			net.sf.okapi.steps.wordcount.ui.ParametersEditor.class.getName(),
 			net.sf.okapi.steps.tokenization.ui.tokens.TokensTab.class.getName(),
 			net.sf.okapi.steps.tokenization.ui.tokens.AddModifyTokenPage.class.getName(),
 			net.sf.okapi.steps.tokenization.ui.locale.LanguageListTab.class.getName(),
 			net.sf.okapi.filters.table.ui.Editor.class.getName(),
 			net.sf.okapi.filters.plaintext.ui.Editor.class.getName(),
 			net.sf.okapi.common.ui.abstracteditor.InputQueryPageInt.class.getName(),
 			net.sf.okapi.common.ui.abstracteditor.InputQueryPageString.class.getName(),
 			net.sf.okapi.filters.table.ui.AddModifyColumnDefPage.class.getName(),					
