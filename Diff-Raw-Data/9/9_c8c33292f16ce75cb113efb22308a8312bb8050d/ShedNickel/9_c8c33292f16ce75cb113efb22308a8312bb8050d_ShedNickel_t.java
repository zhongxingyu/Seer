 ...
 /**
   ...
   */
    public double calcTotalOreWeight() 
    {
       ...
       fTotalOre = 0.0;
       for (OrePile pile : m_orePileStack) {	// For this to work, Iterator must be implemented in DSAStack
 ...
 /**
   ...
   *
   * @return		An Iterator for this Shed (actually, DSAStack's Iterator)
   */
