...
import de.thorstenberger.taskmodel.complex.jaxb.PaintSubTaskDef;
  ...
  *
  */
 public class PaintChoiceImpl implements Choice {
 
 	private de.thorstenberger.taskmodel.complex.jaxb.ComplexTaskDefType.CategoryType.PaintTaskBlockType.Choice choice;
 	
 	/**
 	 * @param choice
 	 */
 	public PaintChoiceImpl(de.thorstenberger.taskmodel.complex.jaxb.ComplexTaskDefType.CategoryType.PaintTaskBlockType.Choice choice) {
 		this.choice = choice;
 	}
