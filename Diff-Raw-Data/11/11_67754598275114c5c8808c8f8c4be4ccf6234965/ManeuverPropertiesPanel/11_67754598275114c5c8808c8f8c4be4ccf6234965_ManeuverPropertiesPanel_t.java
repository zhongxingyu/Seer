  ...
  * Nov 30, 2011
  */
 package pt.lsts.neptus.plugins.planning.edit;
 ...
 public class ManeuverPropertiesPanel extends JPanel {
     ...
     protected JToggleButton editBtn = new JToggleButton(I18n.text("Edit"),  ImageUtils.getScaledIcon("pt/lsts/neptus/plugins/planning/images/man_edit.png", 16, 16));
     protected JButton deleteBtn = new JButton(I18n.text("Delete"), ImageUtils.getScaledIcon("pt/lsts/neptus/plugins/planning/images/man_remove.png", 16, 16));
