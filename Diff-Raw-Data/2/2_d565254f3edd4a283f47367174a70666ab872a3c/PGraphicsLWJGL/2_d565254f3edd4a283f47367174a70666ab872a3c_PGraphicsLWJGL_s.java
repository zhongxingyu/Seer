 ...
 */
  ...
  * 
  */
 public class PGraphicsLWJGL extends PGraphics {
   ...
   protected static URL defFillShaderVertSimpleURL = PGraphicsLWJGL.class.getResource("FillShaderVertSimple.glsl");
   protected static URL defFillShaderVertTexURL    = PGraphicsLWJGL.class.getResource("FillShaderVertTex.glsl");
   protected static URL defFillShaderVertLitURL    = PGraphicsLWJGL.class.getResource("FillShaderVertLit.glsl");
   protected static URL defFillShaderVertFullURL   = PGraphicsLWJGL.class.getResource("FillShaderVertFull.glsl");  
   protected static URL defFillShaderFragNoTexURL  = PGraphicsLWJGL.class.getResource("FillShaderFragNoTex.glsl");
   protected static URL defFillShaderFragTexURL    = PGraphicsLWJGL.class.getResource("FillShaderFragTex.glsl");  
   protected static URL defLineShaderVertURL       = PGraphicsLWJGL.class.getResource("LineShaderVert.glsl");
   protected static URL defLineShaderFragURL       = PGraphicsLWJGL.class.getResource("LineShaderFrag.glsl");
   protected static URL defPointShaderVertURL      = PGraphicsLWJGL.class.getResource("PointShaderVert.glsl");
   protected static URL defPointShaderFragURL      = PGraphicsLWJGL.class.getResource("PointShaderFrag.glsl");
 ...
 //    texEnvMode = MODULATE;
   ...
   protected void initOffscreen() {
     ...
     if (PGraphicsLWJGL.fboMultisampleSupported && 1 < antialias) {
 ...
 //    int temp[] = new int[2];
   ...
   public class InGeometry {
     ...
     public void generateEllipse(int ellipseMode, float a, float b, float c, float d, 
       ...
       float inc = (float) PGraphicsLWJGL.SINCOS_LENGTH / accuracy;
       ...
       for (int i = 0; i < accuracy; i++) {
         idx = addVertex(centerX + PGraphicsLWJGL.cosLUT[(int) val] * radiusH, 
                         centerY + PGraphicsLWJGL.sinLUT[(int) val] * radiusV, 
                         fillColor, strokeColor, strokeWeight,
                         ambient, specular, emissive, shininess,
                         VERTEX);
         val = (val + inc) % PGraphicsLWJGL.SINCOS_LENGTH;
       ...
       addVertex(centerX + PGraphicsLWJGL.cosLUT[0] * radiusH, 
                 centerY + PGraphicsLWJGL.sinLUT[0] * radiusV, 
                 fillColor, strokeColor, strokeWeight,
                 ambient, specular, emissive, shininess,
                 VERTEX);
