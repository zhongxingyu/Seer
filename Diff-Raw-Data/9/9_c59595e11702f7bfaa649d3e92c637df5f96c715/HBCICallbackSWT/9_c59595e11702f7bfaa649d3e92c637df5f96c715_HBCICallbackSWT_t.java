       ...
       String text = null;
           ...
           if (pw == null && !isRDH)
           {
             ...
             w.set("hbci.passport.password." + s,pw);
 				...
 				case NEED_CHIPCARD:
           text = i18n.tr("Bitte legen Sie Ihre HBCI-Chipkarte in das Lesegert.");
           ...
           text = i18n.tr("Bitte entfernen Sie die Chipkarte aus dem Lesegert.");
           HBCIFactory.getInstance().getProgressMonitor().setStatusText(text);
           GUI.getStatusBar().setSuccessText(text);
 					break;
 				...
 				case NEED_CONNECTION:
 					if (!Settings.getOnlineMode())
 						DialogFactory.openSimple(i18n.tr("Internet-Verbindung"),i18n.tr("Bitte stellen Sie sicher, dass eine Internetverbindung verfgbar ist."));
 					break;
 				case CLOSE_CONNECTION:
 					if (!Settings.getOnlineMode())
 						DialogFactory.openSimple(i18n.tr("Internet-Verbindung"),i18n.tr("Sie knnen die Internetverbindung nun wieder trennen."));
 					break;
