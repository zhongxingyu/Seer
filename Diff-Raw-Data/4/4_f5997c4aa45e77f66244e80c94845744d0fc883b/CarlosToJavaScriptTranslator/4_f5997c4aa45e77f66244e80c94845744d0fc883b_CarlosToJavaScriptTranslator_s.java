 ...
 import edu.lmu.cs.xlg.carlos.entities.AfterStatement;
 ...
 import edu.lmu.cs.xlg.carlos.entities.ContinueStatement;
 ...
 public class CarlosToJavaScriptTranslator {
     ...
     private void translateStatement(Statement s) {
         ...
         } else if (s instanceof AfterStatement) {
             translateAfterStatement(AfterStatement.class.cast(s));
