 ...
 // New updated Documentation.
         ...
         SQLS.append(",('application','bugtrackernewurl','','New Bug URL','This correspond to the URL that points to the page where a new bug can be created on the Bug system of the <code class=\\'doc-crbvvoca\\'>application</code>.<br><br><table cellspacing=0 cellpadding=3><th class=\\'ex\\' colspan=\\'2\\'>The following variables can be used inside the URL</th><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%TEST%</code></td><td class=\\'ex\\'>Test</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%TESTCASE%</code></td><td class=\\'ex\\'>Test case reference</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%TESTCASEDESC%</code></td><td class=\\'ex\\'>Description of the test case</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%EXEID%</code></td><td class=\\'ex\\'>Execution ID</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%ENV%</code></td><td class=\\'ex\\'>Environment</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%COUNTRY%</code></td><td class=\\'ex\\'>Country</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%BUILD%</code></td><td class=\\'ex\\'>Build</td></tr><tr><td class=\\'ex\\'><code class=\\'doc-variable\\'>%REV%</code></td><td class=\\'ex\\'>Revision</td></tr></table>')");
         ...
         SQLS.append(",('page_homepage','InProgress','','InProgress','The test case is being implemented.')");
         SQLS.append(",('page_homepage','NbTest','','Number','Number of <code class=\\'doc-crbvvoca\\'>test cases</code> recorded in the Database')");
         SQLS.append(",('page_homepage','Standby','','StandBy','The test is in the database but need to be analysed to know if we have to implement it or delete it.')");
         SQLS.append(",('page_homepage','TBI','','ToImplement','It was decided to implement this test, but nobody work on that yet.')");
         SQLS.append(",('page_homepage','TBV','','ToValidate','The test is correctly implemented but need to be validated by the Test committee.')");
         SQLS.append(",('page_homepage','Working','','Working','The test has been validated by the Test Committee.')");
         ...
         SQLS.append(",('page_runtests','Browser','','Browser','')");
         ...
         SQLS.append(",('testcase','Status','','Status','It is the workflow status of the <code class=\\'doc-crbvvoca\\'>test case</code> used to follow-up the implementation of the tests. It could be :<br><br><b>STANDBY</b>: The <code class=\\'doc-crbvvoca\\'>test case</code> is created but needs to be analysed to know if we have to implement it or delete it. This is the default status when a <code class=\\'doc-crbvvoca\\'>test case</code> is created.<br><b>TO BE IMPLEMENTED</b>: We decide to implement this <code class=\\'doc-crbvvoca\\'>test case</code>, but nobody work on it yet.<br><b>IN PROGRESS</b>: The <code class=\\'doc-crbvvoca\\'>test case</code> is being implemented.<br><b>TO BE VALIDATED</b>: The <code class=\\'doc-crbvvoca\\'>test case</code> is correctly implemented but need to be validated.<br><b>WORKING</b>: The <code class=\\'doc-crbvvoca\\'>test case</code> has been validated as fully working. Only <code class=\\'doc-fixed\\'>TestAdmin</code> users can modify it.<br><b>TO BE DELETED</b>: The <code class=\\'doc-crbvvoca\\'>test case</code> is not used anymore and should be deleted.')");
