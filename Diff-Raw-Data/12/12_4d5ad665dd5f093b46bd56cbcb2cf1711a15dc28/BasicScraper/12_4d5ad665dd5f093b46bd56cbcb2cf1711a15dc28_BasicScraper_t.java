...
import com.dalthed.tucan.R;
 ...
 public abstract class BasicScraper {
 	...
 	/**
 	 * Gibt den genutzten CookieManager zurck
 	...
 	/**
 	 * Gibt entsprechenden ListAdapter nach dem auswerten der Daten zurck
 	 * @param mode evtl genutzt, falls eine Activity mehrere Ansichten untersttzt
 	 * @return der Adapter fr die Liste
 	...
 	/**
 	 * Prft ob die Session schon abgelaufen ist und wirft eine Exception falls dies passiert
