 ...
 public class Reference {
     public static final String MOD_ID = "NumiRP";
     public static final String MOD_NAME = "NumiRP";
    public static final String MOD_VERSION = "1.0.9"; //TODO: Think of a better way to do version bumps.
