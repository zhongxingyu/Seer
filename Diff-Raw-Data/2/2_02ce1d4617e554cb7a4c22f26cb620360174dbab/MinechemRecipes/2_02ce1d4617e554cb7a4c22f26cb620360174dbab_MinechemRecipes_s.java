 ...
 public class MinechemRecipes {
     ...
     public void RegisterRecipes() {
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(MinechemItems.EmptyPillz,4), new Object[] { new ItemStack(Item.slimeBall), new ItemStack(Item.sugar), ItemStack(Item.slimeBall) });
