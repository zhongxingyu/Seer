 ...
 * @author missi
 */
public class FlexDenseDoubleMatrix3D extends DenseDoubleMatrix3D
{
	...
	protected FlexDenseDoubleMatrix3D()
	{
	}

	public FlexDenseDoubleMatrix3D(int nodes, int annotations)
	{
	...
	{
		lastIndexSet = -1;
		int newSize = nodesNumber * annotationsNumber * annotationsNumber;
