 ...
 public class DataSourceTest extends APITestCase
 {
 	 ...
 	 * @throws BirtException
 	 */
 	private IQueryDefinition getJDBCQueryDefn( ScriptExpression expr )
 			throws BirtException
 	{
 	 ...
 	 * @throws BirtException
 	 */
 	private IQueryDefinition getScriptQueryDefn( ScriptExpression expr )
 			throws BirtException
 	{
 		// data source
 		...
 		// data set
 		ScriptDataSetDesign scriptDataSet = new ScriptDataSetDesign( 
 				dataSourceInstance.getOdaDataSetDesign( ).getName( ) );
 		scriptDataSet.setDataSource( scriptDatasource.getName( ) );
 		scriptDataSet.setOpenScript( "count=11; dset_open=true; count--;" );
 		scriptDataSet.setFetchScript( "if (count==0) {return false; } else "
 				+ "{ dataSetRow.NUM=count; --count; return true; }" );
