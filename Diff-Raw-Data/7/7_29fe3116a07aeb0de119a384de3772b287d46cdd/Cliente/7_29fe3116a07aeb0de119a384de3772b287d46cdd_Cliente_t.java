 ...
 public class Cliente
 {
     ...
     public static void servidores() throws Exception{
         ...
         */
    	BufferedInputStream in = new BufferedInputStream(new java.net.URL("https://dl.dropbox.com/s/u53c2jtce261g7r/servidores.txt?token_hash=AAEU65Li2X8QVSCHKIYZRl8a5nZdzhyICNgn6YrcxE-cuw&amp;dl=1").openStream());
         BufferedOutputStream bOut = new BufferedOutputStream(new FileOutputStream("servidores.txt"),1024);
