 ...
 * $Id: XSDValidateTest.java,v 1.1 2004/06/16 18:01:17 elena Exp $
 ...
 public class XSDValidateTest extends TestCase
 {
   ...
   final static String BASE_URI = EMFTestCorePlugin.getPlugin().getPluginDirectory() + "/data/xsd/invalid/";
  ...
  final static String[] xsdFiles = { "Bad.xsd", "BadMinExclusiveFacet.xsd", "BadAttriButeDeclaration.xsd", "BadMinInclusiveFacet.xsd",
   ...
   final static String[] expectedMsg = {
       ...
       "XSD: The value 'a' of attribute 'value' must be of type 'http://www.w3.org/2001/XMLSchema#decimal'",
       "XSD: The value 'bad' of attribute 'fixed' must be of type 'http://www.w3.org/2001/XMLSchema#boolean'",
       "XSD: The value '1' of attribute 'value' must be greater than 2 as constrained by 'http://www.example.com/Bad#badMinInclusiveFacetRestriction_._base'",
       ...
       "XSD: The value '2' of attribute 'value' must be greater than 3 as constrained by 'http://www.example.com/Bad#badMinInclusiveFacetAppliedToDecimal_._base'",
       "XSD: The value '2.9' of attribute 'value' must be greater than 3.0 as constrained by 'http://www.example.com/Bad#badMinInclusiveFacetAppliedToDouble_._base'",
       "XSD: The value '2.9' of attribute 'value' must be greater than 3.0 as constrained by 'http://www.example.com/Bad#badMinInclusiveFacetAppliedToFloat_._base'",
       "XSD: The value 'P1D' of attribute 'value' must be greater than P2D as constrained by 'http://www.example.com/Bad#badMinInclusiveFacetAppliedToDuration_._base'",
       "XSD: The value '1999-10-25' of attribute 'value' must be greater than 1999-10-26 as constrained by 'http://www.example.com/Bad#badMinInclusiveFacetAppliedToDate_._base'",
       ...
       "XSD: The value '1998' of attribute 'value' must be greater than 1999 as constrained by 'http://www.example.com/Bad#badMinInclusiveFacetAppliedToGYear_._base'",
       "XSD: The value '--11--' of attribute 'value' must be greater than --12-- as constrained by 'http://www.example.com/Bad#badMinInclusiveFacetAppliedToGMonth_._base'",
       "XSD: The value '1999-11' of attribute 'value' must be greater than 1999-12 as constrained by 'http://www.example.com/Bad#badMinInclusiveFacetAppliedToGYearMonth_._base'",
       "XSD: The value '---30' of attribute 'value' must be greater than ---31 as constrained by 'http://www.example.com/Bad#badMinInclusiveFacetAppliedToGDay_._base'",
       "XSD: The value '--10-30' of attribute 'value' must be greater than --10-31 as constrained by 'http://www.example.com/Bad#badMinInclusiveFacetAppliedToGMonthDay_._base'",
       ...
       "XSD: The attribute 'bad' is not permitted",
       "XSD: The attribute 'value' is required",
       "XSD: The value '-1' of attribute 'value' must be greater than 0 as constrained by 'http://www.w3.org/2001/XMLSchema#nonNegativeInteger'",
       "XSD: The value 'bad' of attribute 'fixed' must be of type 'http://www.w3.org/2001/XMLSchema#boolean'",
       ...
       "XSD: The value '-1' of attribute 'minOccurs' must be greater than 0 as constrained by 'http://www.w3.org/2001/XMLSchema#nonNegativeInteger'",
       ...
       "XSD: The attribute 'bad' is not permitted",
       "XSD: The attribute 'value' is required",
       "XSD: The value '0' of attribute 'value' must be greater than 1 as constrained by 'http://www.w3.org/2001/XMLSchema#positiveInteger'",
       "XSD: The value 'bad' of attribute 'fixed' must be of type 'http://www.w3.org/2001/XMLSchema#boolean'",
