...
import java.security.spec.KeySpec;
 ...
 public class SecurePasswordHasher {
    ...
    */
   public synchronized static Fingerprint getFingerprint(String input) {
   ...
   /**
    * Returns a one-way keyed function output for the given username
    * and password.
    */
   private static byte[] macInput(String username, String password) {
     if (mac == null) {
       LOGGER.severe("tried to MAC message when mac object uninitialized");
       return new byte[0];
     }
     return mac.doFinal((username + ":" + password).getBytes());
   }
