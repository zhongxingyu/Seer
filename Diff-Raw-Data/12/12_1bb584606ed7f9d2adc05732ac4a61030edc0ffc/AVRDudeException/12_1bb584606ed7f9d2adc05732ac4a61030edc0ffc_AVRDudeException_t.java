  ...
  * <p>
  * This Exceptions contains a reason, set when creating the Exception and
  * readable with {@link #getReason()}. This is used by the
  * {@link AVRDudeErrorDialog} to display a human readable detailed description
  * of the error.
  * </p>
  * 
 ...
 public class AVRDudeException extends Exception {
 	...
 	public enum Reason {
		UNKNOWN, NO_AVRDUDE_FOUND, CANT_ACCESS_AVRDUDE, CONFIG_NOT_FOUND, UNKNOWN_MCU, UNKNOWN_PROGRAMMER, NO_PROGRAMMER, PORT_BLOCKED, TIMEOUT;
 	}
 	...
 	/**
 	 * Instantiate a new AVRDudeException with the given reason and the root
 	 * Exception.
 	 * 
 	 * @param reason
 	 *            Enum <code>Reason</code> for the reason of this Exception.
 	 ...
 	 *            <code>getCause()</code> method). (A <code>null</code>
 	 ...
 	 * <p>
 	 * If the given Exception matches some predefined Exceptions, a reason will
 	 * be set. Otherwise <code>Reason.UNKNOWN</code> will be used.
 	 * </p>
 	 * 
 	 * @param exc
