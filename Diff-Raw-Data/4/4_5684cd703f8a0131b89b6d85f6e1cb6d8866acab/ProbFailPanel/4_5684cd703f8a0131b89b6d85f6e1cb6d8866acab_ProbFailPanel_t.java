 ...
 class ProbFailPanel extends JPanel implements ActionListener
 {
	...
	+ "<p>where <i>P(f)</i> is the probability of failure and <i>D<sub>n</sub></i> is Newmark displacement in centimeters. This equation was calibrated using data from the 1994 Northridge, California, earthquake and is best suited to analyzing shallow landslides in southern California (Jibson and others, 1998, 2000).";
