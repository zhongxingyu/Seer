 ...
 public class Discover extends javax.swing.JFrame {
   private Thread thread = null;
     ...
     private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         String delimiter = " ";
         String[] keywords = textToSearch.split(delimiter);
     ...
     private void SetResult(Collection<ITrackDescriptor> results)
     {
         ...
         for (ITrackDescriptor trackDesc : results)
         {
     ...
     private void SetResultSafely(Collection<ITrackDescriptor> results)
     {
         final Collection<ITrackDescriptor> _results = results;
     ...
     private class myThread implements Runnable
     {
         ...
         public void run()
         {
             ...
             Collection<ITrackDescriptor> results = null;
             try {
