 ...
 /**
  * Modal dialog to display progress of a task being performed by a Swing client
  * (applet or Swing app). The progress is reported in 2 ways:
  * 
  * <ul>
  * <li>Overall status - represented with a progress bar and text saying
  * "Step x of N"</li>
  * <li>Current task - textual information about what is currently happening
  * within the currently executing step (i.e. "Fetching question 1 of 16")</li>
  * </ul>
  * 
 ...
 public class ProgressDialog extends JDialog implements ActionListener {
 	...
 	/**
 	 * constructs a simple panel that uses a titled/lined compound border and
 	 * adds all the items passed in to the panel using the default layout
 	 * manager.
 	 * 
 	 * @param title
 	 * @param content
