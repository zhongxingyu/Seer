 ...
 public class JaxbStringList {
    ...
    private class MyArrayList extends ArrayList<String> {
        private static final long serialVersionUID = 7017493524825668540L;
    }
     ...
     public Response getList() {
         ...
         return Response.ok(
            new JAXBElement<MyArrayList>(new QName("ADDDDMIN"), MyArrayList.class, (MyArrayList) this._list)).build();
     }
