 ...
 public class ObjectDslLinkingService {
     ...
     private PictogramElement createPictogramElement() {
        ...
        final Diagram pictogramElement = Graphiti.getPeCreateService().createDiagram(diagramType.getId(),
                diagramType.getName(), false);// Bug 417454 // TODO: Inject the PE Create Service using Google Guice
