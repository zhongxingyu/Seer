 ...
 public class SQLConstants
 {
 	...
 	public static final String FETCH_INCOMING_DETAILS_BY_INVOICE = "SELECT ID.INVOICE_ID, I.DATE_OF_DELIVERY, IT.ITEM_NAME, CT.TYPE, ID.QUANTITY FROM INCOMING_STOCK I,"+
			" INCOMING_STOCK_DETAILS ID, ITEMS_TABLE IT, CATEGORY_TYPES CT WHERE I.INVOICE_ID = ID.INVOICE_ID AND IT.ITEM_NAME = ID.ITEM_NAME AND  I.INVOICE_ID=?";
	...
	public static final String FETCH_INVOICE_INCOMING = "SELECT I.INVOICE_ID FROM INCOMING_STOCK I";
