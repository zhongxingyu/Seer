 ...
 //					System.out.println(node.getParent().toString());
 					if((node.getParent().toString().equalsIgnoreCase("Universitt Ulm") || node.getParent().getParent().toString().equalsIgnoreCase("Universitt Ulm"))){
 						...
 						JOptionPane.showMessageDialog(frame, "Bitte whlen sie entweder einen Studiengang oder ein Modulhandbuch aus.", "Input Error", JOptionPane.ERROR_MESSAGE);
