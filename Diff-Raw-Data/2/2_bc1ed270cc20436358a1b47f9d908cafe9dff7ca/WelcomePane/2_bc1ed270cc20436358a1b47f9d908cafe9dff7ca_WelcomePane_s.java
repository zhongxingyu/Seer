 ...
 package nextapp.echo2.chart.testapp;
 ...
 public class WelcomePane extends ContentPane {
     ...
     public WelcomePane() {
         ...
         loginWindow.setTitle("Welcome to the NextApp Echo2 Chart Test Application");
         ...
         label = new Label("This application provides an interactive test for the Echo2 Chart Library. "
                 + "The Echo2 Chart Library is a wrapper to integrate JFreeChart into Echo2 applications. "
