 ...
 //                
 //                if ((Boolean)session.getAttribute("authRequired")) {
 ...
 //                if ((Boolean)session.getAttribute("authRequired")) { //Bug : it created a account but fail here and send me to fail to create a account
 //                    session.setAttribute("authRequired", null);
 //                    
