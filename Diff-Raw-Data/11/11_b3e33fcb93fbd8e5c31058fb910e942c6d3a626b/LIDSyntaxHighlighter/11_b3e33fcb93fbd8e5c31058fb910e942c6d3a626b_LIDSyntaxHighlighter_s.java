...
import com.intellij.openapi.editor.SyntaxHighlighterColors;
 ...
 public class LIDSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public static final TextAttributesKey COMMENT = createTextAttributesKey("SIMPLE_COMMENT", SyntaxHighlighterColors.LINE_COMMENT);
     ...
     public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
         if (tokenType.equals(LIDTypes.SEPARATOR)) {
             return SEPARATOR_KEYS;
         } else if (tokenType.equals(LIDTypes.KEY)) {
             return KEY_KEYS;
         } else if (tokenType.equals(LIDTypes.VALUE)) {
             return VALUE_KEYS;
         } else if (tokenType.equals(LIDTypes.COMMENT)) {
             return COMMENT_KEYS;
