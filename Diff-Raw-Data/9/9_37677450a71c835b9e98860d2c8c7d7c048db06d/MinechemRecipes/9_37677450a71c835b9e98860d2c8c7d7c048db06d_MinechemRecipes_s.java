 ...
 public class MinechemRecipes {
     ...
     public void RegisterRecipes() {
        ...
        GameRegistry.addRecipe(new ItemStack(MinechemItems.IAintAvinit), new Object[] { "CZC", Character.valueOf('C'), new ItemStack(Item.slimeball), Character.valueOf('Z'), new ItemStack(Item.sugar) });
