 ...
 public final class FavouritesAdapter extends CursorAdapter {
     ...
     public void bindView(View view, Context context, Cursor cursor) {
        ...
        artistView.setText(cursor.getString(cursor.getColumnIndex(FavouritesDatabase.COLUMN_ARTIST)));
        titleView.setText(cursor.getString(cursor.getColumnIndex(FavouritesDatabase.COLUMN_TITLE)));
     }
 }
