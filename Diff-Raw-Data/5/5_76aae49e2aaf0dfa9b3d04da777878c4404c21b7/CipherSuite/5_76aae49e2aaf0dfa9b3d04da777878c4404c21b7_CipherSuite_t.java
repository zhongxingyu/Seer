 ...
 public class CipherSuite
 {
 	...
 	private static CipherSuite[] allCiphers = 
 	{
		...
		new CipherSuite(0xCC13, "TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256"),
		new CipherSuite(0xCC14, "TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256"),
		new CipherSuite(0xCC15, "TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256")
 	};
 	
 	private static CipherSuite[] chromeCiphers = 
 	{
 		new CipherSuite(0xc00a, "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA"),
 		new CipherSuite(0xC014, "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA"),
 		new CipherSuite(0x0088, "TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA"),
 		...
 		new CipherSuite(0xC00d, "TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA"),
 		new CipherSuite(0xC003, "TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA"),
 		new CipherSuite(0xFEFF, "SSL_RSA_FIPS_WITH_3DES_EDE_CBC_SHA"),
 		new CipherSuite(0x000a, "TLS_RSA_WITH_3DES_EDE_CBC_SHA")
 	};
 	
 	public CipherSuite(int codepoint, String desc)
 	{
 		suite = new byte[2];
 		suite[1] = (byte)(codepoint&0xff);
 		suite[0] = (byte)((codepoint>>8)&0xff);
 		description = desc;
 	}
 	
 	public static CipherSuite getUnsupported()
 	{
 		return new CipherSuite(0x0044, "TLS_DHE_DSS_WITH_CAMELLIA_128_CBC_SHA");
 	}
 	public static CipherSuite getSupported()
 	{
 		return new CipherSuite(0x0004, "TLS_RSA_WITH_RC4_128_MD5");
 	}
 	
 	public static CipherSuite[] getChromeCipherSuites()
 	{
 		return chromeCiphers;
 	}
