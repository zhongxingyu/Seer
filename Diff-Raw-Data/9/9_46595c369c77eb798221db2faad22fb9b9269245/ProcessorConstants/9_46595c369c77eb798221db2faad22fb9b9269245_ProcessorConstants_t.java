 ...
 public class ProcessorConstants
 {
	...
	public static final String RELATED_REGEX 		= "^(R|RELATED-TO|REFER-TO)[ ]*:(.|(\r?\n))*$";
 	...
 	public static final String WARN_EDIT_INFO_MSG					= "Note: All descriptions, tags, source urls and writers will be ignored for existing Topics.";
 	...
 	public static final String ERROR_INVALID_TYPE_TITLE_ID_MSG		= LINE + INVALID_TOPIC + " Title, Type and ID must be specified." + CSLINE_MSG;
 	...
 	public static final String ERROR_TOPIC_NEXT_PREV_MSG			= LINE + INVALID_TOPIC + " Next and Previous relationships can't be used directly. If you wish to use next/previous then please use a Process." + CSLINE_MSG;
 	public static final String ERROR_TOPIC_BRANCH_OUTSIDE_PROCESS	= LINE + INVALID_TOPIC + " A Branch cannot exist outside of a Process." + CSLINE_MSG;
 	public static final String ERROR_TOPIC_EXISTING_TOPIC_CANNOT_REMOVE_TAGS = LINE + INVALID_TOPIC + " An Existing Topic cannot have tags removed." + CSLINE_MSG;
 	public static final String ERROR_TOPIC_EXISTING_BAD_OPTIONS		= LINE + INVALID_TOPIC + " An Existing topic cannot have a new Writer, Description or Source URLs." + CSLINE_MSG;
