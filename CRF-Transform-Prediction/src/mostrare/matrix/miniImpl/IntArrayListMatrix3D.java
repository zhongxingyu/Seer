 ...
 * @author missi
 */
public abstract class IntArrayListMatrix3D extends AbstractMatrix3D
{
	/**
	 ...
	 *             bounds.
	 */
	public void set(int indexNode1, int annotation1, int annotation2, IntArrayList value)
	{
	 ...
	 *             bounds.
	 */
	public IntArrayList get(int indexNode1, int annotation1, int annotation2)
	{
		if (indexNode1 < 0 || indexNode1 >= nodes || annotation1 < 0 || annotation1 >= annotations
				|| annotation2 < 0 || annotation2 >= annotations)
			throw new IndexOutOfBoundsException("Wrong coordinate");
	 ...
	 * @return the value of the specified cell.
	 */
	public abstract IntArrayList getQuick(int indexNode1, int annotation1, int annotation2);
