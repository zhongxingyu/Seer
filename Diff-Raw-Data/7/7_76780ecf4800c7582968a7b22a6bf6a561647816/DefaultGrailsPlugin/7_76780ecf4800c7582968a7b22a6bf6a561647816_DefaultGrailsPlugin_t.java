     ...
     public DefaultGrailsPlugin(Class pluginClass, Resource resource, GrailsApplication application) {
         ...
         if(resource != null) {
             try {
                 ...
                 try {
                     urlConnection = pluginUrl
                                                         .openConnection();
                     this.pluginLastModified = urlConnection
                                                 .getLastModified();
                 }
                 finally {
                     try {
