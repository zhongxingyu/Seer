 ...
 public class TRouteTests {
 	...
 	public void testAtoBSameLine2Arms() {
 		...
 		TRoute route = TFactory.findShortestPath(start, end);
 		List<TStop> expectedRoute = new ArrayList<TStop>();
 		expectedRoute.add(TFactory.getStop(TStopData.ASHMONT_N.getID()));
 		expectedRoute.add(TFactory.getStop(TStopData.JFK_N_A.getID()));
 		expectedRoute.add(TFactory.getStop(TStopData.JFK_S_B.getID()));
 		expectedRoute.add(TFactory.getStop(TStopData.BRAINTREE_E.getID()));
 		TRoute expected = new TRoute(expectedRoute);
 	...
 	public void testAtoB1Transfer() {
 		...
 		List<TStop> expectedRoute = new ArrayList<TStop>();
 		expectedRoute.add(TFactory.getStop(TStopData.RUGGLES_N.getID()));
 		expectedRoute.add(TFactory.getStop(TStopData.DTX_N_O.getID()));
 		...
 		expectedRoute2.add(TFactory.getStop(TStopData.STATE_S_B.getID()));
 	...
 	public void testAtoB2Transfers() {
 		...
 		expectedRoute.add(TFactory.getStop(TStopData.STATE_S_B.getID()));
 	...
 	public void testAtoBtoCSameLine() {
 		...
 		stations.add(bStation);
 		stations.add(cStation);
 		
		TRoute route = TFactory.findShortestPath(stations, 0);
 		List<TStop> expectedRoute = new ArrayList<TStop>();
 	...
 	public void testAtoBtoCDiffLines() {
		...
		TRoute route = TFactory.findShortestPath(stations, 0);
 		List<TStop> expectedRoute = new ArrayList<TStop>();
 		expectedRoute.add(TFactory.getStop(TStopData.ALEWIFE.getID()));
 		expectedRoute.add(TFactory.getStop(TStopData.DTX_S_R.getID()));
 		expectedRoute.add(TFactory.getStop(TStopData.DTX_S_O.getID()));
 		expectedRoute.add(TFactory.getStop(TStopData.RUGGLES_S.getID()));
 		expectedRoute.add(TFactory.getStop(TStopData.RUGGLES_N.getID()));
 		expectedRoute.add(TFactory.getStop(TStopData.STATE_N_O.getID()));
 	...
 	/** Test that the path between JFK and Suffolk Downs is correct */
 	@Test
 	public void testJFKtoSuffolkDowns() {
 		TRoute actualRoute = TFactory.findShortestPath(TStationData.JFK.getID(), TStationData.SUFFOLK.getID());
 		List<TStop> expected = new ArrayList<TStop>();
 		expected.add(TFactory.getStop(TStopData.JFK_N_A.getID()));
 		expected.add(TFactory.getStop(TStopData.DTX_N_R.getID()));
 		expected.add(TFactory.getStop(TStopData.DTX_N_O.getID()));
 		expected.add(TFactory.getStop(TStopData.STATE_N_O.getID()));
 		expected.add(TFactory.getStop(TStopData.STATE_N_B.getID()));
 		expected.add(TFactory.getStop(TStopData.SUFFOLK_N.getID()));
 		TRoute expectedRoute = new TRoute(expected);
 	...
 	/** Test that the path between JFK and Suffolk Downs is correct */
 	@Test
 	public void testSavinToWonderland() {
 		TRoute actualRoute = TFactory.findShortestPath(TStationData.SAVINHILL.getID(), TStationData.WONDERLAND.getID());
 		List<TStop> expected = new ArrayList<TStop>();
 		expected.add(TFactory.getStop(TStopData.SAVINHILL_N.getID()));
 		expected.add(TFactory.getStop(TStopData.DTX_N_R.getID()));
 		expected.add(TFactory.getStop(TStopData.DTX_N_O.getID()));
 		expected.add(TFactory.getStop(TStopData.STATE_N_O.getID()));
 		expected.add(TFactory.getStop(TStopData.STATE_N_B.getID()));
 		expected.add(TFactory.getStop(TStopData.WONDERLAND_E.getID()));
 		TRoute expectedRoute = new TRoute(expected);
