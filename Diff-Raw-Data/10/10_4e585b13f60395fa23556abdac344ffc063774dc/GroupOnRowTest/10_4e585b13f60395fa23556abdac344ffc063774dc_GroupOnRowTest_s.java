 ...
 public class GroupOnRowTest extends APITestCase
 {
	...
	public void testMultiGroupOnRowKeyCount() throws Exception
 	...
 	/**
 	 * Test another function, that row[colIndex] JS expression should be
 	 * supported defineed in sort.
 	 * 
 	 * @throws Exception
 	 */
 	public void testSortOnKeyIndex( ) throws Exception
 	{
 		...
 		// execute query
 		IResultIterator ri = this.executeQuery( createQuery( null,
 				null,
 				null,
 				bindingNameSort,
 				bindingExprSort,
 	...
 	public void testGroupOnRowPosition( ) throws Exception
 	{
 		...
 		QueryDefinition qd = this.createQuery( bindingNameGroup,
 				...
 				bindingNameRow,
 				bindingExprRow );
 		String outputStr = getOutputStrForGroupTest( 15,
 				qd,
 				groupDefn.length,
 				bindingNameRow,
 				columnStr );
 	...
 	private void groupOnQuarter( Object startValue ) throws Exception, IOException
 	{
 		...
 		QueryDefinition qd = this.createQuery( bindingNameGroup,
 				...
 				bindingNameRow,
 				bindingExprRow );
 		String outputStr = getOutputStrForGroupTest( 40,
 				qd,
 				groupDefn.length,
 				bindingNameRow,
 				columnStr );
 	...
 	{
 		ComputedColumn computedColumn = new ComputedColumn( "STR", "(row.ID==9)?\"\":((row.ID==8)?null:row.ID.toString())" ,DataType.STRING_TYPE );
