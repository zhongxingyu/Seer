 ...
 import org.nchelp.meteor.util.exception.BaseException;
 ...
 public class MeteorServlet extends HttpServlet {
 	...
 	private void buildParameters(
 		...
 		try {
 			...
 			log.fatal("Error getting the Opaque User ID from the class: " + userClass);
 		...
 		while (enum.hasMoreElements()) {
 			...
 			if (key.equalsIgnoreCase("SSN")) {
 				...
 				try {
 					...
 					throw new ParameterException("Invalid Date Of Birth " + e.getMessage());
 				}
