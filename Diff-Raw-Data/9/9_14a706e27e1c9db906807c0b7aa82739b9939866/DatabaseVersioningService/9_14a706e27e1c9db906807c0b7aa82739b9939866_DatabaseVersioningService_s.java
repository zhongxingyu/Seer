 ...
 public class DatabaseVersioningService implements IDatabaseVersioningService {
     ...
     public ArrayList<String> getSQLScript() {
         ...
         SQLS = new StringBuilder();
         SQLS.append("INSERT INTO `usergroup` VALUES ('admin','Admin'),('cerberus','User');");
         SQLInstruction.add(SQLS.toString());
         ...
         SQLS = new StringBuilder();
         SQLS.append("INSERT INTO `application` VALUES ('Cerberus','Testing Interface new','N',240,'GUI','DEVTOOLS','https://1localhost:8443/svn/trunk/Cerberus/',NULL,''),('CerberusFake','Cerberus Fake Application for testing the Cerberus engine','N',241,'GUI','DEVTOOLS','https://IP:8443/svn/TIT/trunk/TST-GUI-Cerberus/',NULL,'');");
         SQLInstruction.add(SQLS.toString());
 
         SQLS = new StringBuilder();
         SQLS.append("INSERT INTO `test` VALUES ('Cerberus','Cerberus Tests','Y','Y','2012-06-19 09:56:06'),('Pre Testing','Preliminary Tests','Y','Y','0000-00-00 00:00:00');");
         SQLInstruction.add(SQLS.toString());
         ...
         SQLS = new StringBuilder();
         SQLS.append("INSERT INTO `testcase` VALUES ('Cerberus','0001A','Cerberus',' ','','Load Test List','Load Test List','Y',NULL,1,'TO BE VALIDATED','Y','INTERACTIVE','RX','','','','2012-06-19 09:56:40','','','','','','','','cerberus','cerberus','cerberus',NULL,'Y','Y','Y')");
         SQLS.append(",('Cerberus','0002A','Cerberus','','','Create Test List','Create temporary Test List','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','','','2012-06-19 14:35:33','','','','','','','','cerberus','null','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0003A','Cerberus','','','Modify Test List','Modify temporary Test List','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','','','2012-06-19 14:43:24','','','','','','','','cerberus','cerberus','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0004A','Cerberus','','','Documentation Test','Test the documentation of pages (?)','N',NULL,1,'IN PROGRESS','N','INTERACTIVE','RX','','','Need to add Selenium action waitForPopUp','2012-06-19 16:09:56','','','','','','','','cerberus','cerberus','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0005A','Cerberus','','','Create User','Create User','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','','','2012-06-19 16:13:04','','','','','','','','cerberus','cerberus','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0010A','Cerberus',' ','','Engine : Control - No Execution when testcase is not active.','Test of Cerberus feature that does not start the test when test case does is not active.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test that is not active and get an error message.','','2012-08-09 18:19:47','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0011A','Cerberus',' ','','Engine : Control - No Execution when Env is COMPARISON','Test of Cerberus feature that does not start the test when the environment type is in COMPARISON and test group is not COMPARISON.\r\nThis is to prevent Cerberus to modify the database of the environment on environment that require not modification for comparison purpose.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test that is not in COMPARISON group on an environment that is flagged as COMPARISON and get an error message.','','2012-08-09 19:36:41','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0012A','Cerberus',' ','','Engine : Control - No Execution when From Sprint Specified','Test of Cerberus feature that does not start the test when the testcase From Build and From Rev is not reached on the corresponding environment.\r\nThis is to anticipate the creation of a test for a specific build/revision without it beeing executed in the wrong environmant.\r\n','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test that has a From Build and From Rev feeded on an environment that has not reach the corresponding values and get an error message.','','2012-08-09 19:42:40','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0013A','Cerberus',' ','','Engine : Control - No Execution when To Sprint Specified','Test of Cerberus feature that does not start the test when the testcase To Build and To Rev is reached on the corresponding environment.\r\nThis is to desactivate a test when a specific Build/Revision is reached.\r\n','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test that has a To Build and To Rev feeded on an environment that has reach the corresponding values and get an error message.','','2012-08-09 19:46:25','','','','','','','','cerberus','null','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0014A','Cerberus',' ','','Engine : Control - No Execution when Target Sprint Specified','Test of Cerberus feature that does not start the test when the testcase Target Build and Target Rev is not reached on the corresponding environment.\r\nThis is used to desactivate a test until a specifc bug has been solved. That should be a temporary use until bugs are solved.\r\n','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test that has a Target Build and Target Rev feeded on an environment that has not reach the corresponding values and get an error message.','','2012-08-09 19:47:25','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0015A','Cerberus',' ','','Engine : Control - No Execution when inactive environment','Test of Cerberus feature that does not start the test when the environment is not active.\r\nThis is used to prevent getting KO on environment that we already know that it doesn\\'t work. ','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test that is active on an environment that is not active and get an error message.','','2012-08-10 20:19:25','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0016A','Cerberus',' ','','Engine : Control - No Execution when Env is PROD.','Test of Cerberus feature that does not start the test when the environment group is PROD and the test is inactive for PROD.\r\nThis is used to disable all the test that modify data in live environment still allowing that Readonly test to be active in production.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test that is not active in PROD in a PROD environment group.','','2012-08-11 08:41:47','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0017A','Cerberus',' ','','Engine : Control - No Execution when Env is QA.','Test of Cerberus feature that does not start the test when the environment group is QA and the test is inactive for QA.\r\nThis is used to disable some tests that require a feature that is not available in QA.','N',NULL,1,'TO BE IMPLEMENTED','N','INTERACTIVE','RX','','Try to run a test that is not active in QA in a QA environment group.','','2012-08-13 16:25:50','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0018A','Cerberus',' ','','Engine : Control - No Execution when Env is UAT.','Test of Cerberus feature that does not start the test when the environment group is UAT and the test is inactive for UAT.\r\nThis is used to disable some tests that require a feature that is not available in UAT.','N',NULL,1,'TO BE IMPLEMENTED','N','INTERACTIVE','RX','','Try to run a test that is not active in UAT in a UAT environment group.','','2012-08-13 16:27:57','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0019A','Cerberus',' ','','Engine : Control - No Execution when testcase does not exist','Test of Cerberus feature that does not start the test when test case does not exist or not provided.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test that does not exist and get an error message.','','2012-08-15 19:55:33','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0020A','Cerberus',' ','','Engine : Control - No Execution when environment does not exist','Test of Cerberus feature that does not start the test when environment does not exist or not provided.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test on an environment that does not exist and get an error message.','','2012-08-15 19:59:02','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0021A','Cerberus',' ','','Engine : Control - No Execution when country does not exist','Test of Cerberus feature that does not start the test when country does not exist or not provided.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test on a country that does not exist and get an error message.','','2012-08-15 20:04:41','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0022A','Cerberus',' ','','Engine : Control - No Execution when Selenium server is not started.','Test of Cerberus feature that does not start the test when the Selenium server is not started.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test against a port that is not listening and get an error message.','','2012-08-15 20:11:17','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0100A','Cerberus',' ','','Engine : Simple Test Execution.','This is to test Cerberus execution on simple selenium instructions..\r\n','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test that has simple OpenURL Selenium instruction and verify that result id OK on the execution detail page.','','2012-08-09 19:49:30','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0101A','Cerberus',' ','','Engine : Test Execution with Network trafic.','This is to test Cerberus execution on a simple selenium scenario to verify that size, hits are correctly feeded.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Try to run a test and verify that result has the correct network traffic information on the execution detail page.','','2012-08-09 19:52:05','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','0500A','Cerberus',' ','','Engine : Test Execution with Data retrival from multiple databases.','This is to test Cerberus execution with multiple data retrival with SQL execution on multiple databases.','N',NULL,1,'TO BE IMPLEMENTED','N','INTERACTIVE','RX','','Try to run a test that execute multiple SQL on multiple databases and verify that the results are correct on every databases.','','2012-08-09 20:03:00','','','','','','','','cerberus','','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','1000A','CerberusFake',' ','','Engine : Dummy Test','Fake Application Test for Cerberus Testing engine purpose.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Fake Application Test for Cerberus Testing engine purpose.','null','2012-08-10 07:56:48','','','','','null','','','cerberus','null','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','1001A','CerberusFake',' ','','Engine : Dummy Test Inactive','Fake Application Test for Cerberus Testing engine purpose.','N',NULL,1,'TO BE VALIDATED','N','INTERACTIVE','RX','','Fake Application Test for Cerberus Testing engine purpose.','null','2012-08-10 09:17:36','','','','','null','','','cerberus','null','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','1002A','CerberusFake',' ','','Engine : Dummy Test From 2012S1R10','Fake Application Test for Cerberus Testing engine purpose.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Fake Application Test for Cerberus Testing engine purpose.','null','2012-08-10 09:21:11','2012S1','R11','','','null','','','cerberus','null','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','1003A','CerberusFake',' ','','Engine : Dummy Test To 2012S1R10','Fake Application Test for Cerberus Testing engine purpose.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Fake Application Test for Cerberus Testing engine purpose.','null','2012-08-10 09:21:45','','','2012S1','R09','null','','','cerberus','null','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','1004A','CerberusFake',' ','','Engine : Dummy Test Target 2012S1R10','Fake Application Test for Cerberus Testing engine purpose.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Fake Application Test for Cerberus Testing engine purpose.','null','2012-08-10 09:22:21','','','','','null','2012S1','R11','cerberus','null','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','1005A','CerberusFake',' ','','Engine : Dummy Test Disabled PROD','Fake Application Test for Cerberus Testing engine purpose.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Fake Application Test for Cerberus Testing engine purpose.','null','2012-08-13 17:06:41','','','','','null','','','cerberus','null','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','1006A','CerberusFake',' ','','Engine : Dummy Test Disabled QA','Fake Application Test for Cerberus Testing engine purpose.','N',NULL,1,'WORKING','Y','INTERACTIVE','RX','','Fake Application Test for Cerberus Testing engine purpose.','null','2012-08-13 17:07:24','','','','','null','','','cerberus','null','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','1007A','CerberusFake',' ','','Engine : Dummy Test Disabled UAT','Fake Application Test for Cerberus Testing engine purpose.','N',NULL,1,'TO BE VALIDATED','Y','INTERACTIVE','RX','','Fake Application Test for Cerberus Testing engine purpose.','null','2012-08-13 17:08:13','','','','','null','','','cerberus','null','cerberus',NULL,'Y','Y','N')");
         SQLS.append(",('Cerberus','1008A','Cerberus',' ','','Cerberus Engine - Selenium not starting when application not GUI.','','N',NULL,2,'STANDBY','N','INTERACTIVE','All','','start a selenium test on a non GUI and non AS400 application with fake host and port and verify that it does execute on the execution detail page.',NULL,'2012-08-29 08:33:19',NULL,NULL,NULL,NULL,'',NULL,NULL,'cerberus',NULL,NULL,NULL,'Y','Y','N')");
         SQLS.append(",('Pre Testing','0050A','Cerberus','','','Cerberus Login','Cerberus Login','Y',NULL,0,'STANDBY','Y','PRIVATE','RX','','','','2012-06-19 13:30:26','','','','','null','','','cerberus','cerberus','cerberus',NULL,'Y','Y','Y');");
         SQLInstruction.add(SQLS.toString());
 
         SQLS = new StringBuilder();
         SQLS.append("INSERT INTO `testcasecountry` VALUES ('Cerberus','0001A','RX')");
         SQLS.append(",('Cerberus','0002A','RX')");
         SQLS.append(",('Cerberus','0003A','RX')");
         SQLS.append(",('Cerberus','0004A','RX')");
         SQLS.append(",('Cerberus','0005A','RX')");
         SQLS.append(",('Cerberus','0010A','RX')");
         SQLS.append(",('Cerberus','0011A','RX')");
         SQLS.append(",('Cerberus','0012A','RX')");
         SQLS.append(",('Cerberus','0013A','RX')");
         SQLS.append(",('Cerberus','0014A','RX')");
         SQLS.append(",('Cerberus','0015A','RX')");
         SQLS.append(",('Cerberus','0016A','RX')");
         SQLS.append(",('Cerberus','0017A','RX')");
         SQLS.append(",('Cerberus','0018A','RX')");
         SQLS.append(",('Cerberus','0019A','RX')");
         SQLS.append(",('Cerberus','0020A','RX')");
         SQLS.append(",('Cerberus','0021A','RX')");
         SQLS.append(",('Cerberus','0022A','RX')");
         SQLS.append(",('Cerberus','0100A','RX')");
         SQLS.append(",('Cerberus','0101A','RX')");
         SQLS.append(",('Cerberus','0500A','RX')");
         SQLS.append(",('Cerberus','1000A','RX')");
         SQLS.append(",('Cerberus','1001A','RX')");
         SQLS.append(",('Cerberus','1002A','RX')");
         SQLS.append(",('Cerberus','1003A','RX')");
         SQLS.append(",('Cerberus','1004A','RX')");
         SQLS.append(",('Cerberus','1005A','RX')");
         SQLS.append(",('Cerberus','1006A','RX')");
         SQLS.append(",('Cerberus','1007A','RX')");
         SQLS.append(",('Cerberus','1008A','RX')");
         SQLS.append(",('Pre Testing','0050A','RX');");
         SQLInstruction.add(SQLS.toString());
 
 
         SQLS = new StringBuilder();
         SQLS.append("INSERT INTO `testcasestep` VALUES ('Cerberus','0001A',1,'List')");
         SQLS.append(",('Cerberus','0002A',1,'Create Test')");
         SQLS.append(",('Cerberus','0003A',1,'Modify Test')");
         SQLS.append(",('Cerberus','0004A',1,'Documentation')");
         SQLS.append(",('Cerberus','0005A',1,'Create User')");
         SQLS.append(",('Cerberus','0010A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0011A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0012A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0013A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0014A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0015A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0016A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0017A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0018A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0019A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0020A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0021A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0022A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0100A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0101A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','0500A',1,'Execute a Test')");
         SQLS.append(",('Cerberus','1000A',1,'Open a Page')");
         SQLS.append(",('Cerberus','1001A',1,'Open a Page')");
         SQLS.append(",('Cerberus','1002A',1,'Open a Page')");
         SQLS.append(",('Cerberus','1003A',1,'Open a Page')");
         SQLS.append(",('Cerberus','1004A',1,'Open a Page')");
         SQLS.append(",('Cerberus','1005A',1,'Open a Page')");
         SQLS.append(",('Cerberus','1006A',1,'Open a Page')");
         SQLS.append(",('Cerberus','1007A',1,'Open a Page')");
         SQLS.append(",('Pre Testing','0050A',1,'Login');");
 
         SQLInstruction.add(SQLS.toString());
 
         SQLS = new StringBuilder();
         SQLS.append("INSERT INTO `testcasecountryproperties` VALUES ('Cerberus','0001A','RX','LIST','TEXT','VC','label=Application - New Application',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0002A','RX','ACTIVE','TEXT','VC','label=N',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0002A','RX','AUTOMATED','TEXT','VC','label=N',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0002A','RX','DESCRIPTION','TEXT','VC','Tests created by Cerberus to test',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0002A','RX','NAME','TEXT','VC','_Tests_Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0003A','RX','ACTIVE','TEXT','VC','label=Y',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0003A','RX','AUTOMATED','TEXT','VC','label=Y',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0003A','RX','DESCRIPTION','TEXT','VC','Tests created by Cerberus to test himself',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0003A','RX','NAME','TEXT','VC','_Tests_Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0003A','RX','TEST','TEXT','VC','label=_Tests_Cerberus - Tests created by Cerberus to test',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0005A','RX','GROUP','TEXT','VC','label=User',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0005A','RX','NAME','TEXT','VC','Cerberus User to Test',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0005A','RX','REQUEST','TEXT','VC','label=true',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0005A','RX','TEST','TEXT','VC','usrTest',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0010A','RX','COUNTRY','TEXT','VC','RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0010A','RX','ENV','TEXT','VC','RQA2',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0010A','RX','RCMESSAGE','HTML','VC','ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0010A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Test Case Not Active.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0010A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0010A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0010A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0010A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0010A','RX','TEST','TEXT','VC','Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0010A','RX','TESTCASE','TEXT','VC','1001A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','COUNTRY','TEXT','VC','label=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','ENV','TEXT','VC','value=RQA',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','OUTPUT','TEXT','VC','value=gui',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','RCMESSAGE','HTML','VC','ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Environment Type is Comparison and Test Case Group is : INTERACTIVE.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','TESTCASE','TEXT','VC','value=1000A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0011A','RX','VERBOSE','TEXT','VC','value=1',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0012A','RX','COUNTRY','TEXT','VC','label=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0012A','RX','ENV','TEXT','VC','value=RQA2',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0012A','RX','RCMESSAGE','HTML','VC','ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0012A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Build Range not compatible. Environment Build/Revision : 2012S1/R10 , Test Case From Build/Revision : 2012S1/R11.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0012A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0012A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0012A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0012A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0012A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0012A','RX','TESTCASE','TEXT','VC','value=1002A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0013A','RX','COUNTRY','TEXT','VC','label=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0013A','RX','ENV','TEXT','VC','value=RQA2',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0013A','RX','RCMESSAGE','HTML','VC','id=ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0013A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Build Range not compatible. Environment Build/Revision : 2012S1/R10 , Test Case To Build/Revision : 2012S1/R09.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0013A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0013A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0013A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0013A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0013A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0013A','RX','TESTCASE','TEXT','VC','value=1003A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0014A','RX','COUNTRY','TEXT','VC','label=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0014A','RX','ENV','TEXT','VC','value=RQA2',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0014A','RX','RCMESSAGE','HTML','VC','id=ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0014A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Test Case disabled until environment reach Target Build/Revision : 2012S1/R11 , Environment Build/Revision : 2012S1/R10.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0014A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0014A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0014A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0014A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0014A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0014A','RX','TESTCASE','TEXT','VC','value=1004A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0015A','RX','COUNTRY','TEXT','VC','label=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0015A','RX','ENV','TEXT','VC','value=RQA3',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0015A','RX','RCMESSAGE','HTML','VC','ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0015A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Environment Not Active.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0015A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0015A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0015A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0015A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0015A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0015A','RX','TESTCASE','TEXT','VC','1000A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','COUNTRY','TEXT','VC','label=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','ENV','TEXT','VC','value=PROD',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','OUTPUT','TEXT','VC','value=gui',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','RCMESSAGE','HTML','VC','ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Environment group is PROD and Test Case is disabled for PROD Group environments.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','TESTCASE','TEXT','VC','value=1005A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0016A','RX','VERBOSE','TEXT','VC','value=1',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','COUNTRY','TEXT','VC','label=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','ENV','TEXT','VC','value=RQA2',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','OUTPUT','TEXT','VC','value=gui',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','RCMESSAGE','HTML','VC','ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Environment group is QA and Test Case is disabled for QA Group environments.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','TESTCASE','TEXT','VC','value=1006A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0017A','RX','VERBOSE','TEXT','VC','value=1',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','COUNTRY','TEXT','VC','label=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','ENV','TEXT','VC','value=UAT',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','OUTPUT','TEXT','VC','value=gui',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','RCMESSAGE','HTML','VC','ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Environment group is UAT and Test Case is disabled for UAT Group environments.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','TESTCASE','TEXT','VC','value=1007A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0018A','RX','VERBOSE','TEXT','VC','value=1',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0019A','RX','COUNTRY','TEXT','VC','RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0019A','RX','ENV','TEXT','VC','RQA2',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0019A','RX','RCMESSAGE','HTML','VC','ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0019A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Test Case \\'XXXX\\' does not exist.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0019A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0019A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0019A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0019A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0019A','RX','TEST','TEXT','VC','Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0019A','RX','TESTCASE','TEXT','VC','XXXX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0020A','RX','COUNTRY','TEXT','VC','RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0020A','RX','ENV','TEXT','VC','XXXX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0020A','RX','RCMESSAGE','HTML','VC','ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0020A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Environment \\'XXXX\\' does not exist.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0020A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0020A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0020A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0020A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0020A','RX','TEST','TEXT','VC','Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0020A','RX','TESTCASE','TEXT','VC','1000A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0021A','RX','COUNTRY','TEXT','VC','XXXX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0021A','RX','ENV','TEXT','VC','RQA2',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0021A','RX','RCMESSAGE','HTML','VC','ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0021A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Country \\'XXXX\\' does not exist.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0021A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0021A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0021A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0021A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0021A','RX','TEST','TEXT','VC','Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0021A','RX','TESTCASE','TEXT','VC','1000A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','COUNTRY','TEXT','VC','value=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','ENV','TEXT','VC','value=RQA2',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','OUTPUT','TEXT','VC','value=gui',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','RCMESSAGE','HTML','VC','ReturnCodeMessage',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','RCMESSAGE-VERIF','TEXT','VC','Could not run Test. Could not contact Selenium Server on host \\'localhost\\' port \\'9999\\'.',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','SSPORT','TEXT','VC','9999',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','TESTCASE','TEXT','VC','value=1000A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0022A','RX','VERBOSE','TEXT','VC','value=1',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','COUNTRY','TEXT','VC','label=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','ENV','TEXT','VC','value=RQA2',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','IDEXE','HTML','VC','exeid',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','IDEXE-DTB','SQL','CRB','select max(ID) from testcaseexecution where test=\\'Cerberus\\' and testcase=\\'1000A\\';',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','OUTPUT','TEXT','VC','value=gui',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','SSIP','TEXT','VC','200.1.15.43',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','SSPORT','TEXT','VC','5555',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','TESTCASE','TEXT','VC','value=1000A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0100A','RX','VERBOSE','TEXT','VC','value=1',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','COUNTRY','TEXT','VC','label=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','ENV','TEXT','VC','value=RQA2',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','NBHITS','HTML','VC','tot_nbhits',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','NBHITSREAL','TEXT','VC','1',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','SIZE','HTML','VC','tot_size',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','SIZEREAL','TEXT','VC','302',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0101A','RX','TESTCASE','TEXT','VC','value=1000A',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0500A','RX','COUNTRY','TEXT','VC','label=RX',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0500A','RX','ENV','TEXT','VC','value=RQA2',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0500A','RX','SSBROWSER','TEXT','VC','*firefox',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0500A','RX','SSIP','TEXT','VC','localhost',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0500A','RX','SSLOG','TEXT','VC','logpath-FakeApp',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0500A','RX','SSPORT','TEXT','VC','5556',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0500A','RX','TEST','TEXT','VC','label=Cerberus',0,0,'STATIC')");
         SQLS.append(",('Cerberus','0500A','RX','TESTCASE','TEXT','VC','value=1005A',0,0,'STATIC')");
         SQLS.append(",('Pre Testing','0050A','RX','LOGIN','TEXT','VC','cerberus',0,0,'STATIC')");
         SQLS.append(",('Pre Testing','0050A','RX','PASSWORD','TEXT','VC','cerberus',0,0,'STATIC');");
         SQLInstruction.add(SQLS.toString());
 
         SQLS = new StringBuilder();
         SQLS.append("INSERT INTO `testcasestepaction` VALUES ('Cerberus','0001A',1,10,'openUrlWithBase','Test.jsp','null')");
         SQLS.append(",('Cerberus','0001A',1,20,'select','id=stestbox','LIST')");
         SQLS.append(",('Cerberus','0001A',1,30,'clickAndWait','id=loadbutton','null')");
         SQLS.append(",('Cerberus','0002A',1,20,'clickAndWait','link=Create Test','null')");
         SQLS.append(",('Cerberus','0002A',1,30,'type','id=createTest','NAME')");
         SQLS.append(",('Cerberus','0002A',1,40,'type','id=createDescription','DESCRIPTION')");
         SQLS.append(",('Cerberus','0002A',1,50,'select','id=createActive','ACTIVE')");
         SQLS.append(",('Cerberus','0002A',1,60,'select','id=createAutomated','AUTOMATED')");
         SQLS.append(",('Cerberus','0002A',1,70,'clickAndWait','id=add_test','null')");
         SQLS.append(",('Cerberus','0003A',1,20,'clickAndWait','link=Edit Test','null')");
         SQLS.append(",('Cerberus','0003A',1,30,'select','id=stestbox','TEST')");
         SQLS.append(",('Cerberus','0003A',1,40,'clickAndWait','xpath=(//input[@id=\\'loadbutton\\'])[2]','null')");
         SQLS.append(",('Cerberus','0003A',1,50,'click','id=button1','null')");
         SQLS.append(",('Cerberus','0003A',1,60,'type','id=test_test','NAME')");
         SQLS.append(",('Cerberus','0003A',1,70,'type','id=test_description','DESCRIPTION')");
         SQLS.append(",('Cerberus','0003A',1,80,'select','id=test_active','ACTIVE')");
         SQLS.append(",('Cerberus','0003A',1,90,'select','id=test_automated','AUTOMATED')");
         SQLS.append(",('Cerberus','0003A',1,100,'clickAndWait','id=savetestbutton','null')");
         SQLS.append(",('Cerberus','0004A',1,10,'addSelection','/CerberusDev/Homepage.jsp','null')");
         SQLS.append(",('Cerberus','0004A',1,20,'click','link=exact:?','null')");
         SQLS.append(",('Cerberus','0004A',1,30,'waitForPage','popup','30000')");
         SQLS.append(",('Cerberus','0005A',1,20,'clickAndWait','link=Users Manager','null')");
         SQLS.append(",('Cerberus','0005A',1,30,'click','id=btnAddNewRow','null')");
         SQLS.append(",('Cerberus','0005A',1,40,'type','id=login','TEST')");
         SQLS.append(",('Cerberus','0005A',1,50,'type','id=name','NAME')");
         SQLS.append(",('Cerberus','0005A',1,60,'select','id=group','GROUP')");
         SQLS.append(",('Cerberus','0005A',1,70,'select','id=newPassword','REQUEST')");
         SQLS.append(",('Cerberus','0005A',1,80,'click','id=btnAddNewRowOk','null')");
         SQLS.append(",('Cerberus','0010A',1,20,'openUrlWithBase','BatchExecution?redirect=Y&ss_ip=localhost&ss_p=5556&browser=*firefox&logpath=logpath-FakeApp&Test=Cerberus&TestCase=1001A&Country=RX&Environment=RQA2&Tag=&outputformat=gui&verbose=1','null')");
         SQLS.append(",('Cerberus','0010A',1,30,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0010A',1,40,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0011A',1,20,'clickAndWait','link=Run Tests','null')");
         SQLS.append(",('Cerberus','0011A',1,30,'type','name=ss_ip','SSIP')");
         SQLS.append(",('Cerberus','0011A',1,40,'type','name=ss_p','SSPORT')");
         SQLS.append(",('Cerberus','0011A',1,50,'type','name=browser','SSBROWSER')");
         SQLS.append(",('Cerberus','0011A',1,60,'type','name=logpath','SSLOG')");
         SQLS.append(",('Cerberus','0011A',1,70,'selectAndWait','id=test','TEST')");
         SQLS.append(",('Cerberus','0011A',1,80,'selectAndWait','id=testcase','TESTCASE')");
         SQLS.append(",('Cerberus','0011A',1,90,'selectAndWait','id=country','COUNTRY')");
         SQLS.append(",('Cerberus','0011A',1,100,'selectAndWait','id=environment','ENV')");
         SQLS.append(",('Cerberus','0011A',1,105,'selectAndWait','id=Verbose','VERBOSE')");
         SQLS.append(",('Cerberus','0011A',1,106,'selectAndWait','id=Format','OUTPUT')");
         SQLS.append(",('Cerberus','0011A',1,110,'click','buttonRun','null')");
         SQLS.append(",('Cerberus','0011A',1,115,'wait','null','null')");
         SQLS.append(",('Cerberus','0011A',1,120,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0011A',1,130,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0012A',1,20,'clickAndWait','link=Run Tests','null')");
         SQLS.append(",('Cerberus','0012A',1,30,'type','name=ss_ip','SSIP')");
         SQLS.append(",('Cerberus','0012A',1,40,'type','name=ss_p','SSPORT')");
         SQLS.append(",('Cerberus','0012A',1,50,'type','name=browser','SSBROWSER')");
         SQLS.append(",('Cerberus','0012A',1,60,'type','name=logpath','SSLOG')");
         SQLS.append(",('Cerberus','0012A',1,70,'selectAndWait','id=test','TEST')");
         SQLS.append(",('Cerberus','0012A',1,80,'selectAndWait','id=testcase','TESTCASE')");
         SQLS.append(",('Cerberus','0012A',1,90,'selectAndWait','id=country','COUNTRY')");
         SQLS.append(",('Cerberus','0012A',1,100,'selectAndWait','id=environment','ENV')");
         SQLS.append(",('Cerberus','0012A',1,110,'click','buttonRun','null')");
         SQLS.append(",('Cerberus','0012A',1,115,'wait','null','null')");
         SQLS.append(",('Cerberus','0012A',1,120,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0012A',1,130,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0013A',1,20,'clickAndWait','link=Run Tests','null')");
         SQLS.append(",('Cerberus','0013A',1,30,'type','name=ss_ip','SSIP')");
         SQLS.append(",('Cerberus','0013A',1,40,'type','name=ss_p','SSPORT')");
         SQLS.append(",('Cerberus','0013A',1,50,'type','name=browser','SSBROWSER')");
         SQLS.append(",('Cerberus','0013A',1,60,'type','name=logpath','SSLOG')");
         SQLS.append(",('Cerberus','0013A',1,70,'selectAndWait','id=test','TEST')");
         SQLS.append(",('Cerberus','0013A',1,80,'selectAndWait','id=testcase','TESTCASE')");
         SQLS.append(",('Cerberus','0013A',1,90,'selectAndWait','id=country','COUNTRY')");
         SQLS.append(",('Cerberus','0013A',1,100,'selectAndWait','id=environment','ENV')");
         SQLS.append(",('Cerberus','0013A',1,110,'click','buttonRun','null')");
         SQLS.append(",('Cerberus','0013A',1,115,'wait','null','null')");
         SQLS.append(",('Cerberus','0013A',1,120,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0013A',1,130,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0014A',1,20,'clickAndWait','link=Run Tests','null')");
         SQLS.append(",('Cerberus','0014A',1,30,'type','name=ss_ip','SSIP')");
         SQLS.append(",('Cerberus','0014A',1,40,'type','name=ss_p','SSPORT')");
         SQLS.append(",('Cerberus','0014A',1,50,'type','name=browser','SSBROWSER')");
         SQLS.append(",('Cerberus','0014A',1,60,'type','name=logpath','SSLOG')");
         SQLS.append(",('Cerberus','0014A',1,70,'selectAndWait','id=test','TEST')");
         SQLS.append(",('Cerberus','0014A',1,80,'selectAndWait','id=testcase','TESTCASE')");
         SQLS.append(",('Cerberus','0014A',1,90,'selectAndWait','id=country','COUNTRY')");
         SQLS.append(",('Cerberus','0014A',1,100,'selectAndWait','id=environment','ENV')");
         SQLS.append(",('Cerberus','0014A',1,110,'click','buttonRun','null')");
         SQLS.append(",('Cerberus','0014A',1,115,'wait','null','null')");
         SQLS.append(",('Cerberus','0014A',1,120,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0014A',1,130,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0015A',1,20,'openUrlWithBase','BatchExecution?redirect=Y&ss_ip=localhost&ss_p=5556&browser=*firefox&logpath=logpath-FakeApp&Test=Cerberus&TestCase=1000A&Country=RX&Environment=RQA3&Tag=&outputformat=gui&verbose=1','null')");
         SQLS.append(",('Cerberus','0015A',1,30,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0015A',1,40,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0016A',1,20,'clickAndWait','link=Run Tests','null')");
         SQLS.append(",('Cerberus','0016A',1,30,'type','name=ss_ip','SSIP')");
         SQLS.append(",('Cerberus','0016A',1,40,'type','name=ss_p','SSPORT')");
         SQLS.append(",('Cerberus','0016A',1,50,'type','name=browser','SSBROWSER')");
         SQLS.append(",('Cerberus','0016A',1,60,'type','name=logpath','SSLOG')");
         SQLS.append(",('Cerberus','0016A',1,70,'selectAndWait','id=test','TEST')");
         SQLS.append(",('Cerberus','0016A',1,80,'selectAndWait','id=testcase','TESTCASE')");
         SQLS.append(",('Cerberus','0016A',1,90,'selectAndWait','id=country','COUNTRY')");
         SQLS.append(",('Cerberus','0016A',1,100,'selectAndWait','id=environment','ENV')");
         SQLS.append(",('Cerberus','0016A',1,105,'selectAndWait','id=Verbose','VERBOSE')");
         SQLS.append(",('Cerberus','0016A',1,106,'selectAndWait','id=Format','OUTPUT')");
         SQLS.append(",('Cerberus','0016A',1,110,'click','buttonRun','null')");
         SQLS.append(",('Cerberus','0016A',1,115,'wait','null','null')");
         SQLS.append(",('Cerberus','0016A',1,120,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0016A',1,130,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0017A',1,20,'clickAndWait','link=Run Tests','null')");
         SQLS.append(",('Cerberus','0017A',1,30,'type','name=ss_ip','SSIP')");
         SQLS.append(",('Cerberus','0017A',1,40,'type','name=ss_p','SSPORT')");
         SQLS.append(",('Cerberus','0017A',1,50,'type','name=browser','SSBROWSER')");
         SQLS.append(",('Cerberus','0017A',1,60,'type','name=logpath','SSLOG')");
         SQLS.append(",('Cerberus','0017A',1,70,'selectAndWait','id=test','TEST')");
         SQLS.append(",('Cerberus','0017A',1,80,'selectAndWait','id=testcase','TESTCASE')");
         SQLS.append(",('Cerberus','0017A',1,90,'selectAndWait','id=country','COUNTRY')");
         SQLS.append(",('Cerberus','0017A',1,100,'selectAndWait','id=environment','ENV')");
         SQLS.append(",('Cerberus','0017A',1,105,'selectAndWait','id=Verbose','VERBOSE')");
         SQLS.append(",('Cerberus','0017A',1,106,'selectAndWait','id=Format','OUTPUT')");
         SQLS.append(",('Cerberus','0017A',1,110,'click','buttonRun','null')");
         SQLS.append(",('Cerberus','0017A',1,115,'wait','null','null')");
         SQLS.append(",('Cerberus','0017A',1,120,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0017A',1,130,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0018A',1,20,'clickAndWait','link=Run Tests','null')");
         SQLS.append(",('Cerberus','0018A',1,30,'type','name=ss_ip','SSIP')");
         SQLS.append(",('Cerberus','0018A',1,40,'type','name=ss_p','SSPORT')");
         SQLS.append(",('Cerberus','0018A',1,50,'type','name=browser','SSBROWSER')");
         SQLS.append(",('Cerberus','0018A',1,60,'type','name=logpath','SSLOG')");
         SQLS.append(",('Cerberus','0018A',1,70,'selectAndWait','id=test','TEST')");
         SQLS.append(",('Cerberus','0018A',1,80,'selectAndWait','id=testcase','TESTCASE')");
         SQLS.append(",('Cerberus','0018A',1,90,'selectAndWait','id=country','COUNTRY')");
         SQLS.append(",('Cerberus','0018A',1,100,'selectAndWait','id=environment','ENV')");
         SQLS.append(",('Cerberus','0018A',1,105,'selectAndWait','id=Verbose','VERBOSE')");
         SQLS.append(",('Cerberus','0018A',1,106,'selectAndWait','id=Format','OUTPUT')");
         SQLS.append(",('Cerberus','0018A',1,110,'click','buttonRun','null')");
         SQLS.append(",('Cerberus','0018A',1,115,'wait','null','null')");
         SQLS.append(",('Cerberus','0018A',1,120,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0018A',1,130,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0019A',1,20,'openUrlWithBase','BatchExecution?redirect=Y&ss_ip=localhost&ss_p=5556&browser=*firefox&logpath=logpath-FakeApp&Test=Cerberus&TestCase=XXXX&Country=RX&Environment=RQA2&Tag=&outputformat=gui&verbose=1','null')");
         SQLS.append(",('Cerberus','0019A',1,30,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0019A',1,40,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0020A',1,20,'openUrlWithBase','BatchExecution?redirect=Y&ss_ip=localhost&ss_p=5556&browser=*firefox&logpath=logpath-FakeApp&Test=Cerberus&TestCase=0100A&Country=RX&Environment=XXXX&Tag=&outputformat=gui&verbose=1','null')");
         SQLS.append(",('Cerberus','0020A',1,30,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0020A',1,40,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0021A',1,20,'openUrlWithBase','BatchExecution?redirect=Y&ss_ip=localhost&ss_p=5556&browser=*firefox&logpath=logpath-FakeApp&Test=Cerberus&TestCase=0100A&Country=XXXX&Environment=RQA2&Tag=&outputformat=gui&verbose=1','null')");
         SQLS.append(",('Cerberus','0021A',1,30,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0021A',1,40,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0022A',1,20,'clickAndWait','link=Run Tests','null')");
         SQLS.append(",('Cerberus','0022A',1,30,'type','name=ss_ip','SSIP')");
         SQLS.append(",('Cerberus','0022A',1,40,'type','name=ss_p','SSPORT')");
         SQLS.append(",('Cerberus','0022A',1,50,'type','name=browser','SSBROWSER')");
         SQLS.append(",('Cerberus','0022A',1,60,'type','name=logpath','SSLOG')");
         SQLS.append(",('Cerberus','0022A',1,70,'selectAndWait','id=test','TEST')");
         SQLS.append(",('Cerberus','0022A',1,80,'selectAndWait','id=testcase','TESTCASE')");
         SQLS.append(",('Cerberus','0022A',1,90,'selectAndWait','id=country','COUNTRY')");
         SQLS.append(",('Cerberus','0022A',1,100,'selectAndWait','id=environment','ENV')");
         SQLS.append(",('Cerberus','0022A',1,105,'selectAndWait','id=Verbose','VERBOSE')");
         SQLS.append(",('Cerberus','0022A',1,106,'selectAndWait','id=Format','OUTPUT')");
         SQLS.append(",('Cerberus','0022A',1,110,'click','buttonRun','null')");
         SQLS.append(",('Cerberus','0022A',1,115,'wait','null','null')");
         SQLS.append(",('Cerberus','0022A',1,120,'calculateProperty','null','RCMESSAGE')");
         SQLS.append(",('Cerberus','0022A',1,130,'calculateProperty','null','RCMESSAGE-VERIF')");
         SQLS.append(",('Cerberus','0100A',1,20,'clickAndWait','link=Run Tests','null')");
         SQLS.append(",('Cerberus','0100A',1,30,'type','name=ss_ip','SSIP')");
         SQLS.append(",('Cerberus','0100A',1,40,'type','name=ss_p','SSPORT')");
         SQLS.append(",('Cerberus','0100A',1,50,'type','name=browser','SSBROWSER')");
         SQLS.append(",('Cerberus','0100A',1,60,'type','name=logpath','SSLOG')");
         SQLS.append(",('Cerberus','0100A',1,70,'selectAndWait','id=test','TEST')");
         SQLS.append(",('Cerberus','0100A',1,80,'selectAndWait','id=testcase','TESTCASE')");
         SQLS.append(",('Cerberus','0100A',1,90,'selectAndWait','id=country','COUNTRY')");
         SQLS.append(",('Cerberus','0100A',1,100,'selectAndWait','id=environment','ENV')");
         SQLS.append(",('Cerberus','0100A',1,105,'selectAndWait','id=Format','OUTPUT')");
         SQLS.append(",('Cerberus','0100A',1,107,'selectAndWait','id=Verbose','VERBOSE')");
         SQLS.append(",('Cerberus','0100A',1,110,'click','buttonRun','null')");
         SQLS.append(",('Cerberus','0100A',1,120,'wait','null','null')");
         SQLS.append(",('Cerberus','0100A',1,130,'calculateProperty','null','IDEXE')");
         SQLS.append(",('Cerberus','0100A',1,140,'calculateProperty','null','IDEXE-DTB')");
         SQLS.append(",('Cerberus','0100A',1,150,'wait','null','null')");
         SQLS.append(",('Cerberus','0101A',1,20,'clickAndWait','link=Run Tests','null')");
         SQLS.append(",('Cerberus','0101A',1,30,'type','name=ss_ip','SSIP')");
         SQLS.append(",('Cerberus','0101A',1,40,'type','name=ss_p','SSPORT')");
         SQLS.append(",('Cerberus','0101A',1,50,'type','name=browser','SSBROWSER')");
         SQLS.append(",('Cerberus','0101A',1,60,'type','name=logpath','SSLOG')");
         SQLS.append(",('Cerberus','0101A',1,70,'selectAndWait','id=test','TEST')");
         SQLS.append(",('Cerberus','0101A',1,80,'selectAndWait','id=testcase','TESTCASE')");
         SQLS.append(",('Cerberus','0101A',1,90,'selectAndWait','id=country','COUNTRY')");
         SQLS.append(",('Cerberus','0101A',1,100,'selectAndWait','id=environment','ENV')");
         SQLS.append(",('Cerberus','0101A',1,110,'click','buttonRun','null')");
         SQLS.append(",('Cerberus','0101A',1,120,'wait','null','null')");
         SQLS.append(",('Cerberus','0101A',1,130,'calculateProperty','null','SIZE')");
         SQLS.append(",('Cerberus','0101A',1,135,'calculateProperty','null','SIZEREAL')");
         SQLS.append(",('Cerberus','0101A',1,140,'calculateProperty','null','NBHITS')");
         SQLS.append(",('Cerberus','0101A',1,145,'calculateProperty','null','NBHITSREAL')");
         SQLS.append(",('Cerberus','0500A',1,20,'clickAndWait','link=Run Tests','null')");
         SQLS.append(",('Cerberus','0500A',1,30,'type','name=ss_ip','SSIP')");
         SQLS.append(",('Cerberus','0500A',1,40,'type','name=ss_p','SSPORT')");
         SQLS.append(",('Cerberus','0500A',1,50,'type','name=browser','SSBROWSER')");
         SQLS.append(",('Cerberus','0500A',1,60,'type','name=logpath','SSLOG')");
         SQLS.append(",('Cerberus','0500A',1,70,'selectAndWait','id=test','TEST')");
         SQLS.append(",('Cerberus','0500A',1,80,'selectAndWait','id=testcase','TESTCASE')");
         SQLS.append(",('Cerberus','0500A',1,90,'selectAndWait','id=country','COUNTRY')");
         SQLS.append(",('Cerberus','0500A',1,100,'selectAndWait','id=environment','ENV')");
         SQLS.append(",('Cerberus','0500A',1,110,'click','buttonRun','null')");
         SQLS.append(",('Cerberus','0500A',1,115,'wait','null','null')");
         SQLS.append(",('Cerberus','1000A',1,10,'openUrlWithBase','index1.jsp','null')");
         SQLS.append(",('Cerberus','1001A',1,10,'openUrlWithBase','index1.jsp','null')");
         SQLS.append(",('Cerberus','1002A',1,10,'openUrlWithBase','index1.jsp','null')");
         SQLS.append(",('Cerberus','1003A',1,10,'openUrlWithBase','index1.jsp','null')");
         SQLS.append(",('Cerberus','1004A',1,10,'openUrlWithBase','index1.jsp','null')");
         SQLS.append(",('Cerberus','1005A',1,10,'openUrlWithBase','index1.jsp','null')");
         SQLS.append(",('Cerberus','1006A',1,10,'openUrlWithBase','index1.jsp','null')");
         SQLS.append(",('Cerberus','1007A',1,10,'openUrlWithBase','index1.jsp','null')");
         SQLS.append(",('Pre Testing','0050A',1,10,'URLLOGIN','null','null')");
         SQLS.append(",('Pre Testing','0050A',1,20,'type','name=j_username','LOGIN')");
         SQLS.append(",('Pre Testing','0050A',1,30,'type','name=j_password','PASSWORD')");
         SQLS.append(",('Pre Testing','0050A',1,40,'click','Login','null');");
         SQLInstruction.add(SQLS.toString());
 
         SQLS = new StringBuilder();
         SQLS.append("INSERT INTO `testcasestepactioncontrol` VALUES ('Cerberus','0001A',1,30,1,'verifyElementPresent','null','parametergeneral','Y')");
         SQLS.append(",('Cerberus','0001A',1,30,2,'verifyElementPresent','null','name=DeleteTestcase','Y')");
         SQLS.append(",('Cerberus','0010A',1,40,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0015A',1,40,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0019A',1,40,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0020A',1,40,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0021A',1,40,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0002A',1,70,1,'verifyurl','null','/Test.jsp?stestbox=_Tests_Cerberus','Y')");
         SQLS.append(",('Cerberus','0005A',1,80,1,'verifyElementPresent','null','usrTest','Y')");
         SQLS.append(",('Cerberus','0003A',1,100,1,'verifyurl','null','/Test.jsp?stestbox=_Tests_Cerberus','Y')");
         SQLS.append(",('Cerberus','0500A',1,110,1,'verifyurl','null','/BatchExecution','Y')");
         SQLS.append(",('Cerberus','0011A',1,130,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0012A',1,130,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0013A',1,130,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0014A',1,130,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0016A',1,130,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0017A',1,130,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0018A',1,130,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0022A',1,130,1,'PropertyIsEqualTo','RCMESSAGE-VERIF','RCMESSAGE','Y')");
         SQLS.append(",('Cerberus','0101A',1,135,1,'PropertyIsEqualTo','SIZEREAL','SIZE','N')");
         SQLS.append(",('Cerberus','0100A',1,140,1,'PropertyIsEqualTo','IDEXE-DTB','IDEXE','N')");
         SQLS.append(",('Cerberus','0101A',1,145,1,'PropertyIsEqualTo','NBHITSREAL','NBHITS','N');");
         SQLInstruction.add(SQLS.toString());
 ...
 //-- ------------------------
         ...
         SQLInstruction.add(SQLS.toString());
         SQLS = new StringBuilder();
         SQLS.append("UPDATE `invariant` SET `value`='openUrlLogin', `sort`=61, `description`='openUrlLogin' WHERE `id`='12' and`sort`='180';");
         SQLInstruction.add(SQLS.toString());
         SQLS = new StringBuilder();
 ...
 //-- ------------------------
         ...
         SQLS.append("  ('SYSTEM', 'SYS1', 10, 41, 'System1 System'),");
