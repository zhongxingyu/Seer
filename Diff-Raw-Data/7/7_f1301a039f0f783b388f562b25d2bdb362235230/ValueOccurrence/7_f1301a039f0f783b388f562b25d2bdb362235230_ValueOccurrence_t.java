 ...
 //		}
 	...
 	public String getResultStr() throws ParseException {
		if ((type == OccurrenceType.Duration) && ((result == null) || (result == 0)) && (state == State.RUNNING) && (creationDate != null)) {
			long r = (System.currentTimeMillis() - creationDate.getTime());
			return format(r, type);
		} else {
