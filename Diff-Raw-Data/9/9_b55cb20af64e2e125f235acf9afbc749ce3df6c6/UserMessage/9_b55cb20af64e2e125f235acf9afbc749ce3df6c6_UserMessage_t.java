  ...
  * Eine Meldung besteht aus dem Identifikator (Suchschlssel im Meldungspool), einem Dialogtitel, einem Buttonset und
  * dem Meldungstext mit eventuellen Platzhaltern fr die Parameter.
  *
  * @author S. Gorkhover
  * @version 18.03.1999
  *
  ...
  * @subject MessageException untersttzen
  *
 ...
 * @subject Unicode
 ...
 public class UserMessage {
   ...
   // Zulssige Werte fr Dialogart:
   /**
   * Mglicher Wert des Meldungstypes. Fenster-Title "Info" (de).
   */
   private static final int INFO      = JOptionPane.PLAIN_MESSAGE;
   /**
   * Mglicher Wert des Meldungstypes. Fenster-Title "Warnung" (de).
   */
   private static final int WARNING   = JOptionPane.WARNING_MESSAGE;
   /**
   * Mglicher Wert des Meldungstypes. Fenster-Title "Frage" (de).
   */
   private static final int QUESTION  = JOptionPane.QUESTION_MESSAGE;
   /**
   * Mglicher Wert des Meldungstypes. Fenster-Title "Fehler" (de).
   */
   private static final int ERROR     = JOptionPane.ERROR_MESSAGE;
   /**
   * Mglicher Wert des Meldungstypes. Fenster-Title "Systemfehler" (de).
   */
   ...
   */
   /**Mglicher Rckgabewert @see ButtonDialog*/
   ...
   */
   ...
   /**
   * Gibt den Title frs Dialogfenster.
   ...
   */
   ...
   /**
   * ffnet das Dialogfenster mit der bersetzung der per Suchschlssel bergebenen Meldung
   * mit eingesetzten Parametern. Fr die bersetzung der Parameter trgt die aufrufende Stelle die Sorge.
   * Der Dialog ist modal zum Frame <code>frame</code>.
   * @param <UL>
   * <LI> textID - Suchschlssel der Meldung im Meldungspool,
   * <LI> param - Array der in die Meldung einzusetztenden Parameter,
   * <LI> frame - das Fenster, zu dem der Dialog modal ist.
   * </UL>
   * @return <UL>
   * <LI> -1 wenn keine Rckgabe mglich ist oder Dialog NICHT MODAL ist.
   * <LI> ButtonDialog.YES = 2
   * <LI> ButtonDialog.NO = 4
   * <LI> ButtonDialog.CANCEL = 8
   * <LI> Wird das Dialog-Fenster ohne Buttonklick geschlossen (Kreuzchen oben rechts), so ist die Rckgabe gleich ButtonDialog.CANCEL.
   * </UL>
   */
