 ...
 public class ExportDialog extends AbstractDialog
 {
   ...
   protected void paint(Composite parent) throws Exception
   {
 		...
 		group.addText(i18n.tr("Bitte whlen Sie das gewnschte Dateiformat aus fr den Export aus"),true);
 
 		group.addLabelPair(i18n.tr("Verfgbare Formate:"),getExporterList());
   ...
   private void export() throws ApplicationException
   {
     ...
     if (exp == null || exp.exporter == null)
       throw new ApplicationException(i18n.tr("Bitte whlen Sie ein Export-Format aus"));
    ...
    fd.setFileName(i18n.tr("hibiscus-export-{0}." + exp.format.getFileExtension(),HBCI.FASTDATEFORMAT.format(new Date())));
     ...
     if (file.exists())
     {
       try
       {
         ...
         d.setText(i18n.tr("Mchten Sie die Datei berschreiben?"));
   ...
   private Input getExporterList() throws Exception
     ...
     for (int i=0;i<exporters.length;++i)
       ...
       for (int j=0;j<formats.length;++j)
       {
 		...
 		if (size == 0)
 		{
 			exporterListe = new LabelInput(i18n.tr("Keine Export-Filter verfgbar"));
 			return exporterListe;
 		}
