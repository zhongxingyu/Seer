 ...
 import net.sharenav.sharenav.routing.ConnectionWithNode;
 import net.sharenav.sharenav.routing.RouteInstructions;
 import net.sharenav.sharenav.routing.RouteLineProducer;
 import net.sharenav.sharenav.routing.TravelMode;
 import net.sharenav.sharenav.tile.SingleTile;
 import net.sharenav.sharenav.tile.Tile;
 import net.sharenav.sharenav.ui.Trace;
 import net.sharenav.midlet.graphics.FilledTriangle;
  ...
  *   Yes/No ;-) from the ShareNav data perspective a way is complete within a tile.
  *   from OSM Perspective ways are splited into two ways if they are to large 
  * - Where are the way nodes combined if a tile was split in Osm2ShareNav?
 ...
 //	public static final byte WAY_FLAG_ISINHIGH = 64;	
 	 ...
 	 * The routeability of the way in each route mode is determined by Osm2ShareNav,
