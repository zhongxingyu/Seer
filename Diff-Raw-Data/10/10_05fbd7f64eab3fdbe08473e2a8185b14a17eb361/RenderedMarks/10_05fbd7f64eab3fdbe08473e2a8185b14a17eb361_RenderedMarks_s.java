 ...
 * @version $Id: RenderedMarks.java,v 1.11 2003/03/21 23:05:31 desruisseaux Exp $
 ...
 public abstract class RenderedMarks extends RenderedLayer {
     ...
     /**
      * Procde au traage des marques de cette couche. Les classes drives ne
      * devraient pas avoir besoin de redfinir cette mthode. Pour modifier la
      * faon de dessiner les marques, redfinissez plutt les mthodes de
      * {@link MarkIterator}.
      *
     ...
     protected void paint(final RenderingContext context) throws TransformException {
         ...
         try {
             ...
             if (!isValid(AREAS_MASK|MARKS_MASK|ICONS_MASK|GLYPHS_MASK)) {
                 ...
                 /*
                  * On veut utiliser une transformation affine identite (donc en utilisant
                  * une chelle base sur les pixels plutt que les coordonnes utilisateur),
                  * mais en utilisant la mme rotation que celle qui a cours dans la matrice
                  * <code>mapToTxt</code>. On peut y arriver en utilisant l'identit ci-dessous:
                  *
     ...
     /**
      * Efface des informations qui avaient t conserves dans une mmoire cache.
      * Cette mthode est automatiquement appele lorsqu'il a t dtermin que cette
      * couche ne sera plus affiche avant un certain temps.
      */
     void clearCache() {
         assert Thread.holdsLock(getTreeLock());
         validMask        = 0;
      ...
      * de la souris trane sur la carte. L'implmentation par dfaut
      * identifie la marque sur laquelle trane le curseur et appelle
      * {@link MarkIterator#getToolTipText()}.
      *
      * @param  event Coordonnes du curseur de la souris.
      * @return Le texte  afficher lorsque la souris trane sur cet lment.
