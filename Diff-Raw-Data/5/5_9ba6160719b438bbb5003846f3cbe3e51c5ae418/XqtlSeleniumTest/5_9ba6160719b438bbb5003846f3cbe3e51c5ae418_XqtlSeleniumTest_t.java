 ...
 public class XqtlSeleniumTest extends XqtlSeleniumInit
 {
 	...
 	public void configureAnalysis() throws Exception
 	{
		...
		//"Now for the killer part, for sites that use jQuery, if all you need is to confirm there arent any active asynchronous requests, then the following does the trick:"
