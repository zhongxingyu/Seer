 ...
 */
 ...
 public class CollectionProtocolForm extends SpecimenProtocolForm
 {
 	...
 	public void setAllValues(AbstractDomainObject abstractDomain)
 	{
 		...
 		{
 			this.aliqoutInSameContainer = cProtocol.getAliquotInSameContainer();
 		}
 		...
 		//this.consentWaived = cProtocol.getConsentsWaived();
     ...
     private void setRemoteData(final CollectionProtocol collectionProtocol)
     {
         if (!CommonUtilities.isNull(collectionProtocol.getRemoteManagedFlag()))     {
         	remoteManagedFlag = collectionProtocol.getRemoteManagedFlag().booleanValue();
         }
         if (!CommonUtilities.isNull(collectionProtocol.getDirtyEditFlag()))     {
         	dirtyEditFlag = collectionProtocol.getDirtyEditFlag().booleanValue();
         }
         if (!CommonUtilities.isNull(collectionProtocol.getRemoteId()))     {
         	remoteId = collectionProtocol.getRemoteId().longValue();
         }
     }
