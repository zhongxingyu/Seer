 ...
 public class EnrollmentAlertServiceTest {
     ...
     public void shouldScheduleOneRepeatJobForEachAlertInTheFirstMilestone() {
         ...
         milestone.addAlert(WindowName.due, new Alert(new WallTime(0, null), new WallTime(dueAlert20Weeks, WallTimeUnit.Week), 2, 1));
     ...
     public void shouldNotScheduleJobsInThePast() {
         ...
         schedule.addMilestones(milestone);
         when(allTrackedSchedules.getByName("my_schedule")).thenReturn(schedule);
         Enrollment enrollment = new Enrollment("entity_1", "my_schedule", milestone.getName(), daysAgo(6), daysAgo(0), new Time(8, 10));
