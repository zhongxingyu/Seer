 /*
 * $Id: MeetingFeeBusinessBean.java,v 1.13 2005/02/18 14:50:02 laddi Exp $
 		...
 		if (email != null) {
 			...
 			try {
 				...
 				while (iter.hasNext()) {
 					...
 					participants.append("\t").append(hours).append(":").append(minutes == 0 ? "00" : String.valueOf(minutes)).append("\t").append(amount);
 					if (iter.hasNext()) {
 						participants.append("\n");
 					}
 				}
