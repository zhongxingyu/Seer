 		...
 		public void run()
 		{
 			...
 			try
 			{
 				...
 				if(task.exportOVFTask != null)
 				{
 					...
 					try
 					{
						ExportVMResponse expvm = vcli.exportvm(task.vmName);
						String baseName = (task.exportOVFTask.name.equals("") ? task.vmName : task.exportOVFTask.name);
