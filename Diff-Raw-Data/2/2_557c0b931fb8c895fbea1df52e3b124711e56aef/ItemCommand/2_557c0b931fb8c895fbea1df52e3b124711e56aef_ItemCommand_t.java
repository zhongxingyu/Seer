 ...
 public class ItemCommand extends MasterCommand {
     ...
     public void exec(CommandSender sender, String commandName, String[] args, Player player, boolean isPlayer) {
         if (isPlayer) {
            ...
            player.sendMessage(ChatColor.YELLOW + "You've been given " + ChatColor.AQUA + itemCount + " " + ChatColor.GOLD + ChatColor.BOLD + (type != null && type.getName() != null ? type.getName().toLowerCase() : itemMaterial.toString().toLowerCase().replace("_", " ")));
             //Log the spawning
