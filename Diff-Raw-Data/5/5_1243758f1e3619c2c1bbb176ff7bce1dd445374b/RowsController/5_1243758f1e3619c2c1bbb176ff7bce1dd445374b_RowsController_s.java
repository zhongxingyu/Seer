 ...
 public class RowsController extends JSONController {
 	 ...
 	 */
	@RequestMapping(value = "/api/rows/ringings", method = RequestMethod.GET, produces = "application/json")
 	@ResponseBody
 	 ...
 	 */
	@RequestMapping(value = "/api/rows/controls", method = RequestMethod.GET, produces = "application/json")
 	@ResponseBody
