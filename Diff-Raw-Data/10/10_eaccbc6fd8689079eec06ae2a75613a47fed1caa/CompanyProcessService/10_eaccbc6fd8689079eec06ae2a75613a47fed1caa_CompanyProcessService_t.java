 ...
 import org.eclipse.scout.tutorial.jaxws.server.services.ws.consumer.StockQuoteWebServiceClient;
 ...
 public class CompanyProcessService extends AbstractService implements ICompanyProcessService {
   ...
   public CompanyFormData load(CompanyFormData formData) throws ProcessingException {
     ...
     StockQuoteWebServiceClient service = SERVICES.getService(StockQuoteWebServiceClient.class);
