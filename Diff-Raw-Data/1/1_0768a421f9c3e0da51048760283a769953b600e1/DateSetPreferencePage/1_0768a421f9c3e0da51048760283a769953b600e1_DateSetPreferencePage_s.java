 		...
 		implements IWorkbenchPreferencePage
 {
 	...
 	private void initializeSchemaPrefetchConfig( )
 	{
 		if ( JdbcPlugin.getDefault( )
 				.getPluginPreferences( ).contains( SCHEMAS_PREFETCH_CONFIG ) )
 		{
 			String selection = JdbcPlugin.getDefault( )
 					.getPluginPreferences( )
 					.getString( SCHEMAS_PREFETCH_CONFIG );
 			
 			schemasPrefetchConfigCheckbox.setSelection( selection.equals( ENABLED )
 					? true : false );
 		}	
 		else
 		{
 			JdbcPlugin.getDefault( )
 			.getPluginPreferences( ).setValue( SCHEMAS_PREFETCH_CONFIG, ENABLED );
