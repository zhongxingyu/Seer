 ...
 public interface IMarker extends IAdaptable {
 	...
 	/**
 	 * Generated by attribute.  A string attribute that can be used by tools that
 	 * generate markers to indicate who it was generated by. Use of this attribute
 	 ...
 	 * can use in tracking down problems with markers.
 	 * 
 	 * @see #getAttribute(String, String)
 	 * @since 3.3
