 	...
 	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
 		...
 		if (submission != null) {
			...
			if ("[A-Za-z0-9 _-]+\\.(xmi|zargo|png)".equals(task.getFilenameRegexp())) {
				...
				out.println("if (!navigator.javaEnabled() || document.applets[0].Version < 1.4){ document.write(\"Sie bentigen mindestens Java 1.6 (JRE), um diese Funktion nutzen zu knnen. <a href=\"http://www.java.com/\">Download</a>\");");
 			}
