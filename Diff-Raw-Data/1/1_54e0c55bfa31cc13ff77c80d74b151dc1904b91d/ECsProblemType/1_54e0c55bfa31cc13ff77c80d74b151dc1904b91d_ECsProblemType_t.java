 ...
 public enum ECsProblemType {
 	...
 	INVALID_ESCAPE_IN_CS_STRING(CsEProblemType.ERROR),
 	INVALID_GEN_MODEL(CsEProblemType.ERROR),
 	INVALID_OPERATOR_ANNOTATION(CsEProblemType.ERROR),
 	...
 	TOKEN_SPACE_VALUE_MUST_BE_INTEGER(CsEProblemType.ERROR), 
 	TOKEN_SPACE_VALUE_MUST_BE_POSITIVE_INTEGER(CsEProblemType.ERROR),
