 ...
 /**
  * Default implementation of the DiscoveryStrategy abstract class. The annotated bean discovery mode is not supported, since the scanning of the whole classpath
  * would be too heavy.
  */
