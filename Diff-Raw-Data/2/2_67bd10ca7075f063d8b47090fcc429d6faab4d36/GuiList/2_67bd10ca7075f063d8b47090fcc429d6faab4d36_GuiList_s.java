 ...
 public class GuiList extends GuiScreen {
 	...
 	public void drawScreen(int i, int j, float k) {
		...
		String title = StatCollector.translateToLocal("tof.setting")+StatCollector.translateToLocal(this.targetid==1?"enchantment.lootBonusDigger":"enchantment.untouching");
