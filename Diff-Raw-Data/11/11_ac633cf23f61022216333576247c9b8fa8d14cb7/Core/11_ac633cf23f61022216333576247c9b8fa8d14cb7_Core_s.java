 ...
 public class Core {
     ...
     public Player search_won() {
         for (int i = 0; i < 3; i++)
            if (field.get_field(0, i) == field.get_field(1, i) && field.get_field(0, i) == field.get_field(2, i))
                 return field.get_field(0, i);
         for (int i = 0; i < 3; i++)
            if (field.get_field(i, 0) == field.get_field(i, 1) && field.get_field(i, 0) == field.get_field(i, 2))
                 return field.get_field(i, 0);
        if (field.get_field(0, 0) == field.get_field(1, 1) && field.get_field(0, 0) == field.get_field(2, 2))
             return field.get_field(0, 0);
        if (field.get_field(2, 0) == field.get_field(1, 1) && field.get_field(2, 0) == field.get_field(0, 2))
