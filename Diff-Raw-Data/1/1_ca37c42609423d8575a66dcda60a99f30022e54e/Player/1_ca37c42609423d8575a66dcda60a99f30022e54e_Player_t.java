 ...
 public class Player implements Actor {
 	 ...
 	 * @effect 	Add the given item to the current location of this player
 	 ...
 	 * 
 	 * @effect	The player has recieved damage.
 	 ...
 	 * @effect	If the player has no actions left after doing the action, check if the turn changes.
 	 * 			| if getActionsLeft <= 0 then
 	 ...
 	 * @effect	Set the action damage to zero.
 	 * 			| setActionDamage(0)
 	 */
