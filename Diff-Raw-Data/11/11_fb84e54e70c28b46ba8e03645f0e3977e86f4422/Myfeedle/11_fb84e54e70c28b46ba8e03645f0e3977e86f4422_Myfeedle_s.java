 ...
 public class Myfeedle {
 
     private static final String TAG = "Myfeedle";
     ...
     public static final String ACTION_REFRESH = "com.shafiq.myfeedle.Myfeedle.REFRESH";
     protected static final String ACTION_PAGE_UP = "com.shafiq.myfeedle.Myfeedle.PAGE_UP";
     protected static final String ACTION_PAGE_DOWN = "com.shafiq.myfeedle.Myfeedle.PAGE_DOWN";
     public static final String ACTION_ON_CLICK = "com.shafiq.myfeedle.Myfeedle.ON_CLICK";
     protected static final String ACTION_UPLOAD = "com.shafiq.myfeedle.Myfeedle.UPLOAD";
     protected static final String SMS_RECEIVED = "android.provider.Telephony.SMS_RECEIVED";
     protected static final String EXTRA_ACCOUNT_ID = "com.shafiq.myfeedle.Myfeedle.ACCOUNT_ID";
     public static final String EXTRA_SCROLLABLE_VERSION = "com.shafiq.myfeedle.Myfeedle.SCROLLABLE_VERSION";
    ...
    protected static final int[] map_icons = new int[]{R.drawable.twitter, R.drawable.facebook, R.drawable.foursquare, R.drawable.linkedin, R.drawable.sms, R.drawable.rss, R.drawable.googleplus, R.drawable.buzz};
     ...
     protected static final String TWITTER_RETWEET = "%s1.1/statuses/retweet/%s.json";
     ...
     protected static final String TWITTER_MENTIONS = "%s1.1/statuses/mentions.json%s";
     ...
     protected static final String GOOGLEPLUS_AUTHORIZE = "https://accounts.google.com/o/oauth2/auth?client_id=%s&redirect_uri=%s&scope=https://www.googleapis.com/auth/plus.login&response_type=code";
     ...
     public static String getAuthority(Context context) {
         return !context.getPackageName().toLowerCase().contains(PRO) ? MyfeedleProvider.AUTHORITY : MyfeedleProvider.PRO_AUTHORITY;
     }
     ...
     public static final class Accounts implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/accounts");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.accounts";
     ...
     public static final class Widget_accounts implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/widget_accounts");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.widget_accounts";
     ...
     public static final class Widget_accounts_view implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/widget_accounts_view");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.widget_accounts_view";
     ...
     public static final class Widgets implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/widgets");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.widgets";
     ...
     public static final class Widgets_settings implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/widgets_settings");
         }
 
         public static Uri getDistinctContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/distinct_widgets_settings");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.widgets_settings";
     ...
     public static final class Accounts_styles implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/accounts_styles");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.accounts_styles";
     ...
     public static final class Statuses implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/statuses");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.statuses";
     ...
     public static final class Statuses_styles implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/statuses_styles");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.statuses_styles";
     ...
     public static final class Entities implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/entities");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.entities";
     ...
     public static final class Notifications implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/notifications");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.notifications";
         public static final String SID = "sid";
         public static final String ESID = "esid";
         public static final String FRIEND = "friend";
         public static final String MESSAGE = "message";
     ...
     public static final class Status_links implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/status_links");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.status_links";
     ...
     public static final class Status_images implements BaseColumns {
         ...
         public static Uri getContentUri(Context context) {
             return Uri.parse("content://" + Myfeedle.getAuthority(context) + "/status_images");
         }
 
         public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.shafiq.status_images";
         public static final String STATUS_ID = "status_id";
         public static final String IMAGE = "image";
         public static final String IMAGE_BG = "image_bg";
     ...
     protected static String getCreatedText(long epoch, boolean time24hr) {
         ...
         if ((calendar.get(Calendar.ERA) == todayCal.get(Calendar.ERA)) && (calendar.get(Calendar.YEAR) == todayCal.get(Calendar.YEAR)) && (calendar.get(Calendar.DAY_OF_YEAR) == todayCal.get(Calendar.DAY_OF_YEAR))) {
             if (time24hr) {
                 ...
                 // set am/pm
                 if (hours == 0) {
                     return String.format("%d:%02d%s", 12, calendar.get(Calendar.MINUTE), Myfeedle.AM);
                 } else if (hours < 12) {
                     return String.format("%d:%02d%s", hours, calendar.get(Calendar.MINUTE), Myfeedle.AM);
                 } else if (hours == 12) {
                     return String.format("%d:%02d%s", hours, calendar.get(Calendar.MINUTE), Myfeedle.PM);
                 } else {
                     return String.format("%d:%02d%s", hours - 12, calendar.get(Calendar.MINUTE), Myfeedle.PM);
                 }
             }
         } else {
             return String.format("%s %d", Myfeedle.MONTHS[calendar.get(Calendar.MONTH)], calendar.get(Calendar.DATE));
         }
     }
     ...
     protected static int[] getWidgets(Context context, AppWidgetManager awm) {
         ...
         Class[] clazzes = new Class[]{MyfeedleWidget_2x2.class, MyfeedleWidget_2x3.class, MyfeedleWidget_2x4.class, MyfeedleWidget_4x2.class, MyfeedleWidget_4x3.class, MyfeedleWidget_4x4.class};
         for (Class clazz : clazzes) {
             widgets = Myfeedle.arrayCat(widgets, awm.getAppWidgetIds(new ComponentName(context, getPackageClass(context, clazz))));
         }
         return widgets;
     }
