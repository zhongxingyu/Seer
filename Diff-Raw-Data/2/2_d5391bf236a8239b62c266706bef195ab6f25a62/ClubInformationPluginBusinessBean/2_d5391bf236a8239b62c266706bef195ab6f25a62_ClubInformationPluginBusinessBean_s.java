 ...
 public class ClubInformationPluginBusinessBean extends IBOServiceBean implements ClubInformationPluginBusiness,
 	...
 	protected Group addClubCollectionGroupToLeague(Group league) throws RemoteException, CreateException {
 		...
 		try {
 			...
 			if(!clubColl.getName().equalsIgnoreCase("Aildarflg")){
 				clubColl.setName("Aildarflg");
 				clubColl.store();	
 			}
 			return clubColl;
 		}
 			...
 			clubColl = getGroupBusiness().createGroupUnder("Aildarflg",null,IWMemberConstants.GROUP_TYPE_LEAGUE_CLUB_COLLECTION,league);
