 ...
 * @author missi
 */
public abstract class AbstractMatrix3D extends AbstractMatrixForFeature
{
	...
	{
		int secondAnnotationStride = 1;
		int firstAnnotationStride = maxAnnotations;
		int firstNodeStride = firstAnnotationStride * maxAnnotations;
		setUp(2, maxNodes, maxAnnotations, firstNodeStride, firstAnnotationStride,
				secondAnnotationStride);
	}
