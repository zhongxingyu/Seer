 ...
 public class JabaWizard extends Wizard {
     ...
     protected JMTToolBar makeToolbar() {
         ...
         AbstractJMTAction[] actions = {FILE_NEW,FILE_OPEN, FILE_SAVE,null, ACTION_SOLVE,
         ...
         String[] htext = {"Creates a new model","Opens a saved model", "Saves the current model",
                           "Solves the current model", "Import current model to JSIMwiz to solve it with the simulator", "Randomize model data", "Show help"};
     ...
     private JMTMenuBar makeMenubar(){
         ...
         AbstractJMTAction[] menuItems = new AbstractJMTAction[]{
                 ...
                 new MenuAction("Action", new AbstractJMTAction[] {ACTION_SOLVE, ACTION_RANDOMIZE_MODEL, null, SWITCH_TO_SIMULATOR, null, ACTION_NEXT, ACTION_PREV}),
     ...
     private class DrawSolPanel extends WizardPanel{
         ...
         JLabel replace = new JLabel(
                 "<html><body align=\"center\", valign=\"top\"><font size=\"4\"><b>Results</b>"+
