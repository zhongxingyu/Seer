 ...
 public class BukkitBlock implements Block {
 	...
 	private static final BiomeGenBase BiomeGenBase_MAPPING[];
 	...
 	public static BiomeGenBase biomeToBiomeGenBase(Biome bio) {
 		...
 		return BiomeGenBase_MAPPING[bio.ordinal()];
 	}
 	...
 	static {
 		...
 		for (int i = 0; i < BIOME_MAPPING.length; i++) {
 			...
 			if (BIOME_MAPPING[i] != null) {  /* Build reverse mapping for setBiome */
 				BiomeGenBase_MAPPING[BIOME_MAPPING[i].ordinal()] = BiomeGenBase.biomeList[i];
 			}
 		}
 	}
