 ...
 * @version $Id: GridCoverageReader.java,v 1.7 2003/01/12 16:48:39 desruisseaux Exp $
 ...
 public abstract class GridCoverageReader {
     ...
     * {@link #reset}, then it will queries @link #getImageReaders} for
     ...
     /**
      * Vrifie si l'index de l'image est dans la plage des valeurs
      * autorises. L'index maximal autoris est obtenu en appelant
      * <code>{@link #getNumImages getNumImages}(false)</code>.
      *
      * @param  imageIndex Index dont on veut vrifier la validit.
      * @throws IndexOutOfBoundsException si l'index spcifi n'est pas valide.
      * @throws IOException si l'opration a choue  cause d'une erreur d'entrs/sorties.
      */
