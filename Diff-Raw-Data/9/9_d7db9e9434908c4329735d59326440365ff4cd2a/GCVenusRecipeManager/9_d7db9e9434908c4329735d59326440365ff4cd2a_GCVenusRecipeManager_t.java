 ...
 //        RecipeUtil.addRecipe(new ItemStack(GCVenusItems.venusBattery, 1, GCVenusItems.venusBattery.getMaxDamage()), new Object[] { " T ", "TRT", "TCT", 'T', "plateSulfer", 'R', Item.redstone, 'C', Item.coal });
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(GCVenusItems.venusItemBasic, 9, 3), new ItemStack(StarcraftVenus.VenusRedGemBlock, 1, 0));
         ...
         GameRegistry.addShapelessRecipe(new ItemStack(StarcraftVenus.VenusBasalt, 1, 0),  new ItemStack(GCVenusItems.venusItemBasic, 1, 7), new ItemStack(GCVenusItems.venusItemBasic, 1, 7), new ItemStack(GCVenusItems.venusItemBasic, 1, 7), new ItemStack(GCVenusItems.venusItemBasic, 1, 7));
         
         GameRegistry.addShapelessRecipe(new ItemStack(StarcraftVenus.VenusHalfBasalt, 6, 0), new ItemStack(StarcraftVenus.VenusBasalt, 1, 0), new ItemStack(StarcraftVenus.VenusBasalt, 1, 0), new ItemStack(StarcraftVenus.VenusBasalt, 1, 0));
 ...
 //        CompressorRecipes.addShapelessRecipe(new ItemStack(GCVenusItems.venusItemBasic, 1, 2), "ingotGem", "ingotGem");
         ...
         // Smelting
         FurnaceRecipes.smelting().addSmelting(StarcraftVenus.VenusSulferOre.blockID, 0, new ItemStack(GCVenusItems.venusItemBasic, 1, 1), 0.2F);
         FurnaceRecipes.smelting().addSmelting(StarcraftVenus.VenusCoalOre.blockID, 0, new ItemStack(Item.coal), 0.2F);
         FurnaceRecipes.smelting().addSmelting(StarcraftVenus.VenusIronOre.blockID, 0, new ItemStack(Item.ingotIron), 0.2F);
         FurnaceRecipes.smelting().addSmelting(StarcraftVenus.VenusCopperOre.blockID, 0, OreDictionary.getOres("ingotCopper").get(0), 0.2F);
         FurnaceRecipes.smelting().addSmelting(StarcraftVenus.VenusTinOre.blockID, 0, OreDictionary.getOres("ingotTin").get(0), 0.2F);
         FurnaceRecipes.smelting().addSmelting(StarcraftVenus.VenusRedGemOre.blockID, 0, new ItemStack(GCVenusItems.venusItemBasic, 1, 3), 0.2F);
