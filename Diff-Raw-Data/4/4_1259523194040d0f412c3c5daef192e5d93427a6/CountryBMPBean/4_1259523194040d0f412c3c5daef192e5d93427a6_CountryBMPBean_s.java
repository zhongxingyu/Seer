 ...
 public class CountryBMPBean extends GenericEntity implements Country{
   ...
   public void initializeAttributes() {
     ...
     this.addAttribute(getColumnNameDescription(),"Lsing",true,true,String.class,500);
     this.addAttribute(getColumnNameIsoAbbreviation(),"ISO skammstfun",true,true,String.class,10);
