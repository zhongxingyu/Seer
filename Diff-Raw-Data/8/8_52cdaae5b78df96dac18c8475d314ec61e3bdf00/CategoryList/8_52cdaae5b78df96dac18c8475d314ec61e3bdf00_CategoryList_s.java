 ...
 * @version $Id: CategoryList.java,v 1.8 2003/02/14 23:38:12 desruisseaux Exp $
 ...
 class CategoryList extends AbstractList implements MathTransform1D, Comparator, Serializable
 {
     ...
     /**
      * Compare deux valeurs de type <code>double</code>. Cette mthode
      * est similaire  {@link Double#compare(double,double)}, except
      * qu'elle ordonne aussi les diffrentes valeurs NaN.
      */
     ...
     /**
      * Vrifie si le tableau de catgories spcifi est bien en ordre croissant.
      * La comparaison ne tient pas compte des valeurs <code>NaN</code>. Cette
      * mthode n'est utilise que pour les <code>assert</code>.
      */
     ...
     /**
      * Effectue une recherche bi-linaire de la valeur spcifie. Cette
      * mthode est semblable  {@link Arrays#binarySearch(double[],double)},
      * except qu'elle peut distinguer diffrentes valeurs de NaN.
      *
     ...
     public final Category getCategory(final double sample) {
         /*
          * Recherche  quelle catgorie pourrait appartenir la valeur.
          * Note: Les valeurs 'NaN' sont  la fin du tableau 'values'. Donc:
          *
          * 1) Si 'value' est NaN,  alors 'i' pointera forcment sur une catgorie NaN.
          * 2) Si 'value' est rel, alors 'i' peut pointer sur une des catgories de
          *    valeurs rels ou sur la premire catgorie de NaN.
          */
     ...
     final String toString(final Object owner) {
         ...
         /*
          * Ecrit la liste des catgories en dessous.
          */
         for (int i=0; i<categories.length; i++) {
             buffer.append("   ");
