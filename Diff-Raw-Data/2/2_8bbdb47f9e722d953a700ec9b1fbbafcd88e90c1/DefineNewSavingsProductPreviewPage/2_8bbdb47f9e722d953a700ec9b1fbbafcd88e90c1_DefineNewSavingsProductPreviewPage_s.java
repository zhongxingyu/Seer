 ...
 public class DefineNewSavingsProductPreviewPage extends MifosPage {
     public DefineNewSavingsProductPreviewPage(Selenium selenium) {
         super(selenium);
     }
     ...
     public DefineNewSavingsProductConfirmationPage submitAndNavigateToDefineNewSavingsProductConfirmationPage() {
         ...
         waitForPageToLoad();
         return new DefineNewSavingsProductConfirmationPage(selenium);
     }
