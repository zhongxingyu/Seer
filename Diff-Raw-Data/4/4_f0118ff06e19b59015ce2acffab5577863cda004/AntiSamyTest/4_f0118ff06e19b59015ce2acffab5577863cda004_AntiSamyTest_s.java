 ...
 public class AntiSamyTest extends TestCase {
 	...
 	protected void setUp() throws Exception {
 		...
 		policy = Policy.getInstance(
 		        getClass().getResourceAsStream("/antisamy.xml"));
 ...
 //		}
     ...
     public void testPreviousBugs() {
     	...
     	try {
 			...
 			Policy mySpacePolicy = Policy.getInstance(
 			        getClass().getResourceAsStream("/antisamy-myspace.xml"));
 			CleanResults cr = as.scan(dirty, mySpacePolicy);
 			assertNotNull( cr.getCleanHTML() ) ;
 				
 			Policy ebayPolicy = Policy.getInstance(
 			        getClass().getResourceAsStream("/antisamy-ebay.xml"));
 			cr = as.scan(dirty, ebayPolicy);
 			assertNotNull( cr.getCleanHTML() ) ;
 			
 			Policy slashdotPolicy = Policy.getInstance(
