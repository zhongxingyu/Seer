 ...
 * @version $Id: ChildCareCustomerApplicationTable.java,v 1.109 2005/11/30 14:18:13 dainis Exp $
  * @since 12.2.2003 
  */
 		...
 		while (i.hasNext()) {
 			...
 			if (status.isDefined()) {
 				...
 				if (status.isAccepted()) {
 					...
 					subject,
 					localize("ccot_accept_msg1", "Vrdnadshavare fr")
 						+ child.getName()
 						+ ", "
 						+ child.getPersonalID()
 						+ " "
 					...
 					getChildCareBusiness(iwc).sendMessageToProvider(
 											application,
 											subject,
 											localize("ccot_new_date_msg1", "Vrdnadshavare fr")
 												+ " "
 												+ child.getName()
 												+ ", "
 												+ child.getPersonalID()
 					...
 					getChildCareBusiness(iwc).sendMessageToProvider(
 						application,
 						subject,
 						localize("ccot_reject_msg1", "Vrdnadshavare fr")
 							+ " "
 							+ child.getName()
 							+ ", "
 							+ child.getPersonalID()
