 ...
 public class Dashboard extends Activity implements TrackServiceListener {
 	...
 	protected void onCreate(Bundle savedInstanceState) {
 		...
 		trackServiceConnection = new TrackServiceConnection(this, new Intent(this, TrackService.class), this);
 	}
 	...
 	static public void updateButtons(Context context) {
 		...
 		if (null != MapViewActivity.start)
 			MapViewActivity.start.setVisibility(Mode.STOPPED == mode ? View.VISIBLE
 			    : View.GONE);
 		...
 		if (null != dashboardStart)
 			dashboardStart.setVisibility(Mode.STOPPED == mode ? View.VISIBLE
 			    : View.GONE);
