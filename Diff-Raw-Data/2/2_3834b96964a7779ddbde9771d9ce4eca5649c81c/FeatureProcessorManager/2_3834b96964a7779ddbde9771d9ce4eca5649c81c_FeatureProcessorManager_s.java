     ...
     public FeatureProcessorManager()
     {
         ...
         try{
             ...
             String[] pos = {"0", "NN", "NE", "NNm", "ADJA", "ADJD", "CARD",
                     "CARDj", "ORD", "ITJ", "PDS", "PPOSS", "TRUNC",
                     "ADV", "ADVq", "ADVf", "APPR", "APPRbis", "APPRART",
                     "APPO", "APZR", "ART", "ARTdna", "ARTg", "ARTngd",
                     "FM", "KOUI", "KOUS", "KON", "KOKOM", "KOKOMa",
                     "PDAT", "PIS", "PIAT", "PIDAT", "PIDAT2", "PPER",
                     "PPOSAT", "PRELS", "PRELAT", "PRF", "PWS", "PWAT",
                     "PWAV", "PAV", "PTKZU", "PTKNEG", "PTKVZ", "PTKANT",
                     "PTKA", "SGML", "SPELL",
                     "VVFIN", "VVIMP", "VVINF", "VVIZU", "VVPP", "VV",
            ...
            AllophoneSet allophoneSet = AllophoneSet.getAllophoneSet(MaryProperties.needFilename("german.allophoneset"));
             ...
             String[] phoneClasses = new String[] {
                     ...
                     "c_glottal", "c_uvular", "v_i", "v_u", "v_O",
                     "v_E", "v_EI", "v_@", "v_aU", "v_6", "v_~",
                     "v_a", "v_y", "v_2", "v_e", "v_o", "v_9",                        
                     "v_OY", "v_Ya", "v_aI" 
             };
            ...
            addFeatureProcessor(new MaryLanguageFeatureProcessors.PhoneFeature(allophoneSet,
                    "next_wordbegin_cplace", "cplace", cplaceValues, "_", firstSegNextWord));
            addFeatureProcessor(new MaryLanguageFeatureProcessors.PhoneFeature(allophoneSet,
                    "next_wordbegin_ctype", "ctype", phonefeatures2values.get("ctype"), "_", firstSegNextWord));
 /*
