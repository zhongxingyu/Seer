 /*
  oCpyright (c) 2009-2013 Olivier Chafik, All Rights Reserved
 ...
 public class Result extends Scanner {
     ...
     public void init() {
         declarationsConverter = config.runtime.createDeclarationsConverter(this);
         globalsGenerator = config.runtime.createGlobalsGenerator(this);
         typeConverter = config.runtime.createTypeConversion(this);
