 ...
 public class TweetObjectParserTest {
 	...
 	public void testTransform() throws ParseException {
		...
		DBObject expected = (DBObject) JSON.parse("{ 'created_at': null, 'id': 294869617401282560, 'text': '???????? ???? - ???????? ??????????! ?????????????, ? ???? ??? ???????! http://t.co/JnTkBSVC #iPad #iPa dGames #GameInsight', 'user': { 'id': 477459620, 'screen_name': 'yarem27', 'lang': 'ru' }, 'retweeted': false, 'lang': 'ru', 'urls': [ 'http://gigam.es/tw_psAlbion' ], 'hashtags': [ 'iPad', 'iPadGames' , 'GameInsight' ] }");
