 ...
 public class EventSetImpl extends MirrorImpl implements EventSet {
 	...
 	public int suspendPolicy() {
 		switch(fSuspendPolicy) {
 			...
 			default:
 				throw new InternalException(EventMessages.getString("EventSetImpl.Invalid_suspend_policy_encountered___1") + fSuspendPolicy); //$NON-NLS-1$
 		}
 	}
	...
	public Object toArray()[] {
 	...
 	public boolean add(Object arg1) {
 		throw new UnsupportedOperationException(EventMessages.getString("EventSetImpl.EventSets_are_unmodifiable_3")); //$NON-NLS-1$
 	}
