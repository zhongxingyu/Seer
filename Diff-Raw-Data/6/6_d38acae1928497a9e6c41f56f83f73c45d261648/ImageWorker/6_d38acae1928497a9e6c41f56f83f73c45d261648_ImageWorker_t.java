 ...
 import com.andreaszeiser.bob.utils.LogUtils;
 import com.andreaszeiser.bob.utils.UIUtils;
 ...
 public abstract class ImageWorker {
 	...
 	/**
 	 * Shortcut method for
 	 * {@link #loadImage(Object, ImageView, Bitmap, ImageWorkerListener)}.
 	 * 
 	 * @param data
 	 * @param imageView
 	 * @param loadingBitmap
 	...
 	protected void loadImage(Object data, ImageView imageView,
 		...
 		loadImage(data, imageView, loadingBitmap, null);
 	}
 	 ...
 	 *            The ImageView to bind the downloaded image to.
 	 * @param loadingBitmap
 	 *            The placeholder bitmap while the image loads.
 	 */
 	protected void loadImage(Object data, ImageView imageView,
 			Bitmap loadingBitmap, final ImageWorkerListener listener) {
 		Bitmap bitmap = null;
 		...
 		if (bitmap != null) {
 			...
 			if (listener != null) {
 				if (listener.onImageLoaded(imageView, bitmap)) {
 					return;
 				}
 			}
 	...
 	public static boolean cancelPotentialWork(Object data, ImageView imageView) {
 		...
 		if (bitmapWorkerTask != null) {
 			...
 			if (bitmapData == null || !bitmapData.equals(data)) {
 				bitmapWorkerTask.cancel(true);
 				LogUtils.v(TAG, "cancelPotentialWork - cancelled work for "
 						+ data);
 			} else {
 	...
 	private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
 		...
 		private final ImageWorkerListener mImageWorkerListener;
 
 		public BitmapWorkerTask(ImageView imageView,
 				ImageWorkerListener listener) {
 		...
 		protected void onPostExecute(Bitmap bitmap) {
 			...
 			if (bitmap != null && imageView != null) {
 				if (mImageWorkerListener != null
 						&& mImageWorkerListener
 								.onImageLoaded(imageView, bitmap)) {
 					return;
 				}
