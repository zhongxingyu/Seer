 ...
 public class ExpressionLookupTaskR extends AnalysisTaskR {
 
 	private ExpressionLookupResult result;
 	
 	private static Logger logger = Logger.getLogger(ExpressionLookupTaskR.class);
 	private ExpressionLookupRequest lookupRequest;
 
 	
 	public ExpressionLookupTaskR(AnalysisRequest request) {
 		super(request);
 	}
 
 	public ExpressionLookupTaskR(AnalysisRequest request, boolean debugRcommands) {
 	...
 	@Override
 	public void run() {
 		lookupRequest = (ExpressionLookupRequest) getRequest();
 		result = new ExpressionLookupResult(getRequest().getSessionId(), getRequest().getTaskId());
