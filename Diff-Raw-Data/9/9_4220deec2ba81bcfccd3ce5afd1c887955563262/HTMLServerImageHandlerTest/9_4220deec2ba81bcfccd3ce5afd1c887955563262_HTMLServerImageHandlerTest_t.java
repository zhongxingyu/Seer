 ...
 public class HTMLServerImageHandlerTest extends EngineCase
 {
 	...
 	/**
 	 * API test on HTMLServerImageHandler.onDocImage( ) method. This method is
 	...
 	/**
 	 * API test on HTMLServerImageHandler.onURLImage( ) method. This test get
 	...
 	private boolean isValid( String path )
 	{
 		...
 		if ( path.startsWith( URL_PREFIXS[0] )
 				|| path.startsWith( URL_PREFIXS[1] ) )
 		{
 			return true;
 		}
