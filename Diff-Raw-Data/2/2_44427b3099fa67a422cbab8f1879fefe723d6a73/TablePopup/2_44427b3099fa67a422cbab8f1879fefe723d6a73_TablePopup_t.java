 ...
 public class TablePopup extends javax.swing.JFrame {
    ...
    private MainController cont;
      ...
      */
     public TablePopup(MainScreen m, MainController c, int b, int cursor) {
         main = m;
         cont = c;
         buffer = b;
         curs = cursor;
     ...
     private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        cont.insert(buffer, curs, Integer.parseInt(jTextField1.getText()), Integer.parseInt(jTextField2.getText()));
         main.updateText();
         this.dispose();
     ...
     public static void main(String args[]) {
         ...
         java.awt.EventQueue.invokeLater(new Runnable() {
             public void run() {
                 new TablePopup(null,null,0,0).setVisible(true);
             }
         });
     }
