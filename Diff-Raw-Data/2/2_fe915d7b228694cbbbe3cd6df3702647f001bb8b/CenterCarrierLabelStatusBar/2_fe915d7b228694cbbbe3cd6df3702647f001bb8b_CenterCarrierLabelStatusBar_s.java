  ...
  * SPN if available.
  */
 public class CenterCarrierLabelStatusBar extends TextView {
     ...
     private boolean mStatusBarCarrierCenter;
     ...
     public CenterCarrierLabelStatusBar(Context context) {
         this(context, null);
     }
 
     public CenterCarrierLabelStatusBar(Context context, AttributeSet attrs) {
         this(context, attrs, 0);
     }
 
     public CenterCarrierLabelStatusBar(Context context, AttributeSet attrs, int defStyle) {
