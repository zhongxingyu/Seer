  ...
  * }<br/></code>
  */
 //FIXME Remove this class and fix rules when wonder changes land on master
 public class R2DDelayedNonNullConditionalAssignment extends ERDDelayedAssignment {
 	/**
 	...
 	public static Object decodeWithKeyValueUnarchiver(EOKeyValueUnarchiver eokeyvalueunarchiver) {
 		return new R2DDelayedNonNullConditionalAssignment(eokeyvalueunarchiver);
 	}
 	 ...
 	 */
 	public R2DDelayedNonNullConditionalAssignment(EOKeyValueUnarchiver u) {
 		super(u);
 	}
 	 ...
 	 *            of the assignment
 	 */
 	public R2DDelayedNonNullConditionalAssignment(String key, Object value) {
 		super(key, value);
 	}
