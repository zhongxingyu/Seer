  ...
  * XML communication API. This mediator is designed to be referrenced by the
  * synapse.xml.
  * <p>
  * A sample synapse.xml file is found in the examples folder.
  * @see AxiomMediator
  */
 public class XMLMediator implements SynapseEsperMediator {
     ...
     public String getType() {
            return XMLMediator.class.getName();
     }
 }
