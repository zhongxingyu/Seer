 ...
 * @version $Revision: 1.27 $
 ...
 public class PostingParametersBMPBean extends GenericEntity implements PostingParameters {
 	...
 	public void initializeAttributes() {
 		...
 		addAttribute(COLUMN_CHANGED_SIGN, "ndrings sign", true, true, String.class);
 		...
 		addAttribute(COLUMN_COMMUNE_BELONGING_ID, "Kommuntillhrighet", true, true, 
 						Integer.class, "many-to-one", CommuneBelongingType.class);
 
 		addAttribute(COLUMN_SCHOOL_YEAR1_ID, "Skolr 1", true, true, 
 						Integer.class, "many-to-one", SchoolYear.class);
 
 		addAttribute(COLUMN_SCHOOL_YEAR2_ID, "Skolr 2", true, true, 
 						Integer.class, "many-to-one", SchoolYear.class);
