  ...
  * FtpCommandCode.java goldengate.ftp.core.command GoldenGateFtp
  * frederic
  */
 ...
 /**
  * This class must rassemble all the commands that could be implemented.
  * The comment says the object of the command and the kind of returned codes that could follow this command.<br><br> 
  * Command structure:<br>
  * Main class<br>
  * Previous Valid Command (null means all are valid)<br> 
  * Next Valids Commands (none means all are valid)<br>
  * 
  * @author frederic
  * goldengate.ftp.core.command FtpCommandCode
  * 
  */
 public enum FtpCommandCode {
 //	 XXX CONNECTION
 			/**
 			 * Command to simulate the begining of a connection in order to force the authentification step.<br> 
 			 * 
 			 * 
 			 * 120->220<br>
                220<br>
                421<br>
 			 */
 	Connection (ConnectionCommand.class,
 			null,
 			goldengate.ftp.core.command.access.USER.class),
 // XXX Commande de contrle d'accs
 			/**
 			 ...
 			 * 230<br>
                   ...
                   331, 332<br>
 			 */
 	USER 	(goldengate.ftp.core.command.access.USER.class, 
             ...
             the sensitive password information.<br>
 			 ...
 			 *  230<br>
                   ...
                   332<br>
 			 */
 	PASS 	(goldengate.ftp.core.command.access.PASS.class, 
 			null),
 			/**
             ...
             the latter case the command may arrive at any time.<br><br>
 			 ...
 			 * 230<br>
                   ...
                   500, 501, 503, 421<br>
 			 */
 	ACCT 	(goldengate.ftp.core.command.access.ACCT.class, 
 			null),
 			/**
 			 ...
 			 */
 	CWD 	(goldengate.ftp.core.command.directory.CWD.class,
 			null),
 			/**
             ...
             Appendix II for further details.<br>
 
 			 * 
 			 * 200<br>
                   500, 501, 502, 421, 530, 550<br>
 			 */
 	CDUP 	(goldengate.ftp.core.command.directory.CDUP.class,
 			null),
 			/**
             ...
             directory or other system dependent file group designator.<br><br>
 			 ...
 			 */
 			//TODO 502
 	SMNT 	(goldengate.ftp.core.command.directory.SMNT.class,
 			null),
 			/**
             ...
             expected to follow.<br><br>
             As for now, this command will not be implemented, so returns 502.<br><br>
 			 ...
 			 */
 			//TODO 502
 	REIN 	(goldengate.ftp.core.command.access.REIN.class,
 			null),
 			/**
             ...
             each, then the REIN command should be used instead of QUIT.<br><br>
 			 ...
 			 * 221<br>
                   500<br>
 			 */
 	QUIT 	(goldengate.ftp.core.command.access.QUIT.class,
 			null),
 
 //	XXX Commande de paramtres de transfert
 			/**
 ...
 <pre>
 			 ...
 			 * 200<br>
                   500, 501, 421, 530<br>
 			 */
 	PORT 	(goldengate.ftp.core.command.parameter.PORT.class,
 			null),
 			/**
             ...
             host and port address this server is listening on.<br>
 			 ...
 			 */
 	PASV 	(goldengate.ftp.core.command.parameter.PASV.class,
 			null),
 			/**
             ...
             The parameters are separated by a <code>&lt;SP&gt;</code> (Space, ASCII code
             32).<br><br>
 ...
 <pre>
 			 ...
 			 */
 	TYPE 	(goldengate.ftp.core.command.parameter.TYPE.class,
 			null),
 			/**
             The argument is a single Telnet character code specifying
             file structure described in the Section on Data
             Representation and Storage.<br><br>
 ...
 <pre>
             ...
             The default structure is File.<br>
 
 			 * 
 			 * 200<br>
                   500, 501, 504, 421, 530<br>
 			 */
 	STRU 	(goldengate.ftp.core.command.parameter.STRU.class,
 			null),
 			/**
            The argument is a single Telnet character code specifying
             the data transfer modes described in the Section on
             Transmission Modes.<br><br>
 ...
 <pre>
 			 ...
 			 * 200<br>
                   500, 501, 504, 421, 530<br>
 			 */
 	MODE 	(goldengate.ftp.core.command.parameter.MODE.class,
 			null),
 
 //	XXX Commande de service FTP
 			/**
           	This command causes the server-DTP to transfer a copy of the
             file, specified in the pathname, to the server- or user-DTP
             at the other end of the data connection.  The status and
             contents of the file at the server site shall be unaffected.<br>
 			 ...
 			 * 125, 150<br>
                   ...
                   500, 501, 421, 530<br>
 			 */
 	RETR 	(goldengate.ftp.core.command.service.RETR.class,
 			null),
 			/**
             ...
             pathname does not already exist.<br>
 			 ...
 			 * 125, 150<br>
                   ...
                   500, 501, 421, 530<br>
 			 */
 	STOR 	(goldengate.ftp.core.command.service.STOR.class,
 			null),
 			/**
             This command behaves like STOR except that the resultant
             file is to be created in the current directory under a name
             unique to that directory.  The 250 Transfer Started response
             must include the name generated.<br>
 			 ...
 			 * 125, 150<br>
                   ...
                   500, 501, 421, 530<br>
 			 */
 	STOU 	(goldengate.ftp.core.command.service.STOU.class,
 			null),
 			/**
             This command causes the server-DTP to accept the data
 			 ...
 			 * 125, 150<br>
                   ...
                   500, 501, 421, 530<br>
 			 */
 	APPE 	(goldengate.ftp.core.command.service.APPE.class,
 			null),
 			/**
             ...
             Telnet characters <code>&lt;SP&gt;</code> R <code>&lt;SP&gt;</code>.  This command shall be
             followed by a STORe or APPEnd command.  The ALLO command
             should be treated as a NOOP (no operation) by those servers
             which do not require that the maximum size of the file be
             declared beforehand, and those servers interested in only
             the maximum record or page size should accept a dummy value
             in the first argument and ignore it.<br>
 			 ...
 			 * 125, 150<br>
                   ...
                   500, 501, 502, 421, 530<br>
 			 */
 	ALLO 	(goldengate.ftp.core.command.service.ALLO.class,
 			null),
 			/**
             ...
             file transfer to resume.<br><br>
 			The current implementation allows restart only on Stream
 			since others would imply to store those informations somewhere (how?).<br><br>
 			However, it could be changed if necessary by modifying the {@link FtpFile} restartMarker method.<br><br>
 			This command will accept commands of transfer parameter following since some clients do this.<br>
 			 * 
 			 * 500, 501, 502, 421, 530<br>
                   350<br>
 			 */
 	REST 	(goldengate.ftp.core.command.service.REST.class,
 			null,
 			goldengate.ftp.core.command.service.RETR.class, goldengate.ftp.core.command.service.STOR.class, goldengate.ftp.core.command.service.STOU.class, goldengate.ftp.core.command.service.APPE.class,
 			goldengate.ftp.core.command.parameter.PORT.class,goldengate.ftp.core.command.parameter.PASV.class,goldengate.ftp.core.command.parameter.TYPE.class,goldengate.ftp.core.command.parameter.STRU.class,goldengate.ftp.core.command.parameter.MODE.class),
 			/**
             This command specifies the old pathname of the file which is
             to be renamed.  This command must be immediately followed by
             a "rename to" RNTO command specifying the new file pathname.<br>
 			 ...
 			 * 450, 550<br>
                   ...
                   350<br>
 			 */
 	RNFR 	(goldengate.ftp.core.command.service.RNFR.class,
 			null,
 			goldengate.ftp.core.command.service.RNTO.class),
 			/**
             This command specifies the new pathname of the file
             specified in the immediately preceding "rename from" RNFR
 			 ...
 			 */
 	RNTO 	(goldengate.ftp.core.command.service.RNTO.class,
             ...
             or (2) the FTP service command is still in progress.<br><br>
 
                In the first case, the server closes the data connection
                (if it is open) and responds with a 226 reply, indicating
                that the abort command was successfully processed.<br><br>
 			 ...
 			 * 225, 226<br>
                   500, 501, 502, 421<br>
 			 */
 	ABOR 	(goldengate.ftp.core.command.service.ABOR.class,
 			null),
 			/**
             This command causes the file specified in the pathname to be
             deleted at the server site.  If an extra level of protection
             is desired (such as the query, "Do you really wish to
             delete?"), it should be provided by the user-FTP process.<br>
 			 ...
 			 * 250<br>
                   ...
                   500, 501, 502, 421, 530<br>
 			 */
 	DELE 	(goldengate.ftp.core.command.service.DELE.class,
 			null),
 			/**
 			 ...
 			 * 250<br>
                   500, 501, 502, 421, 530, 550<br>
 			 */
 	RMD 	(goldengate.ftp.core.command.service.RMD.class,
 			null),
 			/**
             This command causes the directory specified in the pathname
 			 ...
 			 * 257<br>
                   500, 501, 502, 421, 530, 550<br>
 			 */
 	MKD 	(goldengate.ftp.core.command.service.MKD.class,
 			null),
 			/**
 			 ...
 			 */
 	PWD 	(goldengate.ftp.core.command.service.PWD.class,
 			null),
 			/**
             ...
             in a program, but may be quite useful to a human user.<br><br>
 			 ...
 			 * 125, 150<br>
                   ...
                   500, 501, 502, 421, 530<br>
 			 */
 	LIST 	(goldengate.ftp.core.command.service.LIST.class,
 			null),
 			/**
             ...
             strings separated by <code>&lt;CRLF&gt;</code> or <code>&lt;NL&gt;</code>.  (Again the user must
             ensure that the TYPE is correct.)  This command is intended
             to return information that can be used by a program to
             further process the files automatically.  For example, in
             the implementation of a "multiple get" function.<br><br>
 			 ...
 			 * 125, 150<br>
                   ...
                   500, 501, 502, 421, 530<br>
 			 */
 	NLST 	(goldengate.ftp.core.command.service.NLST.class,
 			null),
 			/**
 			 ...
 			 * 200<br>
                   ...
                   500, 501, 530<br>
 			 */
 	SITE 	(goldengate.ftp.core.command.info.SITE.class,
 			null),
 			/**
             This command is used to find out the type of operating
             system at the server.  The reply shall have as its first
             word one of the system names listed in the current version
             of the Assigned Numbers document.<br><br>
             Returns "UNIX Type: L8".<br> 
 			 * 
 			 * 215<br>
                   500, 501, 502, 421<br>
 			 */
 	SYST 	(goldengate.ftp.core.command.info.SYST.class,
 			null),
 			/**
 			 ...
 			 * 211, 212, 213<br>
                   ...
                   500, 501, 502, 421, 530<br>
 			 */
 	STAT 	(goldengate.ftp.core.command.info.STAT.class,
 			null),
 			/**
             ...
             site-dependent parameters, e.g., in response to HELP SITE.<br>
 
 			 * 
 			 * 211, 214<br>
                   500, 501, 502, 421<br>
 			 */
 	HELP 	(goldengate.ftp.core.command.info.HELP.class,
 			null),
 			/**
 			 ...
 			 * 200<br>
                   500 421<br>
 			 */
 	NOOP 	(goldengate.ftp.core.command.info.NOOP.class,
 			null),
 ...
 // XXX RFC775
 			 ...
 			 * 250<br>
                   500, 501, 502, 421, 530, 550<br>
 			 */
 	XCWD 	(goldengate.ftp.core.command.rfc775.XCWD.class,
 			null),
 			/**
 			 * Change to the parent of  the  current  working
 			 directory. Same as CDUP.<br>
 
 			 * 
 			 * 200<br>
                   500, 501, 502, 421, 530, 550<br>
 			 */
 	XCUP 	(goldengate.ftp.core.command.rfc775.XCUP.class,
 			null),
 			/**
 			 ...
 			 * 250<br>
                   500, 501, 502, 421, 530, 550<br>
 			 */
 	XRMD 	(goldengate.ftp.core.command.rfc775.XRMD.class,
 			null),
 			/**
 			 ...
 			 * 257<br>
                   500, 501, 502, 421, 530, 550<br>
 			 */
 	XMKD 	(goldengate.ftp.core.command.rfc775.XMKD.class,
 			null),
 			/**
 			 ...
 			 * 257<br>
                   500, 501, 502, 421, 550<br>
 			 */
 	XPWD 	(goldengate.ftp.core.command.rfc775.XPWD.class,
 			null),
 
 // XXX RFC3659
 			/**
 			 * The FTP command, MODIFICATION TIME (MDTM), can be used to determine
    				when a file in the server NVFS was last modified.<br><br>
    ...
    with an unspecified value, the choice being made by the server-PI.<br><br>
    ...
    time is unavailable, or some other error has occurred.<br>
 
 			 * 
 			 * 213<br>
 			 * 500, 501, 550<br>
 			 */
 	MDTM 	(goldengate.ftp.core.command.rfc3659.MDTM.class,
 			null),
 			/**
    ...
    the currently established STRU, MODE, and TYPE parameters.<br><br>
    ...
    precise information is acceptable.<br>
 
 			 * 
 			 * 213<br>
                   500, 501, 550<br>
 			 */
 	SIZE 	(goldengate.ftp.core.command.rfc3659.SIZE.class,
 			null),
 			/**
 			 *    The MLSD command is intended to standardize the file and
    directory information returned by the server-FTP process.  This
    command differs from the LIST command in that the format of the
    replies is strictly defined although extensible.<br><br>
 
    MLSD lists the contents of a directory if a directory is
    named, otherwise a 501 reply is returned.  If no
    object is named, the current directory is assumed.  That will cause
    MLSD to list the contents of the current directory.<br>
 			 ...
 			 * 125, 150<br>
                   ...
                   500, 501, 502, 421, 530<br>
 			 */
 	MLSD 	(goldengate.ftp.core.command.rfc3659.MLSD.class,
 			null),
 			/**
 			 *    The MLST command is intended to standardize the file and
    directory information returned by the server-FTP process.  This
    command differs from the LIST command in that the format of the
    replies is strictly defined although extensible.<br><br>
 
    MLST provides data about
    exactly the object named on its command line, and no others.  If no
    object is named, the current directory is assumed.  That will cause
    ...
    itself.<br>
 			 ...
 			 * 125, 150<br>
                   ...
                   500, 501, 502, 421, 530<br>
 			 */
 	MLST 	(goldengate.ftp.core.command.rfc3659.MLST.class,
 			null),
 
 // XXX RFC2389
 			/**
 			 * The FEAT command consists solely of the word "FEAT".  It has no
    parameters or arguments.<br><br>
 ...
 Where a server-FTP process does not support the FEAT command, it will
    ...
    parameters, will result in a 501 reply.<br><br>
    ...
    exactly one response line is required and permitted.<br><br>
 ...
 Replies to the FEAT command MUST comply with the following syntax.
    ...
    precisely defined, and if present, MUST be exactly as specified.<br><br>
 <pre>
    ...
    required even where there is no possibility of ambiguity.<br><br>
    ...
    reply other than a 500 or 502 reply.<br>
 
 			 * 
 			 * 211<br>
 			 * 500, 501, 550<br>
 			 */
 	FEAT 	(goldengate.ftp.core.command.rfc2389.FEAT.class,
 			null),
 			/**
    ...
    particular command there are no options available for that command.<br>
 
 			 * 
 			 * 200<br>
                   451, 500, 501, 550<br>
 			 */
 	OPTS 	(goldengate.ftp.core.command.rfc2389.OPTS.class,
 			null),
 ...
 // XXX RFC2428
    ...
    format of EPRT is:<br><br>
 <pre>
            EPRT&lt;space&gt;&lt;d&gt;&lt;net-prt&gt;&lt;d&gt;<net-addr>&lt;d&gt;&lt;tcp-port&gt;&lt;d&gt;
 </pre><br>
    The EPRT command keyword MUST be followed by a single space (ASCII
    32).  Following the space, a delimiter character (<code>&lt;d&gt;</code>) MUST be
    ...
    The <code>&lt;net-prt&gt;</code> argument MUST be an address family number defined by
 ...
 <pre>
    ...
    The <code>&lt;net-addr&gt;</code> is a protocol specific string representation of the
    network address.  For the two address families specified above (AF
    Number 1 and 2), addresses MUST be in the following format:<br><br>
 <pre>
    ...
    The <code>&lt;tcp-port&gt;</code> argument must be the string representation of the
    ...
    connection.<br>
 			 ...
 			 */
 	EPRT 	(goldengate.ftp.core.command.rfc2428.EPRT.class,
 			null),
 			/**
 ...
 <pre>
    ...
    The text returned in response to the EPSV command MUST be:<br><br>
 <pre>
    ...
    string follows:<br><br>
 <pre>
         Entering Extended Passive Mode (|||6446|)
 </pre><br>
    The standard negative error codes 500 and 501 are sufficient to
    handle all errors involving the EPSV command (e.g., syntax errors).<br><br>
 ...
 <pre>
    ...
    as outlined in section 2.<br><br>
 ...
 <pre>
    ...
    4.<br>
 			 ...
 			 */
 	EPSV 	(goldengate.ftp.core.command.rfc2428.EPSV.class,
 			null),
 
 // XXX EXTENSIONS
 			
 			/**
 			 * Compute CRC on pathname given as argument. Return on control network
 			 * as 250 "CRC" is CRC of file "pathname"<br>
 			 * 
 			 * 250<br>
                   500, 501, 502, 504, 421, 530<br>
 			 */
 	XCRC 	(goldengate.ftp.core.command.extension.XCRC.class,
 			null),
 			/**
 			 * Compute MD5 on pathname given as argument. Return on control network
 			 * as 250 "MD5" is MD5 of file "pathname"<br>
 			 * 
 			 * 250<br>
                   500, 501, 502, 504, 421, 530<br>
 			 */
 	XMD5 	(goldengate.ftp.core.command.extension.XMD5.class,
 			null),
 			/**
 			 * Compute SHA-1 on pathname given as argument. Return on control network
 			 * as 250 "SHA1" is SHA-1 of file "pathname"<br>
 			 * 
 			 * 250<br>
                   500, 501, 502, 504, 421, 530<br>
 			 */
 	XSHA1 	(goldengate.ftp.core.command.extension.XSHA1.class,
 			null),
 ...
 // XXX GLOBAL OPERATION
 	...
 	Unknown (UnknownCommand.class,
 			 ...
 			 */
 	Unimplemented (UnimplementedCommand.class,
 			null),
 			/**
 			 * Bad sequence of commands<br>
 			 * Always return 503<br>
 			 */
 	IncorrectSequence (IncorrectCommand.class,
 			null),
 ...
 // XXX INTERNAL FUNCTION
	...
	LIMITBANWIDTH (goldengate.ftp.core.command.internal.LIMITBANWIDTH.class,
 	 ...
 	 */
 	public Class previousValid;
 	/**
 	 * Next valids class that could follow this command (null means any)
 	 */
 	public Class [] nextValids;
 	
 	private FtpCommandCode(Class command, Class previousValid, Class ...nextValids) {
