  ...
  * @author Dennis Reedy
  */
 public class CybernodeImpl extends ServiceBeanAdapter
     ...
     * @throws Exception if bbootstrapping fails
     ...
     /**
      * @see org.rioproject.core.provision.ServiceBeanInstantiator#getServiceStatements
      */
     ...
     /**
      * @see org.rioproject.core.provision.ServiceBeanInstantiator#getServiceRecords
      */
     ...
     /**
      * @see org.rioproject.core.provision.ServiceBeanInstantiator#getServiceStatement
      */
     ...
     /**
      * @see org.rioproject.core.provision.ServiceBeanInstantiator#getServiceBeanInstances
      */
     ...
     /**
      * @see org.rioproject.core.provision.ServiceBeanInstantiator#update
      */
     ...
     /**
      * @see org.rioproject.core.provision.ServiceBeanInstantiator#getName()
      */
      ...
      *
      * @see org.rioproject.core.provision.ServiceBeanInstantiator#getInstantiatorUuid()
      */
      ...
      * Cybernode.
      *
      * @throws IOException If the UIDescriptos cannot be created
      */
     ...
     /**
      * @see org.rioproject.core.provision.ServiceBeanInstantiator#instantiate
      */
     public DeployedService instantiate(ServiceProvisionEvent event)
         throws JSBInstantiationException, UnknownEventException {
         ...
         try {
             ...
             synchronized(inProcess) {
                 ...
                 if(maxPerMachine!=-1 && activeServiceCounter >= maxPerMachine) {
                     ...
                     throw new JSBInstantiationException("MaxPerMachine "+
                                                         "["+maxPerMachine+"] " +
                                                         "has been "+
                                                         "reached");
                 }
             ...
             if((inProcessCount+containerServiceCount) <= serviceLimit) {
                 ...
                 throw new JSBInstantiationException("Service Limit of "+
     ...
     /*
      * @see org.rioproject.cybernode.Cybernode#enlist(org.rioproject.core.Schedule)
      */
