 ...
 public class DFA {
    private Map<Character, State> transitionTable;
     private State currentState;
     private State startState;
    public DFA(final Map<Character, State> transitionTable, final State startState) {
     ...
     public State doTransition(final Character input) {
        this.currentState = this.transitionTable.get(input);
