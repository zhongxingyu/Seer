 ...
 public class InputField extends JPanel {
     ...
     /**
     * Constructor for  opprette felt for  f tekst fra brukeren. 
      * 
      * 
     * Feltet opprettes basert p kanalnavn og typen tab den skal vre i. Den vil derfra ta teksten som blir puttet inn og sende det til servern.  
      * @author Hallvard Westman
      * @param tabName
      * @param TabType
      */
