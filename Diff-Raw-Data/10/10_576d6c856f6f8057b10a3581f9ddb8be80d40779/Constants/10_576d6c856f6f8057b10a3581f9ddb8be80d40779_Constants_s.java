 ...
 public final class Constants {
 	public static final class IntentParameters {
		public final static String KEY_TOBACK = "toback";
 		public final static String KEY_LINE_STOP = "stop";
 		public final static String KEY_LINE = "line";
		public final static String VALUE_TOBACK_TO = "to";
		public final static String VALUE_TOBACK_BACK = "back";
 	}
 	...
 	public static enum Cities {
 		...
 		public static String[] getCities() {
 			...
 			for (Cities cities : Cities.values()) {
                retval[i++] = cities.getCityFolderName();
 	        }
 			return retval;
 		}
