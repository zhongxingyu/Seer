 ...
 import cz.mzk.editor.client.metadata.AbstractHolder;
 import cz.mzk.editor.client.metadata.AccessConditionHolder;
 import cz.mzk.editor.client.metadata.AudienceHolder;
 import cz.mzk.editor.client.metadata.ClassificationHolder;
 import cz.mzk.editor.client.metadata.CopyInformationHolder;
 import cz.mzk.editor.client.metadata.DateHolder;
 import cz.mzk.editor.client.metadata.DetailHolder;
 import cz.mzk.editor.client.metadata.ExtensionHolder;
 import cz.mzk.editor.client.metadata.ExtentHolder;
 import cz.mzk.editor.client.metadata.GenreHolder;
 import cz.mzk.editor.client.metadata.IdentifierHolder;
 import cz.mzk.editor.client.metadata.LanguageHolder;
 import cz.mzk.editor.client.metadata.ListOfSimpleValuesHolder;
 import cz.mzk.editor.client.metadata.LocationHolder;
 import cz.mzk.editor.client.metadata.MetadataHolder;
 import cz.mzk.editor.client.metadata.ModsConstants;
 import cz.mzk.editor.client.metadata.NameHolder;
 import cz.mzk.editor.client.metadata.NoteHolder;
 import cz.mzk.editor.client.metadata.OriginInfoHolder;
 import cz.mzk.editor.client.metadata.PartHolder;
 import cz.mzk.editor.client.metadata.PhysicalDescriptionHolder;
 import cz.mzk.editor.client.metadata.PlaceHolder;
 import cz.mzk.editor.client.metadata.RecordInfoHolder;
 import cz.mzk.editor.client.metadata.SubjectHolder;
 import cz.mzk.editor.client.metadata.TableOfContentsHolder;
 import cz.mzk.editor.client.metadata.TitleInfoHolder;
 import cz.mzk.editor.client.metadata.TypeOfResourceHolder;
 ...
 public final class TabUtils {
     ...
     private static class GetTitleInfoLayout
         ...
         /*
          * (non-Javadoc)
          * @see cz.mzk.editor.client.view.other.TabUtils.GetLayoutOperation
          * #execute()
          */
         @Override
