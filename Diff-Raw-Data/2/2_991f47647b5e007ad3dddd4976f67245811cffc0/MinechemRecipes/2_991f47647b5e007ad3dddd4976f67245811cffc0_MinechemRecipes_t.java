 ...
 public class MinechemRecipes {
    ...
    public void RegisterRecipes() {
       ...
       //DecomposerRecipe.add(new DecomposerRecipe(var9, new Chemical[]{this.element(EnumElement.Au, 4)}));
       ...
       //DecomposerRecipe.add(new DecomposerRecipe(var15, new Chemical[]{this.element(EnumElement.Fe, 2)}));
       DecomposerRecipe.add(new DecomposerRecipe(ingotIron, new Chemical[]{this.element(EnumElement.Fe, 16)}));
       //DecomposerRecipe.add(new DecomposerRecipe(var22, new Chemical[]{this.element(EnumElement.Au, 2)}));
       ...
       //DecomposerRecipe.add(new DecomposerRecipe(var25, new Chemical[]{this.element(EnumElement.C, 8)}));
       DecomposerRecipe.add(new DecomposerRecipe(chunkCoal, new Chemical[]{this.element(EnumElement.C, 16)}));
       //SynthesisRecipe.add(new SynthesisRecipe(var15, false, 1000, new Chemical[]{this.element(EnumElement.Fe, 2)}));
       //SynthesisRecipe.add(new SynthesisRecipe(var22, false, 1000, new Chemical[]{this.element(EnumElement.Au, 2)}));
       ...
       //SynthesisRecipe.add(new SynthesisRecipe(new ItemStack(Block.blockSteel), true, 5000, new Chemical[]{this.element(EnumElement.Fe, 2), this.element(EnumElement.Fe, 2), this.element(EnumElement.Fe, 2), this.element(EnumElement.Fe, 2), this.element(EnumElement.Fe, 2), this.element(EnumElement.Fe, 2), this.element(EnumElement.Fe, 2), this.element(EnumElement.Fe, 2), this.element(EnumElement.Fe, 2)}));
       //SynthesisRecipe.add(new SynthesisRecipe(new ItemStack(Block.blockGold), true, 5000, new Chemical[]{this.element(EnumElement.Au, 2), this.element(EnumElement.Au, 2), this.element(EnumElement.Au, 2), this.element(EnumElement.Au, 2), this.element(EnumElement.Au, 2), this.element(EnumElement.Au, 2), this.element(EnumElement.Au, 2), this.element(EnumElement.Au, 2), this.element(EnumElement.Au, 2)}));
       ...
       SynthesisRecipe.add(new SynthesisRecipe(var127, true, 1000, new Chemical[]{this.molecule(EnumMolecule.siliconDioxide, 4), this.molecule(EnumMolecule.siliconDioxide, 4), this.molecule(EnumMolecule.siliconDioxide, 4), this.molecule(EnumMolecule.siliconDioxide, 4), null, this.molecule(EnumMolecule.magnesiumOxide, 2), this.molecule(EnumMolecule.magnesiumOxide, 2), this.molecule(EnumMolecule.magnesiumOxide, 2), this.molecule(EnumMolecule.magnesiumOxide, 2)}));
