 ...
 public class CoherenceHibernateSecondLevelCacheFunctionalTest
 {
     ...
     {
         return CacheFactory.getCache("org.hibernate.cache.internal.StandardQueryCache");
     }
     ...
     {
         return CacheFactory.getCache("org.hibernate.cache.spi.UpdateTimestampsCache");
     }
