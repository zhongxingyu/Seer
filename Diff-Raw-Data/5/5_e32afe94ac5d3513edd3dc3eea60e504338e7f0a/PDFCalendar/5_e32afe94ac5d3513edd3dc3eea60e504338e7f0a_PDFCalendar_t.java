 ...
 public class PDFCalendar
 {
 	...
 	{
 		// fonts
		BaseFont bf_normal = BaseFont.createFont(BaseFont.HELVETICA, BaseFont.WINANSI, BaseFont.EMBEDDED);
 		normal = new Font(bf_normal, 16);
 		small = new Font(bf_normal, 8);
		BaseFont bf_bold = BaseFont.createFont(BaseFont.HELVETICA, BaseFont.WINANSI, BaseFont.EMBEDDED);
