 ...
 public class Scheduler implements Runnable{
 	...
 	public void OnMove(SchedulerEvent.Move event){
 		...
 		//System.out.println("Affected: " + Affected.Index);
 		...
 		for(int i = SmallestAffectedIndex; i < Timeline.size(); i++){
 			...
 			if(i > SmallestAffectedIndex){
 				// Just count
 				if(Me.ThrustartType != EnumThrustartType.Thrustart) break;
 		...
 		//System.out.println("SmallestAffectedIndex: " + SmallestAffectedIndex);
