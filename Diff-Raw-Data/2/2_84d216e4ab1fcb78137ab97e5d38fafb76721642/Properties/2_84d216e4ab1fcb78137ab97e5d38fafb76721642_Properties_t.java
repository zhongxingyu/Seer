 ...
 /**
  * Modified to keep track of the order in which the data is read.
  */
  ...
  */
 public
 class Properties extends LinkedHashMap<String,String>{
     /**
     ...
     public Properties(java.util.Properties defaults) {
     	for (String key : keySet())
             this.defaults.put(key,defaults.getProperty(key));
     }
