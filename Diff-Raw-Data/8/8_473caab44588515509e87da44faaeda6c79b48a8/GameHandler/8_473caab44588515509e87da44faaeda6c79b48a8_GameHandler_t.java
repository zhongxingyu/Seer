 ...
 public class GameHandler {
 	...
 	*/
 	public String submitAnswer() {
 		if (answer.equals("")) {
 			FacesMessage fm = new FacesMessage("Skriv inn svaret ditt fr du trykker, din IDIOT!!");
 			FacesContext.getCurrentInstance().addMessage("Skriv inn svaret ditt fr du trykker, din IDIOT!!", fm);
 			return "noob";
 		...
 		int currency_spent = getValutaSpent();
			if(currentChallenge.getDifficulty() == 1 && currency > 0 && tipHelp == true){
			...
			else if(currentChallenge.getDifficulty() == 3 && currency > 2 && tipHelp == true)
 			{
 				...
 				tip = "Det har allerede ftt hjelp til denne oppgaven";
 			}
