 ...
 public class GridTest {
     ...
     @Test
    public void isOccupiedReturnsTrueOnFalseCoordinates() {
         setUpForIsOccupiedTest(TType.O);
 
        assertEquals(true, classicGrid.isOccupied(-1, 0));
        assertEquals(true, classicGrid.isOccupied(0, 22));
        assertEquals(true, classicGrid.isOccupied(12345, -12345));
     }
