  ...
  */
 public class RfAccountingRequestImpl extends RfAccountingMessageImpl implements
 		RfAccountingRequest {
 	 ...
 	 * (non-Javadoc)
 	 * 
 	 * @see net.java.slee.resource.diameter.rf.events.RfAccountingRequest#
 	 * getServiceInformation()
 	 */
 	@Override
 	public ServiceInformation getServiceInformation() {
 		return (ServiceInformation) super
 				.getAvpAsCustom(DiameterRfAvpCodes.SERVICE_INFORMATION,
 						DiameterRfAvpCodes.TGPP_VENDOR_ID,
 						ServiceInformationImpl.class);
 	}
 	...
 	public void setServiceInformation(ServiceInformation si) {
 		super.addAvp(DiameterRfAvpCodes.SERVICE_INFORMATION,
 				DiameterRfAvpCodes.TGPP_VENDOR_ID, si.byteArrayValue());
 	...
 	public boolean hasServiceInformation() {
 		return super.hasAvp(DiameterRfAvpCodes.SERVICE_INFORMATION,
 				DiameterRfAvpCodes.TGPP_VENDOR_ID);
 	}
 	 ...
 	 * 
 	 * @see net.java.slee.resource.diameter.rf.events.RfAccountingRequest#
 	 * setCalledStationId(java.lang.String)
 	 */
 	@Override
 	 ...
 	 * 
 	 * @see
 	 * net.java.slee.resource.diameter.rf.events.RfAccountingRequest#getLocationType
 	 * ()
 	 */
 	@Override
 	public LocationType getLocationType() {
 		return (LocationType) super.getAvpAsCustom(
 				DiameterRfAvpCodes.LOCATION_TYPE, LocationTypeImpl.class);
 	}
 	 ...
 	 * 
 	 * @see
 	 * net.java.slee.resource.diameter.rf.events.RfAccountingRequest#setLocationType
 	 ...
 	 * 
 	 * @see
 	 * net.java.slee.resource.diameter.rf.events.RfAccountingRequest#hasLocationType
 	 * ()
 	 */
 	@Override
