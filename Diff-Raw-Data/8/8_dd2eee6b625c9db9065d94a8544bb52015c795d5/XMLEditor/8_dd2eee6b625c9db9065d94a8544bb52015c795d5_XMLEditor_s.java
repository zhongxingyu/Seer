...
import org.spoofax.views.properties.StrategoTermSelectionProvider;
 ...
 public class XMLEditor extends TextEditor {
 	...
 	public void createPartControl(Composite parent) {
		...
		getSite().setSelectionProvider(new StrategoTermSelectionProvider());
 	}
 	...
 	private class TextSelectionChangedListener implements ISelectionChangedListener {
 		...
 		public void selectionChanged(SelectionChangedEvent event) {
			...
			ISelection selection = new StrategoTermSelection(textSelection, properties);
