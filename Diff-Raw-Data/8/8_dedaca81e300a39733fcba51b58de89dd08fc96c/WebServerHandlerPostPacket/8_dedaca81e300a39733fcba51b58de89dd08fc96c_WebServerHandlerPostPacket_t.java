 ...
 public class WebServerHandlerPostPacket implements IWebServerHandler{
 	...
 	public void Handle(WebServerRequest Request, WebServerResponse Response, String... Data){
 		...
 		try{
			...
			int PacketID = Integer.parseInt(Request.GetPostObject("id"));
			...
			JSONPacket PacketData = new JSONPacket();
			PacketData.put("id", PacketID);
			PacketData.put("data", Json);
			Packet.HandlePacket(PacketData, SenderClient, ProtocolType.FETCH);
