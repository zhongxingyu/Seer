     ...
     public void selectLexer(String lexerName)  {
         ...
         if (currentLexer == null) {
             ...
             if (lexerName.equals("method_keywordLexer")) {
 				...
 				TokenTypes.REGISTER);
                 addKeyword(TokenNames.ACK.toUpperCase(),
 				TokenTypes.ACK);
                 addKeyword(TokenNames.OPTIONS.toUpperCase(),
 				TokenTypes.OPTIONS);
                 addKeyword(TokenNames.BYE.toUpperCase(), 
 				TokenTypes.BYE);
                 addKeyword(TokenNames.INVITE.toUpperCase(),
 				TokenTypes.INVITE);
                 addKeyword(TokenNames.SIP.toUpperCase(),
 				TokenTypes.SIP);
                 addKeyword(TokenNames.SUBSCRIBE.toUpperCase(), 
                                 TokenTypes.SUBSCRIBE);
                 addKeyword(TokenNames.NOTIFY.toUpperCase(),
                             TokenTypes.NOTIFY);
                 ...
                 TokenTypes.AUTHENTICATION_INFO);
                  addKeyword(EventHeader.NAME.toUpperCase(),
                 TokenTypes.EVENT);
                 addKeyword(MinExpiresHeader.NAME.toUpperCase(),
                 TokenTypes.MIN_EXPIRES);
                 addKeyword(RSeqHeader.NAME.toUpperCase(),
                 TokenTypes.RSEQ);
                 addKeyword(RAckHeader.NAME.toUpperCase(),
                 TokenTypes.RACK);
                 ...
                 addKeyword(FromHeader.NAME.toUpperCase(),
                 TokenTypes.FROM	);
                 addKeyword(ToHeader.NAME.toUpperCase(),
                 TokenTypes.TO 		);
                 addKeyword(ReferToHeader.NAME.toUpperCase(),
                 TokenTypes.REFER_TO 		);
                 addKeyword(ViaHeader.NAME.toUpperCase(),
                 TokenTypes.VIA		);
                 ...
                 TokenTypes.ACCEPT 	);
                 addKeyword(AllowHeader.NAME.toUpperCase(),
                 TokenTypes.ALLOW	);
                 addKeyword ( RouteHeader.NAME.toUpperCase(),
                 TokenTypes.ROUTE 	);
                 ...
                 addKeyword ( DateHeader.NAME.toUpperCase(),
                 TokenTypes.DATE  		);
                 ...
                 addKeyword ( CSeqHeader.NAME.toUpperCase(),
                 TokenTypes.CSEQ 		);
                 ...
                 addKeyword ( TokenNames.K.toUpperCase(),
                 TokenTypes.SUPPORTED		);
                 addKeyword(TokenNames.C.toUpperCase(),
                 TokenTypes.CONTENT_TYPE		);
                 addKeyword (TokenNames.E.toUpperCase(),
                 TokenTypes.CONTENT_ENCODING	);
                 addKeyword (TokenNames.F.toUpperCase(),
                 TokenTypes.FROM		);
                 addKeyword (TokenNames.I.toUpperCase(),
                 TokenTypes.CALL_ID		);
                 addKeyword (TokenNames.M.toUpperCase(),
                 TokenTypes.CONTACT	);
                 addKeyword (TokenNames.L.toUpperCase(),
                 TokenTypes.CONTENT_LENGTH	);
                 addKeyword (TokenNames.S.toUpperCase(),
                 TokenTypes.SUBJECT		);
                 addKeyword (TokenNames.T.toUpperCase(),
                 TokenTypes.TO			);
                 addKeyword (TokenNames.V.toUpperCase(),
                 TokenTypes.VIA			);
                 addKeyword (TokenNames.R.toUpperCase(),
                 TokenTypes.REFER_TO		);
 			...
 			TokenTypes.SIP);
                 ...
                 addKeyword(TokenNames.TEL.toUpperCase(),
 			TokenTypes.TEL);
                 addKeyword(TokenNames.SIP.toUpperCase(),
 			TokenTypes.SIP);
 	    }
