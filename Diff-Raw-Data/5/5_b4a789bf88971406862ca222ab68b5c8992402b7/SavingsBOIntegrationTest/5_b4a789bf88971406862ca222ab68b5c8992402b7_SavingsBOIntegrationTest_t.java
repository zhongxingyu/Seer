 ...
 public class SavingsBOIntegrationTest extends MifosIntegrationTestCase {
     ...
     public void testInterestAdjustmentOnLaterWithdrawal() throws Exception {
         ...
         AccountPaymentEntity payment = helper.createAccountPaymentToPersist(savings, depositMoney, depositMoney,
                 helper.getDate("25/09/2008"), AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         ...
         AccountPaymentEntity payment2 = helper.createAccountPayment(savings, null, recommendedAmnt,
                 helper.getDate("26/10/2008"), createdBy);
         payment2.addAccountTrxn(helper.createAccountTrxn(payment2, null, recommendedAmnt, balanceAmount,
                 helper.getDate("26/10/2008"), null, null, AccountActionTypes.SAVINGS_WITHDRAWAL.getValue(), savings,
                 createdBy, group));
         ...
         AccountPaymentEntity payment3 = helper.createAccountPayment(savings, null, recommendedAmnt,
                 helper.getDate("26/10/2008"), createdBy);
         payment3.addAccountTrxn(helper.createAccountTrxn(payment3, null, recommendedAmnt, balanceAmount,
                 helper.getDate("26/10/2008"), null, null, AccountActionTypes.SAVINGS_WITHDRAWAL.getValue(), savings,
                 createdBy, group));
     ...
     public void testInterestAdjustmentOnLaterDeposit() throws Exception {
         ...
         Money depositMoney = new Money(currency, "2000.0");
         AccountPaymentEntity payment = helper.createAccountPaymentToPersist(savings, depositMoney, depositMoney,
                 helper.getDate("25/09/2030"), AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         AccountTestUtils.addAccountPayment(payment, savings);
         savings.setSavingsBalance(depositMoney);
         savings.update();
         StaticHibernateUtil.flushAndClearSession();
         ...
         AccountActionDateEntity actionDate1 = helper.createAccountActionDate(savings, Short.valueOf("1"),
                 helper.getDate("26/10/2030"), paymentDate, savings.getCustomer(), recommendedAmnt, recommendedAmnt,
                 PaymentStatus.PAID);
         ...
         SavingsTrxnDetailEntity trxn1 = helper.createAccountTrxn(payment2, Short.valueOf("1"), recommendedAmnt,
                 balanceAmount, paymentDate, helper.getDate("26/10/2030"), null,
     ...
     public void testInterestAdjustmentOnFirstDeposit() throws Exception {
         ...
         Money depositMoney = new Money(currency, "2000.0");
         AccountPaymentEntity payment = helper.createAccountPaymentToPersist(savings, depositMoney, depositMoney,
                 helper.getDate("25/02/2006"), AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         AccountTestUtils.addAccountPayment(payment, savings);
         savings.setSavingsBalance(depositMoney);
         savings.update();
         StaticHibernateUtil.flushAndClearSession();
         ...
         AccountActionDateEntity actionDate1 = helper.createAccountActionDate(savings, Short.valueOf("1"),
                 helper.getDate("25/02/2006"), paymentDate, savings.getCustomer(), recommendedAmnt, recommendedAmnt,
                 PaymentStatus.PAID);
         AccountTestUtils.addAccountActionDate(actionDate1, savings);
         AccountPaymentEntity payment2 = helper.createAccountPayment(savings, depositMoney, paymentDate, createdBy);
         balanceAmount = new Money(currency, "2000.0");
         SavingsTrxnDetailEntity trxn1 = helper.createAccountTrxn(payment2, Short.valueOf("1"), recommendedAmnt,
                 balanceAmount, paymentDate, helper.getDate("25/02/2006"), null,
                 AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         payment2.addAccountTrxn(trxn1);
         AccountTestUtils.addAccountPayment(payment2, savings);
     ...
     // ///////////////////////////////////////////////////
     private SavingsOfferingBO createSavingsOffering(final String offeringName, final String shortName,
             final SavingsType savingsType, final InterestCalcType interestCalcType,
             final RecurrenceType freqeuncyIntCalc, final short recurAfterIntCalc, final double interestRate,
             final Date startDate, final Double minAmtToCalculateInterest, final Double maxAmtToWithdraw)
             throws Exception {
     ...
     public void testInterestAdjustment_LastDepositPaymentNullify_AfterMultiple_Interest_Calculation_WithMinBal()
         ...
         AccountPaymentEntity payment2 = helper.createAccountPaymentToPersist(savings, depositMoney, balanceAmt,
                 helper.getDate("27/02/2006"), AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         AccountTestUtils.addAccountPayment(payment2, savings);
         savings.setSavingsBalance(balanceAmt);
         savings.update();
         StaticHibernateUtil.flushAndClearSession();
         ...
         AccountActionDateEntity actionDate1 = helper.createAccountActionDate(savings, Short.valueOf("1"),
                 helper.getDate("07/03/2006"), paymentDate, savings.getCustomer(), recommendedAmnt, recommendedAmnt,
                 PaymentStatus.PAID);
         AccountActionDateEntity actionDate2 = helper.createAccountActionDate(savings, Short.valueOf("2"),
                 helper.getDate("14/03/2006"), paymentDate, savings.getCustomer(), recommendedAmnt, recommendedAmnt,
                 PaymentStatus.PAID);
         ...
         SavingsTrxnDetailEntity trxn1 = helper.createAccountTrxn(payment3, Short.valueOf("1"), recommendedAmnt,
                 balanceAmount, paymentDate, helper.getDate("01/05/2006"), null,
                 AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         ...
         SavingsTrxnDetailEntity trxn2 = helper.createAccountTrxn(payment3, Short.valueOf("2"), recommendedAmnt,
                 balanceAmount, paymentDate, helper.getDate("08/05/2006"), null,
                 AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
     ...
     private SavingsBO createSavingsWithAccountPayments() throws Exception {
         ...
         payment = helper.createAccountPayment(savings, null, new Money(currency, "5500.0"), new Date(), createdBy);
         payment.addAccountTrxn(helper.createAccountTrxn(payment, null, initialBal, initialBal,
                 helper.getDate("04/01/2006"), null, null, AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings,
                 createdBy, group));
         AccountTestUtils.addAccountPayment(payment, savings);
         savings.update();
         StaticHibernateUtil.flushAndClearSession();
     ...
     public void testInterestAdjustment_LastWithdrawalPaymentNullified_WithMinBal() throws Exception {
         ...
         AccountPaymentEntity payment2 = helper.createAccountPaymentToPersist(savings, depositMoney, balanceAmt,
                 helper.getDate("24/02/2006"), AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         AccountTestUtils.addAccountPayment(payment2, savings);
         savings.setSavingsBalance(balanceAmt);
         savings.update();
         StaticHibernateUtil.flushAndClearSession();
         ...
         AccountPaymentEntity payment3 = helper.createAccountPaymentToPersist(savings, withrawalAmt, balanceAmt,
                 helper.getDate("26/02/2006"), AccountActionTypes.SAVINGS_WITHDRAWAL.getValue(), savings, createdBy,
                 group);
         AccountTestUtils.addAccountPayment(payment3, savings);
         savings.setSavingsBalance(balanceAmt);
         savings.update();
     ...
     public void testCalculateInterestForClosure() throws Exception {
         ...
         AccountPaymentEntity payment = helper.createAccountPaymentToPersist(savings, new Money(currency, "700.0"),
                 new Money(currency, "1700.0"), helper.getDate("15/01/2006"),
                 AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         AccountTestUtils.addAccountPayment(payment, savings);
         savings.save();
         StaticHibernateUtil.flushAndClearSession();
     ...
     public void testAdjustPmnt_LastPaymentNullified() throws Exception {
         ...
         for (SavingsActivityEntity activity : savings.getSavingsActivityDetails()) {
             ...
             Assert.assertEquals(DateUtils.getCurrentDateWithoutTimeStamp(),
                     DateUtils.getDateWithoutTimeStamp(activity.getTrxnCreatedDate().getTime()));
         }
         group = savings.getCustomer();
         center = group.getParentCustomer();
     }
     ...
     public void testAdjustPmnt_LastPaymentDecreasedForWithdrawal() throws Exception {
         ...
         for (SavingsActivityEntity activity : savings.getSavingsActivityDetails()) {
             if (activity.getActivity().getId().equals(AccountActionTypes.SAVINGS_ADJUSTMENT.getValue())) {
                 ...
                 Assert.assertEquals(DateUtils.getDateWithoutTimeStamp(getDate("20/05/2006").getTime()),
                         DateUtils.getDateWithoutTimeStamp(activity.getTrxnCreatedDate().getTime()));
             }
         }
     ...
     public void testAdjustPmnt_LastPaymentDepositMandatory_PaidAllDue() throws Exception {
         ...
         AccountActionDateEntity actionDate1 = helper.createAccountActionDate(savings, Short.valueOf("1"),
                 helper.getDate("01/05/2006"), paymentDate, savings.getCustomer(), recommendedAmnt, recommendedAmnt,
                 PaymentStatus.PAID);
         AccountActionDateEntity actionDate2 = helper.createAccountActionDate(savings, Short.valueOf("2"),
                 helper.getDate("08/05/2006"), paymentDate, savings.getCustomer(), recommendedAmnt, recommendedAmnt,
                 PaymentStatus.PAID);
         AccountTestUtils.addAccountActionDate(actionDate1, savings);
         AccountTestUtils.addAccountActionDate(actionDate2, savings);
     ...
     public void testAdjustPmnt_LastPaymentDepositMandatory_PaidSomeDueInstallments() throws Exception {
         ...
         AccountActionDateEntity actionDate1 = helper.createAccountActionDate(savings, Short.valueOf("1"),
                 ...
                 PaymentStatus.PAID);
         AccountActionDateEntity actionDate2 = helper.createAccountActionDate(savings, Short.valueOf("2"),
                 helper.getDate("08/05/2006"), null, savings.getCustomer(), recommendedAmnt, null, PaymentStatus.UNPAID);
     ...
     public void testAdjustPmnt_LastPaymentDepositMandatory_PaidPartialDueAmount() throws Exception {
         ...
         AccountActionDateEntity actionDate1 = helper.createAccountActionDate(savings, Short.valueOf("1"),
                 ...
                 PaymentStatus.PAID);
         AccountActionDateEntity actionDate2 = helper.createAccountActionDate(savings, Short.valueOf("2"),
                 helper.getDate("08/05/2006"), paymentDate, savings.getCustomer(), recommendedAmnt, partialAmnt,
     ...
     public void testAdjustPmnt_LastPaymentDepositVol_PaidDueExactAmount() throws Exception {
         ...
         AccountActionDateEntity actionDate1 = helper.createAccountActionDate(savings, Short.valueOf("1"),
                 helper.getDate("01/05/2006"), paymentDate, savings.getCustomer(), recommendedAmnt, partialAmnt,
                 PaymentStatus.PAID);
         AccountActionDateEntity actionDate2 = helper.createAccountActionDate(savings, Short.valueOf("2"),
                 helper.getDate("08/05/2006"), null, savings.getCustomer(), recommendedAmnt, null, PaymentStatus.UNPAID);
     ...
     public void ignore_testGetTotalAmountDueForActiveCustomers() throws Exception {
         ...
         CustomerNoteEntity customerNote = new CustomerNoteEntity("close", new java.util.Date(), client1.getPersonnel(),
                 client1);
         client1.setUserContext(userContext);
 
         CustomerService customerService = DependencyInjectedServiceLocator.locateCustomerService();
         customerService.updateClientStatus((ClientBO) client1, client1.getStatus(), CustomerStatus.CLIENT_CLOSED,
                 CustomerStatusFlag.CLIENT_CLOSED_TRANSFERRED, customerNote);
     ...
     public void testCalculateInterest_IntCalcFreqOneDay_minbal() throws Exception {
         ...
         AccountPaymentEntity payment1 = helper.createAccountPaymentToPersist(savings, new Money(currency, "1000.0"),
                 new Money(currency, "1000.0"), helper.getDate("06/03/2006"),
                 AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         ...
         AccountPaymentEntity payment2 = helper.createAccountPaymentToPersist(savings, new Money(currency, "2500.0"),
                 new Money(currency, "3500.0"), helper.getDate("06/03/2006"),
                 AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         AccountTestUtils.addAccountPayment(payment2, savings);
         savings.update();
         StaticHibernateUtil.flushAndClearSession();
     ...
     public void testCalculateInterest_IntCalcFreqTenDays_minbal() throws Exception {
         ...
         AccountPaymentEntity payment1 = helper.createAccountPaymentToPersist(savings, new Money(currency, "1000.0"),
                 new Money(currency, "1000.0"), helper.getDate("11/03/2006"),
                 AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         ...
         AccountPaymentEntity payment2 = helper.createAccountPaymentToPersist(savings, new Money(currency, "500.0"),
                 new Money(currency, "500.0"), helper.getDate("15/03/2006"),
                 AccountActionTypes.SAVINGS_WITHDRAWAL.getValue(), savings, createdBy, group);
         AccountTestUtils.addAccountPayment(payment2, savings);
         savings.update();
 
         AccountPaymentEntity payment3 = helper.createAccountPaymentToPersist(savings, new Money(currency, "2500.0"),
                 new Money(currency, "3000.0"), helper.getDate("19/03/2006"),
                 AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         AccountTestUtils.addAccountPayment(payment3, savings);
         savings.update();
     ...
     private SavingsOfferingBO createSavingsOfferingForIntCalc(final String offeringName, final String shortName,
             final SavingsType savingsType, final InterestCalcType interestCalcType,
             final RecurrenceType freqeuncyIntCalc, final short recurAfterIntCalc) throws Exception {
         MeetingBO meetingIntCalc = TestObjectFactory.createMeeting(helper.getMeeting(freqeuncyIntCalc,
                 recurAfterIntCalc, SAVINGS_INTEREST_CALCULATION_TIME_PERIOD));
         MeetingBO meetingIntPost = TestObjectFactory.createMeeting(helper.getMeeting(MONTHLY, EVERY_MONTH,
                 SAVINGS_INTEREST_POSTING));
         return TestObjectFactory.createSavingsProduct(offeringName, shortName, ApplicableTo.GROUPS,
                 new Date(System.currentTimeMillis()), PrdStatus.SAVINGS_ACTIVE, 300.0,
                 RecommendedAmountUnit.PER_INDIVIDUAL, 12.0, 200.0, 200.0, savingsType, interestCalcType,
     ...
     public void testInterestAdjustment_LastWithdrawalPaymentModified_WithMinBal() throws Exception {
         ...
         AccountPaymentEntity payment2 = helper.createAccountPaymentToPersist(savings, withrawalAmt, balanceAmt,
                 helper.getDate("25/02/2006"), AccountActionTypes.SAVINGS_WITHDRAWAL.getValue(), savings, createdBy,
                 group);
         AccountTestUtils.addAccountPayment(payment2, savings);
         savings.setSavingsBalance(balanceAmt);
         savings.update();
     ...
     public void testSuccessfulCloseAccount() throws Exception {
         ...
         AccountPaymentEntity payment1 = helper.createAccountPaymentToPersist(savings, new Money(currency, "1000.0"),
                 new Money(currency, "1000.0"), helper.getDate("30/05/2006"),
                 AccountActionTypes.SAVINGS_DEPOSIT.getValue(), savings, createdBy, group);
         AccountTestUtils.addAccountPayment(payment1, savings);
         savings.update();
         StaticHibernateUtil.flushAndClearSession();
         ...
         savings = savingsPersistence.findById(savings.getAccountId());
         savings.setUserContext(userContext);
         Money interestAtClosure = savings.calculateInterestForClosure(new DateTimeService().getCurrentDateMidnight()
                 .toDate());
         ...
         for (SavingsActivityEntity activity : savings.getSavingsActivityDetails()) {
             ...
             if (activity.getActivity().getId().equals(AccountActionTypes.SAVINGS_WITHDRAWAL.getValue())) {
                 // * TODO: financial_calculation_rounding
                 Assert.assertEquals(getRoundedMoney(balanceAmount.add(interestAtClosure)),
