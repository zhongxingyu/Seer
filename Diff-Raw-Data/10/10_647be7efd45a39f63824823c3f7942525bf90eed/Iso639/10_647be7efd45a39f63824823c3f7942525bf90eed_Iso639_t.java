 ...
 public class Iso639 {
 	...
 	static {
 		...
 		putCode("Norwegian Bokml", "nb", "nob", "nob");
 		...
 		putCode("Occitan (post 1500); Provenal", "oc", "oci", "oci");
 		...
 		putCode("Provenal; Occitan (post 1500)", "oc", "oci", "oci");
 		putCode("Provenal, Old (to 1500)", null, "pro", "pro");
