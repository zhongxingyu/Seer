 ...
 public class ChatCore extends JavaPlugin {
     ...
     private void initCommands() {
         ...
         if (allow_channels) {
             ...
             commandHandler.registerCommand(new ChannelBootCommand(this));
         ...
         commandHandler.registerCommand(new ValidateGroupsCommand(this));
         ...
         commandHandler.registerCommand(new UserIgnoreCommand(this));
