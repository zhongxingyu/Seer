 ...
 public class BamLedSettings extends Fragment implements ColorPickerDialog.OnColorChangedListener,
         ShortcutPickerHelper.OnPickListener {
 
     private static final String TAG = "BamLedSettings";
     ...
     public void onActivityCreated(Bundle savedInstanceState) {
         ...
         mLEDButton.setOnClickListener(new View.OnClickListener() {
             public void onClick(View v) {
                 ...
                 picker.setOnColorChangedListener(BamLedSettings.this);
                 picker.show();
             }
         });
         ...
         mLedTest.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 ...
                 ad.setIcon(R.drawable.ic_settings_bamled);
