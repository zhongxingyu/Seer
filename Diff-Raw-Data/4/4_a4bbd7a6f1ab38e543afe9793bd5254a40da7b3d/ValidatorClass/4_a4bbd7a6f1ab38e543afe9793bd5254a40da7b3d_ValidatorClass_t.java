 ...
 public class ValidatorClass
 {
  ...
  protected final String TEXT_174 = ")children.get(i));" + NL + "\t\t\t}\t" + NL + "\t\t}" + NL + "\t\telse" + NL + "\t\t{";
   ...
   protected final String TEXT_179 = "validate";
   ...
   protected final String TEXT_196 = "__VALUES, ";
   ...
   protected final String TEXT_206 = "__VALUES.contains(";
   protected final String TEXT_207 = ");" + NL + "\t\tif (!";
   protected final String TEXT_208 = " && ";
   protected final String TEXT_209 = " != null) " + NL + "\t\t\treportEnumerationViolation(";
   protected final String TEXT_210 = ".eINSTANCE.get";
   protected final String TEXT_211 = "(), ";
   protected final String TEXT_212 = ", ";
   protected final String TEXT_213 = "__VALUES, ";
   protected final String TEXT_214 = ", ";
   protected final String TEXT_215 = ");" + NL + "\t\treturn ";
   protected final String TEXT_216 = "; ";
   protected final String TEXT_217 = NL + "\t\tboolean ";
   protected final String TEXT_218 = " = ";
   protected final String TEXT_219 = " ";
   protected final String TEXT_220 = " ";
   protected final String TEXT_221 = "__VALUE;" + NL + "\t\tif (!";
   protected final String TEXT_222 = " && ";
   protected final String TEXT_223 = " != null) " + NL + "\t\t\treportMinViolation(";
   ...
   protected final String TEXT_229 = "__VALUE), ";
   ...
   protected final String TEXT_236 = ".compareCalendar(";
   protected final String TEXT_237 = ", ";
   protected final String TEXT_238 = "__VALUE);" + NL + "\t\tboolean ";
   protected final String TEXT_239 = " = ";
   protected final String TEXT_240 = " == 0 || ";
   protected final String TEXT_241 = " == 1;";
   protected final String TEXT_242 = NL + "\t\tint ";
   protected final String TEXT_243 = " = ";
   protected final String TEXT_244 = ".compareDuration(";
   protected final String TEXT_245 = ", ";
   protected final String TEXT_246 = "__VALUE);" + NL + "\t\tboolean ";
   protected final String TEXT_247 = " = ";
   protected final String TEXT_248 = " == 0 || ";
   protected final String TEXT_249 = " == 1;";
   protected final String TEXT_250 = NL + "\t\tboolean ";
   protected final String TEXT_251 = " = ";
   protected final String TEXT_252 = ".compareTo(";
   protected final String TEXT_253 = "__VALUE) ";
   protected final String TEXT_254 = " 0;";
   protected final String TEXT_255 = NL + "\t\tif (!";
   protected final String TEXT_256 = " && ";
   protected final String TEXT_257 = " != null) " + NL + "\t\t\treportMinViolation(";
   protected final String TEXT_258 = ".eINSTANCE.get";
   protected final String TEXT_259 = "(), ";
   protected final String TEXT_260 = ", ";
   protected final String TEXT_261 = "__VALUE, ";
   ...
   protected final String TEXT_272 = " != null) " + NL + "\t\t\treportMaxViolation(";
   ...
   protected final String TEXT_283 = NL + "\t\tint ";
   protected final String TEXT_284 = " = ";
   protected final String TEXT_285 = ".compareCalendar(";
   protected final String TEXT_286 = ", ";
   protected final String TEXT_287 = "__VALUE);" + NL + "\t\tboolean ";
   protected final String TEXT_288 = " = ";
   protected final String TEXT_289 = " == 0 || ";
   protected final String TEXT_290 = " == -1;";
   protected final String TEXT_291 = NL + "\t\tint ";
   protected final String TEXT_292 = " = ";
   protected final String TEXT_293 = ".compareDuration(";
   ...
   protected final String TEXT_301 = ".compareTo(";
   protected final String TEXT_302 = "__VALUE) ";
   protected final String TEXT_303 = " 0;";
   protected final String TEXT_304 = NL + "\t\tif (!";
   protected final String TEXT_305 = " && ";
   protected final String TEXT_306 = " != null) " + NL + "\t\t\treportMaxViolation(";
   ...
   protected final String TEXT_329 = NL + "\t\tint length = ";
   protected final String TEXT_330 = ".";
   protected final String TEXT_331 = ";  " + NL + "\t\tboolean ";
   protected final String TEXT_332 = " = length <= ";
   protected final String TEXT_333 = ";" + NL + "\t\tif (!";
   protected final String TEXT_334 = " && ";
   protected final String TEXT_335 = " != null) " + NL + "\t\t\treportMaxLengthViolation(";
   protected final String TEXT_336 = ".eINSTANCE.get";
   protected final String TEXT_337 = "(), ";
   protected final String TEXT_338 = ", length, ";
   protected final String TEXT_339 = ", ";
   protected final String TEXT_340 = ", ";
   protected final String TEXT_341 = ");" + NL + "\t\treturn ";
   protected final String TEXT_342 = ";";
   protected final String TEXT_343 = NL + "\t\tboolean ";
   protected final String TEXT_344 = " = ";
   protected final String TEXT_345 = " > ";
   protected final String TEXT_346 = "__LOWER_BOUND && ";
   protected final String TEXT_347 = " < ";
   protected final String TEXT_348 = "__UPPER_BOUND;" + NL + "\t\tif (!";
   ...
   protected final String TEXT_360 = ".unscaledValue().abs().toString().length() <= ";
   protected final String TEXT_361 = ";" + NL + "\t\tif (!";
   protected final String TEXT_362 = " && ";
   protected final String TEXT_363 = " != null) " + NL + "\t\t\treportTotalDigitsViolation(";
   ...
   protected final String TEXT_373 = "__LOWER_BOUND) > 0 && ";
   protected final String TEXT_374 = ".compareTo(";
   protected final String TEXT_375 = "__UPPER_BOUND) < 0;" + NL + "\t\tif (!";
   ...
   protected final String TEXT_388 = ".scale() <= ";
   protected final String TEXT_389 = ";" + NL + "\t\tif (!";
   protected final String TEXT_390 = " && ";
   protected final String TEXT_391 = " != null) " + NL + "\t\t\treportFractionDigitsViolation(";
   protected final String TEXT_392 = ".eINSTANCE.get";
   ...
   protected final String TEXT_399 = NL + "\t\t// TODO override the constraint, if desired" + NL + "\t\t// -> uncomment the scaffolding" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
   protected final String TEXT_400 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
   protected final String TEXT_401 = ".add" + NL + "\t\t\t\t\t(new ";
   protected final String TEXT_402 = NL + "\t\t\t\t\t\t(";
   protected final String TEXT_403 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
   protected final String TEXT_404 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
   protected final String TEXT_405 = "\", getValueLabel(";
   protected final String TEXT_406 = ".eINSTANCE.get";
   protected final String TEXT_407 = "(), ";
   protected final String TEXT_408 = ", ";
   protected final String TEXT_409 = ") }),";
   protected final String TEXT_410 = NL + "\t\t\t\t\t\t new Object[] { ";
   protected final String TEXT_411 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn ";
   protected final String TEXT_412 = "validate";
   protected final String TEXT_413 = "_";
   protected final String TEXT_414 = "(";
   protected final String TEXT_415 = ", ";
   protected final String TEXT_416 = ", ";
   protected final String TEXT_417 = ");";
   protected final String TEXT_418 = NL + "\t\t// TODO implement the constraint" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
   ...
   protected final String TEXT_424 = "\", getValueLabel(";
   protected final String TEXT_425 = ".eINSTANCE.get";
   protected final String TEXT_426 = "(), ";
   protected final String TEXT_427 = ", ";
   protected final String TEXT_428 = ") }),";
   protected final String TEXT_429 = NL + "\t\t\t\t\t\t new Object[] { ";
   protected final String TEXT_430 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
   protected final String TEXT_431 = NL + "\t\t// TODO override the constraint, if desired" + NL + "\t\t// -> uncomment the scaffolding" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
   protected final String TEXT_432 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
   protected final String TEXT_433 = ".add" + NL + "\t\t\t\t\t(new ";
   protected final String TEXT_434 = NL + "\t\t\t\t\t\t(";
   protected final String TEXT_435 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
   protected final String TEXT_436 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
   protected final String TEXT_437 = "\", getObjectLabel(";
   protected final String TEXT_438 = ", ";
   protected final String TEXT_439 = ") }),";
   protected final String TEXT_440 = NL + "\t\t\t\t\t\t new Object[] { ";
   protected final String TEXT_441 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn ";
   protected final String TEXT_442 = "validate";
   ...
   protected final String TEXT_453 = NL + "\t\t// TODO implement the constraint" + NL + "\t\t// -> specify the condition that violates the constraint" + NL + "\t\t// -> verify the diagnostic details, including severity, code, and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
   protected final String TEXT_454 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
   protected final String TEXT_455 = ".add" + NL + "\t\t\t\t\t(new ";
   protected final String TEXT_456 = NL + "\t\t\t\t\t\t(";
   protected final String TEXT_457 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
   protected final String TEXT_458 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
   protected final String TEXT_459 = "\", getObjectLabel(";
   protected final String TEXT_460 = ", ";
   protected final String TEXT_461 = ") }),";
   protected final String TEXT_462 = NL + "\t\t\t\t\t\t new Object[] { ";
   protected final String TEXT_463 = " }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
