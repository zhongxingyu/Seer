 ...
 public class GameUpdater implements Runnable {	 
 	...
 	protected String[] certificateRefusedMessage = { "   applet .", "   ", "    ." };
    ...
    protected void loadJarURLs() throws MalformedURLException, IOException  {
 	   ...
 	   if (nativeJar == null)
 		   fatalErrorOccured("  lwjgl natives", null);
 	   else
    ...
    public void run() {
 	   ...
 	   try {
 		   ...
 		   fatalErrorOccured("  url (" + e.getMessage() + ")",e);
 	   }catch (Exception e) {
      ...
      for (int i = 0; i < this.urlList.length; i++) {
        ...
        while (downloadFile) {
          ...
          while ((bufferSize = inputstream.read(buffer, 0, buffer.length)) != -1)
          {
            ...
            this.subtaskMessage = (": " + currentFile + " " + this.currentSizeDownload * 100 / this.totalSizeDownload + "%");
          ...
          if (unsuccessfulAttempts < maxUnsuccessfulAttempts) {
            ...
            throw new Exception("   " + currentFile);
          }
        }
