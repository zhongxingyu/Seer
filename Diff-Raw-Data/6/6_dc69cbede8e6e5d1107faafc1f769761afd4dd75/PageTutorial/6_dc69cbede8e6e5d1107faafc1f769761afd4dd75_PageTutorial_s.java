 ...
 public class PageTutorial extends Page{
     public PageTutorial(final float pWidth, final float pHeight, int worldId, final VertexBufferObjectManager pVertexBufferObjectManager){
        ...
        this.addElement(new PageElement(0, 0, 0, false, ResourcesManager.getInstance().lvlJump, pVertexBufferObjectManager));
        this.addElement(new PageElement(0, 0, 1, false, ResourcesManager.getInstance().lvlRoll, pVertexBufferObjectManager));
        this.addElement(new PageElement(0, 0, 2, false, ResourcesManager.getInstance().lvlDoubleJump, pVertexBufferObjectManager));
