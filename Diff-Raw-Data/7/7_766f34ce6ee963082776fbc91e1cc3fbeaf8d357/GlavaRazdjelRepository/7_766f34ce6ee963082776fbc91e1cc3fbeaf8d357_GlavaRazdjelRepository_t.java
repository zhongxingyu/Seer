 ...
 public class GlavaRazdjelRepository implements SpjRepository
 {
     ...
     {
        GlavaRazdjelDTO glavaRazdjelDTO = entityManager.find(GlavaRazdjelDTO.class,cast(spjDomainModel).getSifraGlavaRazdjel());
        entityManager.remove(glavaRazdjelDTO);
     }
 
     @Override
     public List<? extends SpjDomainModel> findAll()
     {
        TypedQuery<GlavaRazdjelDTO> query = entityManager.createQuery("SELECT gr FROM glava_razdjel gr", GlavaRazdjelDTO.class);
