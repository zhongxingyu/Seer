 ...
 public final class Launcher extends Activity
     ...
     private static final String TAG = "ChaOSLauncher.Launcher";
     ...
     static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
             "org.chameleonos.chaoslauncher.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
     ...
     protected void onActivityResult(
         ...
         if (resultCode == RESULT_OK && mPendingAddInfo.container != org.chameleonos.chaoslauncher.ItemInfo.NO_ID) {
     ...
     private void restoreState(Bundle savedState) {
         ...
         if (pendingAddContainer != org.chameleonos.chaoslauncher.ItemInfo.NO_ID && pendingAddScreen > -1) {
 ...
 >>>>>>> Scale the icon bitmap associated with icons and not the entire view which included the text
     ...
     void completeAddApplication(Intent data, long container, int screen, int cellX, int cellY) {
         ...
         if (info != null) {
             ...
             info.container = org.chameleonos.chaoslauncher.ItemInfo.NO_ID;
...
>>>>>>> Trebuchet: fix uninstall app from shortcut
     ...
     private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
         ...
         public void onReceive(Context context, Intent intent) {
             ...
             if (Intent.ACTION_SCREEN_OFF.equals(action)) {
                 ...
                 if (mAppsCustomizeTabHost != null && mPendingAddInfo.container == org.chameleonos.chaoslauncher.ItemInfo.NO_ID) {
     ...
     protected void onSaveInstanceState(Bundle outState) {
         ...
         if (mPendingAddInfo.container != org.chameleonos.chaoslauncher.ItemInfo.NO_ID && mPendingAddInfo.screen > -1 &&
                 mWaitingForResult) {
 ...
 >>>>>>> Always show overflow menu and fix layout where market icon would overlap menu icon
     ...
     private void resetAddInfo() {
         mPendingAddInfo.container = org.chameleonos.chaoslauncher.ItemInfo.NO_ID;
