 ...
 public class TestGetAccountJavascriptServlet extends AbstractGetAccountJavascriptServlet {
     ...
     protected List<String> getUrlList(HttpServletRequest request) {
        ...
        returnList.add(request.getContextPath() + "/GetJavascript/Static/1528795644/script.js");
        returnList.add(request.getContextPath() + "/GetJavascript/Dynamic/9876543210/script.js?thisis=aparam&thatis=anotherone");
