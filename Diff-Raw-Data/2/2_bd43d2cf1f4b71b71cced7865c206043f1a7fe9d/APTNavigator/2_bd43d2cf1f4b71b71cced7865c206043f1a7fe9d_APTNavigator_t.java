 ...
 public class APTNavigator implements Navigator<TypeMirror,TypeDeclaration,FieldDeclaration,MethodDeclaration> {
      ...
      */
     abstract class APTTypeVisitor<ParamT> {
         public final TypeMirror apply(TypeMirror type, ParamT param) {
         ...
         protected abstract TypeMirror onArrayType(ArrayType type, ParamT param);
         protected abstract TypeMirror onClassType(ClassType type, ParamT param);
         protected abstract TypeMirror onInterfaceType(InterfaceType type, ParamT param);
         protected abstract TypeMirror onTypeVariable(TypeVariable type, ParamT param);
         protected abstract TypeMirror onWildcard(WildcardType type, ParamT param);
      ...
      */
     private final APTTypeVisitor<TypeDeclaration> baseClassFinder = new APTTypeVisitor<TypeDeclaration>(){
