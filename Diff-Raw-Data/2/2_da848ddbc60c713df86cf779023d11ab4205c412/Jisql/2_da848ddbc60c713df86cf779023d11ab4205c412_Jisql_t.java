  ...
  * does not try to make the output look &quot;better&quot; By specifying a value
 ...
 public class Jisql {
    ...
    private static final String defaultFormatterClassName = "com.xigole.util.sql.outputformatter.DefaultFormatter";
     ...
     private void usage() {
         System.err.println();
         System.err.println( "Jisql v" + Version.version + " (built " + Version.buildDate + ") copyright (c) 2011 Scott Dunbar (scott@xigole.com)" );
     ...
     /*
      * I haven't converted to the 1.6 Console class yet as I'm still trying to
      * maintain some backward compatibility.  So I'm using this method until that
      * time.
      * 
      * This is a pretty big hack. Basically the problem is that Java provides no
      * O/S independent way of doing screen manipulation such as preventing the
      * echoing of password characters (see
      * http://bugs.sun.com/bugdatabase/view_bug.do;:WuuT?bug_id=4050435 for more
      * information). So a thread is created that runs in the background that
      * prints over the same place that the password characters are being echoed.
      * This kinda works but it can look a little wierd - the prompt text can
      * flash a little.
      * <p>
      * This code is taken from
      * http://java.sun.com/features/2002/09/pword_mask.html - both this method
      * and the MaskingThread class have come from that article. The article
      * states
      * <p>
      * <quote> Feel free to reuse and improve the code in this article for your
      * applications. </quote>
      * <p>
      * So I think that it should be ok to include it here.
      * 
      */
