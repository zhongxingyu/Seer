 ...
 public class ServeStaticContent implements ChainFilter
 {
 	...
 	@Override
	public void filter(Filter filterOptions) throws LogicException
 	{
 	 ...
 	 * @throws Exception
 	 */
	private void serveStatic(String path) throws LogicException
 	{
 		try
 		{
 		...
 		catch(Exception e)
 		{
			...
			throw new LogicException(404, e.getMessage());
 		}
 	}
