 ...
 * $Id: FAMConstants.java,v 1.1 2008-07-02 18:50:36 kanduls Exp $
 ...
 public interface FAMConstants extends AMTuneConstants {
     static String FAMADM_LOCATION = "FAMADM_LOCATION";
     static String FAMSERVER_URL = "FAMSERVER_URL";
     static String FAMADM_USER = "FAMADM_USER";
     static String FAM_CONFIG_DIR = "FAM_CONFIG_DIR";
     ...
     static String FAMADM_SERVER = "--servername";
     ...
     static String SUN_DSAM_SCHEMA_NAME = "Sun DS with AM schema";
     static String GENERIC_LDAPV3 = "generic ldapv3";
