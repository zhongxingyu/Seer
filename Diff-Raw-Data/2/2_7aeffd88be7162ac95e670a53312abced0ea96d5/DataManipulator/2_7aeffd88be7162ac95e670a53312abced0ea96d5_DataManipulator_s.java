 ...
 public class DataManipulator
 {
 	...
 	private static class OpenHelper extends SQLiteOpenHelper
 	{
 		...
 		public void onCreate(SQLiteDatabase db)
 		{
			...
			db.execSQL("CREATE TABLE " + res.getString(R.string.routes_to_points_table_name) + " (_id INTEGER PRIMARY KEY AUTOINCREMENT, end1 INTEGER, end2 INTEGER, routeId INTEGER, order INTEGER)");
