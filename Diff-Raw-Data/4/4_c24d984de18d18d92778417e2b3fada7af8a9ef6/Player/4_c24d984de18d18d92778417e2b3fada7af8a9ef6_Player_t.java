 ...
 public class Player {
     ...
     private String getPlayerImage() {
         try {
             ...
             if (doc.getElementsByTag("h3") != null) {
                 if (doc.getElementsByTag("h3").get(0).getElementsByTag("a") != null) {
                     String href = doc.getElementsByTag("h3").get(0).getElementsByTag("a").get(0).attr("href");
                     doc = Jsoup.connect(href).get();
                     if (doc.getElementsByClass("main-headshot") != null) {
                         if (doc.getElementsByClass("main-headshot").get(0).getElementsByTag("img") != null) {
