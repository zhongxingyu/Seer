 ...
 public class ControllerConstruct
 {
 	...
 	public static ControllerMethodPerformer construct(Environ env, String controllerName, String actionName,
			Map<String, ControllerClass> context) throws LogicException, InitializeException, MethodException, ConfigException
 	{
		...
		Object instance = ClassLoader.constructClass(controlerClass.getControllerClass(), env);
