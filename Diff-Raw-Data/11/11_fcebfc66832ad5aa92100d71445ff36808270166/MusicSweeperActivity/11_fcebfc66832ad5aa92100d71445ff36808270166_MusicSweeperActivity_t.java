 ...
 //		setMyEditText(key);
     ...
     private String getApplicationHelpMsg() {
		return "Short press plays song \r\n" +
		"Long press shows menu for stop and delete \r\n" +
		"Use reset button for soft reset (re-order) list \r\n" +
 		"Use back button or hard refresh to re-query for songs \r\n" +
		"Use home button or quit to stop using the application \r\n" +
		"Use menu button for additional functions";
     }
