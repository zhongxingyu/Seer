 ...
 */
 ...
 public class HttpRequest
 {
    ...
    protected HttpRequest(String path, String request_type, Hashtable<String, String> headers, Hashtable<String, String> cookies, Hashtable<String, String> post_data, String raw_post, Hashtable<String, String> get_data, String raw_get, Socket socket, PlaceboHttpServer myServer)
     {
         this.path = path;
