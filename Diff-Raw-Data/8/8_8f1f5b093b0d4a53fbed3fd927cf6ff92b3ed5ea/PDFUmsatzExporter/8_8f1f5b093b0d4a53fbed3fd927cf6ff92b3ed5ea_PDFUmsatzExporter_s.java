 ...
 public class PDFUmsatzExporter implements Exporter
 {
       ...
       ApplicationException
   {
     ...
     if (objects == null || objects.length == 0)
       throw new ApplicationException(i18n.tr("Bitte whlen Sie die zu exportierenden Umstze aus"));
     ...
     if (monitor != null) 
     {
       monitor.setStatusText(i18n.tr("Ermittle zu exportierende Umstze und Konten"));
     ...
     try
     {
       ...
       table.addCell(getDetailCell("Empfnger/Einzahler",     Element.ALIGN_CENTER,Color.LIGHT_GRAY));
      ...
      table.setHeaderRows(2);
       ...
       if (monitor != null)
       {
         ...
         monitor.setStatusText(i18n.tr("Exportiere Umstze"));
       }
       ...
       while (konten.hasMoreElements())
       {
         ...
         if (list.size() == 0)
         {
           PdfPCell empty = getDetailCell(i18n.tr("Keine Umstze"), Element.ALIGN_CENTER,Color.LIGHT_GRAY);
           empty.setColspan(5);
           table.addCell(empty);
           continue;
         }
     ...
     finally
     {
       if (monitor != null)
       {
         monitor.setStatusText(i18n.tr("Schliee PDF-Datei"));
       }
       if (rpt != null)
         rpt.close();
     }
