 ...
 public class OracleXmlTypeDataTypeComponent extends BaseDataTypeComponent
     ...
     private static ILogger s_log = 
         LoggerController.createLogger(OracleXmlTypeDataTypeComponent.class);
     ...
     static interface i18n {
         ...
         String CELL_ERROR_MSG = 
             s_stringMgr.getString("OracleXmlTypeDataTypeComponent.cellErrorMsg");
     }
      ...
      * issues using the XDK to display the data.  If we should encounter 
      * Exceptions using XDK, then we should prevent the user from editing the 
      * cell (our error message is not meant to be valid XML data; further, we 
      * don't want to let the user whack their data with our tool accidentally)
      * 
     ...
     /**
      * This Data Type can be edited in a popup as long as there are no 
      * issues using the XDK to display the data. If we should encounter 
      * Exceptions using XDK, then we should prevent the user from editing the 
      * cell (our error message is not meant to be valid XML data; further, we 
      * don't want to let the user whack their data with our tool accidentally)
