 ...
 public class CassandraUtilities
 {
     ...
     public static byte[] serializeToStream(Object o)
     {
         ...
         {
             LogUtil.getLogger(CassandraUtilities.class.getName()).info( LogUtil.throwableToString(e) );
         }
 		return bytes;
     }
     ...
     public static byte[] hash(String type, byte[] data)
     {
         ...
         {
     		LogUtil.getLogger(CassandraUtilities.class.getName()).debug(LogUtil.throwableToString(e));
     	}
     	return result;
 	}
