 ...
 public class EffectsConstants {
 	 ...
 	 public static final String BOUNCE = "${jquery.ui.path}/jquery.effects.bounce.js";
 	 
 	 public static final String CLIP = "${jquery.ui.path}/jquery.effects.clip.js";
 	 ...
 	 public static final String PULSATE = "${jquery.ui.path}/jquery.effects.pulsate.js";
 	 
 	 public static final String SCALE = "${jquery.ui.path}/jquery.effects.scale.js";
 	 
 	 public static final String SHAKE = "${jquery.ui.path}/jquery.effects.shake.js";
 	 
 	 public static final String SLIDE = "${jquery.ui.path}/jquery.effects.slide.js";
 	 
 	 public static final String TRANSFER = "${jquery.ui.path}/jquery.effects.transfer.js";
