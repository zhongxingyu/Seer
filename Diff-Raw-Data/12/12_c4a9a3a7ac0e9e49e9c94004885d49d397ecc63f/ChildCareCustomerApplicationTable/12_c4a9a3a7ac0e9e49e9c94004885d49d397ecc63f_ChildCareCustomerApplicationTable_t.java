 ...
 * @version $Id: ChildCareCustomerApplicationTable.java,v 1.17 2003/04/16 11:35:51 roar Exp $
 ...
 //		cancelBtn.setName(CANCEL[0] + PAGE_2);
 	...
 	private Table getHelpTextPage1(){
 		...
 		Text t =  getLocalizedSmallText("ccatp1_help", "Om du accepterar erbjudande kan du enbart kvarst i k till i de ovanstende valen. Du stryks automatiskt frn de underliggande alternativen. Om ditt erbjudande gller ditt frstahandsval har du mjlighet att vlja att kvarst i k fr ETT alternativ av de underliggande alternativen.");
 		t.setItalic(true); 
 		tbl.add(t);
 		return tbl;
 	}
