 ...
 * Provide some logging management APIs such as the ability to redirect logs to an {@link EventListener}.
 ...
 public interface LoggerManager
 {
      ...
      * </p><p>
      * After this method is called, logs will be only be received as XWiki events sent to the provided listener.
      * In addition, it also overrides any previous call to {@link #pushLogListener(EventListener)} (which will get
      * active again after a call to {@link #popLogListener()}).
      * </p>
      *
