 ...
 */
 public class IndexMessageHandler implements HPCMessageHandler {
 	...
 	public HPCMessage handle(HPCMessage message)
		...
		if(indexClass == null) {
			log.error("No class name found for the property 'default.index.server' in indexprovider.properties");
			throw new ParsingException("Configuration Error");
		}
 		...
 		try {
			...
			log.error("Error instantiating class: '" + indexClass + "' - " + e.getMessage());
