 ...
 public class ContentAssistTest extends AbstractXbaseContentAssistInBlockTest implements IJavaProjectProvider {
 	...
 	public void testRichString_02() throws Exception {
 		newBuilder().append("'''foobarnull'''").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''foobarnull''").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''foobarnull'").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''foobarnull").assertTextAtCursorPosition("foobar", "");
 	}
 	...
 	public void testRichString_03() throws Exception {
 		newBuilder().append("'''nullzonkfoobar'''").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''nullzonkfoobar''").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''nullzonkfoobar'").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''nullzonkfoobar").assertTextAtCursorPosition("foobar", "");
 	}
 	...
 	public void testRichString_04() throws Exception {
 		newBuilder().append("'''nullzonkfoobarnull'''").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''nullzonkfoobarnull''").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''nullzonkfoobarnull'").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''nullzonkfoobarnull").assertTextAtCursorPosition("foobar", "");
 	}
 	...
 	public void testRichString_06() throws Exception {
 		newBuilder().append("'''\n comment \nfoobarnull'''").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''\n comment \nfoobarnull''").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''\n comment \nfoobarnull'").assertTextAtCursorPosition("foobar", "");
 		newBuilder().append("'''\n comment \nfoobarnull").assertTextAtCursorPosition("foobar", "");
 	}
 	...
 	public void testRichString_08() throws Exception {
 		newBuilder().append("'''\n comment foobarnull'''").assertTextAtCursorPosition("foobar");
 	}
