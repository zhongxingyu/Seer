 ...
 //    }
 	...
 	*/
     		...
     		int x1, int y1, int x2, int y2)
     {
         ...
         Shape edgeShape = edgeShapeFunction.getShape(graph, e);
    ...
    public Component prepareRenderer(GraphLabelRenderer<V,E> renderer, Object value, 
     ...
     protected void labelEdge(Graphics2D g2d, Graph<V,E> graph, E e, String label, int x1, int x2, int y1, int y2) 
     {
         ...
         parallelOffset += parallelEdgeIndexFunction.getIndex(graph, e);
     ...
     public void paintIconForVertex(Graphics g, V v, int x, int y) {
         ...
         if(icon == null) {
             paintShapeForVertex((Graphics2D)g, v, vertexShapeFunction.getShape(v));
         }
