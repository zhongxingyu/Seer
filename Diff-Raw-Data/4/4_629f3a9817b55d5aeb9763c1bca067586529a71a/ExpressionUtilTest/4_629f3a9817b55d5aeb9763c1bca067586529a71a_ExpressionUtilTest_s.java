 ...
 public class ExpressionUtilTest extends TestCase
 {
 	...
 	public void testToNewExpression( )
 	{
 		...
 		String[] newExpressions = new String[]{
 				null,
 	...
 	public void testreplaceRowsExpression( )
 	{
 		...
 		for ( int i = 0; i < oldExpressions.length; i++ )
 		{
 			assertEquals( ExpressionUtil.updateParentQueryReferenceExpression( oldExpressions[i],
 					false ),
 					newExpressions[i] );
 		}
 		...
 		assertEquals( ExpressionUtil.updateParentQueryReferenceExpression( paramBinding,
 				true ),
 				result );
 	}
 	...
 	public void testGetColumnBindingName( ) throws BirtException
 	{
 		...
 		assertTrue( ExpressionUtil.getColumnBindingName( "row[\"col1\"]" )
 				.equals( "col1" ) );
 		assertTrue( ExpressionUtil.getColumnBindingName( "row[\"col1\"+1]" )
 				.equals( "col11" ) );
