 ...
 public class SerenityGallery extends SerenityAbsSpinner implements
 	...
 	public SerenityGallery(Context context, AttributeSet attrs) {
 	...
 	public SerenityGallery(Context context, AttributeSet attrs, int defStyle) {
 		...
 		TypedArray a = context.obtainStyledAttributes(attrs,
 				R.styleable.EcoGallery, defStyle, 0);
 		...
 		int animationDuration = a.getInt(
 				R.styleable.EcoGallery_animationDuration, -1);
 		if (animationDuration > 0) {
 			setAnimationDuration(animationDuration);
 		}
 
 		int spacing = a.getDimensionPixelOffset(R.styleable.EcoGallery_spacing,
 				0);
 		setSpacing(spacing);
 		...
 		try {
 			...
 			FLAG_SUPPORT_STATIC_TRANSFORMATIONS = supportStaticTrans
 					.getInt(this);
 	...
 	protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
 		 ...
 		 */
 		return new SerenityGallery.LayoutParams(
 ...
 //		}
 	...
 	private void setUpChild(View child, int offset, int x, boolean fromLeft) {
 		...
 		// make some up...
 		SerenityGallery.LayoutParams lp = (SerenityGallery.LayoutParams) child
 				.getLayoutParams();
 		if (lp == null) {
 			lp = (SerenityGallery.LayoutParams) generateDefaultLayoutParams();
 		}
