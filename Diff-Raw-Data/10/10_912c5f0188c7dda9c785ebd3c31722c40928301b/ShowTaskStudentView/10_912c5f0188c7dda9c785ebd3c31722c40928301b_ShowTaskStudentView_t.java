 	...
 	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
 		...
 		if (submission != null) {
			...
			if ("loesung\\.(xmi|zargo|png)".equals(task.getFilenameRegexp())) {
 				out.println("<p><div class=mid><a onclick=\"return confirmLink('ArgoUML ffnen')\" href=\"WebStart?tool=argouml&amp;taskid=" + task.getTaskid() + "\">ArgoUML ffnen</a></div>");
				out.println("<script type=\"javascript\">if (!navigator.javaEnabled() || document.applets[0].Version < 1.4){ document.write(\"Sie bentigen mindestens Java 1.6 (JRE), um diese Funktion nutzen zu knnen. <a href=\"http://www.java.com/\">Download</a>\");</script>");
 			}
