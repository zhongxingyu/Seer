 ...
 */
 ...
 //	}
 	...
 	public void setparam(double filterLargeDia, double filterSmallDia, int choiceIndex, double toleranceDia, 
 			boolean doScalingDia, boolean saturateDia, boolean displayFilter, boolean processStack){
 		setFilterLargeDia(filterLargeDia);
 		setFilterSmallDia(filterSmallDia);
 		setChoiceIndex(choiceIndex);
 		choiceDia = choices[choiceIndex];
 		setToleranceDia(toleranceDia);
 		setDoScalingDia(doScalingDia);
 		setSaturateDia(saturateDia);
 		setDisplayFilter(displayFilter);
 		setProcessStack(processStack);
 	}
 	
 	public String returnParameterString(){
 		String fftargument = 
 			"filter_large="+Double.toString(filterLargeDia) +"\n"
 			+" filter_small="+Double.toString(filterSmallDia) +"\n"
 			//+" suppress="+suppress +"\n"
 			+" tolerance="+Double.toString(toleranceDia) +"\n"
 			+" process" + Boolean.toString(processStack);
 			return fftargument;
 	}
 	...
 	public static void setFilterLargeDia(double filterLargeDia) {
 		FFTFilter_NoGenDia.filterLargeDia = filterLargeDia;
 	}
 	...
 	public static void setFilterSmallDia(double filterSmallDia) {
 		FFTFilter_NoGenDia.filterSmallDia = filterSmallDia;
 	}
 	...
 	public static void setChoiceIndex(int choiceIndex) {
 		FFTFilter_NoGenDia.choiceIndex = choiceIndex;
 	}
 	...
 	public static void setToleranceDia(double toleranceDia) {
 		FFTFilter_NoGenDia.toleranceDia = toleranceDia;
 	}
 
 	public static boolean isDoScalingDia() {
 		return doScalingDia;
 	}
 
 	public static void setDoScalingDia(boolean doScalingDia) {
 		FFTFilter_NoGenDia.doScalingDia = doScalingDia;
 	}
 
 	public static boolean isSaturateDia() {
 		return saturateDia;
 	}
 
 	public static void setSaturateDia(boolean saturateDia) {
 		FFTFilter_NoGenDia.saturateDia = saturateDia;
 	}
 
 	public static boolean isDisplayFilter() {
 		return displayFilter;
 	}
 
 	public static void setDisplayFilter(boolean displayFilter) {
 		FFTFilter_NoGenDia.displayFilter = displayFilter;
 	}
 
 	public static boolean isProcessStack() {
 		return processStack;
 	}
 
 	public static void setProcessStack(boolean processStack) {
 		FFTFilter_NoGenDia.processStack = processStack;
 	}
 }
