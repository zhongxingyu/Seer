 ...
 public class GenerateHtml
 {
 			...
 			AttributeInterface attribute, EntityInterface entity)
 	{
 		...
 		if (attrDetails.getDataType().equalsIgnoreCase(Constants.DATE))
 		{
 			html.append(newLine).append(
 					generateHTMLForCalendar(componentId, false, attrDetails.isBetween(), cssClass));
 		}
 		else
 		{
 			html.append("\n<td valign='top' />");
 	...
 	private static void getHtmlValueAndOperator(List<String> values, String operator,
 			String textBoxId, StringBuffer html)
 	{
 	...
 	private static void getHtmlValueNull(String operator, String textBoxId, StringBuffer html)
 	{
 		...
 		if (operator == null)
 		{
 			temp = "<input style=\"width:150px; display:block;\" type=\"text\" name=\"" + textBoxId
 					+ "\" id=\"" + textBoxId + "\">";
 			html.append(temp);
 		}
 		else
 			...
 			List<String> operatorList, boolean isSecondTime)
 	{
 		...
 		if (operatorList != null && !operatorList.isEmpty())
 		{
 			String html = "\n<td width='15%'  valign='top' >" + "\n<select "
 					+ " style=\"width:150px; display:block;\" name=\"" + comboboxName + "\" id = '"
 					+ comboboxName + "'onChange=\"operatorChanged('" + componentId + "','true')\">";
 	...
 	public static boolean checkBetweenOperator(String operator)
 	{
 		...
 		if (operator != null && operator.equalsIgnoreCase(RelationalOperator.Between.toString()))
 		{
 			isBetween = true;
 		}
 		return isBetween;
 			...
 			String compIdofID)
 	{
 		...
 		if (operatorsList != null && !operatorsList.isEmpty())
 		{
 			...
 			html.append("\n<select  class=" + cssClass
 					...
 					+ "_combobox\" onChange=\"changeIdOperator('" + componentId + "','"
 					+ compIdofID + "')\">");
 			getHtmlForSelectedOperator(attributeDetails, cssClass, html, operatorsList);
 			html.append("\n</select>");
 			html.append(endTD);
