 ...
 public class UserStatusTab extends UserTab {
 	...
 	public void initializeFields() {
		...
		_boardStatusField = new SelectDropdown(_boardStatusFieldName);
 		 ...
 		 */		
 		_statusField.addOption(new SelectOption("Flagsmaur","0"));
 		_statusField.addOption(new SelectOption("Ikandi","1"));
 		_statusField.addOption(new SelectOption("Keppandi","2"));
 		_statusField.addOption(new SelectOption("Stjrnarmaur","3"));
 		_statusField.addOption(new SelectOption("jlfari","4"));
 		_statusField.addOption(new SelectOption("Astoarjlfari","5"));
 		_statusField.addOption(new SelectOption("Dmari","6"));
 		_statusField.addOption(new SelectOption("Foreldri","7"));
 		_statusField.addOption(new SelectOption("Forramaur","8"));
 		_statusField.addOption(new SelectOption("Starfsmaur","9"));
 		_statusField.addOption(new SelectOption("Styrktaraili","10"));
 		_statusField.addOption(new SelectOption("Aukaflokkur","11"));
 		_statusField.addOption(new SelectOption("Ik.  rinu","12"));
 		_statusField.addOption(new SelectOption("Flagsmaur","13"));
 		_statusField.addOption(new SelectOption("Flagsmaur","14"));
 		
 		_parentStatusField.addOption(new SelectOption("","0"));
 		_parentStatusField.addOption(new SelectOption("Forramaur I","1"));
 		_parentStatusField.addOption(new SelectOption("Forramaur II","2"));
 		_parentStatusField.addOption(new SelectOption(" foreldrari","3"));
 		_parentStatusField.addOption(new SelectOption(" unglinganefnd","4"));
 		_parentStatusField.addOption(new SelectOption("Vill taka tt  flagsstarfi","5"));
 		
 		_boardStatusField.addOption(new SelectOption("","0"));
 		_boardStatusField.addOption(new SelectOption("Formaur","0"));
 		_boardStatusField.addOption(new SelectOption("Varaformaur","0"));
 		_boardStatusField.addOption(new SelectOption("Gjaldkeri","0"));
 		_boardStatusField.addOption(new SelectOption("Ritari","0"));
 		_boardStatusField.addOption(new SelectOption("Mestjrnandi","0"));
 		_boardStatusField.addOption(new SelectOption("Framkvmdastjri","0"));
 	}
