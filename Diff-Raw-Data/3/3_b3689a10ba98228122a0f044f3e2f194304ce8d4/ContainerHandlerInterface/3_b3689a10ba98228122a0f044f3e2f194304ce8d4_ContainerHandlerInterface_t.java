 ...
 public interface ContainerHandlerInterface {
      ...
      * <p/>
      * The provided XML data in the body is only accepted if the size is less than ESCIDOC_MAX_XML_SIZE.<br/> See
      * chapter 4 for detailed information about input and output data elements<br/>
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The XML data is validated against the XML-Schema of a container.</li> <li>It's
      * checked weather the context id is provided. In a REST case it's checked weather REST-URL of a context is
      ...
      * <li>It's checked weather the content-model to the provided id exists.</li> <li>If a "struct-map" section is set,
      * it's checked weather resources to all provided member ids exist.</li> <li>If a "relations" section is set, it's
      * checked weather resources to all provided relations targets exist and weather used relations are part of the
      * related ontologies.</li> <li>The public-status of the container is set to "pending".</li> <li>The Version 1 of
      * the container is created. All members referenced in the struct-map are added to the container.</li> <li>The
      * container is added to the provided context.</li> <li>The XML input data is updated and some new data is
      * added.</li> <li>The XML representation of the container corresponding to XML-schema is returned as output.</li>
      * </ul>
      * <p/>
      * See chapter 4 for detailed information about input and output data elements.<br/> Creates a resource container
      * with the provided data.
      *
      * @param xmlData The XML representation of the container to be created corresponding to XML-schema
      *                "container.xsd".
      ...
      * @throws ContentModelNotFoundException  Thrown if the content model specified in the provided data cannot be
      *                                        found.
      ...
      * @throws MissingAttributeValueException Thrown if an value of an attribute not set, but expected.
      * @throws MissingElementValueException   Thrown if a text of an element not set, but expected.
      * @throws MissingMdRecordException       Thrown if the required metadata record (with name 'escidoc') is not
      *                                        provided.
      * @throws SystemException                Thrown if a framework internal error occurs.
      * @throws RelationPredicateNotFoundException
      *                                        Thrown if a content relation predicate specified in the provided data does
      *                                        not belong to the provided ontology.
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided Id.</li> <li>The container will be
      * deleted from IR.</li> <li>No data is returned.</li> </ul>
      * <p/>
      ...
      *                                    locked it.
      * @throws InvalidStatusException     Thrown if a container in the current status is not allowed to delete.
      * @throws SystemException            Thrown if a framework internal error occurs.
      * @throws MissingMethodParameterException
      ...
      * The container must exist<br/>
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>The XML
      * representation of the container corresponding to XML-schema is returned as output.</li> </ul>
      *
      * @param id The id of the container.
      ...
      * respectively the attribute "objid" is set to id of the target. A target id may not contain a version
      * number.<br/>
      * <p/>
      * The section "struct-map" is read-only section. It will be discarded and set by the framework.<br/>
      * <p/>
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>The XML data is validated against the XML-Schema of a container.</li> <li>If
      * changed, the internal metadata record is updated.</li> <li>If the status of the version is "released" a new
      * version is created and gets the status "pending" otherwise a new version is created with the same status as
      * before.</li> <li>If the container is modified a new version of the container is created.</li> <li>The XML input
      * data is updated and some new data is added.</li> <li>The XML representation of the container corresponding to
      * XML-schema is returned as output.</li> </ul> <b>Note:</b> The status of a container can't bet changed by this
      * method nor can't it be moved to a different context. Please use the methods dedicated for this purpose.<br/>
      *
      * @param id      The id of the container.
      * @param xmlData The XML representation of the container to be updated corresponding to XML-schema
      *                "container.xsd".
      * @return The XML representation of the updated container corresponding to XML-schema "container.xsd".
      * @throws ContainerNotFoundException     Thrown if a container with the provided id does not exist in the
      *                                        framework.
      * @throws LockingException               Thrown if the container is locked and the current user is not the one who
      *                                        locked it.
      * @throws InvalidContentException        Thrown if the provided data for the resource is invalid.
      * @throws MissingMethodParameterException
      ...
      * @throws InvalidXmlException            Thrown if the schema validation of the provided data fails or provided
      *                                        data is corrupted.
      * @throws OptimisticLockingException     If the provided latest-modification-date does not match.
      * @throws InvalidStatusException         Thrown if a container in the current status is not allowed to update.
      * @throws ReadonlyVersionException       If the provided container id does not identify the latest version.
      * @throws SystemException                Thrown if a framework internal error occurs.
      * @throws ReferencedResourceNotFoundException
      *                                        If a resource referred from the provided data could not be found.
      * @throws RelationPredicateNotFoundException
      ...
      *
      * @param filter The filter criteria to select the containers given as a map of key - value pairs
      ...
      * @throws InvalidXmlException         If the given xml is not valid.
      * @throws MissingMethodParameterException
      ...
      * The public-status is not "withdrawn".<br/>
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Check whether all
      * filter criteria names are valid.</li> <li>The members are accessed using the provided filters.</li> <li>The XML
      * representations of the list of all members corresponding to SRW schema is returned as output</li> </ul> <br/> See
      * chapter "Filters" for detailed information about filter definitions.
      *
      * @param id     The id of the container.
      * @param filter The filter criteria to select the containers given as a map of key - value pairs
      ...
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Check whether all
      * filter criteria names are valid.</li> <li>The members are accessed using the provided filters.</li> <li>The XML
      * representations of the list of all members corresponding to the SRW schema is returned as output</li> </ul> <br/>
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>Add the members to the member list.</li> <li>A new version is created.</li> <li>A
      * XML containing the new latest version timestamp is returned.</li> </ul> The members to be added to the container
      * are listed in the "param" section of the input data using their IDs.
      * <p/>
      ...
      *
      * @param id        The id of the container.
      * @param taskParam The list of Members to add to the container. (See example above.)
      * @return last-modification-date within XML (result.xsd)
      * @throws ContainerNotFoundException     Thrown if a container with the provided id does not exist in the
      *                                        framework.
      * @throws LockingException               Thrown if the container is locked and the current user is not the one who
      *                                        locked it.
      * @throws InvalidContentException        Thrown if for any ids there is no a resource in the framework or the
      *                                        resource is neither Item nor Container.
      * @throws MissingMethodParameterException
      *                                        Thrown if one of expected input parameter is missing.
      * @throws SystemException                Thrown if a framework internal error occurs.
      * @throws InvalidContextException        Thrown if a context of any member differs from a context of the container
      *                                        with the provided id.
      * @throws AuthenticationException        Thrown if authorization fails.
      * @throws AuthorizationException         Thrown if authorization fails.
      * @throws MissingAttributeValueException It a mandatory attribute value is missing.
      * @throws OptimisticLockingException     If the provided latest-modification-date does not match.
      */
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>Add the tocs to the member list.</li> <li>A new version is created.</li> <li>A XML
      * containing the new latest version timestamp is returned.</li> </ul> The tocs to be added to the container are
      * listed in the "param" section of the input data using their IDs.
      * <p/>
      * <b>Parameter for request:</b> (example)<br/>
      * <p/>
      * <pre>
      ...
      *
      * @param id        The id of the container.
      * @param taskParam The list of tocs to add to the container. (See example above.)
      * @return last-modification-date within XML (result.xsd)
      * @throws ContainerNotFoundException     Thrown if a container with the provided id does not exist in the
      *                                        framework.
      * @throws LockingException               Thrown if the container is locked and the current user is not the one who
      *                                        locked it.
      * @throws InvalidContentException        Thrown if for any ids there is no a resource in the framework.
      * @throws MissingMethodParameterException
      *                                        Thrown if one of expected input parameter is missing.
      * @throws SystemException                Thrown if a framework internal error occurs.
      * @throws InvalidContextException        Thrown if a context of any member differs from a context of the container
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>Remove the members from the member list.</li> <li>A new version is created.</li>
      * <li>A XML containing the new latest version timestamp is returned.</li> </ul> The members to be removed from the
      * container are listed in the "param" section of the input data using their IDs.
      * <p/>
      * <b>Parameter for request:</b> (example)<br/>
      * <p/>
      * <pre>
      ...
      * @param taskParam The list of Members to add to the container. (See example above.)
      * @return last-modification-date within XML (result.xsd)
      * @throws ContextNotFoundException      Thrown if provided Context could not be found
      * @throws LockingException              Thrown in case of an optimistic locking error.
      * @throws XmlSchemaValidationException  Thrown if the schema validation of the provided data fails.
      * @throws ItemNotFoundException         Thrown if the removed member should be an Item but could not be found
      * @throws ContainerNotFoundException    Thrown if the removed member should be an Container but could not be found
      * @throws InvalidContextStatusException Thrown if the Context is in invalid status
      * @throws InvalidItemStatusException    Thrown if the Item member is in invalid status
      * @throws AuthenticationException       Thrown if authorization fails.
      * @throws AuthorizationException        Thrown if authorization fails.
      * @throws SystemException               Thrown if a framework internal error occurs.
      * @throws InvalidContentException       Thrown if the taskParam has invalid content
      */
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>Add new metadata record to the container.</li> <li>The container is marked for
      * indexing (to be done by SB).</li> <li>A new version is created.</li> <li>In case of public-status "released", the
      * status of the new version is set to "pending".</li> <li>Timestamp for the container of the latest modification in
      * the system is updated to the current time.</li> <li>The XML data is returned.</li> </ul>
      *
      * @param id      The id of the container.
      * @param xmlData The XML representation of the metadata record to be created.
      ...
      * @throws AuthorizationException     Thrown if authorization fails.
      * @throws SystemException            Thrown if a framework internal error occurs.
      * @throws InvalidXmlException        Thrown if taskParam contains invalid data.
      */
     @Deprecated
      ...
      * <b>Prerequisites:</b><br/>
      * <p/>
      * The container must exist<br/> The metadata record with the provided name must exist in the container<br/>
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>The XML data for the
      * Metadata Record is created.</li> <li>The XML data is returned.</li> </ul>
      *
      * @param id         The id of the container.
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>Update the Metadata Record.</li> <li>The container is marked for indexing (to be
      * done by SB).</li> <li>A new version is created.</li> <li>In case of public-status "released", a new revision will
      * be created.</li> <li>Timestamp of the latest modification in the system is updated to the current time.</li>
      * <li>The updated XML data is returned as output.</li> </ul>
      *
      * @param id         The id of the container.
      * @param mdRecordId The id of the metadata record.
      * @param xmlData    The XML Metadata Record for the container.
      * @return The XML Metadata Record of the container.
      * @throws ContainerNotFoundException Thrown if a container with the provided id cannot be found.
      * @throws LockingException           Thrown in case of an optimistic locking error.
      ...
      * @throws AuthorizationException     Thrown if authorization fails.
      * @throws SystemException            Thrown if a framework internal error occurs.
      * @throws InvalidStatusException     Thrown if Conmtainer is in wrong status to update.
      * @throws InvalidXmlException        Thrown if taskParam contains invalid data.
      * @throws ReadonlyVersionException   If the provided container id does not identify the latest version.
      */
     @Validate(param = 2, resolver = "getContainerSchemaLocation")
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>The XML data for the
      * set of Metadata Records is created.</li> <li>The XML data is returned.</li> </ul>
      *
      * @param id The id of the container.
      ...
      * The container must exist<br/>
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Retrieve the
      * properties of the container. This includes the Content Model specific properties, too</li> <li>The XML data for
      * the properties is created.</li> <li>The XML data is returned.</li> </ul>
      *
      * @param id The id of the container.
     ...
     /**
      * Retrieve the list of related resources of a container with the provided id.<br/> This methods returns a list of
      * additional resources which aren't stored in IR but created on request.<br/>
      * <p/>
      * <b>Prerequisites:</b><br>
      * <p/>
      * The container must exist<br>
      * <p/>
      * <b>Tasks:</b><br> <ul> <li>The container is accessed using the provided reference.</li> <li>Determine which
      * resources are available.</li> <li>Create the list of resources.</li> <li>The XML data is returned.</li> </ul>
      *
      * @param id The id of the container.
      ...
      * <p/>
      * <b>Prerequisites:</b><br/> The container must exist.<br/> The specified resource must exist.<br/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided Id.</li> <li>Determine if the resource
      * is available.</li> <li>Create the content of the resource.</li> <li>The data is returned.</li> </ul>
      *
      * @param id           The id of the container.
      * @param resourceName The name of the resource.
      * @param parameters   Optional parameters to influence the content of the resource.
      * @return The content of the resource.
      * @throws ContainerNotFoundException Thrown if an container with the specified id cannot be found.
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Determine which
      * relations are available.</li> <li>Create the list of relations.</li> <li>The XML data is returned.</li> </ul>
      *
      * @param id The id of the container.
      ...
      * The container must exist<br/>
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Retrieve all version
      * and revision information.</li> <li>The XML datastream 'version-history' is returned.</li> </ul>
      * <b>Example:</b><br/>
      * <p/>
      * <pre>
     ...
     /**
      * Retrieve a list with references to all Containers to that this Container is directly subordinated.<br /> <br />
      * <b>Prerequisites:</b><br /> <br /> The Container must exist.<br /> <br /> <b>Tasks:</b> <ul> <li>The XML
      ...
      * @throws ContainerNotFoundException Thrown if an Container with the provided id does not exist.
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>The status of the latest-version is changed to "released".</li> <li>Latest version
      * date is updated.</li> <li>No new version is created.</li> <li>A XML containing the new latest version timestamp
      * is returned.</li> </ul> <b>Parameter for request:</b> (example)<br/>
      * <p/>
      * <pre>
      * &lt;param last-modification-date=&quot;1967-08-13T12:00:00.000+01:00&quot;&gt;
      * </pre>
      ...
      * </pre>
      *
      * @param id        The id of the Container to be released.
      * @param taskParam The timestamp of the last modification of the Container and a comment. The timestamp is
      ...
      * @throws OptimisticLockingException If the provided latest-modification-date does not match.
      * @throws ReadonlyVersionException   If the provided container id does not identify the latest version.
      * @throws InvalidXmlException        Thrown if taskParam has invalid structure.
      */
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>The status of the latest-version is changed to "submitted".</li> <li>Latest version
      * date is updated.</li> <li>No new version is created.</li> <li>A XML containing the new latest version timestamp
      * is returned.</li> </ul> <b>Parameter for request:</b> (example)<br/>
      * <p/>
      * <pre>
      ...
      * </pre>
      *
      * @param id        The id of the Container to be submitted.
      * @param taskParam The timestamp of the last modification of the Container and a comment. The timestamp is
      *                  necessary for optimistic locking purpose.
      * @return last-modification-date within XML (result.xsd)
      * @throws ContainerNotFoundException Thrown if a Container with the specified id cannot be found.
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>The status of the latest-version is changed to "in-revision".</li> <li>Latest
      * version date is updated.</li> <li>No new version is created.</li> <li>A XML containing the new latest version
      * timestamp is returned.</li> </ul> <b>Parameter for request:</b> (example)<br/>
      * <p/>
      * <pre>
      * &lt;param last-modification-date=&quot;1967-08-13T12:00:00.000+01:00&quot;&gt;
      * </pre>
      ...
      * </pre>
      *
      * @param id        The id of the Container to be revised.
      * @param taskParam The timestamp of the last modification of the Container and a comment. The timestamp is
      *                  necessary for optimistic locking purpose.
      * @return last-modification-date within XML (result.xsd)
      * @throws ContainerNotFoundException Thrown if a Container with the specified id cannot be found.
      ...
      * @throws OptimisticLockingException If the provided latest-modification-date does not match.
      * @throws ReadonlyVersionException   If the provided container id does not identify the latest version.
      * @throws XmlCorruptedException      Thrown if taskParam has invalid structure.
      */
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>The status of the latest-version is changed to "withdrawn".</li> <li>Latest version
      * date is updated.</li> <li>No new version is created.</li> <li>A XML containing the new latest version timestamp
      * is returned.</li> </ul> <b>Parameter for request:</b> (example)<br/>
      * <p/>
      * <pre>
      ...
      * </pre>
      *
      * @param id        The id of the Container to be withdrawn.
      * @param taskParam The timestamp of the last modification of the Container and a comment. The timestamp is
      *                  necessary for optimistic locking purpose.
      * @return last-modification-date within XML (result.xsd)
      * @throws ContainerNotFoundException Thrown if a Container with the specified id cannot be found.
      ...
      * @throws SystemException            Thrown if a framework internal error occurs.
      * @throws OptimisticLockingException If the provided latest-modification-date does not match.
      * @throws InvalidStatusException     Thrown if Container is in invalid status to lock.
      * @throws InvalidXmlException        Thrown if taskParam has invalid structure.
      */
      ...
      * @throws SystemException            Thrown if a framework internal error occurs.
      * @throws OptimisticLockingException If the provided latest-modification-date does not match.
      * @throws InvalidStatusException     Thrown if Conmtainer is in wrong status to unlock.
      * @throws InvalidXmlException        Thrown if taskParam contains invalid data.
      */
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>The target context is accessed using the provided reference.</li> <li>It is checked
      * whether the input adhere to the allowed values defined in the Admin Descriptor of the provided Context.</li>
      * <li>The container is added to the provided Context.</li> <li>An XML representation of the container is
      ...
      * @param taskParam   The timestamp of the last modification of the container and the new Context Id.
      ...
      * @throws AuthenticationException    Thrown if authorization fails.
      * @throws AuthorizationException     Thrown if authorization fails.
      * @throws ContextNotFoundException   Thrown if new Context could not be found.
      * @throws InvalidContentException    Thrown if taskParam contains invalid content.
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>The item is added to the container.</li> <li>A new version is created.</li> <li>The
      * XML representation of the item corresponding to XML-schema is returned as output.</li> </ul>
      *
      * @param containerId The id of the container.
      ...
      *                                        locked it.
      * @throws InvalidContentException        Thrown if the content is invalid.
      * @throws InvalidContextException        Thrown if a context specified in the provided data differs from a context
      *                                        of the container with the provided id.
      * @throws InvalidStatusException         Thrown if the container in the current status not allows to create a new
      *                                        Item.
      * @throws ReferencedResourceNotFoundException
      *                                        Thrown if a content relation target specified in the provided data does
    ...
    @Deprecated
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>The new container is added to the container.</li> <li>A new version is
      * created.</li> <li>The XML representation of the new container corresponding to XML-schema is returned as
      * output.</li> </ul>
      *
      * @param containerId The id of the container.
      * @param xmlData     The XML representation of the item to be created corresponding to XML-schema "container.xsd".
    ...
    @Deprecated
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>The new relations, which have the container as a source are created according to a
      * provided data</li> <li>Latest version date is updated.</li> <li>A new version is created.</li> <li>Method checks
      * if content relations with provided data already exist in the system. If there are matched content relations the
      * AlreadyExistException will be thrown.</li> <li>For content relations data that does not match existing relations
      * the framework checks if provided target ids contain a version nummer. In this case an InvalidContentException
      * will be thrown. Then framework checks if resources with a provided ids and provided predicates from provided
      * ontology exist in the system. New relations will be created.</li> <li>A XML containing the new latest version
      * timestamp is returned.</li> </ul> <b>Parameter for request:</b> (example)<br/>
      * <p/>
      * <pre>
      * &lt;param last-modification-date=&quot;1967-08-13T12:00:00.000+01:00&quot;&gt;
      ...
      * </pre>
      *
      * @param id    The id of the container, which will be a source of new relations.
      * @param param xml structure with a last modification date of the source container and a list of sections
      *              containing respectively a target id and a content relation predicate. A target id may not contain a
      ...
      *                                      match.
      * @throws ReferencedResourceNotFoundException
      *                                      Thrown if a content relation target specified in the provided data does not
      *                                      exist in the framework.
      * @throws RelationPredicateNotFoundException
      *                                      Thrown if a content relation predicate specified in the provided data does
      *                                      not belong to the provided ontology.
      * @throws AlreadyExistsException       Thrown if a content relation specified in a provided data already exists
      * @throws InvalidStatusException       Thrown if a container in the current status is not allowed to to add new
      *                                      content relations to.
      * @throws InvalidXmlException          Thrown if the schema validation of the provided data fails or provided data
      *                                      is corrupted.
      * @throws MissingElementValueException If a mandatory element value is missing.
      * @throws LockingException             Thrown if the container is locked and the current user is not the one who
      *                                      locked it.
      ...
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided reference.</li> <li>Optimistic Locking
      * criteria is checked.</li> <li>The relations to be deleted, which have the container as a source are deleted
      * according to a provided data</li> <li>Latest version date is updated.</li> <li>A new version is created.</li>
      ...
      * container.</li> <li>No data is returned.</li> </ul> <b>Parameter for request:</b> (example)<br/>
      * <p/>
      * <pre>
      * &lt;param last-modification-date=&quot;1967-08-13T12:00:00.000+01:00&quot;&gt;
      * </pre>
      ...
      * </pre>
      *
      * @param id    The id of the container, which will be a source of deleted relations.
      * @param param xml structure with a last modification date of the source container and a list of sections
      *              containing respectively a target id and a content relation predicate. A target id may not contain a
      *              version number: (see description above)
      * @return last-modification-date within XML (result.xsd)
      ...
      * @throws OptimisticLockingException   OptimisticLockingException If the provided latest-modification-date does not
      *                                      match.
      * @throws InvalidStatusException       Thrown if a container in the current status is not allowed to to remove new
      *                                      content relations from.
      * @throws MissingElementValueException If a mandatory element value is missing.
      * @throws InvalidXmlException          Thrown if the schema validation of the provided data fails or provided data
      *                                      is corrupted.
      * @throws ContentRelationNotFoundException
      *                                      Thrown if a container with the provided id does not have a content relation
      *                                      specified in the provided xml data
      * @throws LockingException             Thrown if the container is locked and the current user is not the one who
      *                                      locked it.
      * @throws ReadonlyVersionException     If the provided container id does not identify the latest version.
      * @throws AuthenticationException      Thrown if authentication fails.
      ...
      * The Container is not locked.<br/>
      * <p/>
      * <b>Tasks:</b><br/> <ul> <li>The Container is accessed using the provided Id.</li> <li>Optimistic Locking criteria
      * is checked.</li> <li>Identifier is created and with the provided URL registered in the configured PID
      * System.</li> <li>Persistent Identifier is added to the Container.</li> <li>The assigned Persistent Identifier is
      ...
      * @param taskParam The timestamp of the last modification of the container and at minimum the URL which is to
      *                  register in the PID resolver. This parameter list is forwarded to the PID resolver and could be
      ...
      * <b>Tasks:</b><br/> <ul> <li>The container is accessed using the provided Id.</li> <li>Optimistic Locking criteria
      * is checked.</li> <li>Identifier is created and with the provided URL registered in the configured PID
      * System.</li> <li>Persistent Identifier is added as version PID to the container.</li> <li>The assigned Persistent
      * Identifier is returned within an XML structure.</li> </ul>
      * <p/>
      * <b>Parameter for request:</b> (example)<br/>
      * <p/>
      * <pre>
