 ...
 public class Classes {
      ...
      *
      * @throws NoSuchMethodException if the given {@link Class} doesn't provide a constructor
      *                               that can be applied to the given arguments.
      ...
      *                                  or if, after possible unwrapping, a parameter value cannot
      *                                  be converted to the corresponding formal parameter type
      *                                  by a method invocation conversion; if this constructor
      *                                  pertains to an enum type.
      * @throws InstantiationException if the given {@link Class} is <i>abstract</i>,
      *                                an <i>interface</i>, an array or doesn't define a nullary
      *                                constructor.
     ...
     public static <T> T unsafeNewInstance(final Class<T> clazz, final Object... args)
         ...
         try {
             ...
             throw new AssertionError(
                     "IllegalAccessError while instantiating " + clazz +
      ...
      * following types:
      * <ul>
      *     <li>All primitive array types: e.g. <i>byte[]</i>, <i>int[]</i>, <i>boolean[]</i>,
      *     etc.</li>
      ...
      * </ul>
      * An argument of type <i>Object[]</i> is considered to be a variable list of arguments,
      * each with their own distinct type.
      *
     ...
     public static Object[] resolveVarArgs(final Object... args) {
         return args != null && args.getClass() == Object[].class
                 ? args
                 : new Object[] { args };
     }
     ...
     public static <T> Constructor<T> getApplicableConstructor(final Class<T> clazz,
         ...
         throw new NoSuchMethodException(String.format(
                 "No applicable constructor for %s found for argument types: %s",
      ...
      * @return a {@link Method} of the given name from the given {@link Class} that is applicable
      *         to the given arguments.
      * @throws NoSuchMethodException if no {@link Method} is found that is applicable to the
      *                               given arguments.
      */
     public static Method getApplicableMethod(final Class clazz,
         ...
         throw new NoSuchMethodException(String.format(
                 "No applicable method overload %s#%s found for argument types: %s",
                 clazz.getName(), name, Arrays.toString(args)));
     }
