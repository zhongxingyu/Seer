 ...
 * 
 *  This is the "smartest" constructor and should be the only one used!
 *  1. gets the image (ARGB) and pulls out the rgbs
 *  2. runs the NeuQuant colour reduction algorthym
 *  3. rebuilds a list of pixels for the Gif89Encoder byte[] constructor
 *  4. explicitly sets the transparent color
 * 
 *   most of this is adapted from AnimatedGifEncoder
 *    http://www.fmsware.com/stuff/AnimatedGifEncoder.java
 *
 * @param static_image
 *   Any Image object that supports pixel-grabbing.
 * @param transparentColor color to make transparent - or null
 * @exception Exception
 ...
 */  
 ...
 {
 	 return colorTable.ciLookup.getPaletteIndex(rgb);
 }
 }
