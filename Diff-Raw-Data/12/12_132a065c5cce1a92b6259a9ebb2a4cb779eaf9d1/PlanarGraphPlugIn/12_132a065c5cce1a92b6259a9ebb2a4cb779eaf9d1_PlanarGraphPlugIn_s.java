 ...
 public class PlanarGraphPlugIn extends ThreadedBasePlugIn {
     ...
     public void run(TaskMonitor monitor, PlugInContext context)
         ...
         //Erwan aout 2005
         //Ici on applique la procdure pour rcuperer les attributs de la couche d'origine
         //Les attributs sont rappatris si l'entit produite est contenue dans l'entit source
         // Si la couche d'entre est une couche de polygones alors les attributs sont rappatris pour la couche de faces
         // Si la couche d'entre est une couche de linestring alors les attributs sont rappatris pour la couche d'arcs
     ...
     public FeatureCollection createFaceLayer(FeatureCollection fcEdge,
         ...
         // inscrit les numros de face dans les arcs
         // Les arcs qui sont en bords de face sont cods  -1.
         if(relations) {
