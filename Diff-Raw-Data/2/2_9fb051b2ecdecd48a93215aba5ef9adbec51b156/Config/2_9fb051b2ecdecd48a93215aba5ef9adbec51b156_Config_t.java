 ...
 class Config
 {
 	...
 	// Real match tables of Primera Divisin (Spain), downloaded from http://fussballdaten.de
 	...
 	private void initialiseGroup_PrimeraDivision_2006_07() {
 		...
 		groups.add(Group.parseCrossTable("PD_2006_07", "Primera Divisin 2006/07", rawData));
 	}
 	...
 	private void initialiseGroup_PrimeraDivision_2007_08() {
 		...
 		groups.add(Group.parseCrossTable("PD_2007_08", "Primera Divisin 2007/08", rawData));
 	}
 	...
 	private void initialiseGroup_PrimeraDivision_2008_09() {
 		...
 		groups.add(Group.parseCrossTable("PD_2008_09", "Primera Divisin 2008/09", rawData));
 	}
 	...
 	private void initialiseGroup_PrimeraDivision_2009_10() {
 		...
 		groups.add(Group.parseCrossTable("PD_2009_10", "Primera Divisin 2009/10", rawData));
 	}
 	...
 	private void initialiseGroup_PrimeraDivision_2010_11() {
		 ...
		 *   Saragossa (9) and by GF (5) at equal GD (-1) against Sociedad (GF 4).
 		...
 		groups.add(Group.parseCrossTable("PD_2010_11", "Primera Divisin 2010/11", rawData));
 	}
 	...
 	private void initialiseGroup_PrimeraDivision_2011_12() {
 		...
 		groups.add(Group.parseCrossTable("PD_2011_12", "Primera Divisin 2011/12", rawData));
 	}
 	...
 	private void initialiseGroup_B() {
 		...
 		group.addTeam(new Team("DEN", "Dnemark"));
