...
import com.google.gwt.user.client.ui.HasHorizontalAlignment;
 ...
 public class UIMain {
 	...
 	public void displayShowTable(Show... showObject) {
		...
		showTable.getColumnFormatter().setWidth(3, "50px");
		showTable.getColumnFormatter().setWidth(4, "120px");
 		showTable.setText(0, 0, "Band");
 		showTable.setText(0, 1, "Venue");
 		showTable.setText(0, 2, "Dato");
 		showTable.setText(0, 3, "Status");
 		...
 		if (showObject.length > 0) {
 			for (Show s : showObject) {
 				...
 				showTable.setText(count, 3, "" + s.getState());
 				showTable.setText(count, 4, "" + s.getLastEdit());
 				showTable.setText(count, 5, "" + s.getShowID());
