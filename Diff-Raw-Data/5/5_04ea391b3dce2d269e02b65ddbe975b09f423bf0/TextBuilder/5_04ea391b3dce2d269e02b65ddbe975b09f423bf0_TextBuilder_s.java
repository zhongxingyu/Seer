 ...
 public class TextBuilder implements Appendable,
     ...
     /**
      * Returns a {@link _templates.java.lang.CharSequence} corresponding 
      ...
      */
     public final _templates.java.lang.CharSequence subSequence(int start, int end) {
      ...
      * @return <code>this</code>
      */
     public final Appendable/*TextBuilder*/ append(_templates.java.lang.CharSequence csq) {
      ...
      */
     public final Appendable/*TextBuilder*/ append(_templates.java.lang.CharSequence csq, int start,
             int end) {
         if (csq == null)
             return append("null");
      ...
      *         (index > this.length())</code>
      */
     public final TextBuilder insert(int index, _templates.java.lang.CharSequence csq) {
         if ((index < 0) || (index > _length))
      ...
      */
     public final boolean contentEquals(_templates.java.lang.CharSequence csq) {
