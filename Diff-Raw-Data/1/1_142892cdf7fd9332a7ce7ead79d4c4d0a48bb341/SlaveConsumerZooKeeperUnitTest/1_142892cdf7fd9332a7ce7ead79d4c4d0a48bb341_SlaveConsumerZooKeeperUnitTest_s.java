 ...
 public class SlaveConsumerZooKeeperUnitTest {
     ...
     public void testReigsterSlaveConsumer() throws Exception {
         ...
         // 輯Ⱥ̨master,topic1master3;
         // topic2master1,һصmaster1
         ...
         // this.mockConnect("meta://localhost:1");ӵһmaster
         ...
         // "topic2", new Partition("1-0"), 0), 1024 * 1024));һmasterץȡϢ
