 ...
 public class NotTheLispReader130{
 ...
 static Symbol CJDDOC = Symbol.create("cjd!doc");
 ...
 static boolean isWhitespace(int ch){
 	return Character.isWhitespace(ch) /* || ch == ',' */ ; // we like our commas.
 }
 	...
 	public Object invoke(Object reader, Object underscore) {
 		...
 		if (o instanceof PersistentList) {
 			...
 			if (f instanceof Symbol
 					&& ((Symbol) f).getName().equals("*")) {
 				IObj s = (IObj) RT.cons(CJDDOC, RT.next(o));
 				if (line >= 0)
