 ...
 public class NonNullMethodParameterVerifier<S> {
    ...
    public NonNullMethodParameterVerifier excludeMethod(Method... method){
         excludeMethods.addAll(Arrays.asList(method));
        return this;
     }
 
    public NonNullMethodParameterVerifier excludeMethod(String... methodNames){
        ...
        return excludeMethod(foundMethods.toArray(new Method[foundMethods.size()]));
     }
