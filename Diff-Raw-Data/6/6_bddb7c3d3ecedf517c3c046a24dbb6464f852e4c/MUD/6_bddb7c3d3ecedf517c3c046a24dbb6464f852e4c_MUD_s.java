 package com.planet_ink.marble_mud.application;
 ...
 import com.planet_ink.marble_mud.core.database.DBConnector;
 import com.planet_ink.marble_mud.core.database.DBConnection;
 import com.planet_ink.marble_mud.core.database.DBInterface;
 import com.planet_ink.marble_mud.core.http.HTTPserver;
 import com.planet_ink.marble_mud.core.http.ProcessHTTPrequest;
 import com.planet_ink.marble_mud.core.threads.CMRunnable;
 import com.planet_ink.marble_mud.core.threads.ServiceEngine;
 import com.planet_ink.marble_mud.core.threads.Tick;
 import com.planet_ink.marble_mud.core.smtp.SMTPserver;
 import com.planet_ink.marble_mud.core.intermud.IMudClient;
 import com.planet_ink.marble_mud.core.intermud.cm1.CM1Server;
 import com.planet_ink.marble_mud.core.intermud.i3.IMudInterface;
 import com.planet_ink.marble_mud.core.intermud.imc2.IMC2Driver;
 ...
 */
 ...
 public class MUD extends Thread implements MudHost
 {
 	...
 	public static void globalShutdown(Session S, boolean keepItDown, String externalCommand)
 	{
 		...
 		Log.sysOut(Thread.currentThread().getName(),"marblemud shutdown complete.");
 		if(S!=null)S.println("marblemud shutdown complete.");
 		...
 		try
 		{
 			if(page.getBoolean("RUNI3SERVER")&&(tCode==MAIN_HOST))
 			{
 				...
 				IMudInterface imud=new IMudInterface(CMProps.getVar(CMProps.SYSTEM_MUDNAME),
 													 "marblemud v"+CMProps.getVar(CMProps.SYSTEM_MUDVER),
 													 CMLib.mud(0).getPort(),
 													 playstate,
 	...
 	public static void main(String a[])
 	{
 		...
 		if(nameID.equalsIgnoreCase( "TheRealmarblemudCopyright2000-2012ByBoZimmerman" ))
 			nameID="marblemud";
