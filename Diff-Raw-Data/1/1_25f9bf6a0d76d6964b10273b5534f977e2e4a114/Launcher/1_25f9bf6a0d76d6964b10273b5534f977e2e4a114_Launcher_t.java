 ...
 package com.tripndroid.launcher3;
 ...
 import com.tripndroid.launcher3.DropTarget.DragObject;
 import com.tripndroid.launcher3.preference.*;
 ...
 public final class Launcher extends Activity
     ...
     static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
             "com.tripndroid.launcher3.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
     ...
     protected void onCreate(Bundle savedInstanceState) {
         ...
         if (PROFILE_STARTUP) {
             android.os.Debug.startMethodTracing(
                     Environment.getExternalStorageDirectory() + "/launcher3");
         }
     ...
     protected void onActivityResult(
         ...
         if (resultCode == RESULT_OK && mPendingAddInfo.container != com.tripndroid.launcher3.ItemInfo.NO_ID) {
     ...
     private void restoreState(Bundle savedState) {
         ...
         if (pendingAddContainer != com.tripndroid.launcher3.ItemInfo.NO_ID && pendingAddScreen > -1) {
     ...
     void completeAddApplication(Intent data, long container, int screen, int cellX, int cellY) {
         ...
         if (info != null) {
             ...
             info.container = com.tripndroid.launcher3.ItemInfo.NO_ID;
     ...
     private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
         ...
         public void onReceive(Context context, Intent intent) {
             ...
             if (Intent.ACTION_SCREEN_OFF.equals(action)) {
                 ...
                 if (mAppsCustomizeTabHost != null && mPendingAddInfo.container == com.tripndroid.launcher3.ItemInfo.NO_ID) {
     ...
     protected void onSaveInstanceState(Bundle outState) {
         ...
         if (mPendingAddInfo.container != com.tripndroid.launcher3.ItemInfo.NO_ID && mPendingAddInfo.screen > -1 &&
                 mWaitingForResult) {
     ...
     public boolean onPrepareOptionsMenu(Menu menu) {
         ...
         // Hide preferences if not on TripNDroid or not default launcher
         // (in which case preferences don't get shown in system settings)
         boolean preferencesVisible = !getPackageManager().hasSystemFeature("com.tripndroid.android") ||
     ...
     private void resetAddInfo() {
         mPendingAddInfo.container = com.tripndroid.launcher3.ItemInfo.NO_ID;
