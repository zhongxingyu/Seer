 ...
 /**
  * The most important thing is that the model should be triangulated. Rajawali doesnt accept quads, only tris. In Blender, this is an option you can select in the exporter. In a program like MeshLab, this is done automatically.
  * At the moment, Rajawali also doesnt support per-face textures. This is on the todo list.
  * <p>
  ...
  * </ul>
  * <p>
  * The files should be written to your res/raw folder in your ADT project. Usually youll get errors in the console when you do this. The Android SDK ignores file extensions so itll regard the .obj and .mtl files as duplicates. The way to fix this is to rename the files. For instance:
  ...
  * <p>
  * Just as a reminder, heres the code that takes care of the parsing:
  * <pre>
  * {@code
