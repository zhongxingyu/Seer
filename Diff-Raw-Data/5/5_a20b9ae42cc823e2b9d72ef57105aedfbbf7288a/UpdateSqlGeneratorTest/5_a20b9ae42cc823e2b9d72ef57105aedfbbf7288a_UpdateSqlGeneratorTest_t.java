 ...
 public class UpdateSqlGeneratorTest {
     ...
     public void testAddTable() throws Exception {
        Assert.assertEquals("CREATE TABLE Customer (name VARCHAR2(255 CHAR));", getChanges("emptySchema.xml", "emptyIndexNames.xml", "schema1.xml", "emptyIndexNames.xml", com.txtr.hibernatedelta.generator.customer1.Customer.class));
     }
 
     @Test
     public void testAddColumn() throws Exception {
        Assert.assertEquals("ALTER TABLE Customer ADD street VARCHAR2(255 CHAR);", getChanges("schema1.xml", "emptyIndexNames.xml", "schema2.xml", "emptyIndexNames.xml", Customer.class));
     }
