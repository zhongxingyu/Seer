 ...
 public final class ASMUtil {
	...
	private static final String VERSION_MESSAGE = "you use a old version of the ASM Jar, please update your jar files";
 	...
 	/**
 	 * Gibt zurck ob das direkt bergeordnete Tag mit dem bergebenen Full-Name (Namespace und Name) existiert.
 	...
 	/**
 	 * Gibt das bergeordnete CFXD Tag Element zurck, falls dies nicht existiert wird null zurckgegeben.
 	 * @param el Element von dem das parent Element zurckgegeben werden soll.
 	...
 	/**
 	 * Gibt ein bergeordnetes Tag mit dem bergebenen Full-Name (Namespace und Name) zurck, 
 	 * falls ein solches existiert, andernfalls wird null zurckgegeben.
 	 * @param el Startelement, von wo aus gesucht werden soll.
 	 * @param fullName Name des gesuchten Tags.
 	...
 	/**
 	 * Prft ob das das angegebene Tag in der gleichen Ebene nach dem angegebenen Tag vorkommt.
 	...
 	/**
 	 * Prft ob das angegebene Tag innerhalb seiner Ebene einmalig ist oder nicht.
 	 * @param tag Ausgangspunkt, nach diesem tag darf das angegebene nicht vorkommen.
 	 * @return kommt das Tag vor.
 	 */
