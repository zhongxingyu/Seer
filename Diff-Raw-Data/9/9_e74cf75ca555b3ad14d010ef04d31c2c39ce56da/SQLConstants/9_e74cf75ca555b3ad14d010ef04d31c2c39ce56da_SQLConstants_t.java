 ...
 public class SQLConstants
 {
 	...
 	public static final String CREATE_INCOMING_STOCK_DETAILS = "CREATE TABLE if not exists INCOMING_STOCK_DETAILS (INVOICE_ID TEXT,DATE_OF_DELIVERY DATETIME, ITEM_ID text, TYPE_ID text, QUANTITY INTEGER," +
			" PRIMARY KEY(INVOICE_ID,DATE_OF_DELIVERY,ITEM_ID,TYPE_ID), FOREIGN KEY(TYPE_ID) REFERENCES CATEGORY_TYPES(TYPE_ID)," +
 			" FOREIGN KEY(ITEM_ID) REFERENCES ITEMS_TABLE(ITEM_ID))";
 	...
 	public static final String FETCH_INCOMING_DETAILS_BY_INVOICE = "SELECT ID.INVOICE_ID, ID.DATE_OF_DELIVERY,IT.ITEM_ID, IT.ITEM_NAME, CT.TYPE_ID, CT.TYPE, ID.QUANTITY FROM "+
 	...
 	public static final String FETCH_OUTGOING_DETAILS_BY_DATE = "SELECT I.DATE_OF_DELIVERY,IT.ITEM_ID, IT.ITEM_NAME,CT.TYPE_ID, CT.TYPE, I.QUANTITY FROM OUTGOING_STOCK_DETAILS I,"+
 	...
 	public static final String DELETE_TRANSACTION_OUTGOING_STOCK_DETAILS_1 = "DELETE FROM OUTGOING_STOCK_DETAILS WHERE ";
 	public static final String DELETE_TRANSACTION_OUTGOING_STOCK_DETAILS_2 = "DATE_OF_DELIVERY='";
 	public static final String DELETE_TRANSACTION_OUTGOING_STOCK_DETAILS_3 = "' AND ITEM_ID='";
 	public static final String DELETE_TRANSACTION_OUTGOING_STOCK_DETAILS_4 = "' AND TYPE_ID='";
 	public static final String DELETE_TRANSACTION_OUTGOING_STOCK_DETAILS_5 = "'";
 	
 	public static final String ADD_TRANSACTION_UPDATE_ITEM_TYPE_1 = "UPDATE ITEMS_TYPES_TABLE SET QUANTITY = QUANTITY + ";
 	public static final String ADD_TRANSACTION_UPDATE_ITEM_TYPE_2 = " WHERE ITEM_ID ='";
