 ...
 public class DeleteBean {
     ...
     public String deleteSelectedObject() throws ServerOperationFailed, XMLParseException {
        ...
        DigitalObject rootObject = domsManager.getRootDataObject();
        Set<DigitalObject> viewKasse = getViewList(rootObject);
 
         boolean deletedAnything = recursiveDelete(deleteObject,Collections.unmodifiableSet(viewKasse));
         if (deletedAnything){
             domsManager.reload();
            if (deleteObject.equals(rootObject)){//we deleted root
                ...
                domsManager.setSelectedDataObject(rootObject);
