...
import org.jboss.arquillian.api.Deployment;
 ...
 public class PluginTest extends AbstractShellTest {
     ...
     public static JavaArchive getDeployment() {
         ...
         //.addManifestResource(new ByteArrayAsset("<beans><alternatives><class>org.jboss.forge.arquillian.container.FileContainerDirectoryLocationProvider</class></alternatives></beans>".getBytes()), ArchivePaths.create("beans.xml"));
     }
 
 
     private void installContainer(String container, List<DependencyMatcher> dependencies) throws Exception {
