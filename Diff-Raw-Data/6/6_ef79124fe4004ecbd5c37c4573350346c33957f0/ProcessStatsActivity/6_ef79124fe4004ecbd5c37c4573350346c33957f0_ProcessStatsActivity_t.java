 ...
 public class ProcessStatsActivity extends ListActivity implements AdapterView.OnItemSelectedListener
 {
 	/**
 	 * The logging TAG
 	 */
 	private static final String TAG = "ProcessStatsActivity";
