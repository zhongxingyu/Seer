 ...
 public class NexusClassLoader extends URLClassLoader{
 	...
 	public NexusClassLoader(URL[] sources){
 		...
 		this.addTransformerExclusion("com.mysql.jdbc.");
 		this.addTransformerExclusion("com.google.");
 		this.addTransformerExclusion("twitter4j.");
 		this.addTransformerExclusion("org.java_websocket.");
 		this.addTransformerExclusion("org.objectweb.asm.");
 		this.addTransformerExclusion("org.apache.");
