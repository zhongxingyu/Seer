 ...
 public class FormsExporter {
     ...
     public File createXmlForms(final AbstractProcess studioProcess, final boolean isAllInBarExport) throws Exception {
         ...
         builder.addLabelExpression(studioProcess.getName(), studioProcess.getName(), ExpressionConstants.CONSTANT_TYPE, String.class.getName(), null);
         File tempFile;
         final AssociatedFile processTemplate = studioProcess.getProcessTemplate();
         if (processTemplate != null) {
             tempFile = WebTemplatesUtil.getFile(processTemplate.getPath());
             if (tempFile != null && tempFile.exists()) {
                 builder.addLayout(ExporterTools.getTemplateWarPath(studioProcess, TemplateType.PROCESS));
             }
         }
        ...
        if (mandatoryLabel != null) {
         ...
         if (errorTemplate != null) {
             ...
             if (tempFile != null && tempFile.exists()) {
                 builder.addErrorTemplate(ExporterTools.getTemplateWarPath(studioProcess, TemplateType.ERROR));
             }
         }
      ...
      */
     protected void exportRecapPageFlow(final RecapFlow recapPageFlow, final IFormBuilder builder) throws InvalidFormDefinitionException {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void exportEntryPageFlow(final PageFlow pageFlow, final IFormBuilder builder) throws InvalidFormDefinitionException {
     ...
     protected void addProcessRecapPageFlow(final RecapFlow recapPageFlow, final IFormBuilder builder) throws InvalidFormDefinitionException {
         ...
         if (!recapForms.isEmpty()) {
             ...
             addTransientData(recapPageFlow, ProcessPackage.Literals.RECAP_FLOW__RECAP_TRANSIENT_DATA,
                     ProcessPackage.Literals.RECAP_FLOW__RECAP_FLOW_CONNECTORS, builder);
             addFirstPageId(ProcessPackage.Literals.RECAP_FLOW__RECAP_FORMS, recapPageFlow, builder);
         }
     }
 
     protected void addProcessConsultationPageFlow(final ViewPageFlow viewFlow, final IFormBuilder builder) throws InvalidFormDefinitionException {
         if (viewFlow.getViewForm().size() > 0) {
             ...
             addTransientData(viewFlow, ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA,
                     ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS, builder);
             addFirstPageId(ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_FORM, viewFlow, builder);
         } else {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addConsultationPageFlow(final ViewPageFlow task, final IFormBuilder builder) throws InvalidFormDefinitionException {
         // add forms
         ...
         if (viewForm.size() > 0) {
             ...
             addTransientData(task, ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_TRANSIENT_DATA,
                     ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_PAGE_FLOW_CONNECTORS, builder);
             addFirstPageId(ProcessPackage.Literals.VIEW_PAGE_FLOW__VIEW_FORM, task, builder);
         } else {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void generatePageFlow(final AbstractPageFlow pageFlow, final IFormBuilder builder, final boolean isViewPageFlow)
             throws InvalidFormDefinitionException {
         ...
         for (final Data data : ModelHelper.getAccessibleData(pageFlow)) {
             if (!data.isGenerated() || (pageFlow.isUseRegExpToHideDefaultField() && toMatch != null ? data.getName().matches(toMatch) : false)) {
                 noDataToHide = false;
                 break;
             }
         }
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addActivities(final AbstractProcess studioProcess, final IFormBuilder builder) throws InvalidFormDefinitionException {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addFlowElement(final ViewPageFlow viewPageFlow, final IFormBuilder builder) throws InvalidFormDefinitionException {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addTask(final Task task, final IFormBuilder builder) throws InvalidFormDefinitionException {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addViewPage(final Form f, final IFormBuilder builder) throws InvalidFormDefinitionException {
         ...
         builder.addLayout(ExporterTools.getTemplateWarPath(f, TemplateType.PAGE));
         addWidgets(f, builder, true);
         addNextPageId(f, builder);
     }
 
     protected void addPageLabelExpression(final Form f, final IFormBuilder builder) throws InvalidFormDefinitionException {
         if (f.getShowPageLabel() == null || f.getShowPageLabel()) {
             // show a label
             final Expression pageLabel = f.getPageLabel();
             if (pageLabel != null && pageLabel.getContent() != null && !pageLabel.getContent().isEmpty()) {
                 // display label
                 addLabelExpressionIfValid(builder, pageLabel);
             } else {
                 builder.addLabelExpression(EcoreUtil.generateUUID(), "", ExpressionConstants.CONSTANT_TYPE, String.class.getName(), null);
             }
         } else {
             builder.addLabelExpression(EcoreUtil.generateUUID(), "", ExpressionConstants.CONSTANT_TYPE, String.class.getName(), null);
         }
     ...
     protected void addLabelExpressionIfValid(final IFormBuilder builder, final Expression expression) throws InvalidFormDefinitionException {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addActions(final Form f, final IFormBuilder builder) throws InvalidFormDefinitionException {
         ...
         if (w instanceof FileWidget) {
             ...
             if (action != null) {
                 if (action.getRightOperand() != null && action.getRightOperand().getContent() != null && !action.getRightOperand().getContent().isEmpty()
                         && action.getLeftOperand() != null && action.getLeftOperand().getContent() != null && !action.getLeftOperand().getContent().isEmpty()
                         && !w.isReadOnly()) {
                     addAction(builder, action);
                 }
             }
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addAction(final IFormBuilder builder, final Operation action) throws InvalidFormDefinitionException {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addTransientData(final Element element, final EReference pageFlowTransientData, final EReference connectors, final IFormBuilder builder)
             throws InvalidFormDefinitionException {
         ...
         for (final Object child : list) {
             if (child instanceof Data) {
                 ...
                 if (data.getDefaultValue() != null && data.getDefaultValue().getName() != null && !data.getDefaultValue().getName().isEmpty()) {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void createDefaultPageFlow(final AbstractPageFlow pageFlow, final IFormBuilder builder, final boolean isViewPageFlow)
             throws InvalidFormDefinitionException {
         // nothing to do
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addEntryPage(final Form f, final IFormBuilder builder) throws InvalidFormDefinitionException {
         builder.addPage(f.getName());
         addPageLabelExpression(f, builder);
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addPageValidators(final Form f, final IFormBuilder builder) throws InvalidFormDefinitionException {
         final ValidatorDescriptorRepositoryStore store = (ValidatorDescriptorRepositoryStore) RepositoryManager.getInstance().getRepositoryStore(
                 ValidatorDescriptorRepositoryStore.class);
         for (final Validator validator : f.getValidators()) {
             if (validator.getValidatorClass() != null) {
                 builder.addValidator(validator.getName(), validator.getValidatorClass(), validator.getHtmlClass(),
                         validator.isBelowField() ? ValidatorPosition.BOTTOM : ValidatorPosition.TOP);
                 if (validator.getDisplayName() != null && validator.getDisplayName().getContent() != null) {
                     addLabelExpressionIfValid(builder, validator.getDisplayName());
                 }
                 final ValidatorDescriptor descriptor = store.getValidatorDescriptor(validator.getValidatorClass());
                 if (descriptor.getHasParameter() && validator.getParameter() != null && validator.getParameter().getContent() != null) {
     ...
     protected void addParameterExpression(final IFormBuilder builder, final Expression expression) throws InvalidFormDefinitionException {
         final org.bonitasoft.engine.expression.Expression engineExpression = EngineExpressionUtil.createExpression(expression);
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addWidgets(final Form f, final IFormBuilder builder, final boolean isViewForm) throws InvalidFormDefinitionException {
         /*
             ...
             for (int j = 0; j < f.getNColumn(); j++) {
                 for (final Widget w : f.getWidgets()) {
                     if (w.getWidgetLayoutInfo() != null) {
                         if (w.getWidgetLayoutInfo().getLine() == i && w.getWidgetLayoutInfo().getColumn() == j) {
                             widgets.add(w);
                             break;
                         }
                     }
     ...
     protected void performOnWidget(final IFormBuilder builder, final Widget widget, final boolean haveParent, final boolean isViewForm)
             throws InvalidFormDefinitionException {
         if (widget != null) {
             if (widget instanceof FormField) {
                 ...
                 if (!(formField instanceof HiddenWidget)) {
                     ...
                     if (!(widget instanceof Table && !((Table) widget).isAllowSelection())) {
                         addFormFieldValidators((FormField) widget, builder);
                     }
                 }
                 final Expression exampleMessage = formField.getExampleMessage();
                 if (exampleMessage != null && exampleMessage.getContent() != null && !exampleMessage.getContent().isEmpty()) {
                     builder.addSubTitle(getSubtitlePosition(toItemPosition(formField.getExampleMessagePosition())));
                 ...
                 if (widget instanceof SubmitFormButton) {
                     builder.addWidget(widget.getName(), WidgetType.BUTTON_SUBMIT);
                     ...
                     builder.addWidget(widget.getName(), WidgetType.BUTTON_PREVIOUS);
                 } else { // Simple button
                     builder.addWidget(widget.getName(), WidgetType.BUTTON);
                 }
                 builder.addLabelButtonBehavior(((FormButton) widget).getLabelBehavior() != null && ((FormButton) widget).getLabelBehavior());
             ...
             if (helpMessage != null && helpMessage.getName() != null && !helpMessage.getName().isEmpty()) {
                 addTooltipExpression(builder, helpMessage);
             }
 
             addStyle(builder, widget, widget instanceof FormField || widget instanceof FormButton || widget instanceof TextInfo
     ...
     protected void addDisplayCondition(final IFormBuilder builder, final Widget widget) throws InvalidFormDefinitionException {
         final Expression injectWidgetScript = widget.getInjectWidgetScript();
         if (widget.isInjectWidgetCondition() && injectWidgetScript != null && !injectWidgetScript.getName().isEmpty()) {
             ...
             if (((ImageWidget) widget).isIsADocument()) {
                 ...
                 if (path.getContent() != null && !path.getContent().isEmpty()) {
                     if (ExpressionConstants.CONSTANT_TYPE.equals(type)) {
                         final AbstractProcess process = ModelHelper.getParentProcess(widget);
     ...
     private void performOnAbstractTable(final IFormBuilder builder, final Widget widget, final boolean isViewForm) throws InvalidFormDefinitionException {
         ...
         if (widget instanceof Table) {
             ...
             if (table.isAllowSelection()) {
                 final Expression columnIndex = table.getColumnForInitialSelectionIndex();
                 if (columnIndex != null && columnIndex.getContent() != null && !columnIndex.getContent().isEmpty()) {
                 ...
                 final Expression maxRowForPagination = table.getMaxRowForPagination();
                 if (maxRowForPagination != null && maxRowForPagination.getContent() != null && !maxRowForPagination.getContent().isEmpty()) {
             ...
             if (!isViewForm && !widget.isReadOnly()) {
                 builder.addVariableRowsNumber(dynamicTable.isAllowAddRemoveRow());
                 builder.addVariableColumnsNumber(dynamicTable.isAllowAddRemoveColumn());
 
                 if (dynamicTable.isAllowAddRemoveColumn()) {
                     final Expression maxNumberOfColumn = dynamicTable.getMaxNumberOfColumn();
                     if (dynamicTable.isLimitMaxNumberOfColumn() && maxNumberOfColumn != null && !maxNumberOfColumn.getName().isEmpty()) {
                         addMaxColumnsExpression(builder, maxNumberOfColumn);
                     }
                     final Expression minNumberOfColumn = dynamicTable.getMinNumberOfColumn();
                     if (dynamicTable.isLimitMinNumberOfColumn() && minNumberOfColumn != null && !minNumberOfColumn.getName().isEmpty()) {
                         addMinColumnsExpression(builder, minNumberOfColumn);
                     }
                 }
                 if (dynamicTable.isAllowAddRemoveRow()) {
                     final Expression maxNumberOfRow = dynamicTable.getMaxNumberOfRow();
                     if (dynamicTable.isLimitMaxNumberOfRow() && maxNumberOfRow != null && !maxNumberOfRow.getName().isEmpty()) {
                         addMaxRowsExpression(builder, maxNumberOfRow);
                     }
                     final Expression minNumberOfRow = dynamicTable.getMinNumberOfRow();
                     if (dynamicTable.isLimitMinNumberOfRow() && minNumberOfRow != null && !minNumberOfRow.getName().isEmpty()) {
         ...
         if (abstractTable.getInputExpression() != null) {
             builder.addAllowHTMLInFieldBehavior(abstractTable.getInputExpression().isHtmlAllowed());
         }
         // styling
         ...
         // is no style on it
         builder.addHeadingsStyle(classes, abstractTable.isLeftColumnIsHeader(), abstractTable.isFirstRowIsHeader(), abstractTable.isRightColumnIsHeader(),
      ...
      * @throws InvalidFormDefinitionException
      */
     private void addTableHorizontalHeader(final AbstractTable table, final IFormBuilder builder) throws InvalidFormDefinitionException {
         if (table.isInitializedUsingCells()) {
             if (table.isUseHorizontalHeader() && table.getTableExpression() != null) {// use
                 // the first row as header
                 final TableExpression tableExpresssion = table.getTableExpression();
                 final EList<ListExpression> list = tableExpresssion.getExpressions();
                 if (list.size() > 0) {
                     final EList<Expression> firstRowList = list.get(0).getExpressions();
             ...
             final Expression horizontalHeaderExpression = table.getHorizontalHeaderExpression();
             if (horizontalHeaderExpression != null && !horizontalHeaderExpression.getContent().isEmpty()) {
                 addHorizontalHeaderExpression(builder, horizontalHeaderExpression);
             }
         }
     }
      ...
      * @throws InvalidFormDefinitionException
      */
     private void addTableVerticalHeader(final AbstractTable table, final IFormBuilder builder) throws InvalidFormDefinitionException {
         if (table.isInitializedUsingCells()) {
             if (table.isUseVerticalHeader() && table.getTableExpression() != null) {
                 final TableExpression tableExpression = table.getTableExpression();
                 final EList<ListExpression> list = tableExpression.getExpressions();
             ...
             final Expression verticalHeaderExpression = table.getVerticalHeaderExpression();
             if (verticalHeaderExpression != null && !verticalHeaderExpression.getContent().isEmpty()) {
                 addVerticalHeaderExpression(builder, verticalHeaderExpression);
             }
         }
     }
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addTableAvailableValue(final Table table, final IFormBuilder builder) throws InvalidFormDefinitionException {
         if (table.isInitializedUsingCells() && table.getTableExpression() != null) {
             final TableExpression tableExpression = table.getTableExpression();
             final int minRow = table.isUseHorizontalHeader() ? 1 : 0;
             final int minCol = table.isUseVerticalHeader() ? 1 : 0;
             final EList<ListExpression> rowExpressions = tableExpression.getExpressions();
             ...
             for (int i = minRow; i < rowExpressions.size(); i++) {
                 ...
                 for (int j = minCol; j < listExpression.getExpressions().size(); j++) {
                     final Expression cellExpression = listExpression.getExpressions().get(j);
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addParentProperties(final IFormBuilder builder, final Widget widget) throws InvalidFormDefinitionException {
         // do nothing
 
     }
 
     private void addReadOnlyBehavior(final IFormBuilder builder, final Widget widget, final boolean isViewForm) throws InvalidFormDefinitionException {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addTableInitialValue(final AbstractTable table, final IFormBuilder builder) throws InvalidFormDefinitionException {
         if (table instanceof Table) {
             // initial value only in selection mode
             if (((Table) table).isAllowSelection()) {
                 final Expression selectedValues = ((Table) table).getSelectedValues();
                 if (selectedValues != null && !selectedValues.getName().isEmpty()) {
     ...
     protected void addLabel(final IFormBuilder builder, final Widget widget) throws InvalidFormDefinitionException {
         ...
         if ((widget.getShowDisplayLabel() == null || widget.getShowDisplayLabel().booleanValue()) && displayLabel != null
             ...
             builder.addAllowHTMLInLabelBehavior(widget.isAllowHTMLForDisplayLabel());
             builder.addLabelPosition(toItemPosition(widget.getLabelPosition()));
         } else if (widget instanceof FormButton) {
             // add a empty label for buttons
             builder.addLabelExpression("", "", ExpressionConstants.CONSTANT_TYPE, String.class.getName(), null);
         }
     }
     ...
     protected void addMandatoryBehavior(final IFormBuilder builder, final Widget widget) throws InvalidFormDefinitionException {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addSpecificFormField(final FormField widget, final IFormBuilder builder, final boolean isViewForm) throws InvalidFormDefinitionException {
         if (widget instanceof TextFormField) {
             ...
             addItemsStyle(builder, durationWidget, durationWidget.getItemClass() != null && durationWidget.getItemClass().equals("v"));
             builder.addDisplayFormat((durationWidget.getDay() ? "d" : "") + (durationWidget.getHour() ? "h" : "") + (durationWidget.getMin() ? "m" : "")
             ...
             addItemsStyle(builder, widget, ((ItemContainer) widget).getItemClass() != null && ((ItemContainer) widget).getItemClass().equals("h"));
             ...
             if (((DateFormField) widget).getDisplayFormat() != null) {
                 builder.addDisplayFormat(((DateFormField) widget).getDisplayFormat());
             }
             ...
             builder.addAttachmentImageBehavior(((FileWidget) widget).isUsePreview());
      ...
      * @throws InvalidFormDefinitionException
      */
     private void addItemsStyle(final IFormBuilder builder, final FormField widget, final boolean alignmentCondition) throws InvalidFormDefinitionException {
         String classes = "";
         final String widgetUID = ExporterTools.getWidgetUID(widget);
         if (alignmentCondition) {
             classes = widgetUID + "_align ";
         }
         if (widget.getHtmlAttributes() != null && widget.getHtmlAttributes().size() > 0) {
             boolean containsStyle = false;
             for (final Iterator<Entry<String, String>> iterator = widget.getHtmlAttributes().iterator(); iterator.hasNext();) {
         ...
         if (widget.getHtmlAttributes() != null && widget.getHtmlAttributes().containsKey(ExporterTools.PREFIX_ITEMS + ExporterTools.CLASS_ATTR)
                 && widget.getHtmlAttributes().get(ExporterTools.PREFIX_ITEMS + ExporterTools.CLASS_ATTR) != null) {
             classes += widget.getHtmlAttributes().get(ExporterTools.PREFIX_ITEMS + ExporterTools.CLASS_ATTR);
         }
         if (classes.length() > 0) {
     ...
     protected void addMultipleValuatedFormFieldInitialValue(final MultipleValuatedFormField widget, final IFormBuilder builder)
             throws InvalidFormDefinitionException {
         final Expression defaultValueExpression = widget.getDefaultExpression();
         if (defaultValueExpression != null && defaultValueExpression.getContent() != null && !defaultValueExpression.getContent().isEmpty()) {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addInitialValue(final Widget widget, final IFormBuilder builder) throws InvalidFormDefinitionException {
         final Expression inputExpression = widget.getInputExpression();
         if (inputExpression != null) {
             ...
             if (widgetInputScript != null && widgetInputScript.length() > 0) {
                 ...
                 } else if (widget instanceof Info || widget instanceof HiddenWidget || widget instanceof Table) {
                     addInitialValueExpression(builder, inputExpression);
                 }
             }
             // forbidden html have a sens only for these kind of widget
             if (widget instanceof TextFormField || widget instanceof MessageInfo || widget instanceof HtmlWidget || widget instanceof TextAreaFormField
                     || widget instanceof TextInfo) {
                 builder.addAllowHTMLInFieldBehavior(inputExpression.isHtmlAllowed() || widget instanceof HtmlWidget);
             }
 
             // TODO For document addInitialValueExpression for URL and addInitialValueResource for file
         }
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addAvailableValues(final MultipleValuatedFormField widget, final IFormBuilder builder) throws InvalidFormDefinitionException {
         final Expression inputExpression = widget.getInputExpression();
         // TODO add support for list of options
         // Data widgetEnum = widget.getEnum();
         // if (widgetEnum != null && widgetEnum.getDataType() instanceof EnumType) {
         // final EList<String> availableValues = ((EnumType) widgetEnum.getDataType()).getLiterals();
         // if(!availableValues.isEmpty()){
         // builder.addAvailableValue();
         // for (String value : availableValues) {
         // if (widget.getLiterals().size() == 0 || widget.getLiterals().contains(value)) {
         // builder.addAvailableValue(value, value);
         // }
         // }
         // }
         // }
         ...
         if (widget instanceof RadioFormField || widget instanceof CheckBoxMultipleFormField) {
             if (inputExpression != null) {
                 builder.addAllowHTMLInFieldBehavior(inputExpression.isHtmlAllowed());
             } else {
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addFormFieldValidators(final FormField formField, final IFormBuilder builder) throws InvalidFormDefinitionException {
     ...
     protected void addFormFieldUserValidators(final FormField formField, final IFormBuilder builder) throws InvalidFormDefinitionException {
         for (final Validator validator : formField.getValidators()) {
             if (validator.getValidatorClass() != null) {
                 ...
                 if (validator.getParameter() != null && validator.getParameter().getContent() != null) {
                     addParameterExpression(builder, validator.getParameter());
                 }
             }
         }
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addEntryPageFlow(final PageFlow entryPageFlow, final IFormBuilder builder) throws InvalidFormDefinitionException {
         ...
         if (formPages.isEmpty()) {
             ...
             addTransientData(entryPageFlow, ProcessPackage.Literals.PAGE_FLOW__TRANSIENT_DATA, ProcessPackage.Literals.PAGE_FLOW__PAGE_FLOW_CONNECTORS, builder);
         }
         ...
         File tempFile;
         final AssociatedFile confirmationTemplate = entryPageFlow.getConfirmationTemplate();
         if (!formPages.isEmpty() && confirmationTemplate != null && confirmationTemplate.getPath() != null) {
     ...
     protected void addConfirmation(final IFormBuilder builder, final PageFlow entryPageFlow) throws InvalidFormDefinitionException {
         final AssociatedFile confirmationTemplate = entryPageFlow.getConfirmationTemplate();
         if (confirmationTemplate != null && confirmationTemplate.getPath() != null) {
             final File tempFile = WebTemplatesUtil.getFile(confirmationTemplate.getPath());
         ...
         final Expression confirmationMessage = entryPageFlow.getConfirmationMessage();
         if (confirmationMessage != null && confirmationMessage.getContent() != null && !confirmationMessage.getContent().isEmpty()) {
             addConfirmationMessageExpression(builder, confirmationMessage);
         }
     }
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addRecapPage(final Form f, final IFormBuilder builder) throws InvalidFormDefinitionException {
         builder.addPage(f.getName());
         addPageLabelExpression(f, builder);
         builder.addAllowHTMLInLabelBehavior(f.isAllowHTMLInPageLabel());
         /* match with <page-template> */
     ...
     protected void addStyle(final IFormBuilder builder, final Widget widget, final boolean withLabel) throws InvalidFormDefinitionException {
         /*
          * Common to all widgets
          */
         if (withLabel) {
             final String label_classes = getCSSClasses(widget, ExporterTools.PREFIX_LABEL);
         ...
         if (!(widget instanceof IFrameWidget) && !(widget instanceof HiddenWidget)) {
             ...
             if (widgetTooltip != null && widgetTooltip.getContent() != null && !widgetTooltip.getContent().isEmpty()) {
     ...
     private String getCSSClasses(final Widget widget, final String prefix) {
         ...
         if (htmlAttributes != null && htmlAttributes.containsKey(prefix + ExporterTools.CLASS_ATTR)
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addFirstPageId(final EStructuralFeature feature, final Element pageflow, final IFormBuilder builder) throws InvalidFormDefinitionException {
         final String firstPageName = ((Form) ((List<?>) pageflow.eGet(feature)).get(0)).getName();
         builder.addFirstPageIdExpression(firstPageName, firstPageName, ExpressionConstants.CONSTANT_TYPE, String.class.getName(), null);
     }
      ...
      * @throws InvalidFormDefinitionException
      */
     protected void addNextPageId(final Form f, final IFormBuilder builder) throws InvalidFormDefinitionException {
         ...
         if (forms.size() > indexOf + 1) {
             final String nextPageName = ((Element) forms.get(indexOf + 1)).getName();
             builder.addNextPageIdExpression(nextPageName, nextPageName, ExpressionConstants.CONSTANT_TYPE, String.class.getName(), null);
         } else {
     ...
     private String buildFormID(final AbstractPageFlow pageFlow, final String formType) {
         if (pageFlow instanceof Activity || pageFlow instanceof Event) {
             // ActivityDefinition activityDefinition = activityDefNameMap.get(pageFlow.getName());
             // if(activityDefinition != null){
             return procDefid + "--" + pageFlow.getName() + FormServiceProviderUtil.FORM_ID_SEPARATOR + formType;
             // } else {
             // //try to build it manually :s
             // return procDefid+"--"+pageFlow.getName()+FormServiceProviderUtil.FORM_ID_SEPARATOR+formType;
             // }
         } else {
             return procDefid + FormServiceProviderUtil.FORM_ID_SEPARATOR + formType;
         }
     }
     ...
     protected String buildPermission(final AbstractPageFlow pageFlow) {
         if (pageFlow instanceof Activity) {
             // ActivityDefinition activityDefinition = activityDefNameMap.get(pageFlow.getName());
             // if(activityDefinition != null){
             // return FormServiceProviderUtil.ACTIVITY_UUID+"#"+procDefid + "--" + activityDefinition.getName();
             // } else {
             return FormServiceProviderUtil.ACTIVITY_UUID + "#" + procDefid + "--" + pageFlow.getName();
             // }
         } else {
