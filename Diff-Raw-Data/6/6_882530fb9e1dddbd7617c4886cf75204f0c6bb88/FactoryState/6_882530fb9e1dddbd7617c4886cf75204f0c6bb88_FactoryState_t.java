 ...
 public class FactoryState implements ActionListener {
 	...
 	void addNests() {
 		for(int i=0; i<4; i++) {
 			...
 			//Nest 1
 			NestAgent n1 = new NestAgent("Nest " + (i*2), (i*2), "", partRobot, p.getNest1(), partVision, laneList.get(i*2));
 			...
 			//Nest 2
 			NestAgent n2 = new NestAgent("Nest " + (i*2+1), (i*2+1), "", partRobot, p.getNest2(), partVision, laneList.get(i*2+1));
