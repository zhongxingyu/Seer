  ...
  * @author mcculley
  */
 public class EchelonModifierFilter implements ModifierFilter {
     ...
     public void filter(SymbologyStandard std, Document document, String SIDC, Map<String, String> modifiers) {
        ...
        if(s.charAt(1) <= 'N') {
         ...
         if (echelonIndicator != null) {
             ...
             String indicator = echelonIndicator.getIndicator();
             text.appendChild(document.createTextNode(indicator));
