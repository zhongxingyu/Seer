 ...
 public class GUI_KitRobot extends GUI_Component {
 	...
 	boolean goToOne = false,goToTwo = false,moveToOne = false,moveToTwo = false,moveToInspection = false,goToConveyor = false, finalMove = false, initialConveyor = false, placeOnOne = false, placeOnTwo = false;
 	...
 	public boolean arrivedAtStation()//notifies that robot has arrived at station
 	{
 	 ...
 	 { 
 		 System.out.println("moving to conveyor than to stand");
 ...
 //			 System.out.println("shown kit on conveyor ID: " + conveyor.checkKit().kit.kitID);
 	   ...
 	   public void DoMoveFromKitStandToInspection(Kit kit, KitRobotAgent agent) 
 			 ...
 			 if(stand.positionOpen(0))
 			 {
 				 if (stand.checkKit(2) != null)
 				 {
 					...
 					// {
 						 ...
 						 System.out.println("kit matched");
 	    ...
 	    {
 	    	System.out.println("moving from inspection to conveyor");
