...
import railo.print;
  ...
  * Da der data.cfml Transformer keine Spezialflle zulsst, 
  ...
  * Erst durch den Evaluator (siehe 3.3), der fr das Tag script definiert ist, 
 ...
 public final class CFMLScriptTransformer extends CFMLExprTransformer implements TagDependentBodyTransformer {
 	...
 	/**
 	 * Einstiegsmethode fr den CFScript Transformer, 
 	 ...
 	 * Der Parameter ist als data.cfmlString definiert, so dass er die transform Methode berschreibt.
 	...
 	/** 
 	 * Liest smtliche Statements des CFScriptString ein. 
 	 * <br />
 	 * EBNF:<br />
 	...
 	private Tag _propertyStatement(Data data,Body parent) throws TemplateException  {
 		...
 		// folgend wird tlt extra nicht bergeben, sonst findet prfung statt
 	 ...
 	 * und prft ob der Rckgabewert einen boolschen Wert reprsentiert und castet den Wert allenfalls.
 	 * <br />
 	 * EBNF:<br />
 ...
 // finally
 	...
 	/**
 	 * Prft ob sich der Zeiger am Ende eines Script Blockes befindet
