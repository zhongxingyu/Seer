 ...
 public class GUI_PartRobot extends GUI_Component{
     ...
     boolean move = false, changeGripper = false, getPart = false, putPart = false, goHome = false;
     int moveToX, moveToY;
     ...
     public void doTransferParts(ArrayList<GUI_Part> partsToGet, ArrayList<Integer> kitStandIndices){
         ...
         try{
             ...
             for(int k = 0; k < partsToGet.size(); k++){
                 ...
                 doMoveToKitStand(kitStandIndices.get(k));
                 ...
                 doPutPart(partsToGet.get(k),kitStandIndices.get(k));
     ...
     public void paintComponent() //update PartRobot's drawing
     {
        ...
        myDrawing.subDrawings.add(new Drawing(x+vrailX, y, "vrail.png"));
