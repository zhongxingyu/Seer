 ...
 public class NetworkTab {
 	...
 	public JComponent build() {
       ...
       final KeyedComboBoxModel kcbm = new KeyedComboBoxModel(new Object[] { "nl", "fr", "en", "de", "it", "es", "se", "ru" }, new Object[] { "Dutch", Messages.getString("NetworkTab.10"), Messages.getString("NetworkTab.9"), "German", "Italian", "Spanish", "Swedish", "Russian" }); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$ //$NON-NLS-10$ //$NON-NLS-11$ //$NON-NLS-12$
