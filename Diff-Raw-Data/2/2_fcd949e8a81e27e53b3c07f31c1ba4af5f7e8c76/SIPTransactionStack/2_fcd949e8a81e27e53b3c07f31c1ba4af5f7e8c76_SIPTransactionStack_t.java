 ...
 */
 ...
 extends SIPStack implements  SIPTransactionEventListener {
 ...
 */
 ...
 //
     ...
     public synchronized DialogImpl
    ...
    */
 	...
 	synchronized(clientTransactions) {
 		...
 		Event eventHdr = 
 			(Event)notifyMessage.getHeader(EventHeader.NAME);
      ...
      *
      *@param sipRequest -- request for which to retrieve the transaction.
      *
     ...
     MessageChannel	requestMessageChannel
         ...
         synchronized(serverTransactions) {
             ...
             while( transactionIterator.hasNext( ) &&
                 ...
                 if( nextTransaction.isMessagePartOfTransaction
                 ( requestReceived ) ) {
 		   ...
 		   currentTransaction = createServerTransaction
 					(requestMessageChannel);
 		    currentTransaction.setOriginalRequest
 					(requestReceived);
