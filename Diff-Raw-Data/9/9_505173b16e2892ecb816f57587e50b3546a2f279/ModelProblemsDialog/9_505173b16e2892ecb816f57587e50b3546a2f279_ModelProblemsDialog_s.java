 ...
 public class ModelProblemsDialog extends TitleAreaDialog {
 	...
 	private void createProblemsTreeView(Composite parent) {
 		...
 		final TreeViewer treeViewer = new TreeViewer(treeColumnComposite, SWT.BORDER | SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
 	...
 	public void openInBrowserWindow(String url) {
 		try {
