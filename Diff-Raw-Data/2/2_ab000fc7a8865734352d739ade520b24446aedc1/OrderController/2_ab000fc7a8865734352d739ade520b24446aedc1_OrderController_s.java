 ...
 public class OrderController {
 	...
 	public String order(@ModelAttribute("itemOrder") @Valid ItemOrder itemOrder, BindingResult result, HttpSession session) {
 	...
 	private void validateCaptcha(ItemOrder itemOrder, BindingResult result, HttpSession session) {
         ...
         if (captcha == null || captcha.isCorrect(itemOrder.getCaptcha()) == false) {
            result.addError(new ObjectError("itemOrder", "Invalid image characters"));
         }
 	}
 }
