 ...
 * });
 ...
 public final class ImageManager {
     ...
     private ImageManager(Context context) {
         try {
             File imageCacheDirectory = new File(getCacheDirectory(context).getAbsolutePath(), "/images/");
             mDiskLruCache = DiskLruCache.open(imageCacheDirectory, 1, 1, Configuration.DISK_CACHE_SIZE_KB * 1024);
         } catch (IOException e) {
             printStackTrace(e);
