 ...
 public class Main {
     ...
     public void startMainGameLoop() throws NumberFormatException, IOException {
         ...
         while (winner == null) {
             ...
             if (startLocation instanceof Room) {
                winner = offerRoomOptions(currentPlayer, currentToken, (Room) startLocation);
    ...
    private Player offerRoomOptions(Player currentPlayer, Character currentToken, Room room) throws IOException {
     ...
     private Player useSecretPassage(Player currentPlayer,
        ...
        return offerRoomOptions(currentPlayer, character, finishLocation);
     }
                 ...
                 if (toMoveTile.getType() == '.') {
                     ...
                     for (int i =0; i<players.size(); i++) {
                         if (players.get(i).getToken() == currentToken) {
                            offerRoomOptions(players.get(i), currentToken, room);
                         }
                     }
                 } else {
