 ...
 * @version $Id: MapProjection.java,v 1.2 2002/07/10 18:19:45 desruisseaux Exp $
 ...
 abstract class MapProjection extends AbstractMathTransform implements MathTransform2D {
     ...
     /**
      * Convertit en radians une longitude exprime en degrs. Au passage,
      * cette mthode vrifiera si la longitude est bien dans les limites
      * permises (180). Cette mthode est utile pour vrifier la validit
      * des paramtres de la projection, comme {@link #setCentralLongitude}.
      *
      * @param  x Longitude  vrifier, en degrs.
     ...
     /**
      * Convertit en radians une latitude exprime en degrs. Au passage,
      * cette mthode vrifiera si la latitude est bien dans les limites
      * permises (90). Cette mthode est utile pour vrifier la validit
      * des paramtres de la projection, comme {@link #setCentralLongitude}.
      *
      * @param  y Latitude  vrifier, en degrs.
     ...
     {
         /*
          * Vrifie s'il faudra parcourir le tableau en sens inverse.
          * Ce sera le cas si les tableaux source et destination se
          * chevauchent et que la destination est aprs la source.
          */
     ...
     /**
      * Transforme la forme gomtrique <code>shape</code> spcifie.
      * Cette projection peut remplacer certaines lignes droites
      * par des courbes. Tous les points de la forme gomtrique
      * seront copis. Cette mthode n'est donc pas  conseiller
      * si <code>shape</code> est volumineux, par exemple s'il
      * reprsente une bathymtrie entire.
      *
      * @param shape Forme gomtrique  transformer. Les coordonnes des points
      *              de cette forme doivent tre exprimes en degrs de latitudes
      *              et de longitudes.
      * @return      Forme gomtrique transforme. Les coordonnes des points de
      *              cette forme seront exprimes en mtres.
      * @throws TransformException si une transformation a choue.
      */
     ...
     /**
      * Retourne une chane de caractres reprsentant cette projection cartographique.
      * Cette chane de caractres contiendra entre autres le nom de la projection, les
      * coordonnes du centre et celles de l'origine.
      */
