 ...
 public class Xtend2ValidationTest extends AbstractXtend2TestCase {
 	...
 	public void testRichStringIfPredicate() throws Exception {
 		assertNoConformanceError("'''IF Boolean::FALSEENDIF'''");
 		assertNoConformanceError("'''IF trueENDIF'''");
 		assertNoConformanceError("'''IF 1 == 1ENDIF'''");
 		assertConformanceError("'''IF 1ENDIF'''", XbasePackage.Literals.XINT_LITERAL, "int",
 				"boolean", "java.lang.Boolean");
 	}
 	
 	public void testRichStringForLoop() throws Exception {
 		assertNoConformanceError("'''FOR i: 1..10ENDFOR'''");
 		assertNoConformanceError("'''FOR i: 1..10 BEFORE 'a' SEPARATOR 1 AFTER trueENDFOR'''");
 		...
 		assertConformanceError(
 				...
 				"java.lang.Object");
 		assertConformanceError(
 				"'''FOR i: 1..10 BEFORE 'a' SEPARATOR null AFTER while(true) nullENDFOR'''", 
 				XbasePackage.Literals.XWHILE_EXPRESSION, "void",
 				"java.lang.Object");
 	}
