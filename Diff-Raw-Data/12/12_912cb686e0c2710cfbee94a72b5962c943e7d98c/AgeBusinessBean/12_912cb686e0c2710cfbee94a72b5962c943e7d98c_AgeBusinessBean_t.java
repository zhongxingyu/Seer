 /*
 * $Id: AgeBusinessBean.java,v 1.17 2003/12/02 12:50:05 anders Exp $
  *
  ...
  * <p>
 * Last modified: $Date: 2003/12/02 12:50:05 $ by $Author: anders $
  *
 	...
 	public int getChildAge(String childPersonalId, Date date, String operationalField) {
 		...
 		try {
 			...
 			if (calendarDate.getMonth() <= childDate.getMonth()) {
 				if ((calendarDate.getMonth() < childDate.getMonth()) || (calendarDate.getDay() < childDate.getDay())) {
