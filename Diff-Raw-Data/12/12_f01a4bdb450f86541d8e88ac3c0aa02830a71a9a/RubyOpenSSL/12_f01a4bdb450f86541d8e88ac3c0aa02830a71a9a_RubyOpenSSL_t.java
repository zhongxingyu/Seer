     ...
     public static class Service implements Library {
         public void load(final IRuby runtime) throws IOException {
             ...
             try {
                 ...
                 Class.forName("org.bouncycastle.jce.provider.BouncyCastleProvider"); // BC
                 Class.forName("org.bouncycastle.cms.CMSSignedData"); // BC SMIME/CMS
                 c = Class.forName("org.jruby.ext.openssl.OpenSSLReal"); // Check it's actually compiled...
             } catch(Exception e) {
