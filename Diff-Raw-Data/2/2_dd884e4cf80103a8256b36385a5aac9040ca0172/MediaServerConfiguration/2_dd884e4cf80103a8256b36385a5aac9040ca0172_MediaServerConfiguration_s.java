 ...
 public class MediaServerConfiguration {
	...
	public static final String BC_CHANNELS_SERVER = "channels.buddycloud.org";
 	 ...
 	 */
 	// File System
 	public static final long DEF_MEDIA_SIZE_LIMIT_PROPERTY = 1000240;
 	...
 	private void loadDefault() {
 		if (configuration.get(MEDIA_SIZE_LIMIT_PROPERTY) == null) {
 			configuration.put(MEDIA_SIZE_LIMIT_PROPERTY, DEF_MEDIA_SIZE_LIMIT_PROPERTY);
 		}
 	...
 	private void validate() {
 		...
 		if (configuration.get(JDBC_DRIVER_CLASS_PROPERTY) == null) {
 			missingProperties.add(JDBC_DRIVER_CLASS_PROPERTY);
 		}
