 ...
 */
 ...
 public class Constants
 {
 	...
 	/** The Constant GridGrouperMap. */
 	public static final String GRIDGROUPERMAP = "gridGrouperMap";
 
 	/** The Constant GridGrouperStems. */
 	public static final String GRIDGROUPERSTEMS = "gridGrouperStems";
 	...
 	/** The Constant GRID_PRIVILEGE_DATA_LIST_ONLOAD. */
 	public static final String GRID_PRIVILEGE_DATA_LIST_ONLOAD = "listOfGridPrivilegeDataOnLoad";
 	...
 	/**The Constant PARTICIPANT_AUTHORIZE_ACTION. */
 	public static final String PARTICIPANT_AUTHORIZE_ACTION = "ParticipantAddAuthorize.do";
 	...
 	/** The Constant DYNAMIC_EVENT_ACTION. */
 	public static final String DYNAMIC_EVENT_ACTION = "DynamicEventAdd.do";
 	...
 	/** The Constant ROW_ID_OBJECT_BEAN_MAP. */
 	public static final String GRID_ROW_ID_OBJECT_BEAN_MAP = "gridRowIdObjectBeanMap";
 	...
 	/** The Constant OPERATION_ADD_GRID_PRIVILEGE. */
 	public static final String OPERATION_ADD_GRID_PRIVILEGE = "addGridPrivilege";
 
 	/** The Constant OPERATION_REMOVE_GRID_PRIVILEGE. */
 	public static final String OPERATION_REMOVE_GRID_PRIVILEGE = "removeGridPrivileges";
 	...
 	/** The Constant SELECTED_GRID_GROUPER_STEM_NAME. */
 	public static final String SELECTED_GRID_GROUPER_STEM_NAME = "stemName";
 
 	/** The Constant SELECTED_GRID_GROUPER_GROUP_NAME. */
 	public static final String SELECTED_GRID_GROUPER_GROUP_NAME = "groupName";
 
 	/** The Constant SELECTED_GRID_GROUPER_DELETION_ITEMS. */
 	public static final String SELECTED_GRID_GROUPER_DELETION_ITEMS = "deletedGridPrivileges";
 	...
 	*//** Specify the SPECIMEN_ARRAY_LIST as key for specimen array type list. */
 	...
 	/** The Constant ALIAS_SPP. */
 	public static final String ALIAS_SPP = "SpecimenProcessingProcedure";
 	...
 	public static final String getCPGridGroupRoleName(long collectionProtocolId, long groupId,
 			String defaultRole)
 	{
 		final String roleName = defaultRole + "_" + "CP_" + collectionProtocolId + "_GRIDGROUP_"
 				+ groupId;
 		return roleName;
 	}
 	...
 	/** The Constant ADD_EDIT_SPP. */
 	public static final String ADD_EDIT_SPP = "ADD_EDIT_SPP";
 	...
 	public static final int EVENT_NOTIFICATIONS_FORM_ID = 71;
 
 	public static final int GSID_BATCH_UPDATE_FORM_ID = 72;
 
 	public static final int EVENT_NOTIFICATION_FORM_ID = 73;
 
 	/** The constant key for setting the catissue crtp integration. */
 	public static final String CRTP_ORGANIZATION_LINK_ACTION = "CTRPInstitutionLink.do";
 
 	public static final String REMOTE_OPERATION_LINK = "linkRemote";
 
 	public static final String REMOTE_OPERATION_SYNC = "syncRemote";
 
 	public static final String REMOTE_OPERATION_SEARCH = "searchRemote";
 
 	public static final String REMOTE_OPERATION_NO_LINK = "noRemoteLink";
 
 	public static final String REMOTE_OPERATION_EDIT = "dirtyEdit";
 
 	public static final String REMOTE_OPERATION_SEARCH_LINK = "searchLinkRemote";
 
 	public static final String STATE_CODE_MAPPING_RESOURCES = "StateCodeMappingResources";
 
 	public static final String STATE_OTHER = "Other";
 
 	public static final String SPACE_STR = " ";
 
 	public static final String REMOTE_MANAGED_FLAG = "remoteManagedFlag";
	...
	public static final String SPP_XSD_ZIP_FILENAME = "SPP_xsd.zip";
 	...
 	public static final String BARCODE_KEY = "key 3";
 
 	public static final String NAME_KEY = "key 2";
 
 	public static final String SPP_NAME_ERROR = "Submission failed since SPP with same name already exists";
 
 	public static final String SPP_BARCODE_ERROR = "Submission failed since SPP with same barcode already exists";
 
 	public static final String UNIQUE_ID_ERROR = "Submission failed as the SPP contains more than one event with same unique id.";
 
 	public static final String EVENT_BARCODE_ERROR = "Submission failed as the SPP contains more than one event with same barcode";
 	...
 	public static final String CONTEXT_RECORD_MAP = "contextRecordMap";
 
 	public static final String SPP_EVENTS_MSG = "SPP events";
 
 	public static final String DEFAULT_VALUES = "Default values";
 
 	public static final String REFRESH_EVENT_GRID = "refreshEventGrid";
 
 	public static final String PAGE_OF_SPECIMEN_EVENTS = "pageOfSpecimenEvents";
 
 	public static final String NOTCLOSEDACTIVITYSTATUS = "notClosedActivtyStatusList";
 
 	public static final String[] NOT_CLOSED_ACTIVITY_STATUS = {"Closed", "Disabled"};
 
 	public static final String[] CLOSED_ACTIVITY_STATUS = {"Active", "Closed","Disabled"};
 
 	public static final String SPECIMEN_EVENT_PARAMETER = "specimenEventParameter";
 
 	public static final String SPECIMEN_LABLE = "specimenLabel";
 
 	public static final String ERRORS = "errors";
 
 	public static final String SCGID = "scgId";
 
 	public static final String DATE_OF_EVENT = "dateOfEvent";
 
 	public static final String CONTAINS_ERROR = "containsErrors";
 
 	public static final String DYN_EVENT_FORM = "dynamicEventsForm";
