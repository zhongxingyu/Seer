 ...
 public class ResourceBoundleTranslator {
 	...
 	public static void main(String[] args) {
 		...
 		if (args.length == 5 || args.length == 6) {
 			...
 			for (ax = 4; ax < args.length; ax++) {
				...
				} else if (args[ax].startsWith("-offset=")) {
 	...
 	private static void printUsageAndExit() {
		...
		System.err.println("\t  -offset=[from:to,+first,-last,...] :  List of ranges or limit cuantifiers.");
 		//System.err.println("\t  -2WaysCompleemnt");
 		System.err.println("");
 		System.err.println(" Usage Examples:");
		System.err.println("\t${JVM}  com.tracktopell.util.ResourceBoundleTranslator   messages_en.properties  messages_es.properties en es -preferredSynonimsArr=[fichero:archivo,ordenador:computadora] -offset=[1:5,-10]");
 		System.err.println("\t");
 		...
 		System.err.println("\t");
		System.err.println("\t${JVM}  com.tracktopell.util.ResourceBoundleTranslator   messages_fr.properties  -stdout                fr es -offset=[-25]");
 		System.err.println("\t");
 		System.err.println();
 		System.exit(1);
 	}
