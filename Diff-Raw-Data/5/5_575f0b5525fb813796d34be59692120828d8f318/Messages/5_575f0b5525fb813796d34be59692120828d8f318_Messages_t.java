 ...
 public class Messages extends AbstractMessages {
 	...
 	protected Set<Message> createMessage() {
 		...
 		// Command - JAIL
 		newMessages.add(new Message(MessageId.cuboid_cmdJailNotJailCuboid, "&cThe Region %region% is not a Jail Region", new String[] {"%region%"}, null, true));
 		newMessages.add(new Message(MessageId.cuboid_cmdJailNotInRegion, "&cThe Location %location% is not in the Region %region%", new String[] {
 				"%location%",
 				"%region%"
 		}, null, true));
