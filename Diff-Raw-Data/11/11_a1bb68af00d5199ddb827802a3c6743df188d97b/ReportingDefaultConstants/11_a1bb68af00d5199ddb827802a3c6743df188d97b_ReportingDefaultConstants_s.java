  ...
  */
 public class ReportingDefaultConstants {
	...
	public static String DEFAULT_PATH = "file:/users/dpitt/";
 	...
 	// Meta data defaults
 	public static String META_DATA_TITLE = "PDF Batch Report";
 	public static String META_DATA_SUBJECT = "PDF Reporting";
 	public static String META_DATA_KEYWORDS = "Spring, Spring Batch, PDF Report";
 	public static String META_DATA_AUTHOR = "KHS Batch Report";
 	public static String META_DATA_CREATOR = "KHS Batch";
