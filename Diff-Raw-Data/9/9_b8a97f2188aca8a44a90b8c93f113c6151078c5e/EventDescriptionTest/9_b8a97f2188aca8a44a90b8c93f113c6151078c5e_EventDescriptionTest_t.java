 ...
 public class EventDescriptionTest extends TestCase {
   ...
   private final String veryInvalidTestString = "HTTP 400 ERROR NOT VALID ABORT";
    ...
    private final String[] sessionAttributesOracle = {
                                                      "AndoridIDHash__c",
                                                      "DataConnectionType__c",
                                                      "DeviceSerialHash__c",
                                                      "DeviceCountry__c",
                                                      "DeviceManufacturer__c",
                                                      "DeviceModel__c",
                                                      "DeviceType__c",
                                                      "EpochTime__c",
                                                      "LanguageLocale__c",
                                                      "LocaleCountryCode__c",
                                                      "LocalyticsApiKey__c",
                                                      "LocalyticsLibraryVersion__c",
                                                      "NetworkCarrier__c",
                                                      "NetworkCountryCode__c",
                                                      "OSVersion__c",
                                                      "PersistentStorageCreationTimeSeconds__c",
                                                      "SDKCompatibility__c",
    ...
    public void testParseValidJSON() {
       try {
          ...
          checkEventDescription(result.get(1), "button pressed",
                   buttonPressedAttributesOracle);
 
          // check "record name and age" event description
          checkEventDescription(result.get(2), "record name and age",
                   recordNameAttributeOracle);
       }
    ...
    private void checkEventDescription(EventDescription description,
             String eventName, String[] eventAttributeNames) {
       List<AttributeDescription> sessionAttributes = description
                .getAttributes();
       ...
       for (AttributeDescription attrib : sessionAttributes) {
          assertTrue(Arrays.asList(eventAttributeNames).contains(
                   attrib.getName()));
       }
    }
