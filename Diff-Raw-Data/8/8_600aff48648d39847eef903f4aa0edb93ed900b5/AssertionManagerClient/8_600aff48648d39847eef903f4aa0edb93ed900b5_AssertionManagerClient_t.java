 ...
 public final class AssertionManagerClient {
     ...
     public AssertionManagerClient() throws SAMLException {
         if (!checkedForLocal) {
              ...
              * to do a fall back funtion yet, as rest of the access manager
    ...
    protected Assertion getAssertion(AssertionArtifact artifact, String destID)
      ...
      * this instance (or the identified remote instance) of Access Manager.
      ...
      * (or the identified remote instance) of Access Manager.
      *
