 ...
 public class SubTaskView_Paint extends SubTaskView {
     ...
     public String getRenderedHTML(final ViewContext context, final int relativeTaskNumber, final boolean corrected) {
         ...
         // ret.append("<applet name=\"drawTask_" + relativeTaskNumber +
         // "\" codebase=\"");
         ...
         ret.append("<param name=\"mutableForeground\" value=\"").append(paintSubTasklet.getMutablePictureString())
                 .append("\">\n");
         ...
         ret.append("<input type=\"hidden\" id=\"task_" + relativeTaskNumber + ".image\" name=\"task[" + relativeTaskNumber
                 + "].image\">\n");
         ret.append("<input type=\"hidden\" id=\"task_" + relativeTaskNumber + ".resetted\" name=\"task[" + relativeTaskNumber
                 + "].resetted\">\n");
 
         if (!corrected) {
             ret.append("<script type=\"text/javascript\">\n");
             ret.append(" var preSave_task_" + relativeTaskNumber + " = function(){\n");
             ret.append(" document.getElementById(\"task_" + relativeTaskNumber + ".image\").value = document.drawTask_"
                     + relativeTaskNumber + ".getForegroundPictureWithUndoData(5);\n");
             ret.append(" document.getElementById(\"task_" + relativeTaskNumber + ".resetted\").value = document.drawTask_"
                     + relativeTaskNumber + ".isResetted();\n");
             ret.append("};\n");
