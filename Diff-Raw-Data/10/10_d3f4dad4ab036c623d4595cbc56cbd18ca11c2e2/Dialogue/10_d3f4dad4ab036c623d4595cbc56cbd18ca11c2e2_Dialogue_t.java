...
/* returns a portion of the text contained within the Scanner. the argument totalWords decides how many words
 * from the Scanner source will be returned. I believe it starts at 0 inclusive and ends at totalWords exclusive,
...
/* returns a portion of the text contained within the Scanner. the argument beginAtWord describes the nth word
  * for the Scanner to start at. likewise, the argument endAtWord describes the nth word for the Scanner to stop at.
 * like the previous method, I'm unsure which numbers are inclusive/exclusive, so I'll update with that information later. */
