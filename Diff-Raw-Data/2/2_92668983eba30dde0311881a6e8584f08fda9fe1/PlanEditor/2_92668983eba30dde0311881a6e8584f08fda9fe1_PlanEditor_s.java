 ...
 import pt.lsts.neptus.plugins.planning.edit.ManeuverAdded;
 import pt.lsts.neptus.plugins.planning.edit.ManeuverChanged;
 import pt.lsts.neptus.plugins.planning.edit.ManeuverPropertiesPanel;
 import pt.lsts.neptus.plugins.planning.edit.ManeuverRemoved;
 import pt.lsts.neptus.plugins.planning.edit.PlanRotated;
 import pt.lsts.neptus.plugins.planning.edit.PlanTranslated;
  ...
  * @author pdias
  */
 @PluginDescription(name = "Plan Edition", icon = "pt/lsts/neptus/plugins/planning/images/plan_editor.png", author = "José Pinto, Paulo Dias", version = "1.5", category = CATEGORY.INTERFACE)
 ...
 MissionChangeListener {
     ...
     protected AbstractAction getSettingsAction() {
         return new AbstractAction(I18n.text("Statistics"), ImageUtils.getScaledIcon(
                 "pt/lsts/neptus/plugins/planning/images/edit_settings.png", 16, 16)) {
             private static final long serialVersionUID = 1L;
     ...
     protected AbstractAction getNewAction() {
         return new AbstractAction(I18n.textc("New", "Plan"), ImageUtils.getScaledIcon(
                 "pt/lsts/neptus/plugins/planning/images/edit_new.png", 16, 16)) {
             private static final long serialVersionUID = 1L;
     ...
     protected AbstractAction getUndoAction() {
         if (undoAction == null)
             undoAction = new AbstractAction(I18n.text("Undo"), ImageUtils.getScaledIcon(
                     "pt/lsts/neptus/plugins/planning/images/undo.png", 16, 16)) {
             private static final long serialVersionUID = 1L;
     ...
     protected AbstractAction getRedoAction() {
         ...
         if (redoAction == null)
             redoAction = new AbstractAction(I18n.text("Redo"), ImageUtils.getScaledIcon(
                     "pt/lsts/neptus/plugins/planning/images/redo.png", 16, 16)) {
             private static final long serialVersionUID = 1L;
     ...
     protected AbstractAction getSaveAction() {
         return new AbstractAction(I18n.text("Save"), ImageUtils.getScaledIcon(
                 "pt/lsts/neptus/plugins/planning/images/edit_save.png", 16, 16)) {
             private static final long serialVersionUID = 1L;
