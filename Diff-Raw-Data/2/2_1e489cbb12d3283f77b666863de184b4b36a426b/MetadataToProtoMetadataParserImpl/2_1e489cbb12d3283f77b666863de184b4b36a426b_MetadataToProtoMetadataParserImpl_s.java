 ...
 public class MetadataToProtoMetadataParserImpl implements MetadataToProtoMetadataParser {
     ...
     private static final Logger log = LoggerFactory.getLogger(MetadataToProtoMetadataParserImpl.class);
     ...
     public DocumentMetadata yelementToDocumentMetadata(YElement yElement, ZipArchive zipArchive, String sourcePath, String collection) {
         ...
         for (int i = 0; i < authorNodeList.size(); i++) {
             ...
             if (currentNode != null && currentNode.isPerson() && "author".equals(currentNode.getRole())) {
                 Author.Builder author = MetadataToProtoMetadataParserImpl.ycontributorToAuthorMetadata(currentNode);
     ...
     public List<DocumentMetadata> parseStream(InputStream stream, MetadataType type, String collection) {
         ...
         try {
             List<YExportable> elem = streamToYExportable(stream, type);
             if (elem != null) {
