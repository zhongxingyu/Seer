 ...
 public class sm_ic2recipes {
     ...
     public static void initIC2Recipes()
 	{
 		...
 		GameRegistry.addShapelessRecipe(copperBlock,9,0, new ItemStack(sm_ic2plugin.ic2blocksI,1,0));
 		...
 		GameRegistry.addShapelessRecipe(tinBlock,9,0, new ItemStack(sm_ic2plugin.ic2blocksI,1,4));
 		...
 		GameRegistry.addShapelessRecipe(uraniumBlock,9,0, new ItemStack(sm_ic2plugin.ic2blocksI,1,8));
 		...
 		GameRegistry.addShapelessRecipe(bronzeBlock,9,0, new ItemStack(sm_ic2plugin.ic2blocksI,1,12));
