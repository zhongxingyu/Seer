 ...
 public class update0010 implements Update
 {
   ...
   public void execute(UpdateProvider provider) throws ApplicationException
   {
     ...
     if (sql == null)
       throw new ApplicationException(i18n.tr("Datenbank {0} wird untersttzt",driver));
     ...
     catch (Exception e)
     {
       ...
       throw new ApplicationException(i18n.tr("Fehler beim Ausfhren des Updates"),e);
     }
   }
   ...
   {
     return "Datenbank-Update fr Tabelle \"property\"";
   }
