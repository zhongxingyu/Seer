 ...
 //import org.eclipse.wst.jsdt.core.VjetPlugin;
 ...
 public class DefaultCodeFormatterOptions {
 	...
 	public Map getMap() {
 		...
 		options.put(DefaultCodeFormatterConstants.FORMATTER_COMMENT_INSERT_EMPTY_LINE_BEFORE_ROOT_TAGS, this.comment_insert_empty_line_before_root_tags ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_COMMENT_INSERT_NEW_LINE_FOR_PARAMETER, this.comment_insert_new_line_for_parameter ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		...
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_AFTER_ANNOTATION, this.insert_new_line_after_annotation ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_AFTER_OPENING_BRACE_IN_ARRAY_INITIALIZER, this.insert_new_line_after_opening_brace_in_array_initializer? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_AFTER_OPENING_BRACE_IN_OBJLIT_INITIALIZER, this.insert_new_line_after_opening_brace_in_objlit_initializer? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_AFTER_COMMA_IN_OBJLIT_INITIALIZER, this.insert_new_line_after_comma_in_objlit_initializer? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_AT_END_OF_FILE_IF_MISSING, this.insert_new_line_at_end_of_file_if_missing ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_BEFORE_CATCH_IN_TRY_STATEMENT, this.insert_new_line_before_catch_in_try_statement? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_BEFORE_CLOSING_BRACE_IN_ARRAY_INITIALIZER, this.insert_new_line_before_closing_brace_in_array_initializer? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_BEFORE_CLOSING_BRACE_IN_OBJLIT_INITIALIZER, this.insert_new_line_before_closing_brace_in_objlit_initializer? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_BEFORE_ELSE_IN_IF_STATEMENT, this.insert_new_line_before_else_in_if_statement? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_BEFORE_FINALLY_IN_TRY_STATEMENT, this.insert_new_line_before_finally_in_try_statement? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_BEFORE_WHILE_IN_DO_STATEMENT, this.insert_new_line_before_while_in_do_statement? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_IN_EMPTY_ANONYMOUS_TYPE_DECLARATION, this.insert_new_line_in_empty_anonymous_type_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_IN_EMPTY_BLOCK, this.insert_new_line_in_empty_block? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_IN_EMPTY_ANNOTATION_DECLARATION, this.insert_new_line_in_empty_annotation_declaration ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_IN_EMPTY_ENUM_CONSTANT, this.insert_new_line_in_empty_enum_constant? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_IN_EMPTY_ENUM_DECLARATION, this.insert_new_line_in_empty_enum_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_IN_EMPTY_METHOD_BODY, this.insert_new_line_in_empty_method_body? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_NEW_LINE_IN_EMPTY_TYPE_DECLARATION, this.insert_new_line_in_empty_type_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_AND_IN_TYPE_PARAMETER, this.insert_space_after_and_in_type_parameter? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_ASSIGNMENT_OPERATOR, this.insert_space_after_assignment_operator? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_AT_IN_ANNOTATION, this.insert_space_after_at_in_annotation? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_AT_IN_ANNOTATION_TYPE_DECLARATION, this.insert_space_after_at_in_annotation_type_declaration ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_BINARY_OPERATOR, this.insert_space_after_binary_operator? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_CLOSING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS, this.insert_space_after_closing_angle_bracket_in_type_arguments ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_CLOSING_ANGLE_BRACKET_IN_TYPE_PARAMETERS, this.insert_space_after_closing_angle_bracket_in_type_parameters ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_CLOSING_PAREN_IN_CAST, this.insert_space_after_closing_paren_in_cast? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_CLOSING_BRACE_IN_BLOCK, this.insert_space_after_closing_brace_in_block? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COLON_IN_ASSERT, this.insert_space_after_colon_in_assert ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COLON_IN_CASE, this.insert_space_after_colon_in_case ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COLON_IN_CONDITIONAL, this.insert_space_after_colon_in_conditional ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COLON_IN_OBJECT_INITIALIZER, this.insert_space_after_colon_in_object_initializer ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COLON_IN_FOR, this.insert_space_after_colon_in_for ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COLON_IN_LABELED_STATEMENT, this.insert_space_after_colon_in_labeled_statement? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ALLOCATION_EXPRESSION, this.insert_space_after_comma_in_allocation_expression? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ANNOTATION, this.insert_space_after_comma_in_annotation? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ARRAY_INITIALIZER, this.insert_space_after_comma_in_array_initializer? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_CONSTRUCTOR_DECLARATION_PARAMETERS, this.insert_space_after_comma_in_constructor_declaration_parameters? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_CONSTRUCTOR_DECLARATION_THROWS, this.insert_space_after_comma_in_constructor_declaration_throws? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ENUM_CONSTANT_ARGUMENTS, this.insert_space_after_comma_in_enum_constant_arguments ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ENUM_DECLARATIONS, this.insert_space_after_comma_in_enum_declarations ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_EXPLICIT_CONSTRUCTOR_CALL_ARGUMENTS, this.insert_space_after_comma_in_explicit_constructor_call_arguments? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_FOR_INCREMENTS, this.insert_space_after_comma_in_for_increments? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_FOR_INITS, this.insert_space_after_comma_in_for_inits? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_METHOD_INVOCATION_ARGUMENTS, this.insert_space_after_comma_in_method_invocation_arguments? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_METHOD_DECLARATION_PARAMETERS, this.insert_space_after_comma_in_method_declaration_parameters? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_METHOD_DECLARATION_THROWS, this.insert_space_after_comma_in_method_declaration_throws? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_MULTIPLE_FIELD_DECLARATIONS, this.insert_space_after_comma_in_multiple_field_declarations? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_MULTIPLE_LOCAL_DECLARATIONS, this.insert_space_after_comma_in_multiple_local_declarations? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_PARAMETERIZED_TYPE_REFERENCE, this.insert_space_after_comma_in_parameterized_type_reference? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_SUPERINTERFACES, this.insert_space_after_comma_in_superinterfaces? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_TYPE_ARGUMENTS, this.insert_space_after_comma_in_type_arguments ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_TYPE_PARAMETERS, this.insert_space_after_comma_in_type_parameters ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_BRACKET_IN_ARRAY_ALLOCATION_EXPRESSION, this.insert_space_after_opening_bracket_in_array_allocation_expression? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_ELLIPSIS, this.insert_space_after_ellipsis ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_ANGLE_BRACKET_IN_PARAMETERIZED_TYPE_REFERENCE, this.insert_space_after_opening_angle_bracket_in_parameterized_type_reference? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS, this.insert_space_after_opening_angle_bracket_in_type_arguments? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_ANGLE_BRACKET_IN_TYPE_PARAMETERS, this.insert_space_after_opening_angle_bracket_in_type_parameters? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_BRACKET_IN_ARRAY_REFERENCE, this.insert_space_after_opening_bracket_in_array_reference? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_BRACE_IN_ARRAY_INITIALIZER, this.insert_space_after_opening_brace_in_array_initializer? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_ANNOTATION, this.insert_space_after_opening_paren_in_annotation? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_CAST, this.insert_space_after_opening_paren_in_cast? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_CATCH, this.insert_space_after_opening_paren_in_catch? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_CONSTRUCTOR_DECLARATION, this.insert_space_after_opening_paren_in_constructor_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_ENUM_CONSTANT, this.insert_space_after_opening_paren_in_enum_constant? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_FOR, this.insert_space_after_opening_paren_in_for? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_IF, this.insert_space_after_opening_paren_in_if? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_METHOD_DECLARATION, this.insert_space_after_opening_paren_in_method_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_METHOD_INVOCATION, this.insert_space_after_opening_paren_in_method_invocation? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_PARENTHESIZED_EXPRESSION, this.insert_space_after_opening_paren_in_parenthesized_expression? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_SWITCH, this.insert_space_after_opening_paren_in_switch? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_SYNCHRONIZED, this.insert_space_after_opening_paren_in_synchronized? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_WHILE, this.insert_space_after_opening_paren_in_while? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_POSTFIX_OPERATOR, this.insert_space_after_postfix_operator? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_PREFIX_OPERATOR, this.insert_space_after_prefix_operator? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_QUESTION_IN_CONDITIONAL, this.insert_space_after_question_in_conditional? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_SEMICOLON_IN_FOR, this.insert_space_after_semicolon_in_for? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_UNARY_OPERATOR, this.insert_space_after_unary_operator? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_AT_IN_ANNOTATION_TYPE_DECLARATION, this.insert_space_before_at_in_annotation_type_declaration ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_ASSIGNMENT_OPERATOR, this.insert_space_before_assignment_operator? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_BINARY_OPERATOR, this.insert_space_before_binary_operator? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_ANGLE_BRACKET_IN_PARAMETERIZED_TYPE_REFERENCE, this.insert_space_before_closing_angle_bracket_in_parameterized_type_reference? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS, this.insert_space_before_closing_angle_bracket_in_type_arguments? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_ANGLE_BRACKET_IN_TYPE_PARAMETERS, this.insert_space_before_closing_angle_bracket_in_type_parameters? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_BRACE_IN_ARRAY_INITIALIZER, this.insert_space_before_closing_brace_in_array_initializer? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_BRACKET_IN_ARRAY_ALLOCATION_EXPRESSION, this.insert_space_before_closing_bracket_in_array_allocation_expression? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_BRACKET_IN_ARRAY_REFERENCE, this.insert_space_before_closing_bracket_in_array_reference? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_ANNOTATION, this.insert_space_before_closing_paren_in_annotation? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_CAST, this.insert_space_before_closing_paren_in_cast? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_CATCH, this.insert_space_before_closing_paren_in_catch? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_CONSTRUCTOR_DECLARATION, this.insert_space_before_closing_paren_in_constructor_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_ENUM_CONSTANT, this.insert_space_before_closing_paren_in_enum_constant? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_FOR, this.insert_space_before_closing_paren_in_for? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_IF, this.insert_space_before_closing_paren_in_if? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_METHOD_DECLARATION, this.insert_space_before_closing_paren_in_method_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_METHOD_INVOCATION, this.insert_space_before_closing_paren_in_method_invocation? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_PARENTHESIZED_EXPRESSION, this.insert_space_before_closing_paren_in_parenthesized_expression? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_SWITCH, this.insert_space_before_closing_paren_in_switch? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_SYNCHRONIZED, this.insert_space_before_closing_paren_in_synchronized? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_WHILE, this.insert_space_before_closing_paren_in_while? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_ASSERT, this.insert_space_before_colon_in_assert? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_CASE, this.insert_space_before_colon_in_case? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_CONDITIONAL, this.insert_space_before_colon_in_conditional? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_OBJECT_INITIALIZER, this.insert_space_before_colon_in_object_initializer? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_DEFAULT, this.insert_space_before_colon_in_default? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_FOR, this.insert_space_before_colon_in_for ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_LABELED_STATEMENT, this.insert_space_before_colon_in_labeled_statement? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ALLOCATION_EXPRESSION, this.insert_space_before_comma_in_allocation_expression? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ANNOTATION, this.insert_space_before_comma_in_annotation? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ARRAY_INITIALIZER, this.insert_space_before_comma_in_array_initializer? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_CONSTRUCTOR_DECLARATION_PARAMETERS, this.insert_space_before_comma_in_constructor_declaration_parameters? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_CONSTRUCTOR_DECLARATION_THROWS, this.insert_space_before_comma_in_constructor_declaration_throws? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ENUM_CONSTANT_ARGUMENTS, this.insert_space_before_comma_in_enum_constant_arguments? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ENUM_DECLARATIONS, this.insert_space_before_comma_in_enum_declarations? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_EXPLICIT_CONSTRUCTOR_CALL_ARGUMENTS, this.insert_space_before_comma_in_explicit_constructor_call_arguments? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_FOR_INCREMENTS, this.insert_space_before_comma_in_for_increments? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_FOR_INITS, this.insert_space_before_comma_in_for_inits? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_METHOD_INVOCATION_ARGUMENTS, this.insert_space_before_comma_in_method_invocation_arguments? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_METHOD_DECLARATION_PARAMETERS, this.insert_space_before_comma_in_method_declaration_parameters? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_METHOD_DECLARATION_THROWS, this.insert_space_before_comma_in_method_declaration_throws? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_MULTIPLE_FIELD_DECLARATIONS, this.insert_space_before_comma_in_multiple_field_declarations? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_MULTIPLE_LOCAL_DECLARATIONS, this.insert_space_before_comma_in_multiple_local_declarations? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_SUPERINTERFACES, this.insert_space_before_comma_in_superinterfaces? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_TYPE_ARGUMENTS, this.insert_space_before_comma_in_type_arguments ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_TYPE_PARAMETERS, this.insert_space_before_comma_in_type_parameters? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_PARAMETERIZED_TYPE_REFERENCE, this.insert_space_before_comma_in_parameterized_type_reference? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_ELLIPSIS, this.insert_space_before_ellipsis ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_ANGLE_BRACKET_IN_PARAMETERIZED_TYPE_REFERENCE, this.insert_space_before_opening_angle_bracket_in_parameterized_type_reference? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS, this.insert_space_before_opening_angle_bracket_in_type_arguments? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_ANGLE_BRACKET_IN_TYPE_PARAMETERS, this.insert_space_before_opening_angle_bracket_in_type_parameters? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ANNOTATION_TYPE_DECLARATION, this.insert_space_before_opening_brace_in_annotation_type_declaration ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ANONYMOUS_TYPE_DECLARATION, this.insert_space_before_opening_brace_in_anonymous_type_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_BLOCK, this.insert_space_before_opening_brace_in_block? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_CONSTRUCTOR_DECLARATION, this.insert_space_before_opening_brace_in_constructor_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ENUM_CONSTANT, this.insert_space_before_opening_brace_in_enum_constant? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ENUM_DECLARATION, this.insert_space_before_opening_brace_in_enum_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_METHOD_DECLARATION, this.insert_space_before_opening_brace_in_method_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_TYPE_DECLARATION, this.insert_space_before_opening_brace_in_type_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACKET_IN_ARRAY_ALLOCATION_EXPRESSION, this.insert_space_before_opening_bracket_in_array_allocation_expression ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACKET_IN_ARRAY_REFERENCE, this.insert_space_before_opening_bracket_in_array_reference? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACKET_IN_ARRAY_TYPE_REFERENCE, this.insert_space_before_opening_bracket_in_array_type_reference? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ANNOTATION, this.insert_space_before_opening_paren_in_annotation? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ANNOTATION_TYPE_MEMBER_DECLARATION, this.insert_space_before_opening_paren_in_annotation_type_member_declaration ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_CATCH, this.insert_space_before_opening_paren_in_catch? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_CONSTRUCTOR_DECLARATION, this.insert_space_before_opening_paren_in_constructor_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ENUM_CONSTANT, this.insert_space_before_opening_paren_in_enum_constant? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_FOR, this.insert_space_before_opening_paren_in_for? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_IF, this.insert_space_before_opening_paren_in_if? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_METHOD_INVOCATION, this.insert_space_before_opening_paren_in_method_invocation? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_METHOD_DECLARATION, this.insert_space_before_opening_paren_in_method_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_SWITCH, this.insert_space_before_opening_paren_in_switch? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_SWITCH, this.insert_space_before_opening_brace_in_switch? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_SYNCHRONIZED, this.insert_space_before_opening_paren_in_synchronized? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_PARENTHESIZED_EXPRESSION, this.insert_space_before_opening_paren_in_parenthesized_expression? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_WHILE, this.insert_space_before_opening_paren_in_while? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_PARENTHESIZED_EXPRESSION_IN_RETURN, this.insert_space_before_parenthesized_expression_in_return ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_PARENTHESIZED_EXPRESSION_IN_THROW, this.insert_space_before_parenthesized_expression_in_throw ? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_POSTFIX_OPERATOR, this.insert_space_before_postfix_operator? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_PREFIX_OPERATOR, this.insert_space_before_prefix_operator? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_QUESTION_IN_CONDITIONAL, this.insert_space_before_question_in_conditional? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_SEMICOLON, this.insert_space_before_semicolon? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_SEMICOLON_IN_FOR, this.insert_space_before_semicolon_in_for? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_UNARY_OPERATOR, this.insert_space_before_unary_operator? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BETWEEN_BRACKETS_IN_ARRAY_TYPE_REFERENCE, this.insert_space_between_brackets_in_array_type_reference? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_BRACES_IN_ARRAY_INITIALIZER, this.insert_space_between_empty_braces_in_array_initializer? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_BRACKETS_IN_ARRAY_ALLOCATION_EXPRESSION, this.insert_space_between_empty_brackets_in_array_allocation_expression? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_ANNOTATION_TYPE_MEMBER_DECLARATION, this.insert_space_between_empty_parens_in_annotation_type_member_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_CONSTRUCTOR_DECLARATION, this.insert_space_between_empty_parens_in_constructor_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_ENUM_CONSTANT, this.insert_space_between_empty_parens_in_enum_constant? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_METHOD_DECLARATION, this.insert_space_between_empty_parens_in_method_declaration? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_METHOD_INVOCATION, this.insert_space_between_empty_parens_in_method_invocation? VjetPlugin.INSERT : VjetPlugin.DO_NOT_INSERT);
 		...
 		switch(this.tab_char) {
 			case SPACE :
 				options.put(DefaultCodeFormatterConstants.FORMATTER_TAB_CHAR, VjetPlugin.SPACE);
 				break;
 			case TAB :
 				options.put(DefaultCodeFormatterConstants.FORMATTER_TAB_CHAR, VjetPlugin.TAB);
 				break;
 			case MIXED :
 	...
 	public void set(Map settings) {
 		...
 		if (commentInsertEmptyLineBeforeRootTagsOption != null) {
 			this.comment_insert_empty_line_before_root_tags = VjetPlugin.INSERT.equals(commentInsertEmptyLineBeforeRootTagsOption);
 		}
 		...
 		if (commentInsertNewLineForParameterOption != null) {
 			this.comment_insert_new_line_for_parameter = VjetPlugin.INSERT.equals(commentInsertNewLineForParameterOption);
 		}
 		...
 		if (insertNewLineAfterAnnotationOption != null) {
 			this.insert_new_line_after_annotation = VjetPlugin.INSERT.equals(insertNewLineAfterAnnotationOption);
 		}
 		...
 		if (insertNewLineAfterOpeningBraceInArrayInitializerOption != null) {
 			this.insert_new_line_after_opening_brace_in_array_initializer = VjetPlugin.INSERT.equals(insertNewLineAfterOpeningBraceInArrayInitializerOption);
 		}
 		...
 		if (insertNewLineAfterOpeningBraceInObjLitInitializerOption != null) {
 			this.insert_new_line_after_opening_brace_in_objlit_initializer = VjetPlugin.INSERT.equals(insertNewLineAfterOpeningBraceInObjLitInitializerOption);
 		}
 		...
 		if (insertNewLineAfterCommaInObjLitInitializerOption != null) {
 			this.insert_new_line_after_comma_in_objlit_initializer = VjetPlugin.INSERT.equals(insertNewLineAfterCommaInObjLitInitializerOption);
 		}
 		...
 		if (insertNewLineAtEndOfFileIfMissingOption != null) {
 			this.insert_new_line_at_end_of_file_if_missing = VjetPlugin.INSERT.equals(insertNewLineAtEndOfFileIfMissingOption);
 		}
 		...
 		if (insertNewLineBeforeCatchInTryStatementOption != null) {
 			this.insert_new_line_before_catch_in_try_statement = VjetPlugin.INSERT.equals(insertNewLineBeforeCatchInTryStatementOption);
 		}
 		...
 		if (insertNewLineBeforeClosingBraceInArrayInitializerOption != null) {
 			this.insert_new_line_before_closing_brace_in_array_initializer = VjetPlugin.INSERT.equals(insertNewLineBeforeClosingBraceInArrayInitializerOption);
 		}
 		...
 		if (insertNewLineBeforeClosingBraceInObjLitInitializerOption != null) {
 			this.insert_new_line_before_closing_brace_in_objlit_initializer = VjetPlugin.INSERT.equals(insertNewLineBeforeClosingBraceInObjLitInitializerOption);
 		}
 		...
 		if (insertNewLineBeforeElseInIfStatementOption != null) {
 			this.insert_new_line_before_else_in_if_statement = VjetPlugin.INSERT.equals(insertNewLineBeforeElseInIfStatementOption);
 		}
 		...
 		if (insertNewLineBeforeFinallyInTryStatementOption != null) {
 			this.insert_new_line_before_finally_in_try_statement = VjetPlugin.INSERT.equals(insertNewLineBeforeFinallyInTryStatementOption);
 		}
 		...
 		if (insertNewLineBeforeWhileInDoStatementOption != null) {
 			this.insert_new_line_before_while_in_do_statement = VjetPlugin.INSERT.equals(insertNewLineBeforeWhileInDoStatementOption);
 		}
 		...
 		if (insertNewLineInEmptyAnonymousTypeDeclarationOption != null) {
 			this.insert_new_line_in_empty_anonymous_type_declaration = VjetPlugin.INSERT.equals(insertNewLineInEmptyAnonymousTypeDeclarationOption);
 		}
 		...
 		if (insertNewLineInEmptyBlockOption != null) {
 			this.insert_new_line_in_empty_block = VjetPlugin.INSERT.equals(insertNewLineInEmptyBlockOption);
 		}
 		...
 		if (insertNewLineInEmptyAnnotationDeclarationOption != null) {
 			this.insert_new_line_in_empty_annotation_declaration = VjetPlugin.INSERT.equals(insertNewLineInEmptyAnnotationDeclarationOption);
 		}
 		...
 		if (insertNewLineInEmptyEnumConstantOption != null) {
 			this.insert_new_line_in_empty_enum_constant = VjetPlugin.INSERT.equals(insertNewLineInEmptyEnumConstantOption);
 		}
 		...
 		if (insertNewLineInEmptyEnumDeclarationOption != null) {
 			this.insert_new_line_in_empty_enum_declaration = VjetPlugin.INSERT.equals(insertNewLineInEmptyEnumDeclarationOption);
 		}
 		...
 		if (insertNewLineInEmptyMethodBodyOption != null) {
 			this.insert_new_line_in_empty_method_body = VjetPlugin.INSERT.equals(insertNewLineInEmptyMethodBodyOption);
 		}
 		...
 		if (insertNewLineInEmptyTypeDeclarationOption != null) {
 			this.insert_new_line_in_empty_type_declaration = VjetPlugin.INSERT.equals(insertNewLineInEmptyTypeDeclarationOption);
 		}
 		...
 		if (insertSpaceAfterAndInWildcardOption != null) {
 			this.insert_space_after_and_in_type_parameter = VjetPlugin.INSERT.equals(insertSpaceAfterAndInWildcardOption);
 		}
 		...
 		if (insertSpaceAfterAssignmentOperatorOption != null) {
 			this.insert_space_after_assignment_operator = VjetPlugin.INSERT.equals(insertSpaceAfterAssignmentOperatorOption);
 		}
 		...
 		if (insertSpaceAfterAtInAnnotationOption != null) {
 			this.insert_space_after_at_in_annotation = VjetPlugin.INSERT.equals(insertSpaceAfterAtInAnnotationOption);
 		}
 		...
 		if (insertSpaceAfterAtInAnnotationTypeDeclarationOption != null) {
 			this.insert_space_after_at_in_annotation_type_declaration = VjetPlugin.INSERT.equals(insertSpaceAfterAtInAnnotationTypeDeclarationOption);
 		}
 		...
 		if (insertSpaceAfterBinaryOperatorOption != null) {
 			this.insert_space_after_binary_operator = VjetPlugin.INSERT.equals(insertSpaceAfterBinaryOperatorOption);
 		}
 		...
 		if (insertSpaceAfterClosingAngleBracketInTypeArgumentsOption != null) {
 			this.insert_space_after_closing_angle_bracket_in_type_arguments = VjetPlugin.INSERT.equals(insertSpaceAfterClosingAngleBracketInTypeArgumentsOption);
 		}
 		...
 		if (insertSpaceAfterClosingAngleBracketInTypeParametersOption != null) {
 			this.insert_space_after_closing_angle_bracket_in_type_parameters = VjetPlugin.INSERT.equals(insertSpaceAfterClosingAngleBracketInTypeParametersOption);
 		}
 		...
 		if (insertSpaceAfterClosingParenInCastOption != null) {
 			this.insert_space_after_closing_paren_in_cast = VjetPlugin.INSERT.equals(insertSpaceAfterClosingParenInCastOption);
 		}
 		...
 		if (insertSpaceAfterClosingBraceInBlockOption != null) {
 			this.insert_space_after_closing_brace_in_block = VjetPlugin.INSERT.equals(insertSpaceAfterClosingBraceInBlockOption);
 		}
 		...
 		if (insertSpaceAfterColonInAssertOption != null) {
 			this.insert_space_after_colon_in_assert = VjetPlugin.INSERT.equals(insertSpaceAfterColonInAssertOption);
 		}
 		...
 		if (insertSpaceAfterColonInCaseOption != null) {
 			this.insert_space_after_colon_in_case = VjetPlugin.INSERT.equals(insertSpaceAfterColonInCaseOption);
 		}
 		...
 		if (insertSpaceAfterColonInConditionalOption != null) {
 			this.insert_space_after_colon_in_conditional = VjetPlugin.INSERT.equals(insertSpaceAfterColonInConditionalOption);
 		}
 		...
 		if (insertSpaceAfterColonInObjectInitializerOption != null) {
 			this.insert_space_after_colon_in_object_initializer = VjetPlugin.INSERT.equals(insertSpaceAfterColonInObjectInitializerOption);
 		}
 		...
 		if (insertSpaceAfterColonInForOption != null) {
 			this.insert_space_after_colon_in_for = VjetPlugin.INSERT.equals(insertSpaceAfterColonInForOption);
 		}
 		...
 		if (insertSpaceAfterColonInLabeledStatementOption != null) {
 			this.insert_space_after_colon_in_labeled_statement = VjetPlugin.INSERT.equals(insertSpaceAfterColonInLabeledStatementOption);
 		}
 		...
 		if (insertSpaceAfterCommaInAllocationExpressionOption != null) {
 			this.insert_space_after_comma_in_allocation_expression = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInAllocationExpressionOption);
 		}
 		...
 		if (insertSpaceAfterCommaInAnnotationOption != null) {
 			this.insert_space_after_comma_in_annotation = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInAnnotationOption);
 		}
 		...
 		if (insertSpaceAfterCommaInArrayInitializerOption != null) {
 			this.insert_space_after_comma_in_array_initializer = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInArrayInitializerOption);
 		}
 		...
 		if (insertSpaceAfterCommaInConstructorDeclarationParametersOption != null) {
 			this.insert_space_after_comma_in_constructor_declaration_parameters = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInConstructorDeclarationParametersOption);
 		}
 		...
 		if (insertSpaceAfterCommaInConstructorDeclarationThrowsOption != null) {
 			this.insert_space_after_comma_in_constructor_declaration_throws = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInConstructorDeclarationThrowsOption);
 		}
 		...
 		if (insertSpaceAfterCommaInEnumConstantArgumentsOption != null) {
 			this.insert_space_after_comma_in_enum_constant_arguments = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInEnumConstantArgumentsOption);
 		}
 		...
 		if (insertSpaceAfterCommaInEnumDeclarationsOption != null) {
 			this.insert_space_after_comma_in_enum_declarations = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInEnumDeclarationsOption);
 		}
 		...
 		if (insertSpaceAfterCommaInExplicitConstructorCallArgumentsOption != null) {
 			this.insert_space_after_comma_in_explicit_constructor_call_arguments = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInExplicitConstructorCallArgumentsOption);
 		}
 		...
 		if (insertSpaceAfterCommaInForIncrementsOption != null) {
 			this.insert_space_after_comma_in_for_increments = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInForIncrementsOption);
 		}
 		...
 		if (insertSpaceAfterCommaInForInitsOption != null) {
 			this.insert_space_after_comma_in_for_inits = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInForInitsOption);
 		}
 		...
 		if (insertSpaceAfterCommaInMethodInvocationArgumentsOption != null) {
 			this.insert_space_after_comma_in_method_invocation_arguments = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInMethodInvocationArgumentsOption);
 		}
 		...
 		if (insertSpaceAfterCommaInMethodDeclarationParametersOption != null) {
 			this.insert_space_after_comma_in_method_declaration_parameters = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInMethodDeclarationParametersOption);
 		}
 		...
 		if (insertSpaceAfterCommaInMethodDeclarationThrowsOption != null) {
 			this.insert_space_after_comma_in_method_declaration_throws = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInMethodDeclarationThrowsOption);
 		}
 		...
 		if (insertSpaceAfterCommaInMultipleFieldDeclarationsOption != null) {
 			this.insert_space_after_comma_in_multiple_field_declarations = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInMultipleFieldDeclarationsOption);
 		}
 		...
 		if (insertSpaceAfterCommaInMultipleLocalDeclarationsOption != null) {
 			this.insert_space_after_comma_in_multiple_local_declarations = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInMultipleLocalDeclarationsOption);
 		}
 		...
 		if (insertSpaceAfterCommaInParameterizedTypeReferenceOption != null) {
 			this.insert_space_after_comma_in_parameterized_type_reference = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInParameterizedTypeReferenceOption);
 		}
 		...
 		if (insertSpaceAfterCommaInSuperinterfacesOption != null) {
 			this.insert_space_after_comma_in_superinterfaces = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInSuperinterfacesOption);
 		}
 		...
 		if (insertSpaceAfterCommaInTypeArgumentsOption != null) {
 			this.insert_space_after_comma_in_type_arguments = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInTypeArgumentsOption);
 		}
 		...
 		if (insertSpaceAfterCommaInTypeParametersOption != null) {
 			this.insert_space_after_comma_in_type_parameters = VjetPlugin.INSERT.equals(insertSpaceAfterCommaInTypeParametersOption);
 		}
 		...
 		if (insertSpaceAfterEllipsisOption != null) {
 			this.insert_space_after_ellipsis = VjetPlugin.INSERT.equals(insertSpaceAfterEllipsisOption);
 		}
 		...
 		if (insertSpaceAfterOpeningAngleBracketInParameterizedTypeReferenceOption != null) {
 			this.insert_space_after_opening_angle_bracket_in_parameterized_type_reference = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningAngleBracketInParameterizedTypeReferenceOption);
 		}
 		...
 		if (insertSpaceAfterOpeningAngleBracketInTypeArgumentsOption != null) {
 			this.insert_space_after_opening_angle_bracket_in_type_arguments = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningAngleBracketInTypeArgumentsOption);
 		}
 		...
 		if (insertSpaceAfterOpeningAngleBracketInTypeParametersOption != null) {
 			this.insert_space_after_opening_angle_bracket_in_type_parameters = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningAngleBracketInTypeParametersOption);
 		}
 		...
 		if (insertSpaceAfterOpeningBracketInArrayAllocationExpressionOption != null) {
 			this.insert_space_after_opening_bracket_in_array_allocation_expression = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningBracketInArrayAllocationExpressionOption);
 		}
 		...
 		if (insertSpaceAfterOpeningBracketInArrayReferenceOption != null) {
 			this.insert_space_after_opening_bracket_in_array_reference = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningBracketInArrayReferenceOption);
 		}
 		...
 		if (insertSpaceAfterOpeningBraceInArrayInitializerOption != null) {
 			this.insert_space_after_opening_brace_in_array_initializer = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningBraceInArrayInitializerOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInAnnotationOption != null) {
 			this.insert_space_after_opening_paren_in_annotation = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInAnnotationOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInCastOption != null) {
 			this.insert_space_after_opening_paren_in_cast = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInCastOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInCatchOption != null) {
 			this.insert_space_after_opening_paren_in_catch = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInCatchOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInConstructorDeclarationOption != null) {
 			this.insert_space_after_opening_paren_in_constructor_declaration = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInConstructorDeclarationOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInEnumConstantOption != null) {
 			this.insert_space_after_opening_paren_in_enum_constant = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInEnumConstantOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInForOption != null) {
 			this.insert_space_after_opening_paren_in_for = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInForOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInIfOption != null) {
 			this.insert_space_after_opening_paren_in_if = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInIfOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInMethodDeclarationOption != null) {
 			this.insert_space_after_opening_paren_in_method_declaration = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInMethodDeclarationOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInMethodInvocationOption != null) {
 			this.insert_space_after_opening_paren_in_method_invocation = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInMethodInvocationOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInParenthesizedExpressionOption != null) {
 			this.insert_space_after_opening_paren_in_parenthesized_expression = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInParenthesizedExpressionOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInSwitchOption != null) {
 			this.insert_space_after_opening_paren_in_switch = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInSwitchOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInSynchronizedOption != null) {
 			this.insert_space_after_opening_paren_in_synchronized = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInSynchronizedOption);
 		}
 		...
 		if (insertSpaceAfterOpeningParenInWhileOption != null) {
 			this.insert_space_after_opening_paren_in_while = VjetPlugin.INSERT.equals(insertSpaceAfterOpeningParenInWhileOption);
 		}
 		...
 		if (insertSpaceAfterPostfixOperatorOption != null) {
 			this.insert_space_after_postfix_operator = VjetPlugin.INSERT.equals(insertSpaceAfterPostfixOperatorOption);
 		}
 		...
 		if (insertSpaceAfterPrefixOperatorOption != null) {
 			this.insert_space_after_prefix_operator = VjetPlugin.INSERT.equals(insertSpaceAfterPrefixOperatorOption);
 		}
 		...
 		if (insertSpaceAfterQuestionInConditionalOption != null) {
 			this.insert_space_after_question_in_conditional = VjetPlugin.INSERT.equals(insertSpaceAfterQuestionInConditionalOption);
 		}
 		...
 		if (insertSpaceAfterSemicolonInForOption != null) {
 			this.insert_space_after_semicolon_in_for = VjetPlugin.INSERT.equals(insertSpaceAfterSemicolonInForOption);
 		}
 		...
 		if (insertSpaceAfterUnaryOperatorOption != null) {
 			this.insert_space_after_unary_operator = VjetPlugin.INSERT.equals(insertSpaceAfterUnaryOperatorOption);
 		}
 		...
 		if (insertSpaceBeforeAtInAnnotationTypeDeclarationOption != null) {
 			this.insert_space_before_at_in_annotation_type_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeAtInAnnotationTypeDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeAssignmentOperatorOption != null) {
 			this.insert_space_before_assignment_operator = VjetPlugin.INSERT.equals(insertSpaceBeforeAssignmentOperatorOption);
 		}
 		...
 		if (insertSpaceBeforeBinaryOperatorOption != null) {
 			this.insert_space_before_binary_operator = VjetPlugin.INSERT.equals(insertSpaceBeforeBinaryOperatorOption);
 		}
 		...
 		if (insertSpaceBeforeClosingAngleBracketInParameterizedTypeReferenceOption != null) {
 			this.insert_space_before_closing_angle_bracket_in_parameterized_type_reference = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingAngleBracketInParameterizedTypeReferenceOption);
 		}
 		...
 		if (insertSpaceBeforeClosingAngleBracketInTypeArgumentsOption != null) {
 			this.insert_space_before_closing_angle_bracket_in_type_arguments = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingAngleBracketInTypeArgumentsOption);
 		}
 		...
 		if (insertSpaceBeforeClosingAngleBracketInTypeParametersOption != null) {
 			this.insert_space_before_closing_angle_bracket_in_type_parameters = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingAngleBracketInTypeParametersOption);
 		}
 		...
 		if (insertSpaceBeforeClosingBraceInArrayInitializerOption != null) {
 			this.insert_space_before_closing_brace_in_array_initializer = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingBraceInArrayInitializerOption);
 		}
 		...
 		if (insertSpaceBeforeClosingBracketInArrayAllocationExpressionOption != null) {
 			this.insert_space_before_closing_bracket_in_array_allocation_expression = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingBracketInArrayAllocationExpressionOption);
 		}
 		...
 		if (insertSpaceBeforeClosingBracketInArrayReferenceOption != null) {
 			this.insert_space_before_closing_bracket_in_array_reference = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingBracketInArrayReferenceOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInAnnotationOption != null) {
 			this.insert_space_before_closing_paren_in_annotation = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInAnnotationOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInCastOption != null) {
 			this.insert_space_before_closing_paren_in_cast = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInCastOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInCatchOption != null) {
 			this.insert_space_before_closing_paren_in_catch = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInCatchOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInConstructorDeclarationOption != null) {
 			this.insert_space_before_closing_paren_in_constructor_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInConstructorDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInEnumConstantOption != null) {
 			this.insert_space_before_closing_paren_in_enum_constant = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInEnumConstantOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInForOption != null) {
 			this.insert_space_before_closing_paren_in_for = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInForOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInIfOption != null) {
 			this.insert_space_before_closing_paren_in_if = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInIfOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInMethodDeclarationOption != null) {
 			this.insert_space_before_closing_paren_in_method_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInMethodDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInMethodInvocationOption != null) {
 			this.insert_space_before_closing_paren_in_method_invocation = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInMethodInvocationOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInParenthesizedExpressionOption != null) {
 			this.insert_space_before_closing_paren_in_parenthesized_expression = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInParenthesizedExpressionOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInSwitchOption != null) {
 			this.insert_space_before_closing_paren_in_switch = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInSwitchOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInSynchronizedOption != null) {
 			this.insert_space_before_closing_paren_in_synchronized = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInSynchronizedOption);
 		}
 		...
 		if (insertSpaceBeforeClosingParenInWhileOption != null) {
 			this.insert_space_before_closing_paren_in_while = VjetPlugin.INSERT.equals(insertSpaceBeforeClosingParenInWhileOption);
 		}
 		...
 		if (insertSpaceBeforeColonInAssertOption != null) {
 			this.insert_space_before_colon_in_assert = VjetPlugin.INSERT.equals(insertSpaceBeforeColonInAssertOption);
 		}
 		...
 		if (insertSpaceBeforeColonInCaseOption != null) {
 			this.insert_space_before_colon_in_case = VjetPlugin.INSERT.equals(insertSpaceBeforeColonInCaseOption);
 		}
 		...
 		if (insertSpaceBeforeColonInConditionalOption != null) {
 			this.insert_space_before_colon_in_conditional = VjetPlugin.INSERT.equals(insertSpaceBeforeColonInConditionalOption);
 		}
 		...
 		if (insertSpaceBeforeColonInObjectInitializerOption != null) {
 			this.insert_space_before_colon_in_object_initializer = VjetPlugin.INSERT.equals(insertSpaceBeforeColonInObjectInitializerOption);
 		}
 		...
 		if (insertSpaceBeforeColonInDefaultOption != null) {
 			this.insert_space_before_colon_in_default = VjetPlugin.INSERT.equals(insertSpaceBeforeColonInDefaultOption);
 		}
 		...
 		if (insertSpaceBeforeColonInForOption != null) {
 			this.insert_space_before_colon_in_for = VjetPlugin.INSERT.equals(insertSpaceBeforeColonInForOption);
 		}
 		...
 		if (insertSpaceBeforeColonInLabeledStatementOption != null) {
 			this.insert_space_before_colon_in_labeled_statement = VjetPlugin.INSERT.equals(insertSpaceBeforeColonInLabeledStatementOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInAllocationExpressionOption != null) {
 			this.insert_space_before_comma_in_allocation_expression = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInAllocationExpressionOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInAnnotationOption != null) {
 			this.insert_space_before_comma_in_annotation = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInAnnotationOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInArrayInitializerOption != null) {
 			this.insert_space_before_comma_in_array_initializer = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInArrayInitializerOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInConstructorDeclarationParametersOption != null) {
 			this.insert_space_before_comma_in_constructor_declaration_parameters = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInConstructorDeclarationParametersOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInConstructorDeclarationThrowsOption != null) {
 			this.insert_space_before_comma_in_constructor_declaration_throws = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInConstructorDeclarationThrowsOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInEnumConstantArgumentsOption != null) {
 			this.insert_space_before_comma_in_enum_constant_arguments = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInEnumConstantArgumentsOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInEnumDeclarationsOption != null) {
 			this.insert_space_before_comma_in_enum_declarations = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInEnumDeclarationsOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInExplicitConstructorCallArgumentsOption != null) {
 			this.insert_space_before_comma_in_explicit_constructor_call_arguments = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInExplicitConstructorCallArgumentsOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInForIncrementsOption != null) {
 			this.insert_space_before_comma_in_for_increments = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInForIncrementsOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInForInitsOption != null) {
 			this.insert_space_before_comma_in_for_inits = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInForInitsOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInMethodInvocationArgumentsOption != null) {
 			this.insert_space_before_comma_in_method_invocation_arguments = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInMethodInvocationArgumentsOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInMethodDeclarationParametersOption != null) {
 			this.insert_space_before_comma_in_method_declaration_parameters = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInMethodDeclarationParametersOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInMethodDeclarationThrowsOption != null) {
 			this.insert_space_before_comma_in_method_declaration_throws = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInMethodDeclarationThrowsOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInMultipleFieldDeclarationsOption != null) {
 			this.insert_space_before_comma_in_multiple_field_declarations = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInMultipleFieldDeclarationsOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInMultipleLocalDeclarationsOption != null) {
 			this.insert_space_before_comma_in_multiple_local_declarations = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInMultipleLocalDeclarationsOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInParameterizedTypeReferenceOption != null) {
 			this.insert_space_before_comma_in_parameterized_type_reference = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInParameterizedTypeReferenceOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInSuperinterfacesOption != null) {
 			this.insert_space_before_comma_in_superinterfaces = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInSuperinterfacesOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInTypeArgumentsOption != null) {
 			this.insert_space_before_comma_in_type_arguments = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInTypeArgumentsOption);
 		}
 		...
 		if (insertSpaceBeforeCommaInTypeParametersOption != null) {
 			this.insert_space_before_comma_in_type_parameters = VjetPlugin.INSERT.equals(insertSpaceBeforeCommaInTypeParametersOption);
 		}
 		...
 		if (insertSpaceBeforeEllipsisOption != null) {
 			this.insert_space_before_ellipsis = VjetPlugin.INSERT.equals(insertSpaceBeforeEllipsisOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningAngleBrackerInParameterizedTypeReferenceOption != null) {
 			this.insert_space_before_opening_angle_bracket_in_parameterized_type_reference = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningAngleBrackerInParameterizedTypeReferenceOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningAngleBrackerInTypeArgumentsOption != null) {
 			this.insert_space_before_opening_angle_bracket_in_type_arguments = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningAngleBrackerInTypeArgumentsOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningAngleBrackerInTypeParametersOption != null) {
 			this.insert_space_before_opening_angle_bracket_in_type_parameters = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningAngleBrackerInTypeParametersOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBraceInAnnotationTypeDeclarationOption != null) {
 			this.insert_space_before_opening_brace_in_annotation_type_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBraceInAnnotationTypeDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBraceInAnonymousTypeDeclarationOption != null) {
 			this.insert_space_before_opening_brace_in_anonymous_type_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBraceInAnonymousTypeDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBraceInBlockOption != null) {
 			this.insert_space_before_opening_brace_in_block = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBraceInBlockOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBraceInConstructorDeclarationOption != null) {
 			this.insert_space_before_opening_brace_in_constructor_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBraceInConstructorDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBraceInEnumDeclarationOption != null) {
 			this.insert_space_before_opening_brace_in_enum_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBraceInEnumDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBraceInEnumConstantOption != null) {
 			this.insert_space_before_opening_brace_in_enum_constant = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBraceInEnumConstantOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBraceInMethodDeclarationOption != null) {
 			this.insert_space_before_opening_brace_in_method_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBraceInMethodDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBraceInTypeDeclarationOption != null) {
 			this.insert_space_before_opening_brace_in_type_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBraceInTypeDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBracketInArrayAllocationExpressionOption != null) {
 			this.insert_space_before_opening_bracket_in_array_allocation_expression = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBracketInArrayAllocationExpressionOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBracketInArrayReferenceOption != null) {
 			this.insert_space_before_opening_bracket_in_array_reference = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBracketInArrayReferenceOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBracketInArrayTypeReferenceOption != null) {
 			this.insert_space_before_opening_bracket_in_array_type_reference = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBracketInArrayTypeReferenceOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInAnnotationOption != null) {
 			this.insert_space_before_opening_paren_in_annotation = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInAnnotationOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInAnnotationTypeMemberDeclarationOption != null) {
 			this.insert_space_before_opening_paren_in_annotation_type_member_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInAnnotationTypeMemberDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInCatchOption != null) {
 			this.insert_space_before_opening_paren_in_catch = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInCatchOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInConstructorDeclarationOption != null) {
 			this.insert_space_before_opening_paren_in_constructor_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInConstructorDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInEnumConstantOption != null) {
 			this.insert_space_before_opening_paren_in_enum_constant = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInEnumConstantOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInForOption != null) {
 			this.insert_space_before_opening_paren_in_for = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInForOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInIfOption != null) {
 			this.insert_space_before_opening_paren_in_if = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInIfOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInMethodInvocationOption != null) {
 			this.insert_space_before_opening_paren_in_method_invocation = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInMethodInvocationOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInMethodDeclarationOption != null) {
 			this.insert_space_before_opening_paren_in_method_declaration = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInMethodDeclarationOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInSwitchOption != null) {
 			this.insert_space_before_opening_paren_in_switch = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInSwitchOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningBraceInSwitchOption != null) {
 			this.insert_space_before_opening_brace_in_switch = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningBraceInSwitchOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInSynchronizedOption != null) {
 			this.insert_space_before_opening_paren_in_synchronized = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInSynchronizedOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInParenthesizedExpressionOption != null) {
 			this.insert_space_before_opening_paren_in_parenthesized_expression = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInParenthesizedExpressionOption);
 		}
 		...
 		if (insertSpaceBeforeOpeningParenInWhileOption != null) {
 			this.insert_space_before_opening_paren_in_while = VjetPlugin.INSERT.equals(insertSpaceBeforeOpeningParenInWhileOption);
 		}
 		...
 		if (insertSpaceBeforeParenthesizedExpressionInReturnOption != null) {
 			this.insert_space_before_parenthesized_expression_in_return = VjetPlugin.INSERT.equals(insertSpaceBeforeParenthesizedExpressionInReturnOption);
 		}
 		...
 		if (insertSpaceBeforeParenthesizedExpressionInThrowOption != null) {
 			this.insert_space_before_parenthesized_expression_in_throw = VjetPlugin.INSERT.equals(insertSpaceBeforeParenthesizedExpressionInThrowOption);
 		}
 		...
 		if (insertSpaceBeforePostfixOperatorOption != null) {
 			this.insert_space_before_postfix_operator = VjetPlugin.INSERT.equals(insertSpaceBeforePostfixOperatorOption);
 		}
 		...
 		if (insertSpaceBeforePrefixOperatorOption != null) {
 			this.insert_space_before_prefix_operator = VjetPlugin.INSERT.equals(insertSpaceBeforePrefixOperatorOption);
 		}
 		...
 		if (insertSpaceBeforeQuestionInConditionalOption != null) {
 			this.insert_space_before_question_in_conditional = VjetPlugin.INSERT.equals(insertSpaceBeforeQuestionInConditionalOption);
 		}
 		...
 		if (insertSpaceBeforeSemicolonOption != null) {
 			this.insert_space_before_semicolon = VjetPlugin.INSERT.equals(insertSpaceBeforeSemicolonOption);
 		}
 		...
 		if (insertSpaceBeforeSemicolonInForOption != null) {
 			this.insert_space_before_semicolon_in_for = VjetPlugin.INSERT.equals(insertSpaceBeforeSemicolonInForOption);
 		}
 		...
 		if (insertSpaceBeforeUnaryOperatorOption != null) {
 			this.insert_space_before_unary_operator = VjetPlugin.INSERT.equals(insertSpaceBeforeUnaryOperatorOption);
 		}
 		...
 		if (insertSpaceBetweenBracketsInArrayTypeReferenceOption != null) {
 			this.insert_space_between_brackets_in_array_type_reference = VjetPlugin.INSERT.equals(insertSpaceBetweenBracketsInArrayTypeReferenceOption);
 		}
 		...
 		if (insertSpaceBetweenEmptyBracesInArrayInitializerOption != null) {
 			this.insert_space_between_empty_braces_in_array_initializer = VjetPlugin.INSERT.equals(insertSpaceBetweenEmptyBracesInArrayInitializerOption);
 		}
 		...
 		if (insertSpaceBetweenEmptyBracketsInArrayAllocationExpressionOption != null) {
 			this.insert_space_between_empty_brackets_in_array_allocation_expression = VjetPlugin.INSERT.equals(insertSpaceBetweenEmptyBracketsInArrayAllocationExpressionOption);
 		}
 		...
 		if (insertSpaceBetweenEmptyParensInConstructorDeclarationOption != null) {
 			this.insert_space_between_empty_parens_in_constructor_declaration = VjetPlugin.INSERT.equals(insertSpaceBetweenEmptyParensInConstructorDeclarationOption);
 		}
 		...
 		if (insertSpaceBetweenEmptyParensInAnnotationTypeMemberDeclarationOption != null) {
 			this.insert_space_between_empty_parens_in_annotation_type_member_declaration = VjetPlugin.INSERT.equals(insertSpaceBetweenEmptyParensInAnnotationTypeMemberDeclarationOption);
 		}
 		...
 		if (insertSpaceBetweenEmptyParensInEnumConstantOption != null) {
 			this.insert_space_between_empty_parens_in_enum_constant = VjetPlugin.INSERT.equals(insertSpaceBetweenEmptyParensInEnumConstantOption);
 		}
 		...
 		if (insertSpaceBetweenEmptyParensInMethodDeclarationOption != null) {
 			this.insert_space_between_empty_parens_in_method_declaration = VjetPlugin.INSERT.equals(insertSpaceBetweenEmptyParensInMethodDeclarationOption);
 		}
 		...
 		if (insertSpaceBetweenEmptyParensInMethodInvocationOption != null) {
 			this.insert_space_between_empty_parens_in_method_invocation = VjetPlugin.INSERT.equals(insertSpaceBetweenEmptyParensInMethodInvocationOption);
 		}
 		...
 		if (useTabOption != null) {
 			if (VjetPlugin.TAB.equals(useTabOption)) {
 				this.tab_char = TAB;
 			} else if (VjetPlugin.SPACE.equals(useTabOption)) {
 				this.tab_char = SPACE;
 			} else {
 				this.tab_char = MIXED;
 			}
