 ...
 /*
  * ident	"@(#)MainFrame.java 1.1     06/02/22 SMI"
  */
...
import org.opensolaris.opengrok.configuration.RuntimeEnvironment;
 ...
 public class MainFrame extends javax.swing.JFrame {
     ...
     private void displayFile(Editor editor) {
         ...
         if (rows != null) {
             ...
             for (int ii = 0; ii < rows.length; ++ii) {
                 ...
                 sb.append(Config.getInstance().getSourceRoot());
     ...
     private void verifyIndexDatabase() {
         boolean enable = false;
         
         String s = Config.getInstance().getIndexDatabase();
     ...
     private void initComponents() {
         javax.swing.JButton browseIndexBtn;
         ...
         browseIndexBtn = new javax.swing.JButton();
         ...
         searchButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/opensolaris/opengrok/search/scope/q.gif")));
         ...
         clearButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/opensolaris/opengrok/search/scope/stp.gif")));
         ...
         indexDatabaseCombo.setModel(new IndexDatabaseComboModel());
         ...
         browseIndexBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/opensolaris/opengrok/search/scope/do.gif")));
         ...
         moreButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/opensolaris/opengrok/search/scope/more.gif")));
         ...
         databaseMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/opensolaris/opengrok/search/scope/data.gif")));
         databaseMenuItem.setText("Index database...");
         ...
         jMenu2.add(databaseMenuItem);
 
         editorMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/opensolaris/opengrok/search/scope/p.gif")));
         ...
         layout.setHorizontalGroup(
             ...
             .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                 ...
                 .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                     .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                         .add(indexDatabaseCombo, 0, 507, Short.MAX_VALUE)
                         .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                     ...
                     .add(historyField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 543, Short.MAX_VALUE)
                     .add(definitionField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 543, Short.MAX_VALUE)
                     .add(symbolField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 543, Short.MAX_VALUE)
                     .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                         .add(fileField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 512, Short.MAX_VALUE)
                         .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                         .add(holdPath, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 26, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                     .add(fullField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 543, Short.MAX_VALUE))
                 .addContainerGap())
             .add(layout.createSequentialGroup()
                 .addContainerGap()
     ...
     private void browseIndexBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_browseIndexBtnActionPerformed
         databaseMenuItemActionPerformed(null);
     ...
     private void databaseMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_databaseMenuItemActionPerformed
         IndexDatabase db = (IndexDatabase)indexDatabaseCombo.getSelectedItem();
         String dataroot = null;
         if (db != null) {
             dataroot = db.getDatabase();
         }
         indexerWizard =  new IndexerWizard(dataroot);
         indexerWizard.setLocationRelativeTo(this);
         indexerWizard.setVisible(true);
         
         indexerWizard.addWindowListener(new WindowListener() {
             public void windowActivated(WindowEvent e) {
             }
             public void windowClosed(WindowEvent e) {
                 String dbroot = indexerWizard.getDataRoot();
                 if (dbroot != null && dbroot.length() > 0) {
                     Config.getInstance().setIndexDatabase(dbroot);
                     verifyIndexDatabase();
                     ((IndexDatabaseComboModel)(indexDatabaseCombo.getModel())).refresh();
                     indexDatabaseCombo.setSelectedIndex(0);
                 }
             }
     ...
     private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
         ...
         se.setIndexDatabase((IndexDatabase)indexDatabaseCombo.getSelectedItem());
     ...
     private IndexerWizard indexerWizard;
 }
