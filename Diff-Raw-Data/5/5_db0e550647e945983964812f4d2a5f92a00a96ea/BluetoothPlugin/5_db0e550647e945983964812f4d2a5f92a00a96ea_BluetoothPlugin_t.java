     ...
     public PluginResult execute(String action, JSONArray args, String callbackId) {
         ...
         // Connect to a given device & uuid endpoint
             ...
             try {
                 ...
                 Log.i("Bluetooth Plugin content::>> ",content );
                 ...
                 Log.i("Bluetooth Plugin request::>> ",request.toString() );
 
                 pluginResult = new PluginResult(PluginResult.Status.OK, String.valueOf(request));
 //                pluginResult = new PluginResult(PluginResult.Status.OK);
             } catch (Exception e) {
                 Log.e("Bluetooth Plugin ", e.toString() + "/" + e.getMessage());
                 pluginResult = new PluginResult(PluginResult.Status.JSON_EXCEPTION, e.getMessage());
             }
