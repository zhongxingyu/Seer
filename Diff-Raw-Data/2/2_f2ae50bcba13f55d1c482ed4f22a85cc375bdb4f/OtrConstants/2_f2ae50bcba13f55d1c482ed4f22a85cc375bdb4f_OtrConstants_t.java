 ...
 public interface OtrConstants {
    ...
    public static final String QueryMessage_CommonRequest = "?OTR?v2? You are being requested to have an Off-the-Record private conversation &lt;http://otr.cypherpunks.ca/&gt;. Please install ChatSecure (aka Gibberbot Android/iOS), Pidgin (Win/Linux), Adium (Mac) or any other OTR-enabled app.";
