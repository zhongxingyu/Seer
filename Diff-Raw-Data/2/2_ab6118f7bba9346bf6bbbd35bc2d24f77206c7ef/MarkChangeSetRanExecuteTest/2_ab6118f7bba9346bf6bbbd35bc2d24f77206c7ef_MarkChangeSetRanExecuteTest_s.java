 ...
 public class MarkChangeSetRanExecuteTest extends AbstractExecuteTest {
     ...
     public void generateSql_insert() throws Exception {
        ...
        String version = "2.0-b4-snp";
         ...
         assertCorrect("insert into [databasechangelog] ([author], [comments], [dateexecuted], [description], [filename], [id], [liquibase], [md5sum], [orderexecuted]) values ('b', '', now, 'empty', 'c', 'a', '" + version + "', '2:d41d8cd98f00b204e9800998ecf8427e', 1)",HsqlDatabase.class);
         assertCorrect("insert into [databasechangelog] ([author], [comments], [dateexecuted], [description], [filename], [id], [liquibase], [md5sum], [orderexecuted]) values ('b', '', now(), 'empty', 'c', 'a', '" + version + "', '2:d41d8cd98f00b204e9800998ecf8427e', 1)",MySQLDatabase.class,PostgresDatabase.class,SybaseASADatabase.class,H2Database.class);
