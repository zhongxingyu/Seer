 ...
 public class HadoopVfsFileChooserDialog extends VfsFileChooserDialog implements IVfsFileChooser {
   ...
   /**
    * Creates the File System Selection and Connection panel. These make up the Hadoop panel which this class provides in addition the base classes panels.
    * 
    * @param dialog
    */
   ...
   private void localSelected() throws KettleException {
