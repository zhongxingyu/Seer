 ...
 /**
  * Base activity class for legacy (pre-honeycomb) settings screens.
  */
 public abstract class LegacySearchSettingsActivityBase extends PreferenceActivity {
     ...
     protected PreferenceControllerFactory getController() {
         return mController;
     }
