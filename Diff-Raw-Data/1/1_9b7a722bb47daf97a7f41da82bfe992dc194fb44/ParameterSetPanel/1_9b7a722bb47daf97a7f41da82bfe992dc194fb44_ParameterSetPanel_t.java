 ...
 public class ParameterSetPanel extends Composite {
 	...
 	public ParameterSetPanel(BrowseContainer browseContainer, ServiceInfo serviceInfo,
 			SbbInfo sbbInfo, String parameterSetName) {
 		super();
 	...
 	private void refreshUsageParameters() {
 			...
 			public void onSuccess(Object result) {
				...
				sampleTypeUsageParametersPanel.emptyTable();
 				...
 				for (int i = 0; i < usageParameterInfos.length; i++) {
 					...
 					if (GWT.getTypeName(usageParameterInfo).equals(
 									"org.mobicents.slee.container.management.console.client.usage.CounterTypeSBBUsageParameterInfo")) {
 					...
 					if (GWT.getTypeName(usageParameterInfo).equals(
 									"org.mobicents.slee.container.management.console.client.usage.SampleTypeSBBUsageParameterInfo")) {
 		...
 		usageService.getSBBUsageParameters(serviceInfo.getID(),
 				sbbInfo.getID(), parameterSetName, callback);
 	}
