 ...
 * @version $Id: Polyline.java,v 1.23 2003/08/28 10:43:06 desruisseaux Exp $
 ...
 public class Polyline extends Geometry {
    ...
    private static final String CARTESIAN_PROJECTION = "Stereographic";
     ...
     /**
      * Un des maillons de la chane de polylignes, ou
      * <code>null</code> s'il n'y a aucune donne de
      * mmorise.
      */
     ...
     static Polyline[] getInstances(final Shape shape, CoordinateSystem coordinateSystem) {
       ...
       loop: for (pit.next(); !pit.isDone(); pit.next()) {
              ...
              * la forme gomtrique qui vient d'tre balaye.
              */
     ...
     /**
      * Implmentation of the <code>intersects[Polyline|Edge](Polyline)</code> methods.
      *
