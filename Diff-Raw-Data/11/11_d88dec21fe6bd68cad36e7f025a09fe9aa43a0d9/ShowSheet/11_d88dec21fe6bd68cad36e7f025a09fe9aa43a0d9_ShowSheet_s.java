 ...
 import com.pathfinder.character.sheet.database.DatabaseHandler;
 ...
 ///////////////////////self written code////////////////////////////////////
     ...
     public ArrayList<SpellLevel> setSpellList() {
     	...
     	for(int i = 0; i < 10; i++){
     		for(int j = 0; j < 10; j++){
     			//Spell spell = new Spell("Spell " + j);
     			//spells.add(spell);
     			String nameOfSpell = "Spell " + i;
     			ArrayList<String> levelsOfSpell = new ArrayList<String>();
     			levelsOfSpell.add("Wizard " + i);
     			
     			db.addSpell(new Spell(nameOfSpell, levelsOfSpell));
     		}
     		
     		SpellLevel level = new SpellLevel("Level " + i, spells);
 ...
 ///////////////////////////////////////////////////////////////////////////////
 	...
 	public void hitPoints (View v)
 	{
 		  ...
 		  maxHP = myCharacter.getMaxHitPoint();
 		  ...
 		  text = (TextView) hitPointsDialog.findViewById(R.id.Totalhp);
 		  text.setText(Integer.toString(maxHP));
 		  ...
 		  changsSkillDialogDialogButton.setOnClickListener(new View.OnClickListener() 
 		  {
 			     ...
 			     { 
 					 ...
 					 editText = (EditText) hitPointsDialog.findViewById(R.id.Curent);
 					 text = (TextView)findViewById(R.id.hitPointsCurentScore);
 					 text.setText(editText.getText().toString());
 					 curent = Integer.parseInt(editText.getText().toString());
 					 
 					 editText = (EditText) hitPointsDialog.findViewById(R.id.Nonlethal);
 					
 					 text = (TextView)findViewById(R.id.hitPointsNonlethalScore);
 					 text.setText(editText.getText().toString());
 					 nonlethal = Integer.parseInt(editText.getText().toString());
 			    	 
 					 myCharacter.setHitPoint(curent, nonlethal);
 	...
 	public void totalHitPoints (View v)
 	{
 		  // Sets up the custom dialog
 		  final Dialog hitPointsDialog = new Dialog(this);
 		  hitPointsDialog.setContentView(R.layout.edit_max_hp);
 		  hitPointsDialog.setTitle("Hit Points");
 		  ...
 		  maxHP = myCharacter.getMaxHitPoint()-myCharacter.getconModHp();
 		  if (maxHP < 0)
 		  {
 			  maxHP = 0;
 		  }
 		  ...
 		  plussFromCon = "+ ";
 		  plussFromCon += Integer.toString(myCharacter.getconModHp());
 		  
 		  editText = (EditText) hitPointsDialog.findViewById(R.id.Hp);
 		  editText.setText(Integer.toString(maxHP));
 
 		  text = (TextView) hitPointsDialog.findViewById(R.id.plussFromCon);
 		  text.setText(plussFromCon);
 		  ...
 		  changsSkillDialogDialogButton.setOnClickListener(new View.OnClickListener() 
 		  {
 			     ...
 			     { 
 					 ...
 					 editText = (EditText) hitPointsDialog.findViewById(R.id.Hp);
 					 maxHP =  Integer.parseInt(editText.getText().toString());
 					// maxHP += myCharacter.getconModHp();
 					 myCharacter.setMaxHitPoint(maxHP);
 					 
 					 text = (TextView)findViewById(R.id.hitPointsToralScore);
 					 text.setText(Integer.toString(myCharacter.getMaxHitPoint()));
 	...
 	public void changesInfo (View v)
 	{
 		final TextView infoView = (TextView) v;
 		
 		  // Sets up the custom dialog
 		  final Dialog changesDietyDialog = new Dialog(this);
 		  changesDietyDialog.setContentView(R.layout.edit_single_text);
 		 
 		  if(v.getId() == R.id.textDeity1 || v.getId() == R.id.textDeity2)
 		  {
 			  changesDietyDialog.setTitle("Deity");
 		  }		  
 		  else if(v.getId() == R.id.textRace1 || v.getId() == R.id.textRace2)
 		  {
 			  changesDietyDialog.setTitle("Race");
 		  }
 		  else if(v.getId() == R.id.textName1 || v.getId() == R.id.textName2)
 		  {
 			  changesDietyDialog.setTitle("Name");
 		  }
 		  else if(v.getId() == R.id.textAge1 || v.getId() == R.id.textAge2)
 		  {
 			  changesDietyDialog.setTitle("Age");
 		  }
 		  else if(v.getId() == R.id.textHight1 || v.getId() == R.id.textHight2)
 		  {
 			  changesDietyDialog.setTitle("Hight");
 		  }
 		  else if(v.getId() == R.id.textWeight1 || v.getId() == R.id.textWeight2)
 		  {
 			  changesDietyDialog.setTitle("Weight");
 		  }
 		  else if(v.getId() == R.id.textAlignment1 || v.getId() == R.id.textAlignment2)
 		  {
 			  changesDietyDialog.setTitle("Alignment");
 		  }
 		  ...
 		  changesDietyDialogDialogButton.setOnClickListener(new View.OnClickListener() 
 		  {
 			     ...
 			     { 
 			    	 ...
 			    	 TextView textView;
 					  ...
 					  if(infoView.getId() == R.id.textDeity1 || infoView.getId() == R.id.textDeity2)
 					  {
 					    	 editText = (EditText) changesDietyDialog.findViewById(R.id.editText1);
 					    	 charactersInfo = editText.getText().toString();
 					    	 
 					    	 //savs Diety and set it on the character sheet
 					    	 textView = (TextView)findViewById(R.id.textDeity2);
 					    	 textView.setText(charactersInfo);
 					    	 textView.invalidate();
 					    	 myCharacter.setDiety(charactersInfo);
 					  }		  
 					  else if(infoView.getId() == R.id.textRace1 || infoView.getId() == R.id.textRace2)
 					  {
 					    	editText = (EditText) changesDietyDialog.findViewById(R.id.editText1);
 					    	charactersInfo = editText.getText().toString();
 					    	...
 					    	textView.setText(charactersInfo);
 						  	myCharacter.setRace(charactersInfo);
 					    	textView.invalidate();
 					  }
 					  else if(infoView.getId() == R.id.textName1 || infoView.getId() == R.id.textName2)
 					  {
 					    	 editText = (EditText) changesDietyDialog.findViewById(R.id.editText1);
 					    	 charactersInfo = editText.getText().toString();
 					    	 
 					    	 //savs name and set it on the character sheet
 					    	 textView = (TextView)findViewById(R.id.textName2);
 					    	 textView.setText(charactersInfo);
 							 myCharacter.setName(charactersInfo);
 					    	 textView.invalidate();
 					  }
 					  else if(infoView.getId() == R.id.textAge1 || infoView.getId() == R.id.textAge2)
 					  {
 					    	 editText = (EditText) changesDietyDialog.findViewById(R.id.editText1);
 					    	 charactersInfo = editText.getText().toString();
 					    	 
 					    	 //savs age and set it on the character sheet
 					    	 textView = (TextView)findViewById(R.id.textAge2);
 					    	 textView.setText(charactersInfo);
 							 myCharacter.setAge(Integer.parseInt(charactersInfo));
 					    	 textView.invalidate();
 					  }
 					  else if(infoView.getId() == R.id.textHight1 || infoView.getId() == R.id.textHight2)
 					  {
 					    	 editText = (EditText) changesDietyDialog.findViewById(R.id.editText1);
 					    	 charactersInfo = editText.getText().toString();
 					    	 
 					    	 //savs hight and set it on the character sheet
 					    	 textView = (TextView)findViewById(R.id.textHight2);
 					    	 textView.setText(charactersInfo);
 							 myCharacter.setHight(charactersInfo);
 					    	 textView.invalidate();
 					  }
 					  else if(infoView.getId() == R.id.textWeight1 || infoView.getId() == R.id.textWeight2)
 					  {
 					    	editText = (EditText) changesDietyDialog.findViewById(R.id.editText1);
 					    	charactersInfo = editText.getText().toString();
 					    	 
 					    	//savs weight and set it on the character sheet
 					    	textView = (TextView)findViewById(R.id.textWeight2);
 					    	textView.setText(charactersInfo);
 						  	myCharacter.setWeigth(Integer.parseInt(charactersInfo));
 					    	textView.invalidate();
 					  }
 					  else if(infoView.getId() == R.id.textAlignment1 || infoView.getId() == R.id.textAlignment2)
 					  {
 					    	 editText = (EditText) changesDietyDialog.findViewById(R.id.editText1);
 					    	 charactersInfo = editText.getText().toString();
 					    	 
 					    	 //savs alignment and set it on the character sheet
 					    	 textView = (TextView)findViewById(R.id.textAlignment2);
 					    	 textView.setText(charactersInfo);
 						 	 myCharacter.setAlignment(charactersInfo);
 					    	 textView.invalidate();
 					  }
 		  ...
 		  addItemDialogDialogButton.setOnClickListener(new View.OnClickListener() 
 		  {
 			     ...
 			     { 
 			    	...
 			    	lp.setMargins(0, 1, 0, 0);
 			    	 ...
 			    	 stringTester = textFromEditing.getText().toString();
 			    	 if (stringTester.length() < 1)
 			    	 {
 	...
 	View.OnClickListener equipmentEditor  = new View.OnClickListener() 
 	{
 		...
 		public void classEditing (View v)
 		{
 			  // Sets up the custom dialog
 			  final Dialog classEditingDialog = new Dialog(this);
 			  classEditingDialog.setContentView(R.layout.edit_class);
 			  classEditingDialog.setTitle("Classes");
 
 			  Button classEditingDialogDialogButton = (Button) classEditingDialog
 			    .findViewById(R.id.button1);
 			 
 			  Button classEditingDialogDialogButton2 = (Button) classEditingDialog
 					    .findViewById(R.id.button2);
 			
 			  // Exits the dialog if button is clicked
 			  classEditingDialogDialogButton.setOnClickListener(new View.OnClickListener() 
 			  {
 		
 				     public void onClick(View v) 
 				     { 
 				    	 
 				    	 classEditingDialog.dismiss();
 				     }
 			  });
 			  
 			  classEditingDialogDialogButton2.setOnClickListener(new View.OnClickListener() 
 			  {
 		
 				     public void onClick(View v) 
 				     { 
 						  // Sets up the custom dialog
 						  final Dialog addclassDialog = new Dialog(ShowSheet.this);
 						  addclassDialog.setContentView(R.layout.add_class);
 						  addclassDialog.setTitle("Add classes");
 
 						  Button addclassDialogDialogButton = (Button) addclassDialog
 						    .findViewById(R.id.button1);
 
 						  // Exits the dialog if button is clicked
 						  addclassDialogDialogButton.setOnClickListener(new View.OnClickListener() 
 						  {
 							     ...
 							     { 
 							    	 ...
 							    	 final int[] radioButtons = {R.id.radioButton0, R.id.radioButton1, R.id.radioButton2, R.id.radioButton3, R.id.radioButton4,
 							    			 					 R.id.radioButton5, R.id.radioButton6, R.id.radioButton7, R.id.radioButton8, R.id.radioButton9,
 							    			 					 R.id.radioButton10, R.id.radioButton11, R.id.radioButton12, R.id.radioButton13, R.id.radioButton14,
 							    			 					 R.id.radioButton15, R.id.radioButton16, R.id.radioButton17, R.id.radioButton18};
 							    	
 							    	 for (int i = 0; i < radioButtons.length; i++)
 							    	 {
 							    		 radioButton = (RadioButton) addclassDialog.findViewById(radioButtons[i]);
 							    		 if (radioButton.isChecked())
 							    		 {
 							    			 myCharacter.addclass(radioButton.getText().toString());
 							    			 textView = (TextView)findViewById(R.id.textClass2);
 							    			 textView.setText(myCharacter.classToDipslay());
 							    		 }
 							    	 }
 			  ...
 			  classEditingDialog.show();
 		}
 
 		public void addFeat (View v)
 		{
 			  // Sets up the custom dialog
 			  final Dialog addFeatDialog = new Dialog(this);
 			  addFeatDialog.setContentView(R.layout.new_feat);
 			  addFeatDialog.setTitle("Feat");
 
 
 			  Button addFeatDialogDialogButton = (Button)addFeatDialog
 			    .findViewById(R.id.button1);
 			
 			  // Exits the dialog if button is clicked
 			  addFeatDialogDialogButton.setOnClickListener(new View.OnClickListener() 
 			  {
 				     ...
 				     { 
 				    	...
 				    	lp.setMargins(0, 1, 0, 0);
 				    	 ...
 				    	 text = new TextView(getApplicationContext());
 				    	 textFromEditing = (EditText)addFeatDialog.findViewById(R.id.editText1);
 				    	 stringTester = textFromEditing.getText().toString();
 				    	 if (stringTester.length() < 1)
 				    	 {
 				    		 addFeatDialog.dismiss();
 				    	 }
 				    	 else
 				    	 {
 					    	 text.setText(textFromEditing.getText().toString());
 					    	 ...
 					    	 text.setClickable(true);
 					    	 text.setOnClickListener(editFeat);
 					    	 text.setId(text.hashCode());
 					    	 
 					    	
 					    	 
 					    	 layout = (LinearLayout) findViewById(R.id.featBox);
 					    	 layout.addView(text);
 					    	 
 					    	 feat = new Feat();
 					    	 feat.setFeat(text.getText().toString()); 
 					    	 feat.setID(text.hashCode());
 					    	 
 					    	 myCharacter.addFeat(feat);
 				    	 }
 				    	 addFeatDialog.dismiss();
 				     }
 			  });
 		...
 		View.OnClickListener editFeat  = new View.OnClickListener() 
 		{
 			Feat feat;
 			  ...
 			  public void onClick(View v) 
 			  {
 				...
 				feat = myCharacter.getFeat(v.getId());
 				 
 				// Sets up the custom dialog
 				  final Dialog editFeatDialog = new Dialog(ShowSheet.this);
 				  editFeatDialog.setContentView(R.layout.new_feat);
 				  editFeatDialog.setTitle("Edit item");
 				  
 				  EditText editText;
 				  if (feat != null)
 				  {
 					  editText = (EditText) editFeatDialog.findViewById(R.id.editText1);
 					  editText.setText(feat.getFeat());
 				  }
 				  else
 				  {
 					  editFeatDialog.setTitle("Sorry you are out of luck");
 					  editText = (EditText) editFeatDialog.findViewById(R.id.editText1);
 					  editText.setText("some is wrong with the code");
 				  }
 
 				  Button editFeatDialogDialogButton = (Button)editFeatDialog
 				    .findViewById(R.id.button1);
 				  Button editFeatDialogDialogButton2 = (Button)editFeatDialog
 					.findViewById(R.id.button2);
 				
 				  // Exits the dialog if button is clicked
 				  editFeatDialogDialogButton.setOnClickListener(new View.OnClickListener() 
 				  {
 					     ...
 					     { 
 					    	...
 					    	textFromEditing = (EditText)editFeatDialog.findViewById(R.id.editText1);
 					    	stringTester = textFromEditing.getText().toString();
 					    	if (stringTester.length() > 1)
 					    	{
 					    		feat.setFeat(textFromEditing.getText().toString());
 					    	}
 
 					    	text = (TextView)findViewById(feat.getID());
 					    	text.setText(feat.getFeat());
 					    	 
 					    	 myCharacter.replaceFeat(feat, feat.getID());
 					    	
 
 					    	 editFeatDialog.dismiss();
 
 					     }
 				  });
 				  
 				  editFeatDialogDialogButton2.setOnClickListener(new View.OnClickListener() 
 				  {
 					     ...
 					     public void onClick(View v) 
 					     {
 					    	...
 					    	myCharacter.removeFeat(feat.getID());
 					    	editFeatDialog.dismiss();
 					     }
 				  });
 	...
 	*****/
 	...
 	public void addAttack (View v)
 	{
 		  ...
 		  addAttackDialog.setTitle("Attacks");
 
 
 		  Button addAttackDialogDialogButton = (Button)addAttackDialog
 		    .findViewById(R.id.buttonAttackDone);
 		  ...
 		  addAttackDialogDialogButton.setOnClickListener(new View.OnClickListener() 
 		  {
 			     ...
 			     { 
			    	 ...
			    	 textFromEditing = (EditText)addAttackDialog.findViewById(R.id.editText1);
 			    	 stringTester = textFromEditing.getText().toString();
 			    	 if (stringTester.length() < 1)
 			    	 {
 			    	 ...
 			    	 {
 				    	 name.setText(textFromEditing.getText().toString());
 				    	 name.setTextColor(Color.rgb(0,0,0));
 				    	 name.setLayoutParams(lp);
 				    	 name.setClickable(true);
 				    	 name.setOnClickListener(attacksEditor);
 				    	 name.setId(name.hashCode());
 	 
 				    	 damage = new TextView(getApplicationContext());
				    	 textFromEditing = (EditText)addAttackDialog.findViewById(R.id.editText2);
 				    	 stringTester = textFromEditing.getText().toString();
 				    	 if (stringTester.length() < 1)
 				    	 {
 				    		 damage.setText("0");
 				    	 ...
 				    	 {
 				    		 damage.setText(textFromEditing.getText().toString());
 				    	 }
 				    	 damage.setTextColor(Color.rgb(0,0,0));
 				    	 damage.setLayoutParams(lp);
 				    	 damage.setOnClickListener(attacksEditor);
 				    	 damage.setClickable(true);
 				    	 damage.setId(damage.hashCode());
 				    	 
 				    	 crit = new TextView(getApplicationContext());
				    	 textFromEditing = (EditText)addAttackDialog.findViewById(R.id.editText3);
 				    	 stringTester = textFromEditing.getText().toString();
 				    	 if (stringTester.length() < 1)
 				    	 {
 				    		 crit.setText("0");
 				    	 ...
 				    	 {
 				    		 crit.setText(textFromEditing.getText().toString());
 				    	 }
 				    	 
 				    	 crit.setTextColor(Color.rgb(0,0,0));
 				    	 crit.setLayoutParams(lp);
 				    	 crit.setClickable(true);
 				    	 crit.setOnClickListener(attacksEditor);
 				    	 crit.setId(crit.hashCode());
 				    	 
 				    	 bonus = new TextView(getApplicationContext());
				    	 textFromEditing = (EditText)addAttackDialog.findViewById(R.id.editText4);
 				    	 stringTester = textFromEditing.getText().toString();
 				    	 if (stringTester.length() < 1)
 				    	 {
 				    		 bonus.setText("0");
 				    	 ...
 				    	 {
 				    		 bonus.setText(textFromEditing.getText().toString()); 
 				    	 }
 				    	 bonus.setTextColor(Color.rgb(0,0,0));
 				    	 bonus.setLayoutParams(lp);
 				    	 bonus.setClickable(true);
 				    	 bonus.setOnClickListener(attacksEditor);
 				    	 bonus.setId(bonus.hashCode());
 				    	 
 				    	 layout = (LinearLayout) findViewById(R.id.attackNameBox);
 				    	 layout.addView(name);
 				    	
 				    	 layout = (LinearLayout) findViewById(R.id.attackDamageBox);
 				    	 layout.addView(damage);
 				    	 
 				    	 layout = (LinearLayout) findViewById(R.id.attackCritBox);
 				    	 layout.addView(crit);
 				    	 
 				    	 layout = (LinearLayout) findViewById(R.id.attackBonusBox);
 				    	 layout.addView(bonus);
 				    	 addAttackDialog.dismiss();
 				    	 
 				    	 attack = new Attacks();
 				    	 attack.name = name.getText().toString();
 				    	 
 				    	 attack.nameID = name.hashCode();
 				    	 attack.damage = damage.getText().toString();
 				    	 attack.damageID = damage.hashCode();
 				    	 attack.crit = crit.getText().toString();
 				    	 attack.critID = crit.hashCode();
 				    	 attack.attackbonus = bonus.getText().toString();
 				    	 attack.bonusID = bonus.hashCode();
 				    	 myCharacter.addAttack(attack);
 			    	 }
 	...
 	View.OnClickListener attacksEditor  = new View.OnClickListener() 
 	{
 		Attacks attack;
 		...
 		public void onClick(View v) 
 		{
 			 ...
 			 attack = myCharacter.getAttack(v.getId());
 			 
 			// Sets up the custom dialog
 			  final Dialog addAttackDialog = new Dialog(ShowSheet.this);
 			  addAttackDialog.setContentView(R.layout.attacks_button_layout);
 			  addAttackDialog.setTitle("Edit attack");
 			  
 			  EditText editText;
 			  if (attack != null)
 			  {
 				  editText = (EditText) addAttackDialog.findViewById(R.id.editTextAttackName);
 				  editText.setText(attack.name);
 				  editText = (EditText) addAttackDialog.findViewById(R.id.editTextAttackDamage);
 				  editText.setText(attack.name);
 				  editText = (EditText) addAttackDialog.findViewById(R.id.editTextAttackCrit);
 				  editText.setText(attack.name);
 				  editText = (EditText) addAttackDialog.findViewById(R.id.editTextAttackBonus);
 				  editText.setText(attack.attackbonus);
 			  }
 			  else
 			  {
 				  addAttackDialog.setTitle("Sorry you are out of luck");
 				  editText = (EditText) addAttackDialog.findViewById(R.id.editTextAttackName);
 				  editText.setText("some is wrong with the code");
 				  editText = (EditText) addAttackDialog.findViewById(R.id.editTextAttackDamage);
 				  editText.setText("0");
 			  ...
 			  Button addAttackDialogDialogButton = (Button)addAttackDialog
 			    .findViewById(R.id.buttonAttackDone);
 			  Button addAttackDialogDialogButton2 = (Button)addAttackDialog
 				.findViewById(R.id.buttonAttackRemove);
 			  ...
 			  addAttackDialogDialogButton.setOnClickListener(new View.OnClickListener() 
 			  {
 				     ...
 				     { 
 				    	...
 				    	textFromEditing = (EditText)addAttackDialog.findViewById(R.id.editTextAttackName);
 				    	stringTester = textFromEditing.getText().toString();
 				    	if (stringTester.length() > 1)
 				    	{
 				    		attack.name = textFromEditing.getText().toString();
 				    	}
 				    	
 				    	textFromEditing = (EditText)addAttackDialog.findViewById(R.id.editTextAttackDamage);
 				    	stringTester = textFromEditing.getText().toString();
 				    	if (stringTester.length() > 1)
 				    	{
 				    		attack.damage = textFromEditing.getText().toString();
 				    	}
 				    	else
 				    	{
 				    		attack.damage = "xd+y";
 				    	}
 				    	textFromEditing = (EditText)addAttackDialog.findViewById(R.id.editTextAttackCrit);
 				    	stringTester = textFromEditing.getText().toString();
 				    	if (stringTester.length() > 1)
 				    	{
 				    		attack.crit = textFromEditing.getText().toString();
 				    	}
 				    	else
 				    	{
 				    		attack.crit = "20x2";
 				    	...
 				    	textFromEditing = (EditText)addAttackDialog.findViewById(R.id.editTextAttackBonus);
 				    	stringTester = textFromEditing.getText().toString();
 				    	if (stringTester.length() > 1)
 				    	{
 				    		attack.attackbonus = textFromEditing.getText().toString();
 				    	}
 				    	else
 				    	{
 				    	...
 				    	text = (TextView)findViewById(attack.nameID);
 				    	text.setText(attack.name);
 				    	text = (TextView)findViewById(attack.damageID);
 				    	text.setText(attack.damage);
 				    	text = (TextView)findViewById(attack.critID);
 				    	text.setText(attack.crit);
 				    	text = (TextView)findViewById(attack.bonusID);
 				    	text.setText(attack.attackbonus);
 				    	 
 				    	 myCharacter.replaceAttack(attack, attack.nameID);
 			  ...
 			  addAttackDialogDialogButton2.setOnClickListener(new View.OnClickListener() 
 			  {
 				     ...
 				     public void onClick(View v) 
 				     {
 				    	...
 				    	myCharacter.removeAttack(attack.nameID);
 				    	addAttackDialog.dismiss();
 				     }
 			  });
