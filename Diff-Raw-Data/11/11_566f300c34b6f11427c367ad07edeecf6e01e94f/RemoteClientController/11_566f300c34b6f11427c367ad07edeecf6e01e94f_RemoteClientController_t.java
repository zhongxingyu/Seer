 ...
 public class RemoteClientController
 {
     ...
     private IOQueue queue = new IOQueue(this);
     ...
     public void ftpChangeDirectory()
     {
         //TODO: Code
     }
         ...
         Runnable r = new Runnable()
         {
             ...
             public void run()
             {
                 try
                 {
                     ...
                     {
                         model.setFtpUsername(model.getCurrentServer().getFTPUsername());
                     }
                     if (fireChange)
                     {
                         model.fireChange();
         ...
         Runnable r = new Runnable()
         {
             ...
             public void run()
             {
                 try
                 {
                     if (model.isFtpEnabled())
                     {
                         model.setFtpPassword(model.getCurrentServer().getFTPPassword());
                     }
                     if (fireChange)
                     {
                         model.fireChange();
