 ...
 public class _001_00280_Predefined_Directories_Linux extends AbstractGranule {
 	...
 	protected void callback() {
 		DetachedCriteria criteria = 
 				DetachedCriteria.forClass(InventoryCategory.class)
 					.add(Restrictions.eq("nameKey", "inventory.destinations.directories"));
 		@SuppressWarnings("unchecked")
 		List<InventoryCategory> list = getHibernateTemplate().findByCriteria(criteria);
 		InventoryCategory directories = DAOUtil.getSingleResult(list);
