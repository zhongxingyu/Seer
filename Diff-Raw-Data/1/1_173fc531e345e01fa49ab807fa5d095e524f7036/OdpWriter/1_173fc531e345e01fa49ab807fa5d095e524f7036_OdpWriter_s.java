 ...
 {
 	protected static Logger logger = Logger.getLogger( OdpRender.class
 			.getName( ) );
 	...
 	public void newPage( float pageWidth, float pageHeight,
 			Color backgroundColor, String mpName )
 	{
 		currentPageNum++;
 	...
 	public void drawText( String text, float textX, float textY, float width,
 			float height, StyleEntry frameStyle, StyleEntry style, HyperlinkInfo link )
 	{
 	...
 	public void drawImage( String imageId, byte[] imageData, String imageUrl, String extension,
 			float imageX, float imageY, float height, float width,
 			String helpText, HyperlinkInfo link )
 	{
 	...
 	public void drawLine( double startX, double startY, double endX,
 			double endY, StyleEntry styleEntry )
 	{
 	...
 	private void drawRawLine( double startX, double startY, double endX,
 			double endY, StyleEntry lineStyle )
 	{
 	 ...
 	 */
 	public void drawBackgroundColor( double x, double y,
 			double width, double height, StyleEntry rectStyle )
 	{
 	...
 	/**
 	 * Draws the background image at the contentByteUnder with the
 	 * given offset
 	 * 
 	 * @param imageURI
 	 *            the URI referring the image
 	 * @param x
 	 *            the start X coordinate where the image is
 	 *            positioned
 	 * @param y
 	 *            the start Y coordinate where the image is
 	 *            positioned
 	 * @param width
 	 *            the width of the background dimension
 	 * @param height
 			...
 			float positionX, float positionY, int repeat )
 	{
 		...
 		{
 			drawImage( imageURI, null, imageURI, null,
 					position.getX(), position.getY(), imageHeight, imageWidth,
 					null, null );
 		}
 	}
