 ...
 public class CheckIn extends Activity{
 		...
 		public void onComplete(String response, Object state){
 			CheckIn.this.runOnUiThread(new Runnable(){
 				...
 				public void run(){
					...
					Toast.makeText(CheckIn.this, "WǦ\", Toast.LENGTH_LONG).show();
 					finish();
 				}
 			});
 		}
     ...
     public void onCreate(Bundle savedInstanceState) {
         ...
         send.setOnTouchListener(new Button.OnTouchListener(){
            ...
            if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {  //UɭԧܭIC
                 	send.setBackgroundResource(R.drawable.in_on);
                 }  
                if (motionEvent.getAction() == MotionEvent.ACTION_UP) {  //_Ӫɭԫ_IPC
     	...
     	send.setOnClickListener(new OnClickListener() {
     		public void onClick(View v){
            	...
            	//textview.setText("wǰeT"+item_name);
