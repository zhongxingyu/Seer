  ...
  * <p>
  * This information should be enough to get a minimal model going.<p>
 	...
 	public SchemaMeta generateSchemaMeta() throws PentahoMetadataException {
 		...
 		try
 		{
 			...
 			for (int i=0;i<tableNames.length;i++) {
 				...
 				//
 				PhysicalTable physicalTable = PhysicalTableImporter.importTableDefinition(database, schemaTable.getSchemaName(), schemaTable.getTableName(), locale);
