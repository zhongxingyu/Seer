 ...
 public class AppliedVariableAttribute<Container, Type> 
     ...
     @Override
     @Ignore
     public VariableAttribute$impl<Container, Type> $ceylon$language$meta$model$VariableAttribute$impl() {
         return null;
     }
     ...
     public Member$impl $ceylon$language$meta$model$Member$impl() {
         return null;
     }
     ...
     @Override
     protected ceylon.language.meta.model.Variable<Type> bindTo(Object instance) {
