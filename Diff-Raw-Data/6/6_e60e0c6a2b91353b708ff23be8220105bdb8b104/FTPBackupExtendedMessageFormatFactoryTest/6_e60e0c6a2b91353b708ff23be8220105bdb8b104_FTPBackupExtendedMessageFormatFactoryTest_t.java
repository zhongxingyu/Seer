 ...
 public class FTPBackupExtendedMessageFormatFactoryTest {
     ...
     public void testSingleNamedDate() throws Exception {
        Date date = new Date();
        performNamedArgumentTest(DateFormat.getDateInstance(DateFormat.SHORT).format(date), "{today,date,short}", Collections.<String, Object>singletonMap("today", date));
     }
     @Test
     ...
     private void performNamedArgumentTest(String expected, String format, Map<String, Object> namedArguments, Object... arguments) throws UnknownNamedArgumentException {
        assertThat(FTPBackupExtendedMessageFormatFactory.format(format, Locale.getDefault(), arguments, namedArguments), is(expected));
     }
 }
