 ...
 public class AuthorDB extends SQLiteOpenHelper {
     ...
     private void upgradeSchema1To2(SQLiteDatabase db) {
         ...
         while(cursor.moveToNext()){
             ...
             List<monakhv.samlib.sql.entity.Book> books = null;
             try {
                 books = (List<monakhv.samlib.sql.entity.Book>)deserializeObject(data);
             ...
             for (monakhv.samlib.sql.entity.Book book : books){
