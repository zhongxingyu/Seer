 ...
 public class JPanelCloseMoney extends JPanel implements JPanelView, BeanFactoryApp {
     ...
     private void m_jCloseCashActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jCloseCashActionPerformed
         ...
         if (res == JOptionPane.YES_OPTION) {
             ...
             props.setProperty("mail.smtp.host", m_App.getProperties().getProperty("mail.host"));
             props.setProperty("mail.smtp.starttls.enable", "true");
             props.setProperty("mail.smtp.port", m_App.getProperties().getProperty("mail.port"));
             props.setProperty("mail.smtp.auth", "true");
             props.setProperty("mail.smtp.user", m_App.getProperties().getProperty("mail.emailaddress"));
             ...
             message.setFrom(new InternetAddress(m_App.getProperties().getProperty("mail.emailaddress")));
             ...
             t.connect(m_App.getProperties().getProperty("mail.emailaddress"), m_App.getProperties().getProperty("mail.password"));
