 ...
 * @author missi
 */
public abstract class DoubleMatrix4D extends AbstractMatrix4D
{
	 ...
	 *             bounds.
	 */
	public void set(int indexNode1, int annotation1, int annotation2, int annotation3, double value)
	{
		if (indexNode1 < 0 || indexNode1 >= nodes || annotation1 < 0 || annotation1 >= annotations
				|| annotation2 < 0 || annotation2 >= annotations || annotation3 < 0
				|| annotation3 >= annotations)
			throw new IndexOutOfBoundsException("Wrong coordinate");
		setQuick(indexNode1, annotation1, annotation2, annotation3, value);
	}
	 ...
	 *            the value to be filled into the specified cell.
	 */
	public abstract void setQuick(int indexNode1, int annotation1, int annotation2,
			int annotation3, double value);
	 ...
	 *             bounds.
	 */
	public double get(int indexNode1, int annotation1, int annotation2, int annotation3)
	{
		if (indexNode1 < 0 || indexNode1 >= nodes || annotation1 < 0 || annotation1 >= annotations
				|| annotation2 < 0 || annotation2 >= annotations || annotation3 < 0
				|| annotation3 >= annotations)
		...
		return getQuick(indexNode1, annotation1, annotation2, annotation3);
	}
