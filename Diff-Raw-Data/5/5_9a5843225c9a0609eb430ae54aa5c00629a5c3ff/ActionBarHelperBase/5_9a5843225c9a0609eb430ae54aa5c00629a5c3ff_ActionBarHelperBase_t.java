 ...
 public class ActionBarHelperBase extends ActionBarHelper {
 	...
 	private void setupActionBar() {
 		...
 		SimpleMenuItem homeItem = new SimpleMenuItem(
 				tempMenu,
 				(mActivity instanceof HomeActivity) ? R.id.actionbar_compat_logo
 						: android.R.id.home, 0,
 				mActivity.getString(R.string.app_name));
 		homeItem.setIcon((mActivity instanceof HomeActivity) ? R.drawable.actionbar_logo
 				: R.drawable.actionbar_logo_icon);
 		...
 		if (!(mActivity instanceof HomeActivity)) {
 			...
 			// Add dummy spacer view
 			View v = new View(mActivity);
 			v.setLayoutParams(springLayoutParams);
 			actionBarCompat.addView(v);
 		}
 	}
 	...
 	private View addActionItemCompatFromMenuItem(final MenuItem item) {
 		...
 		final int style;
 		final int width;
 		if (itemId == R.id.actionbar_compat_logo) {
 			style = R.attr.actionbarCompatItemLogoStyle;
 			width = (int) mActivity.getResources().getDimension(
 					R.dimen.actionbar_compat_button_logo_width);
 		...
 		actionButton.setLayoutParams(new ViewGroup.LayoutParams(width,
 		...
 		if (item.getItemId() == R.id.menu_refresh) {
 			...
 			final int progressIndicatorWidth = (int) (buttonWidth / 2.5f + 0.5f);
