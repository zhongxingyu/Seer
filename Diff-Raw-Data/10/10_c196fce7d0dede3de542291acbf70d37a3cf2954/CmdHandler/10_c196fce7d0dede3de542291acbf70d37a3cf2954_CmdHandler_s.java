 ...
 public class CmdHandler {
     ...
     public static void displayAdminCmds(CommandSender sender) {
        ...
        /*sender.sendMessage(ChatColor.GREEN + "/ls modifygroup <join/quit/kick> <group> <string>" + ChatColor.WHITE + " -> "  
                + ChatColor.GOLD + "Change the join, quit or kick output for the specific group.");*/
        //sender.sendMessage(ChatColor.GREEN + "/ls modifydefault <join/quit/kick> <string>" + ChatColor.WHITE + " -> " + ChatColor.GOLD + "Change the default output for the specific type.");
         sender.sendMessage("----------------------------------------------------");
     }
     ...
     public static void displayMainPage(CommandSender sender) {
        ...
        sender.sendMessage(ChatColor.GREEN + "/ls prices [output]" + ChatColor.WHITE + " -> " + ChatColor.GOLD + "See info about charges/prices. You can add an output to check the price of it too.");
         sender.sendMessage("----------------------------------------------------");
     }
 }
