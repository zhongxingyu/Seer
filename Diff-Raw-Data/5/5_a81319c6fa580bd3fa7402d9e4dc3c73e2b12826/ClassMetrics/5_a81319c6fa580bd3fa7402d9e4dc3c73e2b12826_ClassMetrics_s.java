 ...
 public class ClassMetrics {
     ...
     public int getWmc() { return mWmc; }
 
     /** Increment the number of children */
     public void incNoc() { mNoc++; }
     /** Return the number of children */
     public int getNoc() { return mNoc; }
 
     /** Increment the Response for a Class */
     public void setRfc(int r) { mRfc = r; }
     /** Return the Response for a Class */
     public int getRfc() { return mRfc; }
 
     /** Set the depth of inheritence tree metric */
     public void setDit(int d) { mDit = d; }
     /** Return the depth of the class's inheritance tree */
     public int getDit() { return mDit; }
     ...
     public int getLcom() { return mLcom; }
     /** Set the class's lack of cohesion in methods metric */
     public void setLcom(int l) { mLcom = l; }
 
     /** Return the class's afferent couplings metric */
     public int getCa() { return mAfferentCoupledClasses.size(); }
     /** Add a class to the set of classes that depend on this class */
     public void addAfferentCoupling(String name) { mAfferentCoupledClasses.add(name); }
 
     /** Increment the number of public methods count */
     public void incNpm() { mNpm++; }
     /** Return the number of public methods metric */
     public int getNpm() { return mNpm; }
 
     /** Return true if the class is public */
     public boolean isPublic() { return mIsPublicClass; }
     /** Call to set the class as public */
     public void setPublic() { mIsPublicClass = true; }
