 package org.dots42.coffeebeans.rebind;
 ...
 public class CoffeeBeanFactoryGenerator extends Generator {
   ...
   private void writeAutoBean(AutoBeanType type) throws UnableToCompleteException {
     ...
     factory.setSuperclass(CoffeeBean.class.getCanonicalName() + "<"
         + type.getPeerType().getQualifiedSourceName() + ">");
     factory.addImport("com.google.web.bindery.autobean.shared.AutoBean");
     factory.addImport("com.google.web.bindery.autobean.shared.Splittable");
     factory.addImport("org.dots42.coffeebeans.shared.CoffeeBean");
     SourceWriter sw = factory.createSourceWriter(context, pw);
   ...
   private void writeReturnWrapper(SourceWriter sw, AutoBeanType type, AutoBeanMethod method)
     ...
     sw.println("toReturn = org.dots42.coffeebeans.shared.ChangeWrapper.wrap(\"%s\", toReturn, %s.this.getChangeSupport());",
         method.getPropertyName(), type.getSimpleSourceName());
