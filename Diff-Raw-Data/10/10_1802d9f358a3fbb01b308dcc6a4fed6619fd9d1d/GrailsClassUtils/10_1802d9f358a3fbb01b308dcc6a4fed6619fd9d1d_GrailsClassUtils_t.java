 ...
 public class GrailsClassUtils {
     ...
     public static MetaClass getExpandoMetaClass(Class clazz) {
        ...
        Assert.isTrue(registry.getMetaClassCreationHandler() instanceof ExpandoMetaClassCreationHandle, "Grailsrequiresaninstanceof[ExpandoMetaClassCreationHandle]tobesetinGroovy'sMetaClassRegistry!");
