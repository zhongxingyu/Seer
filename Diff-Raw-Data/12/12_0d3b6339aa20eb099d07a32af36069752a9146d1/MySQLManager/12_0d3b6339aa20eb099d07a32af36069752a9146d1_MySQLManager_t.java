 ...
 public class MySQLManager {
	...
	String hostname	= plugin.getConfig().getString("backends.sql.hostname","");
	String portnmbr	= Integer.toString(plugin.getConfig().getInt("backends.sql.port",0));
	String database	= plugin.getConfig().getString("backends.sql.database","");
	String username = plugin.getConfig().getString("backends.sql.username","");
	String password = plugin.getConfig().getString("backends.sql.password","");
