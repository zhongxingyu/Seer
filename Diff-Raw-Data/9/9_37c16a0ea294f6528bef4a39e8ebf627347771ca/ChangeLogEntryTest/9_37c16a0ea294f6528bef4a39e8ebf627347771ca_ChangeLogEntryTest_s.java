package org.maven.apache.scm.command.changelog;
     ...
     extends TestCase
 {
     ...
     public void testAddFileWithFileAndRevision()
     {
         ...
         assertTrue( "File name not found in list", instance.toString().indexOf( "maven:dummy" ) != -1 );
         assertTrue( "Revision not found in list", instance.toString().indexOf( "x.y" ) != -1 );
     }
     ...
     public void testToString()
     {
         ...
         assertTrue( "empty file list not found in string", value.indexOf( "[]" ) != -1 );
     }
     ...
     public void testToXML()
     {
         ...
         assertTrue( "XML doesn't start with changelog-entry", trimmedValue.startsWith( "<changelog-entry>" ) );
         assertTrue( "XML doesn't contain date", value.indexOf( "<date>2002-04-01</date>" ) != -1 );
         assertTrue( "XML doesn't contain author CDATA", value.indexOf( "<author><![CDATA[dion]]></author>" ) != -1 );
         assertTrue( "XML doesn't contain comment CDATA", value.indexOf( "<msg><![CDATA[comment]]></msg>" ) != -1 );
     }
