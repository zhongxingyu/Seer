 ...
 public class PlayerEventListener implements Listener {
 	...
 	public void onJoinEvent(final PlayerJoinEvent event) {
 		...
 		} else if (event.getPlayer().hasPermission("archergames.kit.Donor.Infinity") || event.getPlayer().hasPermission("archergames.kit.Donor.Lucky") || event.getPlayer().hasPermission("archergames.kit.Donor.Feeder") || event.getPlayer().hasPermission("archergames.kit.Donor.Juggernaut")) {
 			event.getPlayer().setDisplayName(ChatColor.GREEN + "" + event.getPlayer().getName() + ChatColor.WHITE);
 		} else if (event.getPlayer().hasPermission("archergames.kit.VIP.Healer") || event.getPlayer().hasPermission("archergames.kit.VIP.Sharpshooter") || event.getPlayer().hasPermission("archergames.kit.VIP.Punch") || event.getPlayer().hasPermission("archergames.kit.VIP.Wizard") || event.getPlayer().hasPermission("archergames.kit.VIP.Chef") || event.getPlayer().hasPermission("archergames.kit.VIP.Beastmaker")) {
 			event.getPlayer().setDisplayName(ChatColor.AQUA + "" + event.getPlayer().getName() + ChatColor.WHITE);
 		} else if (event.getPlayer().hasPermission("archergames.kit.Elite.Diamond") || event.getPlayer().hasPermission("archergames.kit.Elite.Miner") || event.getPlayer().hasPermission("archergames.kit.Elite.Baker") || event.getPlayer().hasPermission("archergames.kit.Elite.Tank") || event.getPlayer().hasPermission("archergames.kit.Elite.Prophet")) {
