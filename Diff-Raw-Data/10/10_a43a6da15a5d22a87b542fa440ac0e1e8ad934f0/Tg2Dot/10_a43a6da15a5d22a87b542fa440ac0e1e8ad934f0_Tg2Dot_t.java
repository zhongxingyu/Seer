 ...
 public class Tg2Dot extends Tg2Whatever {
 	...
 	protected void printIncidence(PrintStream out, Incidence i) {
 		...
 		String startLabel = "v";
 		String endLabel = "e";
		GraphElement<? extends GraphElementClass<?,?,?,?>,? extends GraphElement<?,?,?,?>,? extends GraphElementClass<?,?,?,?>,? extends GraphElement<?,?,?,?>> start = null;
		GraphElement<? extends GraphElementClass<?,?,?,?>,? extends GraphElement<?,?,?,?>,? extends GraphElementClass<?,?,?,?>,? extends GraphElement<?,?,?,?>> end = null; 
