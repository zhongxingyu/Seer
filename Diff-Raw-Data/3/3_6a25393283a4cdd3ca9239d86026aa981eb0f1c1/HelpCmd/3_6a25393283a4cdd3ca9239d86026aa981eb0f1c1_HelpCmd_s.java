 ...
 public class HelpCmd extends AbstractPlayerCommand {
     private enum Usage {
         ...
         ADMIN(Perm.ADMIN_HELP, "/admin help", "Show more admin commands.", true, false),
         ...
         MOD(Perm.MOD_HELP, "/mod help", "Show more mod commands.", true, false),
         ...
         WARDEN(Perm.WARDEN_HELP, "/warden help", "Show more warden commands.", true, false),
         ...
         VIP(Perm.VIP_HELP, "/vip help", "Show more vip commands.", true, false),
         ...
         CHAT(Perm.CHAT_HELP, "/chat help", "Show more chat commands.", true, false),
         ...
         CITY(Perm.CITY, "/city help", "Show more city commands.", true, false),
         ...
         CITY_MAYOR(Perm.CITY, "/city mayor <city> <player>", "Change the mayor of the city.", false, true),
         CITY_SET(Perm.CITY, "/city set", "Set the warp point for your city.", false, true),
         ...
         CLAN(Perm.CLAN, "/clan help", "Show more clan commands.", true, false),
        ...
        NICK(Perm.NICK, "/nick <nickname>", "Change your nickname.", false, false),
         MONEY(Perm.MONEY, "/money help", "Show more money commands.", true, false),
         ...
         REGION(Perm.REGION, "/region help", "Show more region commands.", true, false),
         ...
         WE(Perm.WE, "/we help", "Show more WE commands.", true, false),
         WE_EXT(Perm.WE_EXT, "/we ext [radius]", "Extinguish fires.", false, true),
         WE_DRAIN(Perm.WE_DRAIN, "/we drain [radius]", "Remove lava and water.", false, true),
         WE_UNDO(Perm.WE_UNDO, "/we undo", "Undo your last WE command.", false, true),
         WE_COPY(Perm.WE_COPY, "/we copy", "Copy a selection.", false, true),
         WE_PASTE(Perm.WE_PASTE, "/we paste", "Paste from clipboard.", false, true),
         WE_SET(Perm.WE_SET, "/we set <block>", "Fill an area with blocks.", false, true),
         WE_REPLACE(Perm.WE_REPLACE, "/we <old> <new>", "Replace blocks in an area.", false, true),
         WE_MOVE(Perm.WE_MOVE, "/we move <direction> <distance>", "Move an area of blocks.", false, true),
