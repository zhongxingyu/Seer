 ...
 public class CADRG
    ...
    /**
     * Return the number of horizontal frame files that will fit around the world
     * in the current zone. This only makes sense if the projection is at the
     * same scale as the chart data you are interested in.
     * 
    ...
    /**
     * Return the number of vertical frame files that will fit within the current
     * zone, overlaps included. This only makes sense if the projection is at the
     * same scale as the chart data you are interested in.
     * 
     ...
     * <p>
     * A point is plot-able in the CADRG projection if it is within the North and
     * South zone limits.
     * <p>
     * 
