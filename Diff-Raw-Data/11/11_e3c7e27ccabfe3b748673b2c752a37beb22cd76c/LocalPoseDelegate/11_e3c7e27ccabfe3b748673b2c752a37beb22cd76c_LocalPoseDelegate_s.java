 ...
 public class LocalPoseDelegate implements ServiceDelegate<LocalPoseRec>{
 	...
 	public LocalPoseRec getRecord(PresenceVector presenceVector) {	
		...
		localPoseRec.setX(Math.round(robotService.getRobotPosition().getX() + localPoseRecDiff.getX()));
		localPoseRec.setY(Math.round(-robotService.getRobotPosition().getY() + localPoseRecDiff.getY()));
		//localPoseRec.setYaw(Math.round(robotService.getRobotPosition().getTheta() + localPoseRecDiff.getYaw()));
		localPoseRec.setTimeStamp(robotService.getRobotPosition().getTimeStamp());
 		return localPoseRec;
 	}
