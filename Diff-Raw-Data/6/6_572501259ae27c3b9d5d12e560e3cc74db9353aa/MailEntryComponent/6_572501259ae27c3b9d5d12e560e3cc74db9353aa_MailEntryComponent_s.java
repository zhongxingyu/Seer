 	      ...
 	      public void valueChanged(ListSelectionEvent listSelectionEvent) 
 	      {
 			...
 			//ListSelectionModel lsm = (ListSelectionModel)listSelectionEvent.getSource();
 	    	  ...
 	    	  DefaultStyledDocument doc = new DefaultStyledDocument(context);
 	    	    ...
 	    	    try {
					doc.insertString(doc.getLength(), vc.get(listSelectionEvent.getFirstIndex()).getTitle()+"\n", style);
					doc.insertString(doc.getLength(), vc.get(listSelectionEvent.getFirstIndex()).getText(), style);
