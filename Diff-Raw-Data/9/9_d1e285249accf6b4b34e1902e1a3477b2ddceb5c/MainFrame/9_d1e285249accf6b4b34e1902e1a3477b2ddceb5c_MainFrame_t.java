 ...
 public class MainFrame {
 	...
 	public void init() {
 		...
 		try {
			model = CMOMLoader.loadModelFromCMOM(new File("resources/models/ship.cmom"));
 		} catch (IOException e) {
 			e.printStackTrace();
 		}
 		...
 		light = new Light(Matrix.vec3(11, 22, 7), Matrix.vec3(0.2f, 0.2f, 0.2f), Matrix.vec3(1f,
 				1f, 1), Matrix.vec3(1f, 1f, 1f), 100);
 	}
