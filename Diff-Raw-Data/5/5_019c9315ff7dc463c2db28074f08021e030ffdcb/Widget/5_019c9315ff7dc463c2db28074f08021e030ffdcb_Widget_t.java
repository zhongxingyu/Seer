 ...
 public abstract class Widget extends org.gnome.glib.Object
 {
      ...
      * 
      * When using the method you should return true to either display the tooltip
      * or false when not to display the tooltip. You can decide whether to show it or not based
      * on the x and y values that you receive from the method.
      * 
      * Note however that if keyboardMode is true x and y will be undefined.
      * 
      * You will also receive the {@link Tooltip} object where you can place the contents to show in
      * the tooltip. This is the only way to receive a tooltip object to work with.
      * 
    ...
    public interface QueryTooltip extends GtkWidget.QueryTooltipSignal
      ...
      * 
      * This will cause the widget to be be monitored for motion and leave notifications. Also note
      * that this cannot be turned off.
      * 
      * @since 4.1.3
      */
     /*
      * Note that notion in the javadoc entry that mentions that the leave and motion notifications
