 ...
 public class SmartStreetsApp {
    ...
    public void showWarning(Component component, String titleKey, String messageKey) {
        JOptionPane.showMessageDialog(component, getMessage(messageKey), getMessage(titleKey), JOptionPane.WARNING_MESSAGE);
    }

    public void showConfirmation(Component component, String titleKey, String messageKey) {
        JOptionPane.showMessageDialog(component, getMessage(messageKey), getMessage(titleKey), JOptionPane.INFORMATION_MESSAGE);
    }
