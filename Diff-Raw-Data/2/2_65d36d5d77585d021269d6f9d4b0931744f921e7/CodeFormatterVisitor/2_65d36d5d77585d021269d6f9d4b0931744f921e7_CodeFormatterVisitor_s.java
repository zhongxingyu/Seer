 ...
 //import org.eclipse.mod.wst.jsdt.core.formatter.DefaultCodeFormatterConstants;
 ...
 import org.eclipse.mod.wst.jsdt.internal.compiler.ast.ExplicitConstructorCall;
 ...
 //import org.eclipse.vjet.dsf.jstojava.formatter.AbortFormatting;
 //import org.eclipse.vjet.dsf.jstojava.formatter.Alignment;
 //import org.eclipse.vjet.dsf.jstojava.formatter.AlignmentException;
 ...
 */
 public class CodeFormatterVisitor extends ASTVisitor {
 	...
 	private PublicScanner localScanner;
 	...
 	public CodeFormatterVisitor(DefaultCodeFormatterOptions preferences, Map settings, int offset, int length, CodeSnippetParsingUtil codeSnippetParsingUtil) {
 		long sourceLevel = settings == null
 			...
 			: CompilerOptions.versionToJdkLevel(settings.get(VjetPlugin.COMPILER_SOURCE));
 		this.localScanner = new PublicScanner(true, false, false/*nls*/, sourceLevel/*sourceLevel*/, null/*taskTags*/, null/*taskPriorities*/, true/*taskCaseSensitive*/);
