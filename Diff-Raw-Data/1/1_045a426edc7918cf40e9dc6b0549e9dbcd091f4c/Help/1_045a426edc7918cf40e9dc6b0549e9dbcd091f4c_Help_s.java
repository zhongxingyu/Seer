 ...
 public class Help extends Alert {
     ...
     private static final String HELP_TEXT =
         ...
         "understood by the Java Swing JLabel class.  It<br>\n" +
         "is edited processed by running the <code>Help</code> class<br>\n" +
         "and then the output pasted into the Help class, and then<br>\n" +
         "the code is compiled.<br>\n" +
         "--><br>\n" +
         "<br>\n" +
         "<h2>DICOM Utility</h2><br>\n" +
         "<br>\n" +
