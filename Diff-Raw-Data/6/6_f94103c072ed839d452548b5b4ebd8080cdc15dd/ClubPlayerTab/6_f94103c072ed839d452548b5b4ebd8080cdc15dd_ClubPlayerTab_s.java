 ...
 //		setName("Flokkar/hpar - grunnggn");
 	...
 	public void initializeTexts() {
 		...
 		_unionText = new Text(iwrb.getLocalizedString(_unionFieldName, "Srsamband") + ":");
 		...
 		_coachesText = new Text(iwrb.getLocalizedString(_coachesFieldName, "jlfarar") + ":");
 	}
