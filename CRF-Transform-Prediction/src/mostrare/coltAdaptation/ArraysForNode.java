 ...
 * @author missi
 */
public class ArraysForNode
{
	/**
	 * Makes this class non instantiable, but still let's others inherit from it.
	 */
	protected ArraysForNode()
	{
	}
	 ...
	 *            the desired minimum capacity.
	 */
	public static Node[] ensureCapacity(Node[] array, int minCapacity, boolean defaultInc)
	{
		int oldCapacity = array.length;
		Node[] newArray;
		if (minCapacity > oldCapacity)
	 ...
	 *            the desired maximum capacity.
	 */
	public static Node[] trimToCapacity(Node[] array, int maxCapacity)
	{
		if (array.length > maxCapacity)
		{
			Node oldArray[] = array;
