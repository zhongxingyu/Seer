 ...
 * @author missi
 */
public abstract class IntArrayListMatrix2D extends AbstractMatrix2D
{
	/**
	 ...
	 *             bounds.
	 */
	public void set(int indexNode1, int annotation1, IntArrayList value)
	{

		if (indexNode1 < 0 || indexNode1 >= rows || annotation1 < 0 || annotation1 >= columns)
	 ...
	 *            the value to be filled into the specified cell.
	 */
	public abstract void setQuick(int indexNode1, int annotation1, IntArrayList value);
	 ...
	 *             bounds.
	 */
	public IntArrayList get(int indexNode1, int annotation1)
	{
		if (indexNode1 < 0 || indexNode1 >= rows || indexNode1 < 0 || indexNode1 >= columns)
			throw new IndexOutOfBoundsException("Wrong coordinate");
	 ...
	 * @return the value of the specified cell.
	 */
	public abstract IntArrayList getQuick(int indexNode1, int annotation1);
