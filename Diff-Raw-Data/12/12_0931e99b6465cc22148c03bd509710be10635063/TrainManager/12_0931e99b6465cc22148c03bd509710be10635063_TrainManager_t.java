 ...
 public class TrainManager {
 	...
 	public void updateCorsa(int idCorsa, int idNuovaTratta,
 		...
 		Tratta t = em.find(Tratta.class, idTratta);
 		StazioneTratta ultimaStazione = t.getStazioniTratta().get(0);
 		for(int i=1; i< t.getStazioniTratta().size();i++){
 			if (ultimaStazione.getDistanza() < t.getStazioniTratta().get(i).getDistanza()){
 				ultimaStazione=t.getStazioniTratta().get(i);
 			}
 		}
