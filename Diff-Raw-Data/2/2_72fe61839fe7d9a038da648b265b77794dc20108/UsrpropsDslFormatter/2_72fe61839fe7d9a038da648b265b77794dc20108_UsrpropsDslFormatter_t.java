 ...
 public class UsrpropsDslFormatter extends AbstractDeclarativeFormatter {
     ...
     protected void configureFormatting(FormattingConfig c) {
        ...
        c.setNoLinewrap().around(grammar.getBrowserShowHideAccess().getBeginAssignment_1());
        c.setNoLinewrap().around(grammar.getBrowserShowHideAccess().getEndAssignment_3());
