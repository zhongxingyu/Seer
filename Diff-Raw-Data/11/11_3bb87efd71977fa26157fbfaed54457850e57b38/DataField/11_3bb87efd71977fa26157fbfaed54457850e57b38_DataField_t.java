 ...
 public enum DataField {
 	ACCOUNT_TYPE("accountType"), ADDED_ACCOUNT("add_account"), ANDROID_ID(
 			"androidId"), AUTH_TOKEN("Auth"), CAN_UPGRADE_PLUS(
 			"GooglePlusUpgrade"), CAPTCHA_ANSWER("logincaptcha"), CAPTCHA_BITMAP(
 			"captchaBitmap"), CAPTCHA_DATA("CaptchaData"), CAPTCHA_TOKEN(
