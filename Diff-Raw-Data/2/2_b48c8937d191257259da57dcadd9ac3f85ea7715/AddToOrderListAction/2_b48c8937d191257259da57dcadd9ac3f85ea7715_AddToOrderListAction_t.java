 ...
 public class AddToOrderListAction  extends BaseAction
 {
 	...
 	private void removeSelectedItems (String[] itemsToRemove,HttpSession session)
 	{
 		...
 		if(itemsToRemove != null)
 		{
 			...
 			for(int itemCount=0;itemCount < itemsToRemove.length;itemCount++)
 			{
 				...
 				if(session.getAttribute(Constants.REQUESTED_BIOSPECIMENS) != null)
 				{
 					Map orderItemsMap = (HashMap)session.getAttribute(Constants.REQUESTED_BIOSPECIMENS);
 					
 					if(orderItemsMap.containsKey(arrayNameToRemove))
 					{
 						List orderItemsList = (ArrayList) orderItemsMap.get(arrayNameToRemove);
 						OrderSpecimenBean orderSpecimenBeanObj = (OrderSpecimenBean)orderItemsList.get(rowIndex);
 						
 						//Move the orderspecimenobjects that are to be removed to orderItemsToRemoveList
 						if(specimenNameToRemove.equalsIgnoreCase(orderSpecimenBeanObj.getSpecimenName()))
 						{
 			...
 			orderItemsToRetainMap = (HashMap)session.getAttribute(Constants.REQUESTED_BIOSPECIMENS);
 	...
 	private Map putValueInMapSpecimen(OrderSpecimenForm orderSpecimenFormObject,HttpServletRequest request)
 	{
 		...
 		for(int j=0;j<strSelectedItems.length;j++)
     	{
 			...
 			specimenMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_availableQuantity", tempOrderSpecimenFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_availableQuantity"));
 	 ...
 	 */
 	private Map putValueInMapArray(OrderBiospecimenArrayForm orderArrayFormObject,HttpServletRequest request)
 	{
 		...
 		for(int j=0;j<strSelectedItems.length;j++)
     	{
 			arrayMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_specimenId", tempOrderArrayFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_specimenId"));
 			arrayMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_specimenName", tempOrderArrayFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_specimenName"));
 			arrayMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_availableQuantity", tempOrderArrayFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_availableQuantity"));
 			arrayMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_requestedQuantity", tempOrderArrayFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_requestedQuantity"));
 			arrayMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_description", tempOrderArrayFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_description"));
 			arrayMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_unitRequestedQuantity", tempOrderArrayFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_unitRequestedQuantity"));
 			arrayMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_checkedToRemove",tempOrderArrayFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_checkedToRemove"));
 			...
 			{
 				arrayMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_unitRequestedQuantity", "count");
 			}
 	 ...
 	 */
 	private Map putValueInMapPathology(OrderPathologyCaseForm pathologyFormObject,HttpServletRequest request)
 	{
 		int reqQntyError=0;
 		...
 		for(int j=0;j<strSelectedItems.length;j++)
     	{
 			pathologyMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_specimenId", tempOrderPathologyFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_specimenId"));
 			pathologyMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_specimenName", tempOrderPathologyFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_specimenName"));
 			pathologyMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_availableQuantity", tempOrderPathologyFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_availableQuantity"));
 			pathologyMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_requestedQuantity", tempOrderPathologyFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_requestedQuantity"));
 			pathologyMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_description", tempOrderPathologyFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_description"));
 			pathologyMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_specimenCollectionGroup", tempOrderPathologyFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_specimenCollectionGroup"));
 			
 			pathologyMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_isDerived",pathologyFormObject.getTypeOfCase());
     		...
     		pathologyMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_typeOfItem",tempOrderPathologyFormObjectMap.get("OrderSpecimenBean:"+strSelectedItems[j]+"_typeOfItem"));
     		pathologyMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_arrayName",pathologyFormObject.getAddToArray());
 
     		pathologyMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_pathologicalStatus",pathologyFormObject.getPathologicalStatus());
     		pathologyMap.put("OrderSpecimenBean:"+strSelectedItems[j]+"_tissueSite",pathologyFormObject.getTissueSite());
