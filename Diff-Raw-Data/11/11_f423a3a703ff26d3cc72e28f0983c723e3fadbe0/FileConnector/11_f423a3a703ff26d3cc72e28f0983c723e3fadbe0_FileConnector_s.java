 ...
 */
 package org.apache.acf.crawler.connectors.filesystem;
 ...
 */
 ...
 "<table class=\"displaytable\">\n"
     ...
     while (i < ds.getChildCount())
     {
       ...
       if (sn.getType().equals("startpoint"))
       {
         ...
         out.print(
 "  <tr>\n"+
 "    <td class=\"description\">"+org.apache.acf.ui.util.Encoder.bodyEscape(sn.getAttributeValue("path"))+":"+"</td>\n"+
 "    <td class=\"value\">\n"
         );
         int j = 0;
         while (j < sn.getChildCount())
 ...
 "      "+org.apache.acf.ui.util.Encoder.bodyEscape(excludeNode.getAttributeValue("match"))+"<br/>\n"
           );
         }
         out.print(
 "    </td>\n"+
