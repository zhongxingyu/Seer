 package net.LoadingChunks.LeGreenText;
 
 /*
     This file is part of LeGreenText
 ...
 public class LeGreenTextEventListener implements Listener {
 
 	private LeGreenText plugin;
 
 	public LeGreenTextEventListener(LeGreenText plugin) {
 		this.plugin = plugin;
 	}
