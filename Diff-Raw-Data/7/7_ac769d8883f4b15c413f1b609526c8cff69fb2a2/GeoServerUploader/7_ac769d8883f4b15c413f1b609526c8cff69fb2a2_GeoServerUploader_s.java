 ...
 public class GeoServerUploader {
 	...
 	public GeoServerUploader(String username, String password, String port) {
 	...
 	public String createWorkspace() throws HttpException, IOException{
 		String target = "http://localhost:"+port+"/geoserver/rest/workspaces";
 		String request = "<workspace><name>N52</name></workspace>";
 		String result =	sendRasterRequest(target, request, "POST", username, password);
 		return result;
 	}
