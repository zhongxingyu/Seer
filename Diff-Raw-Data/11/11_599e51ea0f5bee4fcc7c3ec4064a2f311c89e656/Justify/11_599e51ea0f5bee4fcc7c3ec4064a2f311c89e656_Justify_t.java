 ...
 public class Justify extends JotifyConnection{
 	...
 	public static void main(String args[]) throws IOException{
 		...
 		if (args.length < 5 || args.length > 6 ){
 			...
 			System.err.println("    cover: descargar cartula del lbum");
 			return;
 		}
 	...
 	private void downloadTrack(Track track, String parent, String bitrate) throws JustifyException, TimeoutException{
 		...
 		try{
			...
			if (track.getRestrictions().get(0).getForbidden().contains(country)) {
				System.out.println("!!! Track no disponible en la regin " +  country + ". Regiones prohibidas: " + track.getRestrictions().get(0).getForbidden());
 				return;
 			}
			else {
