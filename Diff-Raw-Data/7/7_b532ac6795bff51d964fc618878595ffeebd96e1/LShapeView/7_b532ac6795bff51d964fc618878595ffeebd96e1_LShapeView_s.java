 ...
 //
 //	/**
 //	 * Scales the model and updates the view.
 //	 * @param newPos The new position of the moved point of the shape.
 //	 * @param position The position of the used handler.
 //	 * @since 3.0
 //	 */
 //	public Position scale(IPoint newPos, Position position)
 //	{
 //		if(position==null || !GLibUtilities.INSTANCE.isValidPoint(newPos))
 //			return position;
 //
 //		double gap;
 ...
 //		switch(shape.getBordersPosition()) {
 //			case MID:
 //				gap = shape.hasDbleBord() ? shape.getThickness()+shape.getDbleBordSep()/2. : shape.getThickness()/2.;
 //				break;
 //
 //			case OUT:
 //				gap = shape.hasDbleBord() ? shape.getThickness()*2.+shape.getDbleBordSep() : shape.getThickness();
 //				break;
 //
 //			default:
 //			case INTO:
 ...
 //		{
 //			case EAST:
 //				pos  = shape.setRight(newPos.getX()-gap) ? Position.WEST : Position.EAST;
 //				break;
 //
 //			case NE:
 //				b   = shape.setTop(newPos.getY()+gap);
 //				l   = shape.setRight(newPos.getX()-gap);
 //				pos = b ? l ? Position.SW : Position.SE : l ? Position.NW : Position.NE;
 //				break;
 //
 //			case NORTH:
 //				pos = shape.setTop(newPos.getY()+gap) ? Position.SOUTH : Position.NORTH;
 //				break;
 //
 //			case NW:
 //				b   = shape.setTop(newPos.getY()+gap);
 //				r   = shape.setLeft(newPos.getX()+gap);
 //				pos = b ? r ? Position.SE : Position.SW : r ? Position.NE : Position.NW;
 //				break;
 //
 //			case SE:
 //				t   = shape.setBottom(newPos.getY()-gap);
 //				l   = shape.setRight(newPos.getX()-gap);
 //				pos = t ? l ? Position.NW : Position.NE : l ? Position.SW : Position.SE;
 //				break;
 //
 //			case SOUTH:
 //				pos = shape.setBottom(newPos.getY()-gap) ? Position.NORTH : Position.SOUTH;
 //				break;
 //
 //			case SW:
 //				t   = shape.setBottom(newPos.getY()-gap);
 //				r   = shape.setLeft(newPos.getX()+gap);
 //				pos = t ? r ? Position.NE : Position.NW : r ? Position.SE : Position.SW;
 //				break;
 //
 //			case WEST:
 //				pos = shape.setLeft(newPos.getX()+gap) ? Position.EAST : Position.WEST;
 //				break;
 //		}
 //
 //		shape.update();
