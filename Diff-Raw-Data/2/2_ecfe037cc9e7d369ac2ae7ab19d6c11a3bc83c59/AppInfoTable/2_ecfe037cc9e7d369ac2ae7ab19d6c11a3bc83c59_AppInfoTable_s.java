 ...
 public class AppInfoTable {
 	...
 	public static final String KEY_APP_CHANGELOG = "changelog";
 	...
 	public static final String TABLE_CREATE_APPINFO = "create table " + DATABASE_TABLE_NAME
			...
			+ KEY_APP_ADMOB_SITE_ID + " text, " + KEY_APP_LAST_COMMENTS_UPDATE + " date"
 			+ KEY_APP_DESCRIPTION + " text, " + KEY_APP_CHANGELOG + " text)";
 	...
 	static {
 		...
 		PROJECTION_MAP.put(AppInfoTable.KEY_APP_DESCRIPTION, AppInfoTable.KEY_APP_DESCRIPTION);
 		PROJECTION_MAP.put(AppInfoTable.KEY_APP_CHANGELOG,
 				AppInfoTable.KEY_APP_CHANGELOG);
