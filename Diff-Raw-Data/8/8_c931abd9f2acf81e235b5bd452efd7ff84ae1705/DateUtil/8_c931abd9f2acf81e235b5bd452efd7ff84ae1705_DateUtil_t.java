 ...
 public class DateUtil {
 	...
 	public static java.sql.Date toDate(final java.util.Date date) {
		...
		return new java.sql.Date(new DateMidnight(date).getMillis());
 	}
 	...
 	public static Date getDate() {
		return new java.sql.Date(new DateMidnight().getMillis());
 	}
 	...
 	public static Date addDays(final Date date, final int days) {
		return toDate(new DateMidnight(date).plusDays(days).toDate());
