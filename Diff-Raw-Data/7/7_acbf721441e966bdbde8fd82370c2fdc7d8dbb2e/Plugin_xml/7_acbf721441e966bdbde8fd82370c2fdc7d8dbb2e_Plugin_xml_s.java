 ...
 /**
  * Entry point of the 'Plugin_xml' generation module.
  *
  * @author <a href="mailto:goulwen.lefur@obeo.fr">Goulwen Le Fur</a>
  * @generated
  */
 public class Plugin_xml extends AbstractAcceleoGenerator {
 	/**
 	 * The name of the module.
 	 *
 	 * @generated
 	 */
 	public static final String MODULE_FILE_NAME = "plugin_xml";
 	 ...
 	 * @generated
 	 */
 	public static final String[] TEMPLATE_NAMES = { "plugin_xml", };
 	 ...
 	 * @generated
 	 */
 	public Plugin_xml(URI modelURI, File targetFolder,
 	 ...
 	 * @generated
 	 */
 	public Plugin_xml(EObject model, File targetFolder,
 			List<? extends Object> arguments) throws IOException {
     ...
     try {
       if (args.length < 2) {
         ...
         Plugin_xml generator = new Plugin_xml(modelURI, folder, arguments);
