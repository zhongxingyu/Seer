 ...
 * @author missi
 */
public interface DeltaParts
{
	/**
	 * Returns the annotations that maximizes the "score".
	 * 
	 * @return the annotations that maximizes the "score".
	 */
	public abstract int[][] argmaxDeltaTopk();
	
	public abstract int[] argmaxDelta();

	/**
	 * Computes every delta value. Must be called before {@link #argmaxDelta()}.
	 */
	public abstract void fillDeltas(Tree tree);
