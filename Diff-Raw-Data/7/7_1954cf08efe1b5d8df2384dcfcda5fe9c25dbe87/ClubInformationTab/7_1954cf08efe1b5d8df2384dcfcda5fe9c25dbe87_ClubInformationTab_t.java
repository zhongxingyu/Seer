 ...
 public class ClubInformationTab extends UserGroupTab {
 	...
 	public void updateFieldsDisplayStatus() {
 		...
 		if (connection != null && !connection.equals("")) {
 			_connectionToSpecialField.setDisabled(true);
 			_makeField.addMenuElement("2", "Srgreinaflag");
 			_makeField.addMenuElement("4", "virkt");
 		}
 		else {
 			_makeField.addMenuElement("1", "Fjlgreinaflag");
 			_makeField.addMenuElement("2", "Srgreinaflag");
 			_makeField.addMenuElement("3", "Flag n ikenda");
 			_makeField.addMenuElement("4", "virkt");
 	...
 	public void initializeFields() {
 		...
 		/**
 		 * @todo Setja  tflu og skja aan.
 		 */
 		_typeField.addMenuElement("1", "Innlent flag");
 		_typeField.addMenuElement("2", "Srsamband");
 		_typeField.addMenuElement("3", "Hrassamband/rttabandalag");
 
 
 		_statusField.addMenuElement("0", "");
 		_statusField.addMenuElement("1", "Virkt");
 		_statusField.addMenuElement("2", "virkt");
