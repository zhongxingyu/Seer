 ...
 public class InputScanner extends AbstractTokenStream {
     ...
     private void readEscapeSequence(StringBuilder lexem) throws ParseException {
         ...
         while (!this.eos) {
             ...
             if (next == '"') {
                 ...
                 this.parseException("Ungltige-Escape Sequenz: '\\" + (char) next + "'",
                     tokenStart);
             }
         }
     }
     ...
     private Token readUser() throws ParseException {
         ...
         this.parseException("Ungltiges User-Literal: " + lexem.toString(), tokenStart);
         return null;
     }
     ...
     private Token readIdentifier() throws ParseException {
         ...
         this.parseException("Unglltiger identifier: " + lexem.toString(), tokenStart);
         return null;
     }
     ...
     private Token identifierToToken(String string, int tokenStart) throws ParseException {
         ...
         if (lookup == null) {
             ...
             this.parseException("Ungltiger Identifier: " + string, tokenStart);
             return null; /* unreachable */
         } else {
         ...
         while (!this.eos) {
             if (state == 0) {
                 ...
                 if (firstPart > 31 || secondPart > 12) {
                     this.parseException("Unglltiges DateTime-Literal", tokenStart);
                 }
                 ...
                 if (Character.isDigit(next)) {
                     ...
                     this.pushBack(next);
                     this.parseException("Ungltiges Date-Time-Literal", tokenStart);
                 }
                 ...
                 if (Character.isDigit(next)) {
                     ...
                     this.pushBack(next);
                     this.parseException("Ungltige Zahl", tokenStart);
                 }
