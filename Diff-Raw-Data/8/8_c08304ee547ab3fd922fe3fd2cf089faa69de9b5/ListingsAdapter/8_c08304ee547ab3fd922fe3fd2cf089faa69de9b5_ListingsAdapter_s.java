 ...
 public class ListingsAdapter extends ArrayAdapter<Listing> {
     ...
     public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView title = (TextView)rowView.findViewById(R.layout.activity_main_textview_title);
         title.setText(targetListing.getTitle());
 
        TextView subreddit = (TextView)rowView.findViewById(R.layout.activity_main_textview_subreddit);
