 ...
 public class BetaStrategyMasterTest
 {
 	...
 	public void testGetPieceAt_Red(){
		assertEquals(new Piece(PieceType.FLAG, PlayerColor.RED), game.getPieceAt(new Location2D(0,0)));
 	}
 	
 	@Test
 	public void testGetPieceAt_Blue(){
		assertEquals(new Piece(PieceType.FLAG, PlayerColor.BLUE), game.getPieceAt(new Location2D(5,0)));
 	}
 	
 	@Test
 	public void testGetPieceAt_RedLieutenant(){
		assertEquals(new Piece(PieceType.LIEUTENANT, PlayerColor.RED), game.getPieceAt(new Location2D(1,0)));
 	}
