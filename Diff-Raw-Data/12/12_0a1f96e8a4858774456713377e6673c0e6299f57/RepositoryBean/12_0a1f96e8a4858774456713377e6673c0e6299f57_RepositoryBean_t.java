     ...
     public List<Triple> getAllRerencesToObjectSortedAsTriple(String pid) throws ServerOperationFailed, RemoteException, ServiceException, MalformedURIException {
        ...
        int i = 0;
         for (ObjectRelation rel : rels) {
            DigitalObject obj = new DigitalObject(new URI(rel.getObjectPid()), rel.getObject().getTitle());   //TODO this getTitle require a load of the object, which is expensive.
            DigitalObject sub = new DigitalObject(new URI(rel.getSubjectPid()), rel.getSubject().getTitle());
