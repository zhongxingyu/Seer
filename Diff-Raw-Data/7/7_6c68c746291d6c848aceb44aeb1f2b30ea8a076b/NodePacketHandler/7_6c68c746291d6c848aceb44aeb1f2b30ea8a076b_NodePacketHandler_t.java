...
/** Handles incoming and outgoing Packets on Node to Node Level.
  *
         ...
         try
         {
             ...
             while(true == en.hasMoreElements())
             {
                 ...
                 while(true == ei.hasMoreElements())
                 {
                    ...
                    // else -> loop back Address cannot be announced
                    // and is not needed we can use the public IP of this Host for loop back communication
                 }
             }
         }
