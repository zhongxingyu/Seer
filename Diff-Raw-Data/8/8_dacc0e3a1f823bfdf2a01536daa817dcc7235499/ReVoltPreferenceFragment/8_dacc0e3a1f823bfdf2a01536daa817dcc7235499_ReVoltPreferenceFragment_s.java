  ...
  */
 public class ReVoltPreferenceFragment extends PreferenceFragment implements DialogCreatable {
     ...
     public static class SettingsDialogFragment extends DialogFragment {
         ...
         public Dialog onCreateDialog(Bundle savedInstanceState) {
             if (savedInstanceState != null) {
                 ...
                 if (mParentFragment instanceof ReVoltPreferenceFragment) {
                     // restore mDialogFragment in mParentFragment
                     ((ReVoltPreferenceFragment) mParentFragment).mDialogFragment = this;
                 }
             }
         ...
         public void onDetach() {
             ...
             if (mParentFragment instanceof ReVoltPreferenceFragment) {
                 ...
                 if (((ReVoltPreferenceFragment) mParentFragment).mDialogFragment == this) {
                     ((ReVoltPreferenceFragment) mParentFragment).mDialogFragment = null;
                 }
             }
         }
     }
