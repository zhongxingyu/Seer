...
public class DenseDoubleMatrix2D extends DoubleMatrix2D
{
	 ...
	 */
	public DenseDoubleMatrix2D(int nodes, int annotations)
	{
		setUpQuick(nodes, annotations);
		elements = new double[nodes * annotations];
	}

	@Override
	public void setQuick(int indexNode1, int annotation1, double value)
	{
		elements[indexNode1 * firstNodeStride + annotation1] = value;
	}

	@Override
	public double getQuick(int indexNode1, int annotation1)
	{
		return elements[indexNode1 * firstNodeStride + annotation1];
	}
