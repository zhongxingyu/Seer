 /*
  * Copyright (C) 2011 The SavagedZen Project
  *
...
public class VDDLevelsHavsActivity extends AlertActivity {
     ...
     protected void onCreate(Bundle savedInstanceState) {
         ...
         try {
             ...
             int numRead;
             inputReader = new FileReader(vddlevelshavs_PATH);
         ...
         webView.setWebViewClient(new WebViewClient() {
             ...
             public void onPageFinished(WebView view, String url) {
                 ...
                 mAlert.setTitle(getString(R.string.vddlevelshavs_dialog));
             }
         });
 
         final AlertController.AlertParams p = mAlertParams;
         p.mTitle = getString(R.string.vddlevelshavs_loading);
         p.mView = webView;
     ...
     private void showErrorAndFinish() {
         Toast.makeText(this, R.string.vddlevelshavs_error, Toast.LENGTH_LONG)
                 .show();
         finish();
     }
