 ...
 /**
  * An abstract builder that is designed to be extended for testing
  * purposes.
  */
  ...
  * failure if expectations are not met.  If successful, clears the list of expected
  * and actual events in preparation for the next test.
  */
 ...
 /**
  * Return the data, always a <code>Hashtable</code> or
  * <code>String</code>, that was set when this builder was initialized.
  * @see setInitializationData(IConfigurationElement, String, Object)
  */
 ...
 /**
  * Return the name of the child configuration element that named
  * this builder in its class attribute.
  * @see setInitializationData(IConfigurationElement, String, Object)
  */
