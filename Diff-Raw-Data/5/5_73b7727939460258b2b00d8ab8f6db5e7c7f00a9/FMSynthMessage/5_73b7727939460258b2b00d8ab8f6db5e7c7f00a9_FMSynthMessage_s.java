 ...
 public class FMSynthMessage extends CausticMessage {
     ...
     public enum FMOperatorControl {
         ...
         /**
          * Returns a {@link FMOperatorControl} based off the passed String name.
          * 
     ...
     public enum FMAlgorithm {
        ...
        OneTwoThree(4),
         ...
         /**
          * Returns a {@link FMAlgorithm} based off the passed integer type.
          * 
          * @param type The int type.
          */
         ...
         /**
          * @see FMAlgorithm#toType(Integer)
          */
